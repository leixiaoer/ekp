...
<html>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
		...
		<script>
			function openInBrowser(){
				var url = window.localStorage.getItem("dingCurrentUrl");
	...
	<body>
		<div class="model-body no-support-msg">	
			...
			<div class="msg">${lfn:message('third-ding:third.ding.nosupportpc.msg') }</div>	
			<div class="btn"  onclick="openInBrowser()">${lfn:message('third-ding:third.ding.nosupportpc.open')}</div>
		</div>
	</body>
</html>
<%
