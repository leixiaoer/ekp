		...
		<form name="login_form" action="${ LUI_CentextPath }j_acegi_security_check" method="POST" onsubmit="return kmss_onsubmit();">
			...
			<div class="login_modern">
				...
				<div class="form_bottom">
			       ...
			       %>
				   		<a rel="noopener noreferrer" class="kkDownloadLink link" style="display:inline-block;width:150px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;vertical-align:middle;" href="<%=url!=null?url:"#" %>" target="_blank" title="<%=name!=null?name:"" %>"><%=name!=null?name:"" %></a><em>|</em>
					<%} %>
				   	</a>
				    <%
