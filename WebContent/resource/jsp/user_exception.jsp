...
window.onload = function(){
	...
	if(istopWindow){
		window.top.location.href = '${KMSS_Parameter_ContextPath}resource/jsp/user_exception.jsp';
	}
}
</script>
<style> 
              				...
              				<tr>
                				...
                				<td height="40" class="PromptTD_Center">
                					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  						<tr>
                    						<td height="30" colspan="2" valign="bottom"><B><font color=#ff0000><bean:message key="userexception.exception"/></font></B></td>
						                 </tr>
						                 <tr>
						                 ...
						                 <tr>
						                    <td colspan="2" style="line-height:20px">
						                    	<bean:message key="userexception.exception.info"/>
											</td>
						                 </tr>
						                 <tr>
