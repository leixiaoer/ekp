...
<center>
	...
	<ui:button id="btnOk" text="${ lfn:message('button.ok') }" onclick="parent.treeFrame.Com_DialogReturnValue();" style="width:70px"></ui:button>
    <ui:button id="btnCancel" text="${ lfn:message('button.cancel') }" styleClass="lui_toolbar_btn_gray" onclick="parent.Com_DialogReturn();" style="width:70px"></ui:button>
    <ui:button id="btnSelectNone" text="${ lfn:message('dialog.selectNone') }" styleClass="lui_toolbar_btn_gray" onclick="parent.treeFrame.Com_DialogReturnEmpty();" style="width:140px"></ui:button>
</center>
	</template:replace>
</template:include>