...
CKEDITOR.editorConfig = function(config) {
	...
	config.toolbar_Keydata = [
	              			[ 'Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo', '-', 'Link',
	              					'Unlink','Importword', '-', 'multiimage', 'Smiley', 'Table' ],
	              			[ 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock' ],
	              			[ 'NumberedList', 'BulletedList' ],
	              			[ 'Maximize' ],
	              			[ 'Format' ],
	...
	config.toolbar_Wiki = [
			[ 'Category', 'Wikilink' ],
			[ 'Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo', '-', 'Link',
					'Unlink','Importword', '-', 'multiimage', 'Table' ],
			[ 'FontSize' ],
			[ 'TextColor', 'BGColor', 'Bold', 'Italic' ],
			[ 'Maximize' ],
			'/',
...
// CKconfig.ImageUploadDeniedExtensions = ""; // empty for no one
	...
	config.extraPlugins = 'video,category,wikilink,pasteimage,multiimage,keydata,mydata,lineheight,textindent,kemlink,preview,importword,mapsrelation,autoformat';
