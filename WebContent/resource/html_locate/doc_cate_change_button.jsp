					...
					seajs.use(
							[ 'lui/dialog','lui/spa/Spa' ],
								function(dialog,Spa) {
									...
									var url = '/sys/sc/cateChg.do?method=cateChgEdit&listSelectedName=' + listSelectedName + '&cateModelName=${JsParam.cateModelName}&modelName=${JsParam.modelName}&categoryId='+Spa.spa.getValue('docTemplate')+'&docFkName=${JsParam.docFkName}&extProps=${JsParam.extProps}&authType=${JsParam.authType}';
