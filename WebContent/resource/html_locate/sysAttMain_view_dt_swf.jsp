...
public String getIconNameByFileName(String fileName) {
	...
	if(".doc".equals(fileExt) || ".docx".equals(fileExt)){
		...
		return "text.png";
	}else if(".jpg".equals(fileExt) || ".jpeg".equals(fileExt) || ".ico".equals(fileExt) || ".bmp".equals(fileExt) || ".gif".equals(fileExt) || ".png".equals(fileExt)){
		return "image.png";
	}else if(".mp3".equals(fileExt)){
		return "audio.png";
	}else if(".mp4".equals(fileExt) || ".avi".equals(fileExt) || ".flv".equals(fileExt) || ".rmvb".equals(fileExt) || ".m4v".equals(fileExt)){
		 return "video.png";
	}else{
		return "documents.png";
	}
...
<table style="border:none" width="100%">
	...
	<c:if test="${param.fdAttType!='pic' }">
			<c:forEach items="${showAtts}" var="showAtt" varStatus="vstatus">
				<c:if test="${showAtt.fdKey==param_fdKey}">
