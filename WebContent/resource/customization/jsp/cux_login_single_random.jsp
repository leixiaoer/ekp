...
<template:include ref="default.login">
	...
	<template:replace name="body">
        	...
        	<div class="login_top_bar" style="display:block;">
        		<ul v-bind:class="{choose_hover:isHeadLinksActive}">
                	<li
                		...
                		:key="link.id">
                		<a target="_blank" v-bind:href="link.single_random_head_link_href">{{${lfn:concat('link.single_random_head_link_',locale)}}}</a>
                	</li>
                </ul>
        	</div>
            <div class="main_content">
                <span class="logo" v-bind:class="{choose_hover:isLogoActive}">
                	<img v-bind:src="'${LUI_ContextPath }${loginImagePath }/login_single_random/'+single_random_logo"/>
                </span>
            </div>
        </div>
        ...
        <div class="login_footer">
            <p>
            	<span v-bind:class="{choose_hover:isCopyrightActive}">{{${lfn:concat('single_random_footerInfo_',locale)}}}</span>
            </p>
        </div>
        </div>
        <script type="text/javascript">
