...
<div class="option" data-hover="isLogoActive" @mouseenter="enter" @mouseleave="leave">
	...
	<div class="content">
		...
		<form id="single_full_screen_logo" enctype="multipart/form-data" method="post">
			<span class="btn-file">
		        ...
		        <input type="file" name="file" accept=".png,.jpg,.jpeg,.gif,.ico" onclick="this.value='';" onchange="uploadImg('single_full_screen_logo');"/>
		    </span>
		</form>
	</div>
	<div>
...
<div class="option" data-hover="isCopyrightActive" @mouseenter="enter" @mouseleave="leave">
	...
	<c:forEach items="${langs }" var="lang">
		<div class="content">
			<div class="input">
				<input placeholder="${lang.value }" title="${lang.value }" type="text" v-model="single_full_screen_footerInfo_${lang.key }"/>
			</div>
		</div>
	</c:forEach>
</div>
