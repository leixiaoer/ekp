 ...
 * 资源头部模板，用于“待我审的”页签
 */
define(['mui/createUtils','mui/i18n/i18n!geesun-oitems:geesunOitemsBudgerApplication.docCreateTime'], function(createUtils,msg){
	...
	var propertyFilter = h('div', {
		...
		dojoMixins: 'geesun/oitems/mobile/resource/js/header/OitemPropertyWaitToDoMixin'
	});
