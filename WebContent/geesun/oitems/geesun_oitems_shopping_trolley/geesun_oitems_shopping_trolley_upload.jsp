...
<html:form action="/geesun/oitems/geesun_oitems_shopping_trolley/geesunOitemsShoppingTrolley.do" styleId="trolleyUploadForm" enctype="multipart/form-data">
								...
								<span id="div_uploadProcess">
									...
									<c:if test="${not empty result}">
										...
										<c:if test="${fn:length(result.errorMsgs)>0}">
											&nbsp;<font color="red"><bean:message bundle="geesun-oitems" key="geesunOitems.import.addError"/></font>
										</c:if>
									</c:if>
								</span>
							</td>
