...
<div id="optBarDiv">
	<kmss:auth requestURL="/geesun/oitems/geesun_oitems_report_listing/geesunOitemsReportListing.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.edit"/>"
			onclick="Com_OpenWindow('geesunOitemsReportListing.do?method=edit&fdId=${JsParam.fdId}','_self');">
	</kmss:auth>
	<kmss:auth requestURL="/geesun/oitems/geesun_oitems_report_listing/geesunOitemsReportListing.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.delete"/>"
			onclick="if(!confirmDelete())return;Com_OpenWindow('geesunOitemsReportListing.do?method=delete&fdId=${JsParam.fdId}','_self');">
	</kmss:auth>
	<input type="button"
...
<table class="tb_normal" width=95%>
	...
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<c:out value="${geesunOitemsReportListingForm.docCreatorName}" />
		</td>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="geesun-oitems" key="geesunOitemsReportListing.fdMonthReport"/>
		</td><td width="35%">
			<c:out value="${geesunOitemsReportListingForm.fdMonthReportName}" />
		</td>
	</tr>
</table>
</center>
