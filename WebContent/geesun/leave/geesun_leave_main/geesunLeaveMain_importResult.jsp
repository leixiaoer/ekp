...
<link rel="stylesheet" href="<c:url value="/geesun/leave/resource/budget.css"/>" />
<script type="text/javascript">
Com_IncludeFile("jquery.js");
</script>
<script type="text/javascript" src="<c:url value="/geesun/leave/resource/js/jquery.corner.js"/>"></script>
<script type="text/javascript">
