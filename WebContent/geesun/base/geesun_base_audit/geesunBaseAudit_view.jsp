    ...
    <template:include ref="default.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/geesun/base/geesun_base_audit/geesunBaseAudit.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('geesunBaseAudit.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/geesun/base/geesun_base_audit/geesunBaseAudit.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('geesunBaseAudit.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('geesun-base:table.geesunBaseAudit') }" href="/geesun/base/geesun_base_audit/" target="_self" />
            </ui:menu>
        </template:replace>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div id="_xform_fdPersonIds" _xform_type="address">
                                    <xform:address propertyId="fdPersonIds" propertyName="fdPersonNames" mulSelect="true" orgType="ORG_TYPE_PERSON" showStatus="view" textarea="true" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
                        <tr>
