...
<template:include ref="mobile.list">
    ...
    <template:replace name="content">
        <c:choose>
            <c:when test="${ param.filter == '1' }">
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/back/HrefBackMixin" data-dojo-props="href:'/geesun/annual/geesun_annual_use/mobile/index.jsp'">
                    </div>
                ...
                <div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
                    <div data-dojo-type="mui/search/SearchBar" data-dojo-props="modelName:'com.landray.kmss.geesun.annual.model.GeesunAnnualUse',needPrompt:false,height:'3.8rem'">
                    </div>
            ...
            <c:otherwise>
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/nav/MobileCfgNavBar" data-dojo-props="defaultUrl:'/geesun/annual/geesun_annual_use/mobile/nav.jsp', modelName:'com.landray.kmss.geesun.annual.model.GeesunAnnualUse'">
                    </div>
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/Folder" data-dojo-props="tmplURL:'/geesun/annual/geesun_annual_use/mobile/query.jsp'"></div>
                </div>
        ...
        <ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom">
            ...
            <kmss:auth requestURL="/geesun/annual/geesun_annual_use/geesunAnnualUse.do?method=add">
                <li data-dojo-type="mui/tabbar/CreateButton" data-dojo-props="_onClick:function(){location='${LUI_ContextPath}/geesun/annual/geesun_annual_use/geesunAnnualUse.do?method=add'}">
