    ...
    <template:include ref="default.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <kmss:auth requestURL="/geesun/annual/geesun_annual_alter/geesunAnnualAlter.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('geesunAnnualAlter.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/geesun/annual/geesun_annual_alter/geesunAnnualAlter.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('geesunAnnualAlter.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('geesun-annual:table.geesunAnnualAlter') }" href="/geesun/annual/geesun_annual_alter/" target="_self" />
            </ui:menu>
        </template:replace>
                        ...
                        <tr>
                            ...
                            <td width="35%">
                                ...
                                <div id="_xform_fdFieldName" _xform_type="text">
                                    <xform:text property="fdFieldName" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                            <td class="td_normal_title" width="15%">
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div id="_xform_fdSource" _xform_type="text">
                                    <xform:text property="fdSource" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div id="_xform_fdBerforAlter" _xform_type="rtf">
                                    <xform:rtf property="fdBerforAlter" showStatus="view" width="95%" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div id="_xform_fdAfterAlter" _xform_type="rtf">
                                    <xform:rtf property="fdAfterAlter" showStatus="view" width="95%" />
                                </div>
                            </td>
                        </tr>
                        <tr>
