...
function sqlPreview_extract(tbody_search,tbody_in, tbody_out) {
	...
	//stypeDataArray.push("<option value='arrayString'>"+ticJdbcDataSet.arrayString+"</option>");
	...
	//stypeInDataArray.push("<option value='arrayString'>"+ticJdbcDataSet.arrayString+"</option>");
