...
<c:set var="ticJdbcDataSetForm" value="${requestScope[param.formName]}" />
...
function func_history_LoadIframe(){
	...
	if($(iframe).attr("src").length<1){
		 var srcValue="<c:url value="/tic/jdbc/tic_jdbc_query/ticJdbcQuery.do" />?method=list&fdId=${param.fdId}";
...
<tr LKS_LabelName="<bean:message bundle="tic-jdbc" key="ticJdbcQuery.history"/>" style="display:none">
	<td>
