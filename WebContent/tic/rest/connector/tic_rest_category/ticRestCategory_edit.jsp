...
<html:form action="/tic/rest/connector/tic_rest_category/ticRestCategory.do">
    <div id="optBarDiv">
        <c:choose>
            <c:when test="${ticRestCategoryForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="Com_Submit(document.ticRestCategoryForm, 'update');">
            </c:when>
            <c:when test="${ticRestCategoryForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="Com_Submit(document.ticRestCategoryForm, 'save');">
            </c:when>
        </c:choose>
                    ...
                    <td width="35%">
                        <div id="_xform_fdParentId" _xform_type="dialog">
                            <xform:dialog propertyId="fdParentId" propertyName="fdParentName" showStatus="edit" style="width:95%;">
                                dialogSimpleCategory('com.landray.kmss.tic.rest.connector.model.TicRestCategory','fdParentId','fdParentName',false);
                            </xform:dialog>
                        </div>
                        </a>
                    </td>
