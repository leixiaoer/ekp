...
<table class="tb_normal" width=95%>
	...
	<tr>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="tic-rest-connector" key="ticRestSetting.fdTlsVersion"/>
		</td><td colspan="3" width="85%">
			<xform:radio property="fdTlsVersion">
				<xform:simpleDataSource value="default"><bean:message bundle="tic-rest-connector" key="ticRestSetting.fdTlsVersion.default"/></xform:simpleDataSource>
				<xform:simpleDataSource value="tls1.2"><bean:message bundle="tic-rest-connector" key="ticRestSetting.fdTlsVersion.tls1.2"/></xform:simpleDataSource>
			</xform:radio>
		</td>
	</tr>
	<tr>
