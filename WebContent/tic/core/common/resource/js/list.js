...
seajs.use(['lui/jquery','lui/dialog','lui/topic','lui/dialog_common'], function($, dialog , topic, dialogCommon){
    ...
    function addDoc(){
    	Com_OpenWindow(option.contextPath + option.basePath + "?method=add&fdAppType="+option.fdAppType+ "&fdEnviromentId="+option.fdEnviromentId+ "&ldingFlag="+option.ldingFlag);
    }
    function addTemplateConfig(){
        dialog.categoryForNewFile(option.modelName, option.basePath + '?method=add&i.docCategory=!{id}&fdAppType='+option.fdAppType+ "&fdEnviromentId="+option.fdEnviromentId,
                false,null,null,getValueByHash("docCategory"),null,null,false);
    }
    function addTemplateMain(){
        dialog.categoryForNewFile(option.templateName, option.basePath + '?method=add&i.docTemplate=!{id}&fdAppType='+option.fdAppType+ "&fdEnviromentId="+option.fdEnviromentId,
                false,null,null,getValueByHash("docTemplate"));
    }
    function addSCategoryMain(){
    	dialog.simpleCategoryForNewFile(option.templateName, option.basePath + '?method=add&i.docTemplate=!{id}&fdAppType='+option.fdAppType+ "&fdEnviromentId="+option.fdEnviromentId,
    			false,null,null,getValueByHash("docTemplate"));
    }
    function addOtherTemplateMain(){
    	...
    	if(currTempId!=null && currTempId!=''){
    		...
    		dialogCommon.dialogSelectForNewFile(context.modelName, sourceUrl, params, 
    				option.basePath + '?method=add&i.docTemplate=!{id}&fdAppType'+option.fdAppType+ "&fdEnviromentId="+option.fdEnviromentId,null,null,'_blank');
    	}
    }
