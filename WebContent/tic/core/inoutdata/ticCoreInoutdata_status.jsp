...
function refreshInfo(){
	...
	var statusInfo = new Array(
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.stoped"/>",
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.error"/>",
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.finish"/>",
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.ready"/>",
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.starting"/>",
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.running"/>",
		"<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.stopping"/>"
	);
	var blockCount = 40;
	
	var data = new KMSSData();
	data.UseCache = false;
	data.AddBeanData("ticCoreInoutdataXMLDataBean");
...
function doAction(method){
	location.href = "<c:url value="/tic/core/inoutdata/ticCoreInoutdata.do?method="/>"+method+"&type=${param.type}"+"&fdAppType=${param.fdAppType}";
}
			...
			<table width=500 border=0 cellspacing=1 cellpadding=0 bgcolor=#000033>
				<tr> 
					<td height=18 class=barmsg>
						<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.title"/>
					</td>
				</tr>
				<tr>
					<td>
						<table bgcolor="#FFFFFF" border=0 cellspacing=0 cellpadding=0 width=100%>
							<tr>
								...
								<td>
									<br>
									<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.info"/>
									...
									<table class="tb_noborder" width="100%">
										...
										<tr>
											<td class="msgtitle" width="50%">
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.status"/>
												<span id="div_status"></span>
											</td>
											<td class="msgtitle" width="50%">
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.process"/>
												<span id="div_process"></span>
											</td>
										</tr>
										<tr height="25px">
											<td class="msglist">
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.startTime"/>
												<span id="div_startTime"></span>
											</td>
											<td class="msglist">
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.endTime"/>
												<span id="div_endTime"></span>
											</td>
										</tr>
										<tr height="25px">
											<td class="msglist">
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.successCount"/>
												<span id="div_successCount"></span>
											</td>
											<td class="msglist">
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.ignoreCount"/>
										...
										<tr height="25px">
											<td class="msglist" colspan="2">
												...
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.failureCount"/>
										...
										<tr>
											<td class="msglist" colspan="2">
												...
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.help"/><br><br style="font-size:5px"><li>
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.help.click"/></li><br><br style="font-size:5px">	<li>
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.help.specific"/></li><br><br style="font-size:5px"><li>
												<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.help.not"/></li>
											</td>
										</tr>
									</table>
									<br style="font-size:10px">
									<div align=center>
										<input type=button class=btnmsg value="<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.btnImport"/>"
											onclick="doAction('showImport');" id="btn_showImport" style="display:none">
										<input type=button class=btnmsg value="<bean:message bundle="tic-core-inoutdata" key="ticCoreInoutdata.status.btnStop"/>"
