...
function refreshInfo(){
	...
	var statusInfo = new Array(
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.stoped"/>",
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.error"/>",
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.finish"/>",
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.ready"/>",
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.starting"/>",
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.running"/>",
		"<bean:message bundle="tic-core-provider" key="ticCoreIface.status.stopping"/>"
	);
	var blockCount = 40;
			...
			<table width=500 border=0 cellspacing=1 cellpadding=0 bgcolor=#000033>
				<tr> 
					<td height=18 class=barmsg>
						<bean:message bundle="tic-core-provider" key="ticCoreIface.status.title"/>
					</td>
				</tr>
				<tr>
					<td>
						<table bgcolor="#FFFFFF" border=0 cellspacing=0 cellpadding=0 width=100%>
							<tr>
								...
								<td>
									<br>
									<bean:message bundle="tic-core-provider" key="ticCoreIface.status.info"/>
									...
									<table class="tb_noborder" width="100%">
										...
										<tr>
											<td class="msgtitle" width="50%">
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.status"/>
												<span id="div_status"></span>
											</td>
											<td class="msgtitle" width="50%">
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.process"/>
												<span id="div_process"></span>
											</td>
										</tr>
										<tr height="25px">
											<td class="msglist">
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.startTime"/>
												<span id="div_startTime"></span>
											</td>
											<td class="msglist">
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.endTime"/>
												<span id="div_endTime"></span>
											</td>
										</tr>
										<tr height="25px">
											<td class="msglist">
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.successCount"/>
												<span id="div_successCount"></span>
											</td>
											<td class="msglist">
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.ignoreCount"/>
										...
										<tr height="25px">
											<td class="msglist" colspan="2">
												...
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.failureCount"/>
										...
										<tr>
											<td class="msglist" colspan="2">
												...
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.help"/><br><br style="font-size:5px"><li>
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.help.click"/></li><br><br style="font-size:5px">	<li>
												<bean:message bundle="tic-core-provider" key="ticCoreIface.status.help.specific"/></li><br><br style="font-size:5px">
											</td>
										</tr>
									</table>
								</td>
