		...
		_setVisible = function(el, state, alsoChangeEndpoints) {
			...
			_operation(id, function(jpc) {
				if (state && alsoChangeEndpoints) {		
					// this test is necessary because this functionality is new, and i wanted to maintain backwards compaticility.
...
between this method and jsPlumb.reset).  
		...
		this.detach = function() {
            ...
            var connType =  _currentInstance.Defaults.ConnectionType || _currentInstance.getDefaultConnectionType(),
				...
				if (connection) {
					...
					var _p = jsPlumb.extend( {}, params); // a backwards compaticility hack: source should be thought of as 'params' in this case.
        ...
        */
		...
		this.unload = function() {
			...
			// now it exists only for backwards compaticility.
		};
