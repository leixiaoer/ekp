...
var ConfirmInfo = {
	"id" : "permissions",
	"titile" : "",
	"info" : "Do you wish to give Clayface access to the self destruct codes?",
	"yes" : "Yes",
	"no" : "No",
	"cancel" : "Cancel",
	"isThree" : true,
...
function initDialog() {
	var permissions = document.getElementById(ConfirmInfo.id);
...
function createDialog() {
	...
	try {
		...
		dialogButton3.setAttribute("value", ConfirmInfo.cancel);
		...
		dialog.style.top = scrollingPosition[1] + parseInt(viewportSize[1] / 2)
...
function dialogClick(event) {
	...
	eval(ConfirmInfo.action).call(this, value);
	/* if (value == "Cancel")
	 {
	   var dialog = target;
