<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="com.landray.kmss.tic.soap.sync.model.ClocalVo"%>
...
<p class="txttitle">
	<bean:message bundle="tic-soap-sync" key="table.ticSoapSyncJob" />
</p>
...
function edition_LoadIframe(index,tableName,dbID,tempId){
	...
	if($(iframe).attr("src").length<1){
	    var src=Com_Parameter.ContextPath+"tic/soap/sync/tic_soap_sync_temp_func/ticSoapSyncTempFunc.do?method=listDStable&tableName="+tableName+"&dbID="+dbID+"&tempId="+tempId;
		$(iframe).attr("src",src);
	}
}
