...
<frameset name="mainFrameset" frameborder=0 border=0 rows="60,*">
  <frame name="topFrame" noresize scrolling=no src="${KMSS_Parameter_StylePath}head/head.jsp">
  <frameset name="downFrameset" frameborder=0 border=0 cols="180,8,0,0,*">
    <frame name="treeFrame" src="<c:url value="${HtmlParam.nav}"/>">
