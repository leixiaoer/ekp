    ...
    <div class="search_m_body">
        <div class="main_content">
            ...
            <div id="search_m_bodyR" class="search_m_bodyR" style = "display:none;">
                <!-- 关联人员 开始 -->
                <div style="font-size: 14px;color: #333333;line-height: 14px;">${lfn:message('sys-ftsearch-db:search.ftsearch.relate.person')}</div>
            ...
            <!-- 左侧 搜索结果 开始 -->
        <div id="search_m_bodyL" class="search_m_bodyL search_l_bodyLwidth">
                    <!-- 搜索数据 开始 -->
        <div class="search_result">
            ...
            <div id="oper_time" onclick="showTimefilter();" class="show">${lfn:message('sys-ftsearch-db:search.ftsearch.time.range')}
            	<div >
                    ...
                    <div>${lfn:message('sys-ftsearch-db:search.ftsearch.time.custom')}</div>
                    <ul>
                        ...
                        <br/>
                        <input type="button" class="filterClose" onclick="hideTimefilter();" value="${lfn:message('sys-ftsearch-db:search.confirm.button')}"/>
                    </ul>  
        </div>
