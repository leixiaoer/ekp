...
(function( $, app ) {
	...
	services.Cluster = ux.Class.extend({
		...
		request: function( params ) {
			var site = location.href.replace(/sys_ftsearch_head\/.*/, 'head');
			var preUrl = site+"/elasticsearchHead.do?method=convert&path=";
			return $.ajax( $.extend({
				url: preUrl+params.path+"&reqMethodType="+params.mtype,
				//url: "http://127.0.0.1:9200/"+params.path,
		...
		"get": function(path, success, error) { return this.request( { type: "GET", mtype: "GET", path: path, success: success, error: error } ); },
		"post": function(path, data, success, error) { return this.request( { type: "POST", mtype: "POST", path: path, data: data, success: success, error: error } ); },
		"put": function(path, data, success, error) { return this.request( { type: "POST", mtype: "PUT", path: path, data: data, success: success, error: error } ); },
		"delete": function(path, data, success, error) { return this.request( { type: "GET", mtype: "DELETE", path: path, data: data, success: success, error: error } ); }
	});
	...
	ui.AnyRequest = ui.Page.extend({
		...
		_request_handler: function( ev ) {
			...
			this.config.cluster.request({
				url: preUrl + path+ "&reqMethodType="+type,
				type: reqMethod,
				data: query,
