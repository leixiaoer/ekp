            ...
            <div class="search_main_content">
            	 <div class="search_bar">
		            <div class="search_bar_tab">
		                ...
		                <p id="hotwordList" class="hots">
		                	<!-- 近期热门搜索 -->
		                    <span class="titleR"><span class="titleL">${lfn:message('sys-ftsearch-db:search.ftsearch.recent.hot.search')}</span></span>
		                </p>
		                <div class="fiterContent">
		                    <p>
		                        <span class="rd_item">
		                        	<!-- 包含任意一个关键词 -->
    ...
    <div class="search_m_body">
        <div class="main_content">
            ...
            <div class="search_m_bodyR">
                ...
                <!-- 按时间 Begin -->
                <div class="search_aboutBox clrfix">
                	<!-- 按时间 -->
                    <div class="search_about_subject">${lfn:message('sys-ftsearch-db:search.ftsearch.time.range')}</div>
                    <ul>
                    ...
                    <div style="margin-left: 8px;">${lfn:message('sys-ftsearch-db:search.ftsearch.time.custom')}</div>
                    <ul>
                        <input type="text" id="startTime" placeholder="${lfn:message('sys-ftsearch-db:search.ftsearch.time.startTime')}" readonly="readonly" style="width:50%;margin-top: 3px;  margin-left: 8px;"/>
                        <input type="text" id="endTime" placeholder="${lfn:message('sys-ftsearch-db:search.ftsearch.time.endTime')}" readonly="readonly" style="width:50%;margin-top: 3px;  margin-left: 8px;"/>
                    </ul>                 
                </div>
                <!-- 按时间 End -->
                <!-- 相关搜索 Begin -->
                <div class="search_aboutBox clrfix">
                	<!-- 相关搜索 -->
                    <div class="search_about_subject">${lfn:message('sys-ftsearch-db:search.ftsearch.relate.word')}</div>
...
-->
						...
						<div class="grid_s_fl">
							...
							<div class="grid_s_cl_body">
								<div style="padding: 4px 0px 4px 40px;color: #5b5b5b;display: inline-block;">
									<!-- 搜索范围 -->
									<span style="color: #5b5b5b;display: inline-block;font-size: 13px;">${lfn:message('sys-ftsearch-db:search.ftsearch.search.range')}</span>
								</div>
							...
							<div class="grid_s_cl_body">
								<div style="padding: 4px 0px 4px 40px;color: #5b5b5b;display: inline-block;">
									<!-- 文档状态 -->
									<span style="color: #5b5b5b;display: inline-block;font-size: 13px;">${lfn:message('sys-ftsearch-db:search.ftsearch.field.docStatus')}</span>
								</div>
								<div class="grid_s_cl_r">
									<div class="grid_s_cl_all">
							...
							<div class="grid_s_cl_body">
								<div style="padding: 4px 0px 4px 40px;color: #5b5b5b;display: inline-block;">
									<!-- 搜索域 -->
									<span style="color: #5b5b5b;display: inline-block;font-size: 13px;">${lfn:message('sys-ftsearch-db:search.ftsearch.search.fields')}</span>
								</div>
								<div class="grid_s_cl_r">
									<div class="grid_s_cl_all">
									...
									<div id="search_fields" class="grid_s_cl_item search_multiple_selection" >
										...
										<!-- 简介 -->
										<a id="search_field_fdDescription" class="item1"><span class="checkbox"></span><span>简介</span></a>
										 <!-- 创建者 -->
                ...
                <div class="lui_common_list_box">
                        ...
                        <div class="lui_common_list_4_headerR">
                            <div class="lui_common_list_4_headerC clrfix">
                                <ul class="search_tabSort">
                                    ...
                                    <!-- 按时间排序 -->
                                    <li id="sort_by_time" onclick="commitSearchBySort('time');"><span>${lfn:message('sys-ftsearch-db:search.ftsearch.sort.by.time')}</span></li>
                                </ul>

                                <ul class="search_view_pagebar">
                                    <li class="btnPre" onclick="commitSearchByPrePage();"></li>
                                    <li class="num">
                                    	<span id="page_pageno_span_top">1</span>
                                    	/<span id="page_total_span_top">1</span>
                                    </li>
                                    <li class="btnNext" onclick="commitSearchByNextPage();"></li>
                                </ul>
                            </div>
                        </div>
                    </div>
					...
					<!-- 搜索纠正：你是不是想找 -->
	                <div id="search_corrected" style="color:#000;font-size:14px;font-weight:bold;text-align: left;padding:20px 0px 0px 0px;display:none;">
                                                                ...
                                                                <div class="lui_common_pageNav_3_c_itemL">
                                                                    <div class="lui_common_pageNav_3_c_itemR">
                                                                        <div class="lui_common_pageNav_3_c_itemC">
                                                                        	<!-- 上一页 -->
                                                                            <a id="page_pre_a" style="display:none;" href="javascript:void(0)" onclick="commitSearchByPrePage();">${lfn:message('sys-ftsearch-db:sysFtsearchDb.prePage')}</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
        ...
        <div class="search_module_bar">
            <div class="innerbar">
                <div class="search_bar">
                    <input id="bottomKeyword" class="input_txt" type="text" onkeydown="if (event.keyCode == 13 && this.value !='') commitSearchByBottomKeywordInput();" />
                    <!-- 搜索 -->
                    <a class="input_btn"  style="height:34px;" href="javascript:void(0)" onclick="commitSearchByBottomKeywordInput();">${lfn:message('sys-ftsearch-db:ftsearch.advanced.button.search')}</a>
                </div>
                <div class="btn_group">
                	<!-- 在结果中搜索 -->
