						...
						<div class="attachment">
							<ul>
								<li>
									...
									<c:set var="showDownload" value="true"></c:set>
									<c:if test="${fdModelName eq 'com.landray.kmss.km.agreement.model.KmAgreementApply' && docStatus!='' && docStatus eq '30' }">
										<c:set var="showDownload" value="false"></c:set>
									</c:if>
