...
<ui:event event="show">
	if("${param.load}" == 'false'){
 		if((!wps_cloud_${param.fdKey}.hasLoad && !wps_cloud_${param.fdKey}.isLoading) || wps_cloud_${param.fdKey}.forceLoad){
...
<script>
	...
	$(document).ready(function(){
		...
		if("${attachmentId}" != ""){
			wps_cloud_${param.fdKey} = new WPSCloudOffice_AttachmentObject(fdAttMainId,"${param.fdKey}","${param.fdModelId}","${param.fdModelName}","read");
