...
function envTest(){
    ...
    xhr.onload=function(e){
        ...
        xhr1.onload=function(e){
            ...
            isSetupOk = true
            window.location.href.indexOf("file://")>-1?window.location.href="http://192.168.2.172:3888/index.html":''
        }
        xhr1.onerror=function(e){
            isServerOk = false
            window.location.href="./demo.html"
        }
        xhr1.open('get', 'http://192.168.2.172:3888/WpsSetupTest', true)
        xhr1.send()
		*/
    }
    ...
    xhr.open('get', 'http://192.168.2.172:3888/FileList', true)
    xhr.send();
}
