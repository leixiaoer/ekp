...
function OnInsertRedHeaderClick() {
   ...
   // var l_BkFile = GetDocParamsValue(l_Doc, constStrEnum.bkInsertFile);
    //if (l_BkFile == "" || l_insertFileUrl == "") {
        ...
        OnShowDialog("redhead.jsp?&wpsOasisstToken="+token, "OA助手", width, height);
...
function GetImage(control) {
    ...
    switch (eleId) {
        ...
        // ----------------------------------------
        case "btnMyTask":
            return "../../../../../../kms/cowriting/wpsplugin/icon/cw_task.png"; //我的任务
        case "btnTemplate":
            return "../../../../../../kms/cowriting/wpsplugin/icon/cw_template.png"; //知识模板
        case "btnAssister":
            return "../../../../../../kms/cowriting/wpsplugin/icon/cw_assister.png"; //知识助手
        case "btnRecommend":
            return "../../../../../../kms/cowriting/wpsplugin/icon/cw_recommend.png"; //智能推荐
        case "btnNewAgreementFile":
