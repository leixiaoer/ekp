...
<div id="WPSCLOUD_${param.fdKey}"></div>
...
var wpsCloudAattachment_${param.fdKey};

require(["sys/attachment/mobile/viewer/wps/js/WpsCloudAattachment",'dojo/topic', 'dijit/registry',"dojo/query","dojo/request","mui/util", "dojo/_base/lang","dojo/domReady!","dojo/dom-construct","dojo/topic"],
		function(WpsCloudAattachment,topic,registry,query,req,util,lang,domReady,domConstruct,topic) {
	
	var fdAttMainId = "${attachmentId}";
	if("${attachmentId}" == ""){
	 
		//请求在线编辑附件的id
		var addOnlineFileUrl = util.formatUrl("/sys/attachment/sys_att_main/sysAttMain.do?method=addCloudOnlineFile");
		req(addOnlineFileUrl, {
			...
			if (data){
			    ...
			    if(results['editOnlineAttId']!=null){
				        ...
				        wpsCloudAattachment_${param.fdKey} = new WpsCloudAattachment({
				    		fdId: fdAttMainId,
				    		fdKey: fdKey,
				    		fdModelId: fdModelId,
