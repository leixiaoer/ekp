...
require(["sys/attachment/mobile/viewer/wps/js/WpsCloudAattachment","dojo/request","mui/util", "dojo/_base/lang","dojo/domReady","dojo/dom-construct","dojo/topic","dijit/registry",'dojo/query'], function(WpsCloudAattachment,req,util,lang,domReady,domConstruct,topic,registry,query) {
	//如何文件是pdf,并且用了windows在线预览
	//如果文件是pdf、ofd,并且是用了linux在线预览
