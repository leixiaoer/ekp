			...
			<c:forEach items="${showAtts}" var="showAtt" varStatus="vstatus">
				<c:if test="${showAtt.fdKey==param.fdKey}">
					<tr class="upload_list_tr">
						<td class="upload_list_icon">
							<img src="${LUI_ContextPath }/resource/style/common/fileIcon/${showAtt.type }" height="16"
								width="16" border="0" align="absmiddle" style="margin-right: 3px;">
						</td>
