...
<table border="0" width="95%">
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;1.1获取sessionId（/api/sys-authentication/loginService/getLoginSessionId）
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);"><br/>&nbsp;&nbsp;1.2 解析token(/api/sys-authentication/loginService/getTokenLoginName)
			<img src="${KMSS_Parameter_StylePath}icons/collapse.gif" border="0" align="bottom"/>
			</td>
	</tr>
	<tr>
				...
				<tr>
					<td  style='font-size: 13px;'>
						<p style='font-size: 15px;'>2.2 从ekp单点到第三方系统:</p><br/>
							...
							1、代码部署方式：<br/>
							1）将jar包（<a href='webservice/bcprov-ext-jdk15to18-168.jar' style='color:blue'> bcprov-ext-jdk15to18-168.jar </a>，<a href='webservice/EKP-sso-third.jar' style='color:blue'> EKP-sso-third.jar </a>，<a href='webservice/EKP-SSO-client-java.jar' style='color:blue'> EKP-SSO-client-java.jar </a>）和 <a target="_blank" href='./webservice/downloadTokenFile.jsp'  style='color:blue'>LRToken文件</a> 部署到第三方系统的lib目录下<br/>
