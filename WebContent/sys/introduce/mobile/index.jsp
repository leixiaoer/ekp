...
<template:include ref="mobile.list" tiny="true">
	<template:replace name="head">
		...
		<link rel="stylesheet" type="text/css" href="${ LUI_ContextPath}/sys/introduce/mobile/font/iconfont.css" />
		...
		<ul data-dojo-type="mui/tabbar/TabBar" id="intr_tabbar" fixed="bottom">
			<kmss:auth requestURL="${s_requestUrl}" requestMethod="GET">
					<div 
						...
						id="muiIntrOpt">
						<input type="text" readonly="readonly" class="muiIntrText intrButton" placeholder='${lfn:message('sys-introduce:sysIntroduceMain.button.introduce.add') }' />
					</div>
			</kmss:auth>
		</ul>
	</xform:config>
