            ...
            <div class="lui_profile_main_content">
                <ul class="lui_profile_overview_baseInfo_list">
                    ...
                    <%
                            ...
                            String licenseOrgPersonString = null; 
                            ...
                            if(licenseOrgPerson == 9999999){
                                licenseOrgPersonString = unlimit;
                            }else{
                                licenseOrgPersonString = String.valueOf(licenseOrgPerson) + " " + ResourceUtil.getString("sys.profile.maintenance.overview.currentPerson.total", "sys-profile");
                                if(licenseOrgPerson<currentPerson){
                                    pageContext.setAttribute("orgpersonoverflow", "true");
                                }
                            }
