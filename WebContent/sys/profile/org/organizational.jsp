...
function generateTree() {
	LKSTree = new TreeView(
		"LKSTree",
		"<bean:message bundle="sys-organization" key="sysOrg.address.tree"/>",
	...
	n2.AppendBeanData(
		"organizationTree&parent=!{value}&orgType="+(ORG_TYPE_ORGORDEPT|ORG_FLAG_BUSINESSALL)+"&sys_page=true", 
		"<c:url value="/sys/organization/sys_org_dept/index.jsp"/>?parent=!{value}&sys_page=true", 
		openListView, true
	);
