...
<!DOCTYPE html> 
<html manifest="<c:url value='/sys/mobile/html/mobile.manifest' />"> 
<head> 
        <meta charset=utf-8 />
		...
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/sys/mobile/css/font/fontmui.woff"></link>
        <title>cache</title> 
