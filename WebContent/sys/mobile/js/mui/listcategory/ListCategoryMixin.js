define(["dojo/_base/declare","mui/i18n/i18n!sys-mobile:mui.all.category"], function(declare,msg) {
  window.SIMPLE_CATEGORY_TYPE_CATEGORY = 0 //"CATEGORY" 类别

  var simpleCategory = declare("mui.listcategory.ListCategoryMixin", null, {
    ...
    jsURL:
      "/sys/mobile/js/mui/listcategory/ListCategory_sgl.js!modelName=!{modelName}&extendPara=key:!{key}&showFavoriteCate=!{showFavoriteCate}&authType=!{authType}&confirm=!{confirm}&required=!{required}",
