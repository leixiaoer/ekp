define([ 
	...
	],function(declare, lang, array, topic, request, domConstruct, domStyle, domAttr, domClass, domGeometry, query, ScrollableView, ScrollableCategoryPath, util, AddressChannelMixin, Msg) {
	return declare("mui.syscategory.AddressCategoryPath", [ ScrollableCategoryPath, AddressChannelMixin ],
		{
			...
			// 获取详细信息地址
			detailUrl : '/sys/organization/sys_org_element/sysOrgElement.do?method=getParentOrgs&fdId=!{curId}&deptLimit=!{deptLimit}',
