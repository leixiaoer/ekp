define([ "dojo/_base/declare", "dojo/dom-construct", "mui/form/_FormBase",
		"dojo/dom-class", "mui/util","mui/form/_PlaceholderMixin" ,"mui/i18n/i18n!sys-mobile"], function(declare,
		domConstruct, _FormBase, domClass, util, _PlaceholderMixin,Msg) {
