		    ...
		    _buildRender: function(obj){
		    	...
		    	if(this.renderType == obj.renderType){
					this.radioNode = domConstruct.create('label', {
						...
						innerHTML :"<span class='mui-radio-base'>"+ obj.text&&obj.text.indexOf("&#039;")>0 ? util.formatTextChar(obj.text.replace(/</g, "&lt;").replace(/>/g, "&gt;")) : util.formatTextChar(util.formatText(obj.text))+"</span>"
					}, obj.domNode, 'after');
