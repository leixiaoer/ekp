		...
		function(declare, domConstruct, parser, _GroupBase, util,query,domClass) {
			var _field = declare(
					...
					[ _GroupBase ],
					{
						...
						tmpl : '<input type="checkbox" data-dojo-type="mui/form/CheckBox" data-dojo-props="showStatus:\'!{showStatus}\',renderType:\'!{renderType}\',checked:!{checked},name:\'!{name}\',text:\'!{text}\',value:\'!{value}\'">',
						...
						createListItem : function(props) {
							...
							var tmpl = this.tmpl.replace('!{showStatus}',this.showStatus)
									...
									.replace('!{text}', util.formatText(props.text.replace(/'/g,"&#039;")))
