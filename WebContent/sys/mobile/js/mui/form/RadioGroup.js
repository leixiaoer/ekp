define( [ "dojo/_base/declare", "mui/form/_GroupBase", "dojo/dom-construct", "dojo/parser", "dojo/_base/array","mui/util" ,"dojo/dom-class", "mui/dialog/Dialog", "dojo/_base/lang", "dojo/topic"],
		function(declare, _GroupBase, domConstruct, parser, array, util,domClass,Dialog,lang,topic) {
			var _field = declare("mui.form.RadioGroup", [ _GroupBase ], {
						...
						tmpl : '<input type="radio" data-dojo-type="mui/form/Radio" data-dojo-props="checked:!{checked},showStatus:\'!{showStatus}\',renderType:\'!{renderType}\',name:\'!{name}\',text:\'!{text}\',value:\'!{value}\'">',
						...
						createListItem : function(props) {
							...
							var tmpl = this.tmpl.replace('!{showStatus}',this.showStatus)
									   ...
									   .replace('!{value}', util.formatText(props.value))
									   .replace('!{text}',  util.formatText(props.text.replace("'","&#039;")))
