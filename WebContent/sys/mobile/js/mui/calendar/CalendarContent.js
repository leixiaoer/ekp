		...
		function(declare, _WidgetBase, CalendarBase,_ContentEventMixin, dateClaz,
			...
			var claz = declare(
					...
					[ _WidgetBase, CalendarBase ],
					{
						...
						templateString : '<div class="mui_ekp_portal_date muiCalendarTable" data-dojo-attach-point="tableNode">'
						...
						resize : function() {
							/*if(this.domNode.offsetHeight){
								...
								setTimeout(function(){
									topic.publish('/mui/calendar/contentComplete', this, {
										height : document.querySelectorAll('.muiCalendarTable ')[1].offsetHeight
									});
								},10)
							}*/
							var self = this;
							setTimeout(function(){
								topic.publish('/mui/calendar/contentComplete', self, {
