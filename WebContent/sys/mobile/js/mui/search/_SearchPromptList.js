  ...
  return declare("mui.search._SearchPromptList", null, {
    ...
    _onSubmit: function(obj) {
      ...
      if (this.listNode) {
        ...
        self.jsonList.url = util.setUrlParameter(url, "queryString", keyword)
    ...
    templateStr: function() {
      return (
        ...
        "data-dojo-props=\"lazy:false,url:'/sys/ftsearch/searchBuilder.do?method=search&queryString=!{keyword}&modelName=!{modelName}&newLUI=true&forward=mobileList&searchFields='\">" +
        "</ul>" +
        "</div>"
      )
    }
