...
define([
  ...
  return declare("mui.simplecategory.SwapCategoryList", [View], {
    ...
    tmpl:
      ...
      "data-dojo-props=\"lazy:false,isMul:{isMul},key:'{key}',parentId:'!{fdId}',selType:{selType},modelName:'{modelName}',authType:'{authType}',curIds:'{curIds}',confirm:{confirm},index:{index}\" >" +
      "</ul>" +
      "</div>",
