define(	["dojo/_base/declare", "dojo/dom-construct", "dojo/dom-class",
				"dojo/topic", "dojox/mobile/_ItemBase", "mui/util", "mui/iconUtils","mui/list/item/_ListLinkItemMixin"],
		function(declare, domConstruct, domClass, topic, ItemBase, util, iconUtils,_ListLinkItemMixin) {
			var item = declare("mui.category.CategoryItemMixin", [ItemBase,_ListLinkItemMixin], {
						...
						_buildItemBase : function() {
							...
							this.titleNode = domConstruct.create('div', {
								'className' : 'muiProcessTitle muiSubject ',
								'innerHTML' :  this.data[this.displayProp]
							}, this.infoNode);
							this.titleNode.style.minHeight=0;
						...
						startup : function() {
							...
							this.key = parent.key;
							this.href=util.decodeHTML(this.href);
						},
