...
<%!public String getInput(JSONObject var,String luivarid) throws Exception {
		...
		if ("select".equals(showFlag) || "".equals(showFlag)) {
			...
			for (int i = 0; i < array.size(); i++) {
				...
				sb.append("<label><input onclick=\"changeRadio(event)\" "+temp+" type=\"radio\" name=\""+luivarid+"\" value=" + array.getJSONObject(i).getString("value") + ">&nbsp;" + LuiFunctions.msg(array.getJSONObject(i).getString("text")) + "</label>&nbsp;&nbsp;");	
			}
		}
