...
String dialogjsp = (String)jsonbody.get("jsp");
...
if(StringUtil.isNotNull(dialogjsp)){
	...
	dialogrealurl = "VariableSetting.openConfigPage('!{nameField}','!{idField}','"+dialogjsp+"','"+LuiFunctions.msg(var.get("name").toString())+"');";
}else{
	dialogrealurl = dialogjs;
}
