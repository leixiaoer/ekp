...
String dialogjsp = "/sys/ui/jsp/vars/sys.tree.jsp?bean="+URLEncoder.encode(jsonbody.getString("bean"));
...
String dialogrealurl= "VariableSetting.openConfigPage('!{nameField}','!{idField}','"+dialogjsp+"','"+LuiFunctions.msg(var.get("name").toString())+"');";
