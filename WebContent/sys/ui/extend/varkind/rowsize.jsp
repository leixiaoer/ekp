...
<tr>
	...
	<td><input class="inputsgl" id="${ luivarid }" type="text"  value="6" onkeyup='this.value=this.value.replace(/\D/gi,"")'}/>${ luivar['require'] ? "<span style='color:red;'>*<span>" : "" }<span class="com_help">${ lfn:msg(luivarparam['help']) }</span></td>
</tr>