  ...
  var  lunarInfo = [0x04bd8,0x04ae0,0x0a570,0x054d5,0x0d260,0x0d950,0x16554,0x056a0,0x09ad0,0x055d2,//1900-1909
   ...
   var solarMonth=[31,28,31,30,31,30,31,31,30,31,30,31];
	...
	/**
	  ...
	  */
	var leapMonth=function(y) { //闰字编码 \u95f0
	 ...
	 * @return Cn string
	 */
	var toAstro=function(cMonth,cDay) {
	...
	/**
	  ...
	  */
	var toChinaMonth=function(m) { // 月 => \u6708
		if(m>12 || m<1) {return -1} //若参数错误 返回-1
		var s = nStr3[m-1];
		s+= "\u6708";//加上月字
		return s;
	...
	/**
	  ...
	  */
	var solar2lunar=function (y,m,d) { //参数区间1900.1.31~2100.12.31
		//年份限定、上限
		if(y<1900 || y>2100) {
	...
	/**
	  ...
	  */
	var lunar2solar=function(y,m,d,isLeapMonth) {   //参数区间1900.1.31~2100.12.1
