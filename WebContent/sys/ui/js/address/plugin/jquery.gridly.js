		 ...
		 if (!Array.prototype.map) {
		  ...
		  Gridly = (function() {
		    ...
		    Gridly.prototype.draggingBegan = function(event) {
		      ...
		      this.$draggingdom = $(event.target).closest(this.$(this.settings.draggable.selector));
		      $elements = this.$sorted();
		      this.ordinalize($elements);
		      setTimeout(this.layout, 0);
		      return (ref = this.settings) != null ? (ref1 = ref.callbacks) != null ? typeof ref1.reordering === "function" ? ref1.reordering($elements,this.$draggingdom) : void 0 : void 0 : void 0;
		    };

		    Gridly.prototype.draggingEnded = function(event) {
		      var $elements, ref, ref1, movingOut=false;
		      $elements = this.$sorted();
		      this.ordinalize($elements);
		      setTimeout(this.layout, 0);
		      
		      var ___height = this.$draggingdom.data('height') || this.$draggingdom.outerHeight();
		      if(this.$draggingdom.position().top <  0 - ___height){
		    	  movingOut = true;
		      }
		      return (ref = this.settings) != null ? (ref1 = ref.callbacks) != null ? typeof ref1.reordered === "function" ? ref1.reordered($elements, this._draggable.dragged,this.$draggingdom,movingOut) : void 0 : void 0 : void 0;
		    };
