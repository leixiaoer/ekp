...
define(function(require, exports, module) {
	...
	var OrgTreeViewComponent = AbstractTreeViewComponent.extend({
		...
		generateTree : function($super){
			...
			n1.AppendOrgData(treeOrgType, para, null, params.startWith, null, deptLimit);
			n1.isExpanded = true;
		...
		clickNode : function(node){
			...
			if(node.parameter.indexOf('organizationDialogRoleList')==-1){
				...
				beanData = Com_ReplaceParameter("organizationDialogList&parent=!{value}&orgType="+selectType, node)
				if(deptLimit){
