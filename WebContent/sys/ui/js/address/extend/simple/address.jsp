...
<script type="text/javascript">
	...
	dialogObject.searchBeanURL = "organizationDialogSearch"+(dialogObject.addressBookParameter.startWith==null?"":"&startWith="+dialogObject.addressBookParameter.startWith);
	...
	seajs.use(['lui/address/extend/simple/address','lui/jquery'],function(Address,$){
		$(document).ready(function(){
			...
			var params = {
				...
				//搜索树节点beanURL
				nodeBeanURL : dialogObject.nodeBeanURL,
				//是否可以为空
