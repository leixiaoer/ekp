                            ...
                            <table class="muiSimple" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
		                                ...
		                                <xform:address propertyId="fdOrgId" propertyName="fdOrgName" orgType="ORG_TYPE_ALL" showStatus="${status}" required="${required}" subject="人员" mulSelect="true" style="width:95%;" mobile="true" />
		                            	</div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div data-dojo-type="mui/form/CommonDialog" 
                                        	data-dojo-props="idField:'fdDialogId',nameField:'fdDialogName',isMul:true,modelName:'com.landray.kmss.sys.organization.model.SysOrgPerson',dataURL:getSource('it_data_base_dialog'),subject:'对话框',curIds:'',curNames:''">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        删除
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div data-dojo-type="mui/form/CommonDialog" 
                                                                                	data-dojo-props="idField:'fdDetail_Form[!{index}].fdDialogId',nameField:'fdDetail_Form[!{index}].fdDialogName',isMul:false,modelName:'com.landray.kmss.sys.organization.model.SysOrgPerson',dataURL:getSource('it_data_base_dialog'),subject:'对话框'">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
