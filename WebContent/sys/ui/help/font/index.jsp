				...
				<div class="profile-iconList-tabWrap">
					...
					<div class="iconList-tabContent">
						<div class="iconList-tabItemWrap" v-show="index===nowIndex" v-for="(item,index) in iconTab">
							...
							<!-- 固定在头部 Ends -->
							<!-- 标题 Starts -->
							<div class="tab-title"> <span class="title-span">{{iconTab[nowIndex].data.title}} <em><i>共{{iconTab[nowIndex].data.total.module}}个模块</i> <i>共{{iconTab[nowIndex].data.total.icon}}个icon图标</i></em></span> <span class="total"></span>
							</div>
							<!-- 标题 Ends -->
							<!-- 列表部分 Starts -->
