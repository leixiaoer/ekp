	...
	<template:replace name="content">
		<div class="profile_themeSetting_frame">
			<div class='profile_head'>
				<p class='profile_loginSetting_split'><span>${lfn:message('sys-ui:mall.theme.sys') }</span></p>
				...
				<div id="profile_loginsetting_box" >
					...
					<ul class="profile_loginSetting_list">
						...
						<li>
							...
							<div class="profile_loginSetting_content">
								<!-- 删除 Starts -->
								<span class="profile_custom_del" onclick="__deleteTheme('${uploadTheme.fdId}');"><i></i></span>
								<!-- 删除 Ends -->
								<c:choose>
		...
		<form target="_blank" name="themeForm" action="" method="post">
	 	...
	 	<script type="text/javascript">
			...
			function __deleteTheme(rid,evt) {
