...
<list:data>
	<list:data-columns var="sysAnonymLog" list="${queryPage.list}"
		...
		<list:data-column  col="docOptor.fdName" title="${ lfn:message('sys-anonym:sysAnonymLog.fdOptor') }" escape="false">
		...
		<list:data-column property="nowCategory.fdName" title="${lfn:message('sys-anonym:sysAnonymLog.sysNowCate')}" />
	</list:data-columns>
	<%-- 分页信息生成 --%>
