...
<%@page import="com.landray.kmss.sys.anonym.util.SysAnonymUtil" %>
    ...
    <template:include ref="default.view">
        ...
        <template:replace name="title">
            <c:out value="${sysAnonymMainForm.fdName} - " />
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
				<kmss:authShow roles="ROLE_SYSANONYM_DELETE">
					<ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('sysAnonymMain.do?method=delete&fdId=${param.fdId}');" order="4" />
				</kmss:authShow>
                ...
                <ui:content title="${ lfn:message('sys-anonym:py.JiBenXinXi') }" expand="true">
                    <div class='lui_form_title_frame'>
                        <div class='lui_form_subject'>
                            <c:out value="${sysAnonymMainForm.fdName}"></c:out>
                        </div>
                    </div>
                     <table class="tb_normal" width="100%">
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-anonym:sysAnonymMain.submitor')}
                            </td>
