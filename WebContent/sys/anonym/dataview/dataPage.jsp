		...
		<div style="margin: 5px 10px;">
			...
			<list:criteria id="criteria1">
				<list:cri-ref key="fdName" ref="criterion.sys.docSubject"
					title="${lfn:message('sys-anonym:sysAnonymMain.fdName')}" />
			</list:criteria>
            <!-- 操作 -->
			...
			<list:listview id="listview">
				<ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/anonym/sysAnonymData.do?method=dataCommonList&formatKey=listTable')}
                </ui:source>
				<!-- 列表视图 -->
				<list:colTable isDefault="false"
					rowHref="/sys/anonym/sysAnonymData.do?method=dataCommonView&fdId=!{fdAnonymId}"
					name="columntable">
					<list:col-checkbox />
					<list:col-serial />
