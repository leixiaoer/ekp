						   ...
						   <%--enabledText="${ lfn:message('sys-filestore:attConvert.hint.info.global.enable') }"
							...
							<td  colspan="2">
							 <xform:checkbox subject="" property="converter_aspose" onValueChange="SaveConfig"  dataType="boolean" showStatus ="edit">
								...
								<%--  <xform:checkbox subject="" property="converter_yzdcs" onValueChange="SaveConfig" dataType="boolean" showStatus ="edit">
									<xform:simpleDataSource value="true">永中DCS</xform:simpleDataSource>
								</xform:checkbox> --%>
...
<c:if test="${'true' eq convertDianju}">
									<xform:checkbox subject="" property="converter_dianju" onValueChange="SaveConfig"  dataType="boolean" showStatus ="edit">
										<xform:simpleDataSource value="true">点聚(OFD转换)</xform:simpleDataSource>
									</xform:checkbox>
								</c:if>
					            <div>
					            <c:if test="${'true' eq convertSuwellTip || 'true' eq convertWPSTip ||'true' eq convertDianjuTip}">
				...
				<!-- end -->
			 <c:if test="${'true' eq sysFileConvertGlobalConfigForm.converter_aspose || 'true' eq sysFileConvertGlobalConfigForm.converter_wps || 'true' eq sysFileConvertGlobalConfigForm.converter_skofd || 'true' eq sysFileConvertGlobalConfigForm.converter_dianju}">
