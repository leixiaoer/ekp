...
function FlowChart_Mode_Normal_OnMouseDown(e){
	...
	if(this.EventSrc!=null && this.EventSrc.Name=="Node"){
		if (Com_IsFreeFlow()) {
			if (this.EventSrc.Type == "draftNode" || this.EventSrc.Type == "startNode" || this.EventSrc.Type == "endNode" || this.EventSrc.Type == "reviewNode" || this.EventSrc.Type == "signNode" || this.EventSrc.Type == "sendNode" || this.EventSrc.Type == "robotNode") {
