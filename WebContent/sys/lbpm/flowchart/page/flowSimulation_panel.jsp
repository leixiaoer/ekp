...
window.onload=function(){
	...
	if (flowChartObject.modelName === "com.landray.kmss.sys.modeling.main.model.ModelingAppModelMain") {
        fdModelId = flowChartObject.FdAppModelId;
    }
	setExtendFilePath(fdModelId,Com_GetUrlParameter(window.location.href,"simulType"));	
