							...
							<ui:popup align="down-left" positionObject="#__categoryNavigation__" style="background:white;">
								<div style="width:260px;">
									<ui:menu layout="sys.ui.menu.ver.default">
										<ui:menu-source id="__categoryNavigationMenu" autoFetch="true" target="_self" href="javascript:updateList('!{fdTemplateId}','!{modelPath}','!{fdKey}',null,'!{isBase}','!{fdHierarchyId}');">
