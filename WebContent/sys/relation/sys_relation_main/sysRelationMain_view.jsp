...
function loadSysRelationEntiry(moduleModelId, fdType, fdModuleModelName,_this) {
	if (moduleModelId != null) {
		var url = '<c:url value="/sys/relation/relation.do" />'+'?method=result&currModelId=${JsParam.currModelId}&currModelName=${JsParam.currModelName}&fdKey=${JsParam.fdKey}&sortType=time&fdType='+fdType+'&moduleModelId='+moduleModelId+'&moduleModelName='+fdModuleModelName+'&showCreateInfo=${JsParam.showCreateInfo}';
