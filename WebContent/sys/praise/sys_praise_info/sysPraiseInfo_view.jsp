	...
	<template:replace name="content"> 
				<div class="lui_form_title_frame lui_admire_cardWrap">
					...
					<div class="lui_form_content_frame" style="min-height: inherit">
						...
						<c:if test="${ not empty sysPraiseInfoForm.replyContent}">
							<!-- 回执信息展示 Starts -->
		...
		<c:if test="${isShowReplyContainer}">
			<script>
				$(document).ready(function(){
					setTimeout(function(){
						var defaultValue = '${fn:length(replyTextList)>0?replyTextList[0]:''}';
						CKEDITOR.instances.replyContent.setData(defaultValue);
					}, 1000);
				});
			</script>
		</c:if>
