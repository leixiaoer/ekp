...
<template:include ref="default.list">
	...
	<kmss:authShow roles="ROLE_SYSPRAISEINFO_MAINTAINER">
		<ui:content title="${ lfn:message('list.otherOpt')}">  
			<ul class='lui_list_nav_list'>
				<li><a href="${LUI_ContextPath }/sys/profile/index.jsp#app/mechanism/praise" target="_blank"><i class="iconfont lui_iconfont_navleft_com_background"></i>${ lfn:message('list.manager') }</a></li>
			</ul>
		</ui:content>		
	</kmss:authShow>				
	</ui:accordionpanel>
