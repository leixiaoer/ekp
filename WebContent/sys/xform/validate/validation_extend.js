...
Com_AddEventListener(window, 'load', function(){
	...
	XFormExtendValidation.xform_extendValidator = {
		'xform_calculatioFuns' : {
			error : "{name}"+Data_GetResourceString("sys-xform-base:Designer_Lang.controlCalculation_func_timeWarning"),
			test  : function(value, elem) {return XFormExtendValidation.XForm_CalculatioFuns_Validate(elem);}
		},
		'xform_addressMaxPersonNum(num)':{
			error : "{name} "+Data_GetResourceString("sys-xform-base:Designer_Lang.controlAttrMaxPersonNumValidate"),
