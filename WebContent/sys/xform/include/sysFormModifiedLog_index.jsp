    ...
    <template:replace name="content">
		...
		<list:criteria id="criteria">
			<%-- <list:cri-ref ref="criterion.sys.category" key="fdTemplate" multi="false" expand="false" title="${ lfn:message('km-review:kmReviewMain.criteria.fdTemplate') }">
				  <list:varParams modelName="${ param.fdModelName }"/>
			</list:cri-ref> --%>
        ...
        <div class='lui_list_operation'>
			...
			<div style="display: inline-block;vertical-align: middle;float:right;">
				<ui:toolbar id="Btntoolbar" count="10">
					<kmss:auth
						requestURL="/sys/xform/base/sysFormModifiedLogAction.do?method=deleteAll"
						requestMethod="GET">
        ...
        <list:listview id="listview">
            ...
            <!-- 列表视图 -->
            <list:colTable isDefault="true" layout="sys.ui.listview.columntable" rowHref="/sys/xform/base/sysFormModifiedLogAction.do?method=view&fdId=!{fdId}">
