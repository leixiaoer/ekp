...
function templateRefFragmentSet_LoadIframe(){
	 Doc_LoadFrame("templateRefFragmentSetContent","<c:url value="/sys/xform/fragmentSet/ref/xFormRefFragmentSet.do?method=getTemplateRefFragmentSet&versionType=${param.versionType}&isHistory=${param.isHistory}&modelName=${sysFormFragmentSetForm.fdModelName}&fdFragmentSetId="/>${sysFormFragmentSetHistoryForm.fdId}&orderby=fdAlterTime&ordertype=down");
	}
</script>
