...
<table border=1 cellspacing=2 cellpadding=0 bordercolor=#003048 width=100%>
	...
	<tr valign=middle height=35>
		<td align=center>
			...
			<input id="updateFunc" type=button class="btndialog" style="width:50px;display:none;"
				onclick="Com_DialogUpdateFunc();">&nbsp;
			<input id="addFunc" type=button class="btndialog" style="width:50px;display:none;"
