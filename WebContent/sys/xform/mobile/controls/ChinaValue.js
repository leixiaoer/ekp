define([ "dojo/_base/declare", "dojo/dom-construct", "sys/xform/mobile/controls/xformUtil",  
         "mui/form/Input", "dojo/query", "dojo/dom-style", "dojo/dom-class", "dojo/NodeList-traverse"
         ], function(declare, domConstruct, xUtil, Input, query, domStyle, domClass) {
	var claz = declare("sys.xform.mobile.controls.ChinaValue", [ Input], {
		...
		_fillValue:function(wgt){
			...
			var chinaStr = this._parseChinaValue(val.toString().replace(/,/g,''));
