...
define([
  ...
  var claz = declare(
    ...
    [Widget, AutoAdaptionMixin],
    {
      ...
      radioGroupTmpl:
        "<div data-dojo-type=\"mui/form/RadioGroup\" data-dojo-props=\"name:'!{name}',subject:&quot;!{subject}&quot;,mul:'!{mul}',concentrate:'!{concentrate}',showStatus:'!{showStatus}',onValueChange:'!{onValueChange}',store:!{store},required:!{required},validate:'!{validate}'\" class=\"muiField\"></div>",
      checkboxGroupTmpl:
        "<div data-dojo-type=\"mui/form/CheckBoxGroup\" data-dojo-props=\"name:'!{name}',subject:&quot;!{subject}&quot;,mul:'!{mul}',concentrate:'!{concentrate}',showStatus:'!{showStatus}',onValueChange:'!{onValueChange}',store:!{store},required:!{required},validate:'!{validate}'\" class=\"muiField\"></div>",
      selectTmpl:
        "<div data-dojo-type=\"mui/form/Select\" data-dojo-props=\"name:'!{name}',subject:&quot;!{subject}&quot;,mul:!{mul},concentrate:'!{concentrate}',showStatus:'!{showStatus}',onValueChange:'!{onValueChange}',store:!{store},required:!{required},validate:'!{validate}',showPleaseSelect:true\" class=\"muiField\"></div>",
      //构建组件的dom结构
      ...
      getControlValue: function(controlId) {
        ...
        if (this.isRow && controlId.indexOf(".") > -1) {
          ...
          var xformWidget = xUtil.getXformWidget(
                  "TABLE_DL_" + detailFromId,
                  controlId.replace(".", rowIndex));
          if (xformWidget instanceof Address) {
              val += "," + xformWidget.curNames;
          }
