define([ "dojo/_base/declare", "dojo/dom-construct", "dojo/dom-prop", "sys/xform/mobile/controls/xformUtil", "dijit/registry",
    "mui/form/Input", "dojo/query","dojo/dom", "dojo/dom-class","dojo/dom-attr","mui/i18n/i18n!sys-xform-base",
    "mui/util","mui/dialog/Tip","dojo/ready","dojo/_base/lang"], function(declare, domConstruct, domProp, xUtil, registry, Input, query,dom,domClass,domAttr,Msg,util,Tip,ready,lang) {
...
//			}
        ...
        _round: function(a, b) {
            return (Math.round( this._accMul(a ,Math.pow(10, b)) ) / Math.pow(10, b));
        },
