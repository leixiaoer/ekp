define(["dojo/_base/declare",
        ...
        function(declare, query, touch, util, lang, array, on, _CanvasView, msg, adapter,topic,device,domConstruct,domStyle,registry,msg,ready) {
	...
	return declare("sys.xform.mobile.controls.newAuditNote.NewAuditNote", [_CanvasView], {
		...
		createBtn: function() {
			...
			var html = '<div class="handingWay" id="handwriting_' + this.fdId + '">';
		...
		UploadSuccessed:function(srcObj , evt){
			...
			var html = '<li id="li_'+file.filekey+'"><div class="img_wrapper">';
				...
				html +='<div class="img_content"><img width="100" height="auto" src="'+file.href+'"></div></div></li>';
