...
<div id="relevance_cate_{argu.key}"
	...
	<ul data-dojo-type="sys/xform/mobile/controls/relevance/RelevanceList"
		...
		data-dojo-props="key:'{argu.key}',fdControlId:'{argu.fdControlId}',extendXmlPath:'{argu.extendXmlPath}',modelName:'{argu.fdMainModelName}',isUseNew:'{argu.isUseNew}',inputParams:'{argu.inputParams}'">
	</ul>
</div>
