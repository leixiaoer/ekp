define([ "dojo/_base/declare",  "dojo/dom-construct", 
         ...
         "lib/echart/echarts","mui/i18n/i18n!sys-xform-base:mui",
         "mui/chart/Chart"
         ], function(declare, domConstruct, domProp, xUtil, registry,
        		 _FormBase, query,dom,domClass,domAttr,domStyle,on,lang,echarts,Msg,Chart) {
...
//			 //初始化echarts实例
	        var myChart = echarts.init(this.domNode);
	        //使用制定的配置项和数据显示图表
