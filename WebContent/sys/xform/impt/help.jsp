...
<template:include ref="default.dialog">
	...
	<template:replace name="content"> 
			...
			<p> &nbsp;&nbsp; <bean:message key="sysFormTemplate.help.instructions" bundle="sys-xform"/>
			(<a href="<c:url value='/sys/xform/import.do?method=modelExport'/>" style="color: red;"><bean:message key="sysFormTemplate.help.sampleDownload" bundle="sys-xform"/></a>)。</p>
