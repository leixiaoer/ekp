...
<style>
	...
	#optBarMarginTop{height:0px !important;}
	.number_wrap{
		border-radius: 50%;
		height: 20px;
		width: 20px;
...
<script type="text/javascript">
	...
	//父窗口存储的信息
	var _paramJsonExcelUpload = top._sysFormMainExcelUpload;
	function setImportDataAndXform(data){
		importData = data;
	}
	
	function importDatasToTable(){
		top.importData(importData);
	}
	...
	function downTemplate(){
		...
		var url = Com_Parameter.ContextPath + "sys/xform/sys_form/sysFormMainImport.do?method=exportFormLayoutExcelTemplate" + parseJsonToUrlParam("modelName","propertyName","fdTemplateModelId","fdTemplateModelName",_paramJsonExcelUpload);;	
		Com_OpenWindow(url,"_parent");
	}
	
</script>
<html:form action="/sys/xform/sys_form/sysFormMainImport.do?method=uploadFormData" 
	enctype="multipart/form-data"	onsubmit="return validateForm(this);">
	<iframe name="file_frame" style="display:none;"></iframe>
<div id="optBarDiv">
	<input type="button" style="display:none;" value="<bean:message bundle="sys-transport" key="sysTransport.button.download.templet"/>" onclick="downTemplate();">
...
<center>
<div width="80%" style="margin-left:5%;text-align:left;">
	<!-- 下载模板 -->
	<div>
		<div class="operationTitle" style="margin-top:0px;">
			<span><bean:message bundle="sys-xform-base" key="xformMainImport.downLoadTemplate"/></span>
			<!-- <span>^</span> -->
		</div>
		...
		<div class="tip">
			<div>
				<div style="display: inline-block;width:25%;">
         			...
         			</span><bean:message bundle="sys-xform-base" key="xformMainImport.downLoadTemplate"/>
				</div>
				<div style="display: inline-block;">
					<a class="com_btn_link" href="javascript:void(0);" onclick="downTemplate();">
						<bean:message key="xformMainImport.attachmentTemplate" bundle="sys-xform-base"/>
					</a>
				</div>
			</div>
			<div>
				...
				<div style="display: inline-block;width:30%;">
					<html:file property="file" accept=".xls,.xlsx" styleClass="upload" style="width:100%;height:25px;" onchange="resetResult();"/>
				</div>
			</div>
		</div>
	</div>
	<div id="resultTr" style="display:none; margin-top: 10px; margin-left: 30px;" class="tip">
		<div>
	...
	<div>
		<div class="operationTitle">
			<span><bean:message key="xformMainImport.operationStep" bundle="sys-xform-base"/></span>
		</div>
		<hr align="left" width="90%"/>
		<div id="steps" class="tip" style="height:45px;">
			<div>
				<span class="number_wrap">
              		<span class="number">1</span>
         		</span>
				<bean:message key="xformMainImport.operationStep.pleaseDownload" bundle="sys-xform-base"/>&nbsp;<a class="com_btn_link" href="javascript:void(0);" onclick="downTemplate();">
				<bean:message key="xformMainImport.attachmentTemplate" bundle="sys-xform-base"/></a>&nbsp;
				<bean:message key="xformMainImport.operationWrite" bundle="sys-xform-base"/>
			</div>
			<div>
				<span class="number_wrap">
              		<span class="number">2</span>
         		</span>
				<bean:message key="xformMainImport.operationStep2" bundle="sys-xform-base"/>
			</div>
		</div>
	</div>
	...
	<div>
		<div class="operationTitle">
			<span><bean:message key="xformMainImport.attention" bundle="sys-xform-base"/></span>
		</div>
		<hr align="left" width="90%"/>
		<div id="note" class="tip">
			<div class="lineWrap">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
	         		<bean:message key="xformMainImport.rule10" bundle="sys-xform-base"/>
         		</div>
       		</div>
			<div class="lineWrap">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule20" bundle="sys-xform-base"/>
				</div>
			</div>
			<div class="lineWrap">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule30" bundle="sys-xform-base"/>
				</div>
			</div>
			<div class="lineWrap" style = "height:20px;">
				<div class="contentLeft">
					<span class="number_wrap">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule40" bundle="sys-xform-base"/>
				</div>
			</div>
			<div class="lineWrap">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
		             <bean:message key="xformMainImport.rule50" bundle="sys-xform-base"/>
				 </div>
			</div>
			<div class="lineWrap" style = "height:20px;">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule60" bundle="sys-xform-base"/>
				</div>
			</div>
			<div class="lineWrap" style = "height:20px;">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule70" bundle="sys-xform-base"/>
				</div>
			</div>
			<div class="lineWrap" style = "height:20px;">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule80" bundle="sys-xform-base"/>
				</div>
			</div>
			<div class="lineWrap">
				<div class="contentLeft">
         		...
         		<div class="contentRight">
					<bean:message key="xformMainImport.rule90" bundle="sys-xform-base"/>
				</div>
			</div>
		</div>
	</div>
