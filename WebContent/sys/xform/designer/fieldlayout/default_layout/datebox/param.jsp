...
<body>
	...
	<table class="tb_normal"  width=95%>
		...
		<tr>
			<td class="td_normal_title" width=40%><bean:message bundle="sys-xform-base" key="Designer_Lang.Designer_Lang.fieldLayout_calendarType" /></td>
			<td>
				<select id='dateTimeType' storage='true'>
					<option value="datetime"><bean:message bundle="sys-xform-base" key="Designer_Lang.fieldLayout_dateTime" /></option>
					<option value="date"><bean:message bundle="sys-xform-base" key="Designer_Lang.fieldLayout_date" /></option>
					<option value="time"><bean:message bundle="sys-xform-base" key="Designer_Lang.fieldLayout_time" /></option>
				</select>
			</td>
		</tr>
		<tr>
