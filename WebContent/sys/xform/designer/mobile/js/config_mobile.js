...
function _Designer_Control_InputText_DrawMobile() {
	...
	$(domElement).append("<div class='muiSelInput' placeholder='" + PLEASE_INPUT + "'/>");
...
function _Designer_Control_Datetime_DrawMobile() {
	...
	$(domElement).append("<div class='muiSelInput' placeholder='" + PLEASE_SELECT + "'/>");
	return domElement;
}
...
function _Designer_Control_InputCheckbox_DrawMobile(){
	...
	if(this.options.values.items==null || this.options.values.items==''){
		htmlCode = '<label class="muiCheckItem hasText"><span class="mui mui-checked muiCheckBlock"></span><span class="mui-radio-base">选项</span></label>';
	}else{
		...
		for(var i=0; i<items.length; i++){
			...
			htmlCode += '<label class="muiCheckItem hasText"><span class="mui mui-checked muiCheckBlock"></span><span class="mui-radio-base">' + text + '</span></label>';
...
function _Designer_Control_InputRadio_DrawMobile(){
	...
	var htmlCode = "";
	if(this.options.values.items==null || this.options.values.items==''){
		htmlCode = '<label class="muiRadioItem"><span class="mui mui-sort muiRadioCircle"></span><span class="mui-radio-base">选项</span></label>';
	}else{
		var itemStr = this.options.values.items;
		var items = [];
		if(itemStr.indexOf("\r\n")>-1){
		...
		for(var i=0; i<items.length; i++){
			...
			htmlCode += '<label class="muiRadioItem"><span class="mui mui-sort muiRadioCircle"></span><span class="mui-radio-base">' + text + '</span></label>';
...
function _Designer_Control_ChinaValue_DrawMobile(){
	...
	var domElement = _Designer_Control_CreateMobileWrapElement(this.options.domElement,"oldMui muiFormEleWrap");
	_Designer_Control_DrawRequired(this,domElement);
	$(domElement).append("<div class='muiInput_View'></div>");
...
function _Designer_Control_RelationRadio_DrawMobile(){
	...
	var htmlCode = "";
	for (var i = 1; i <= 3; i++) {
		htmlCode += '<label class="muiRadioItem"><span class="mui mui-sort muiRadioCircle"></span><span class="mui-radio-base">选项' + i + '</span></label>';
	}
	$(mobileEle).append(htmlCode);
}
...
function _Designer_Control_RelationCheckbox_DrawMobile(){
	...
	var htmlCode = "";
	for (var i = 1; i <= 3; i++) {
		htmlCode += '<label class="muiCheckItem hasText"><span class="mui mui-checked muiCheckBlock"></span><span class="mui-radio-base">选项' + i + '</span></label>';
	}
	$(mobileEle).append(htmlCode);
}
...
function _Designer_Control_DetailsTable_DrawMobile(){
	...
	this.type = "detailsTable";
	$(domElement).attr("fd_type","detailsTable");
