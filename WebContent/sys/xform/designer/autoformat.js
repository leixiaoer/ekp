...
//	})
	...
	html += '<tr class="panel_tr"><td><input type="checkbox" name="autoformat" value="cellWidth" checked></td>'+
	...
	html += '<tr class="panel_tr"><td><input type="checkbox" name="autoformat" value="tableWidth" checked></td>'+
	...
	html += '<tr class="panel_tr"><td><input type="checkbox" name="autoformat" value="controlWidth" checked></td>'+
	...
	validate:function(checkBoxs){
		...
		if(checkBoxs.indexOf('cellWidth') != -1 && type === 'fixed'){
			...
			if(!widthNum || widthNum == '0'){
				alert(Data_GetResourceString("sys-xform-base:autoformat.validate.cell"));
				return false;
			}
			if(widthNum.indexOf("%") != -1){
				//百分比
				try{
					parseInt(widthNum.substring(0,widthNum.indexOf("%")));
				}catch(e){
					alert(Data_GetResourceString("sys-xform-base:autoformat.validate.cell"));
					return false;
				}
		...
		if(checkBoxs.indexOf('tableWidth') != -1 && type === 'fixed'){//固定值
			...
			if(!widthNum || widthNum == '0'){
				alert(Data_GetResourceString("sys-xform-base:autoformat.validate.table"));
				return false;
			}
			if(widthNum.indexOf("%") != -1){
				//百分比
		...
		if(checkBoxs.indexOf('controlWidth') != -1 && type === 'fixed'){//控件固定值
			...
			if(!widthNum || widthNum == '0'){
				alert(Data_GetResourceString("sys-xform-base:autoformat.validate.control"));
				return false;
			}
			if(widthNum.indexOf("%") != -1){
				try{
