	...
	*/
	...
	function generate(){
		...
		if (this.mold == "11"){//饼图
			var option = {
				    ...
				    legend: {
				        bottom: '25',
				        data: [XformObject_Lang.voteNodeDisagree,XformObject_Lang.voteNodeAgree]
				    },
				    series : [
				        {
				            name: this.title,
				            ...
				            data:[
				                {value:disAgreeNum, name:XformObject_Lang.voteNodeDisagree},
				                {value:agreeNum, name:XformObject_Lang.voteNodeAgree}
				            ],
				            itemStyle: {
				                emphasis: {
				                    shadowBlur: 10,
	        ...
	        var option = {
	            ...
	            series:[
		            {
		                name:XformObject_Lang.voteNodeDisagree,
		                type:'bar',
		                data:disAgreeArr,
		                label: {
		                    normal: {
		            ...
		            {
		                name:XformObject_Lang.voteNodeAgree,
		                type:'bar',
		                data:agreeArr,
		                label: {
		                    normal: {
		...
		if (isShowAbstain){
			...
			option.legend.data[2] = XformObject_Lang.voteNodeAbstain;
			if (this.mold == "11"){
				option.series[0].data[2] = {value:abstainNum, name:XformObject_Lang.voteNodeAbstain}; 
			}
			if (this.mold == "12"){
				option.series[2] = {
						                name:XformObject_Lang.voteNodeAbstain,
						                type:'bar',
						                data:abstainArr,
						                label: {
						                    normal: {
	...
	function processOption(option){
		if (this.mold == "11"){
			option.color[2] = '#f7d868';
			option.legend.data[2] = XformObject_Lang.voteNodeAbstain;
			option.series.data[2] = {value:abstainNum, name:XformObject_Lang.voteNodeAbstain}; 
		}
		if (this.mold == "12"){
