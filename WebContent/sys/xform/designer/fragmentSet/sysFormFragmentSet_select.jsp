	...
	<template:replace name="body">
		<script>
			...
			function submitSelected() {
				...
				dialog.confirm('<bean:message bundle="sys-xform-fragmentSet" key="sysFormFragment.select.confirm"/>',function(value){
					if(value==true){
			...
			<div style="border: 1px #e8e8e8 solid;padding: 5px;height:auto;">
				<list:listview id="sourceList">
					<ui:source type="AjaxJson">
						{"url":"/sys/xform/fragmentSet/xFormFragmentSet.do?method=data&rowsize=8&fdModelName=${JsParam.fdModelName}&fdKey=${JsParam.fdKey}"}
					</ui:source>
