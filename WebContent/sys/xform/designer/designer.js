 ...
 */
function Designer_GetObj(isGlobal, isStore, isNeedFindAll) {
	var objs = [];
...
Designer.instance.getRelationControlInfo = function(isSubFormMode){
	...
	var relationControls = Designer.instance.getControlByType(relationTypeControl,isSubFormMode);
