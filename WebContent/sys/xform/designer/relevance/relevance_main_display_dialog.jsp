...
<script>
	...
	var inputParams = "${param.inputParams}";
	...
	function updateList(fdTemplateId,modelPath,fdKey,mainModelName,isBase){
		...
		var url = Com_Parameter.ContextPath + 'sys/xform/controls/relevance.do?method=updateList&fdKey=' + fdKey + '&fdTemplateId='+fdTemplateId+'&modelPath='+encodeURI(modelPath)
				...
				+ top.Xform_ObjectInfo.formFilePath + '&inputParams=' + encodeURIComponent(inputParams);
	...
	function relevance_dialog_moduleSelect(){
		...
		var url = Com_Parameter.ContextPath + 'sys/xform/controls/relevance.do?method=selectModuleWithField&fdKey='+parentParams.dialogInfo.fdKey+'&fdTemplateId='
				...
				+ top.Xform_ObjectInfo.formFilePath+'&rowsize=9&orderby=fdId&ordertype=down&inputParams=' + encodeURIComponent(inputParams);
...
<div style="height: 32px;background-color:#f3f9fd;">
	<!-- 分类导航 -->
	<div>
		<div id="__categoryNavigation__" style="color: #008cee;font-size:13px; line-height:32px;height:32px;cursor:pointer; padding:0 5px;width:260px;">
