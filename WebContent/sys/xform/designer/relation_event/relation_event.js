...
//		$(".panel_bottom").css("width",w252);
	...
	attrs : {
		...
		outputParams : {
			text : "<span style='cursor:pointer' >"+Designer_Lang.relation_event_params_out1+"&nbsp;&nbsp;<img src='relation_event/style/icons/addshow.gif' onclick='_addOutputParams(this,0);' title='"+Designer_Lang.relation_event_add_show_out+"' style='margin-top:5px;'></img><br>" +
