		...
		<form name="dynamicAttributeFieldForm" action="${LUI_ContextPath}/sys/property/custom_field/customField.do" method="post" style="padding: 20px 0;">
			...
			<table class="tb_normal" width=95%>
				<tr>
					...
					<td width=35%>
						<%
							...
							%>
								<input name="fieldTexts(<%=official%>)" class="inputsgl" validate="required" value="<%=StringEscapeUtils.escapeHtml(value)%>" onblur="genFieldName(this.value)" style="width:80%">
							...
							<%
								...
								%>
									<input name="fieldTexts(<%=key%>)" class="inputsgl" value="<%=StringEscapeUtils.escapeHtml(value)%>" style="width:80%">
							...
							%>
								<input name="fieldTexts(def)" class="inputsgl" validate="required" value="<%=StringEscapeUtils.escapeHtml(value)%>" onblur="genFieldName(this.value)" style="width:80%">
								<span class="txtstrong">*</span>
							<%
							}
						%>
					...
					<td name="columnNameTr" width=35%>
						<input name="columnName" class="inputsgl" validate="required maxLength(30) normalName uniqueColumnName" value="${dynamicAttributeField.columnName}" style="width:90%">
						<span class="txtstrong">*</span>
					</td>
				...
				<tr>
					...
					<td width=35%>
						<input name="fieldName" class="inputsgl" validate="required normalName uniqueFieldName" value="${dynamicAttributeField.fieldName}" style="width:50%">
						<span class="txtstrong">*</span>
						<br>
