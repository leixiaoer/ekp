...
Com_IncludeFile("validation.jsp|validation.js|plugin.js|eventbus.js|xform.js", null, "js");
			 ...
			 <table class="tb_simple" width=100%>
			 	<tr>
			 		<td>
						...
						<xform:textarea property="docContent" style="height:100px;width:96%" showStatus="edit" required="${required}" subject="传阅意见"></xform:textarea>
			 		</td>
			 	</tr>
			 	<tr>
			 		<td>
			 			<div>
							<div class="lui_form_subhead">
								<img src="${KMSS_Parameter_ContextPath}sys/attachment/view/img/attachment.png">&nbsp;附件
							</div>
	...
	<c:if test="${'1' eq sysCirculationMain.fdRegular}">
		<div class="nextInfoContainer">
			...
			<div class="nextInfo">即将流向:${not empty nextPerson?nextPerson:'传阅结束'}</div>
			<div class="nextInfoTips">当前发起的是有序传阅，需要您阅读后才能传阅给下一人。</div>
		</div>	
	</c:if>
