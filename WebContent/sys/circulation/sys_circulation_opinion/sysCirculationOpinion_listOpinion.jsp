...
<list:data>
	<list:data-columns var="sysCirculationOpinion" list="${queryPage.list }">
		...
		<list:data-column style="width:60px;" property="fdOrder" title="序号" >
		</list:data-column>
		...
		<list:data-column style="width:60px;" col="docStatus" title="状态" escape="false">
			<sunbor:enumsShow value="${sysCirculationOpinion.docStatus}" enumsType="sysCirculationOpinion_docStatus" bundle="sys-circulation" />
		</list:data-column>
		<list:data-column style="width:140px;" property="fdReadTime" title="阅读时间" >
			<kmss:showDate value="${sysCirculationOpinion.fdReadTime}" type="datetime" />
		</list:data-column>
		<list:data-column  style="width:140px;" property="fdWriteTime" title="填写时间" >
