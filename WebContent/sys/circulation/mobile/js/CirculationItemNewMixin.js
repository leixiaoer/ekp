define([ "dojo/_base/declare", "dojo/dom-construct", "dojo/dom-class",
		...
		"mui/util", "mui/rating/Rating","mui/i18n/i18n!sys-circulation:sysCirculationMain.mobile" , 
		"mui/openProxyMixin"], function(declare, domConstruct,
		domClass, domStyle, domAttr, ItemBase, util, Praise,Msg,openProxyMixin) {
	var item = declare("sys.circulation.CirculationItemNewMixin", [ ItemBase ,openProxyMixin], {
		tag : "li",
		// 传阅内容
		content : "",
		// 备注
