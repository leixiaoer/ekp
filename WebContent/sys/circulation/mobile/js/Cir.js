			...
			return declare('sys.circulation.Cir',[ widgetBase ],{
						...
						doSubmit : function(evt) {
							...
							var promise = request.post(
									util.formatUrl("/sys/circulation/sys_circulation_main/sysCirculationMain.do?method=save&mobile=true&fdModelId="+fromData.fdModelId+"&fdModelName="+fromData.fdModelName),
