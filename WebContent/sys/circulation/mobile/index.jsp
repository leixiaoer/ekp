		...
		<script type="text/javascript">
			require([ "dojo/topic", "dojo/dom","dojo/query","dijit/registry","dojo/domReady!" ], function(
				...
				window.addCirculate = function(){
					var path = "${LUI_ContextPath}/sys/circulation/sys_circulation_main/sysCirculationMain.do?method=add&fdModelName=${JsParam.modelName}&fdModelId=${JsParam.modelId}";
