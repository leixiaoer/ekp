    ...
    <template:replace name="content">
		...
		<list:criteria id="criteria">
			<%-- <list:cri-ref ref="criterion.sys.category" key="fdTemplate" multi="false" expand="false" title="${ lfn:message('sys-lbpmservice-changelog:lbpmTemplateChangeLog.fdTemplateName') }">
				  <list:varParams modelName="${JsParam.fdTemplateModelName}"/>
			</list:cri-ref> --%>
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/sys/lbpmservice/changelog/lbpmTemplateChangeLogAction.do?method=data&&categoryId=${JsParam.categoryId}&nodeType=${JsParam.nodeType}&fdTemplateModelName=${JsParam.fdTemplateModelName}'}
            </ui:source>
            <!-- 列表视图 -->
