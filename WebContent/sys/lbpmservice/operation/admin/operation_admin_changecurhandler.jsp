...
<%@ include file="/resource/jsp/common.jsp"%>
	...
	( function(operations) {
		...
		function OperationClick(operationName){
			var typeHtml = [];
			typeHtml.push('<label class="lui-lbpm-radio"><input type="radio" name="operationType" onclick="lbpm.globals.clickChangeCurHandlerType(this);" checked value="replace" /><span class="radio-label"><bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle_Type.adminOperationTypeReplace" /></span></label>');
			typeHtml.push('<label class="lui-lbpm-radio"><input type="radio" name="operationType" onclick="lbpm.globals.clickChangeCurHandlerType(this);" value="append" /><span class="radio-label"><bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle_Type.adminOperationTypeAppend" /></span></label>');
			$("#operationsTDTitle_Type").html('<bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle_Type.adminOperationTypeModifyType" />');
		...
		function OperationCheck(){
			...
			if(currentHandler == '' || currentHandler == " "){
				if(repHandlerType == 'replace'){
					...
					alert('<bean:message bundle="sys-lbpmservice" key="lbpmNode.flowContent.admin_operation_type.chgcurhandle.mustChangeAppendOperator" />');
				}
				return false;
			}
			return true;
