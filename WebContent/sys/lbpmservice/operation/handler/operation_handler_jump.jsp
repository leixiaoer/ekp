...
<script language="JavaScript">
	...
	( function(operations) {
		...
		function OperationClick(operationName){
			...
			operationsTDTitle.innerHTML = '<bean:message bundle="sys-lbpmservice-operation-handler" key="lbpmNode.checknode.operationsTDTitle.handlerOperationTypeJump" />'.replace("{jump}", operationName);
