...
<%
	String tname = org.apache.commons.lang.StringEscapeUtils.escapeHtml(request.getParameter("thread"));
	String tlive = org.apache.commons.lang.StringEscapeUtils.escapeHtml(request.getParameter("live"));
