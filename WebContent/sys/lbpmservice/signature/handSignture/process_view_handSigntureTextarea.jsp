...
function initOperation(){
	...
	if(isRight == "true"){
		/* var $moreList = $(".lui-lbpm-opinion-otherFnc .lui-lbpm-opinion-moreList ul");
		if($moreList.length>0){
			var html = '<li id="words_Sign_Href" style="display: none" onclick="lbpmWordSign(this);">文字签批</li>';
			html += '<li id="hand_Sign_Href" style="display: inline-block;" onclick="lbpmHandSign(this);">手写签批</li>';
...
Com_AddEventListener(window,'load',initOperation);
