			...
			var operationItemsSelect = $("[name='operationItemsSelect']")[0];
		  	if(operationItemsSelect != null){
				...
				for(var i=0; i < processorInfoObj.length; i++){
					...
					var processInfoShowText = processInfo.nodeId +"."+ parentHandlerName + langNodeName;
...
lbpm.globals.initialWorkitemParams=function(){	
	...
	var isFollowed = lbpm.globals._getIsFollowed();
...
//判断当前用户是否是流程的跟踪者
lbpm.globals._getIsFollowed = function() {
