			...
			<table width="100%" class="tb_normal">
				...
				<tr>
					...
					<td>
						...
						<label><input type="radio" name="wf_handlerSelectType" value="rule" onclick="switchHandlerSelectType(value);">引用规则</label>
			...
			<table class="tb_normal" width="100%">
				<tr>
					...
					<td>
						...
						<label><input type="radio" name="wf_optHandlerSelectType" value="rule" onclick="switchOptHandlerSelectType(value);">引用规则</label>
...
function writeRuleMapDataToHandler(data){
	...
	window.sysRuleQuoteToHandler.writeData("wf_handlerSelectType");
}
