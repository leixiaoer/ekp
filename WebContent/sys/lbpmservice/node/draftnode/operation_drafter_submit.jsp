...
( function(operations) {
	...
	function OperationCheck(workitemObjArray){
		...
		if((target && target.currentTarget && target.currentTarget.title == "<bean:message key='button.savedraft'/>") || (target && target.srcElement && target.srcElement.innerText == "<bean:message key='button.savedraft'/>") 
			|| (target && target.srcElement && target.srcElement.title == "<bean:message key='button.savedraft'/>")){
			return true;
		}
