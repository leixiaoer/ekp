	...
	( function(operations) {
		...
		function OperationClick(operationName, obj){
			...
			if (currentNodeObj.handlerSelectType=="org") {
				html += '<br>&nbsp;&nbsp;<label id="returnToCommissionedPersonLabel" class="lui-lbpm-checkbox"><input type="checkbox" id="returnToCommissionedPerson" value="true" alertText="" key="returnToCommissionedPerson"><span class="checkbox-label"><bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle.handlerOperationTypeCommission.returnToCommissionedPerson" /></span></label>'.replace("{commission}",operationName);
			}
