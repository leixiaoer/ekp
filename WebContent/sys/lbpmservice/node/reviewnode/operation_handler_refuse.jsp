...
lbpm.globals._refusePassedToThisNodeLabel = function(operationName){
	...
	// zl
	html += 'id="refusePassedToSequenceFlowNodeLabel" class="lui-lbpm-checkbox" onclick="lbpm.globals.handleRefuseOption(this)" title="' + '<bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle.handlerOperationTypeRefuse.sequenceFlow" />'.replace("{refuse}", operationName) + '"><input type="checkbox" id="refusePassedToSequenceFlowNode" value="true" alertText="" key="refusePassedToSequenceFlowNode"';
	...
	html += '<label id="refusePassedToThisNodeLabel" class="lui-lbpm-checkbox" onclick="lbpm.globals.handleRefuseOption(this)" title="' + '<bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle.handlerOperationTypeRefuse.returnBackMe" />'.replace("{refuse}", operationName) +'" ><input type="checkbox" id="refusePassedToThisNode" value="true" alertText="" key="refusePassedToThisNode"';
	if(lbpm.flowcharts["rejectReturn"] == "true"){
		html += " checked='true'";
	}
	html += '>';
	...
	//增加驳回返回本节点，add by wubing date:2016-07-29
	html += '<label id="refusePassedToThisNodeOnNodeLabel" class="lui-lbpm-checkbox" onclick="lbpm.globals.handleRefuseOption(this)" title="' + '<bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle.handlerOperationTypeRefuse.returnBack.title" />'.replace("{refuse}", operationName) + '"'; 
	...
	//增加驳回返回指定节点 add by linbb
	html += '<label id="refusePassedToTheNodeLabel" class="lui-lbpm-checkbox" onclick="lbpm.globals.handleRefuseOption(this)" title="' + '<bean:message bundle="sys-lbpmservice" key="lbpmNode.processingNode.operationsTDTitle.handlerOperationTypeRefuse.returnBackTheNode" />'.replace("{refuse}", operationName) +'" ';
