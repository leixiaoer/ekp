...
FlowChartObject.Lang.Include("sys-lbpmservice-node-checknode");
...
(function(FlowChartObject) {
	...
	FlowChartObject.Nodes.InitializeTypes.push(function() {
		var nodeType = new FlowChartObject.Nodes.NodeType("checkNode");
		nodeType.Hotkey = "E";
		//nodeType.ImgIndex = 23;
		nodeType.ImgUrl = '../images/buttonbar_checkNode.png';
		nodeType.ButtonIndex = 13;
