...
Com_AddEventListener(window, 'load', function(){
	...
	if (isNotifyCurrentHandler === "false" && dialogObject.roleType === "authority"){
		$("#notifyLevelRow").hide();
		$("#notifyTypeRow").hide();
	}	
}); 
...
<c:if test="${param.operationType eq 'history_handler_back'}">
	...
	<table class="tb_normal" width=95% style="table-layout: fixed">
			<tr id="commonUsagesRow">
				...
				<td colspan="3" >
					<select name="commonUsages" onchange="lbpm.globals.setUsages(this);" style="width: auto; overflow-x: hidden">
			...
			<tr id="descriptionRow">
				...
				<td colspan="3">
					<table width=100% border=0 class="tb_noborder">
						<tr>
							<td width="85%">
								<textarea name="fdUsageContent" class="inputMul" style="width:100%;" key="auditNode" subject="${lfn:message('sys-lbpmservice:lbpmNode.createDraft.opinion')}" validate="maxLength(4000)"></textarea>
							</td>
							<td width="15%">
