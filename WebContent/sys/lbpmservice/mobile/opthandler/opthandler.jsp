...
<div id="defaultView_{categroy.key}" class="muiAddressView" data-dojo-type="dojox/mobile/View">
	<div id="allCateScrollableView_{categroy.key}" 
		...
		<div id="allCateView_{categroy.key}" data-dojo-type="dojox/mobile/View" >
			...
			<ul data-dojo-type="sys/lbpmservice/mobile/opthandler/OptHandlerAddressList"
				data-dojo-mixins="mui/address/AddressItemListMixin"
				data-dojo-props="dataUrl:'{categroy.dataUrl}',optHandlerIds:'{categroy.optHandlerIds}',deptLimit:'{categroy.deptLimit}',isMul:{categroy.isMul},key:'{categroy.key}',channel:'all',curIds:'{categroy.curIds}',curNames:'{categroy.curNames}',selType:{categroy.type},exceptValue:'{categroy.exceptValue}',scope:'{categroy.scope}',maxPageSize:{categroy.maxPageSize}">
			</ul>
		</div>
...
<div id="searchView_{categroy.key}"
	...
	<ul data-dojo-type="sys/lbpmservice/mobile/opthandler/OptHandlerAddressList"
		...
		data-dojo-props="history:true,dataUrl:'{categroy.dataUrl}',searchUrl:'{categroy.searchUrl}',optHandlerIds:'{categroy.optHandlerIds}',deptLimit:'{categroy.deptLimit}',isMul:{categroy.isMul},key:'{categroy.key}',channel:'search',curIds:'{categroy.curIds}',curNames:'{categroy.curNames}',selType:{categroy.type},exceptValue:'{categroy.exceptValue}',scope:'{categroy.scope}'">
	</ul>
</div>
<c:if test="${param.isMul == true }">
<!-- 已选 -->
