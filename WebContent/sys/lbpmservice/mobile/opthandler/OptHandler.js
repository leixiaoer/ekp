define([ 
	...
	return declare("sys.lbpmservice.mobile.opthandler.OptHandler", [Address], {
		...
		dataUrl: '/sys/lbpmservice/mobile/opthanlder.do?method=handlers&handlerIdentity=!{handlerIdentity}&optHandlerSelectType=!{optHandlerSelectType}&fdModelName=!{fdModelName}&fdModelId=!{fdModelId}',
