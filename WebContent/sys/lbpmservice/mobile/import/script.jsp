	...
	<script>
		require(["mui/dialog/Tip", "dojo/ready"], function(Tip, ready) {
			ready(function(){
				...
				var personName = "";
				if(nameInfo[0].adminName.length<10){
					personName = nameInfo[0].adminName;
				}else{
					 personName = "<span style='text-overflow: break-word;width:200px;overflow: hidden; white-space: nowrap; text-overflow: ellipsis;padding: 0 8px 0 8px;display: block;'>"+nameInfo[0].adminName+"</span>"
				}
