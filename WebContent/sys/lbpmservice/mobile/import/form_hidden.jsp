...
<%
   request.setAttribute("pdaflag",MobileUtil.getClientType(new RequestContext(request)));
%>
...
<input type="hidden" id="sysWfBusinessForm.fdAuditNoteFrom" name="sysWfBusinessForm.fdAuditNoteFrom" value='<c:out value="${pdaflag}" />' >
