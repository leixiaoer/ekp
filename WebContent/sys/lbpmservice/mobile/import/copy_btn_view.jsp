...
<c:if test="${showOption == 'label'}">
	<c:set var="_copy_label" value="复制流程" />
</c:if>
...
<div data-dojo-type="sys/lbpmservice/mobile/workitem/CopyButton"
	...
	,href:"/km/review/km_review_main/kmReviewMain.do?method=add&fdReviewId=${kmReviewMainForm.fdId}&fdTemplateId=${kmReviewMainForm.fdTemplateId}"
	,checkUrl:"/km/review/km_review_main/kmReviewMain.do?method=checkTemplate&fdReviewId=${kmReviewMainForm.fdId}&fdTemplateId=${kmReviewMainForm.fdTemplateId}"'>
</div>
</c:if>
