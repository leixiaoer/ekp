...
<c:if test="${docStatus < '30' }">
	...
	<%-- 按钮区域分组 --%>
	<div data-dojo-type="mui/tabbar/TabBarGroup" fixed="bottom" id="${lbpmBtnId}" class="muiTabBarBottomAdaptive">
...
<c:if test="${docStatus>='30' }">
	<%-- 流程发布后的业务按钮区域--%>
	<ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom" data-dojo-props='fill:"grid"' class="muiTabBarBottomAdaptive">
