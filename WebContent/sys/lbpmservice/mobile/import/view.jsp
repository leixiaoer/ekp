		...
		<c:set var="lbpmViewName" value="${(empty param.viewName) ? 'lbpmView' : (param.viewName)}"/>
			...
			<c:if test="${param.viewName != 'none'}">
			 ...
			 data-dojo-mixins="sys/lbpmservice/mobile/common/_LbpmValidateMixin">
								...
								<td colspan="2">
									...
									<div  id="commonUsagesRow">
										...
										<div id="descriptionDiv">
											<div id="fdUsageContent" data-dojo-type='mui/form/Textarea' data-dojo-mixins="sys/lbpmservice/mobile/common/_TextareaApprovalMixin,sys/lbpmservice/mobile/usage/_LbpmUsageEventMixin"
				...
				<script type="text/javascript">				
					require(["dijit/registry","dojo/topic","dojox/mobile/sniff","mui/device/device"], function(registry,topic,has,device) {
						<%-- 提交流程(点击“提交”按钮的响应函数)  --%>
