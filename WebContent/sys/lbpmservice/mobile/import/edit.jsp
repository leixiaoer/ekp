	...
	<c:otherwise>
		...
		<div id="lbpmOperationTable" <c:if test="${empty param['isNew'] }" >style='padding:0 1.2rem;'</c:if>>
			<table class="muiSimple" cellpadding="0" cellspacing="0">
				...
				<tr id="handlerIdentityRowTr" style="display:none"><!-- #144417-流程引擎关闭提交人身份开关，在移动端新建流程还是可以选择提交身份 -->
		...
		<div class="lbpmAuditNoteTable" id="lbpmAuditNoteTable" <c:if test="${empty param['isNew'] }" >style='padding:0 1.2rem;'</c:if>>
			<%-- 审批意见扩展使用 --%>
