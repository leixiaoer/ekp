define(["dojo/_base/lang","dijit/registry","dojo/topic","dojo/request","sys/lbpmservice/mobile/common/syslbpmprocess","mui/dialog/Tip",
	"mui/util","dojo/request"],function(lang, registry, topic,request,syslbpmprocess, tip, util, request){
	var workitem={};
