		...
		function(declare,Category,topic,Msg,registry,win,has) {
			var freeflowNodeAttribute = declare("sys.lbpmservice.mobile.freeflow.freeflowNodeAttribute",
					[Category], {
						...
						attrFileds : ["name","langs","handlerIds","handlerNames","processType","notifyType","canModifyMainDoc","canAddAuditNoteAtt","flowPopedom","isFixedNode","canJump","ignoreOnHandlerSame","onAdjoinHandlerSame","ignoreOnFutureHandlerSame"],
