			...
			var freeflowNodeAttr = declare("sys.lbpmservice.mobile.freeflow.freeflowNodeAttr",
					[address], {
						...
						isSignNodeNoHasAttr : function(){
							return this.isSignNode() && this.attType=='canJump';
						},
						
						isSendNodeNoHasAttr : function(){
							return this.isSendNode() && (this.attType=="processType"||this.attType=="canJump"||this.attType=="popedom"||this.attType=="flowPopedom"||this.attType=="handlerSameSelect");
						},
