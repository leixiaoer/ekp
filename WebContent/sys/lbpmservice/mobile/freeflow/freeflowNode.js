					...
					[WidgetBase, ScrollableMixin], {
						...
						postCreate : function() {
							...
							if(this.canUpdate){
								...
								this.subscribe("/sys/lbpmservice/freeflow/moveNodeEnd","_moveNodeEnd");
						...
						upNodeClick : function(){
							...
							var prevNode = itemNode.prev();
							itemNode.insertBefore(prevNode);
							topic.publish("/sys/lbpmservice/freeflow/moveNode",this);
						},
						...
						downNodeClick : function(){
							...
							nextNode.insertBefore(itemNode);
							topic.publish("/sys/lbpmservice/freeflow/moveNode",this);
						},
						...
						_updateNode : function(srcObj){
							if(srcObj.nodeId==this.nodeId){
								...
								this.nodeNameDom.innerText = this.formatNodeName(WorkFlow_getLangLabel(node.Data["name"],node.Data["langs"],"nodeName"));
								var nodeClass = "fontmuis muis-org-approve";
								if (node.Type=="signNode"){
									nodeClass = "fontmuis muis-org-signature"
								} else if (node.Type=="sendNode"){
						...
						formatNodeName : function(nodeName){
