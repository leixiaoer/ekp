define([ "dojo/_base/declare",
         ...
         function(declare, array, lang, domClass, ViewController, viewRegistry, query, 
        		 request, topic, TransitionEvent, registry, win, util, Dialog, Tip, adapter, ScrollableView, TabBarButton, ExtOperationButton, msg){
	var button = declare("sys.lbpmservice.mobile.freeflow.freeflowChartView", [ScrollableView], {
		isInit:false,
