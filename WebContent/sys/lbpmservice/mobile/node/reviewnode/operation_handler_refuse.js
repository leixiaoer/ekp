      ...
      .then(function(passNodeArray) {
        if (passNodeArray && passNodeArray.length) {
          ...
          if (lbpm.rejectOptionsEnabled) {
              ...
              html +=
                  lbpm.workitem.constant.handlerOperationTypeRefuse_sequenceFlow + "'"
            ...
            html +=
              lbpm.workitem.constant.handlerOperationTypeRefuse_returnBackMe + "'"
            html += ",checked:" + (lbpm.flowcharts["rejectReturn"] == "true")
            html += '"></div></div>'
            ...
            html +=
              lbpm.workitem.constant.handlerOperationTypeRefuse_returnBack + "'"
            html += '"></div></div>'
            ...
            html +=
              lbpm.workitem.constant.handlerOperationTypeRefuse_returnBackTheNode + "'"
            html += '"></div></div>'
            html +=
