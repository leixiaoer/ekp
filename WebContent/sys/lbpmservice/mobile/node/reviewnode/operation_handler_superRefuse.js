							...
							function(nodeArrays) {
								...
								if (passNodeArray && passNodeArray.length) {
									...
									if (lbpm.rejectOptionsEnabled){
										...
										html += lbpm.workitem.constant.handlerOperationTypeRefuse_sequenceFlow + "'";
										...
										html += lbpm.workitem.constant.handlerOperationTypeRefuse_returnBackMe + '\'';
										html += ",checked:" + (lbpm.flowcharts["rejectReturn"] == "true");
										html += '"></div></div>';
										...
										html += lbpm.workitem.constant.handlerOperationTypeRefuse_returnBack + '\'';
										html += '"></div></div>';
										...
										html += lbpm.workitem.constant.handlerOperationTypeRefuse_returnBackTheNode + '\'';
										html += '"></div></div>';
															...
															if (lbpm.rejectOptionsEnabled) {
																...
																refusePassedToSequenceFlowNode.watch("checked", function(
																	...
																	if(val) {
																		...
																		var flag = !refusePassedToThisNode.checked && !refusePassedToThisNodeOnNode.checked && !refusePassedToTheNode.checked;
																		if(flag) {
																...
																refusePassedToThisNode.watch('checked',function(name, old, val) {
																	...
																	if(val) {
												                        ...
												                        refusePassedToSequenceFlowNode.set("checked", false);
												                    	 ...
												                    	 var flag = !refusePassedToThisNodeOnNode.checked && !refusePassedToTheNode.checked && !refusePassedToSequenceFlowNode.checked;
												                     	 if(flag) {
																	...
																	// #102686 保证单选，不允许单独取消
												                     if(val) {
												                       ...
												                       refusePassedToSequenceFlowNode.set("checked", false);
												                    	 ...
												                    	 var flag = !refusePassedToThisNode.checked && !refusePassedToTheNode.checked && !refusePassedToSequenceFlowNode.checked;
												                      	 if(flag) {
																...
																refusePassedToTheNode.watch('checked', function(name, old, val) {
											                        ...
											                        if(val) {
											                         ...
											                         refusePassedToThisNodeOnNode.set("checked", false);
											                        	 ...
											                        	 var flag = !refusePassedToThisNode.checked && !refusePassedToThisNodeOnNode.checked && !refusePassedToSequenceFlowNode.checked;
											                          	 if(flag) {
									...
									query("#operationsTDContent")
										.html(lbpm.workitem.constant.noRefuseNode.replace("{refuse}", operationName) + '<input type="hidden" alertText="' + lbpm.workitem.constant.noRefuseNode.replace("{refuse}", operationName) + '" key="jumpToNodeId">');
									 //构建一个隐藏的校验域
