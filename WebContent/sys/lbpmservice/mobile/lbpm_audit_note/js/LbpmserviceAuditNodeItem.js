    ...
    [widgetBase],
    {
      ...
      _setFdAuditNoteAttr: function (fdAuditNote) {
        switch (this.fdIsHide) {
          case "1":
            this.fdAuditNote =
              '<span class="muiLbpmserviceAuditNodeHide">' +
      ...
      startup: function () {
        ...
        this.extNoteNode = domConstruct.create(
          "p",
          {
            className: "muiLbpmserviceExtNoteNode",
        ...
        if (!this.fdHandlerImage) {
          this.fdHandlerImage =
            dojoConfig.baseUrl +
            "sys/lbpmservice/mobile/lbpm_audit_note/images/sys_img.png";
        }
        var linkNode = domConstruct.create(
          "a",
          {
            innerHTML:
              '<span class="muiLbpmserviceAuditNodeImage" style="background:url(' +
              this.fdHandlerImage +
              ') center center no-repeat;background-size:cover;display:inline-block;" ></span>',
            href: "javascript:;",
          },
          this.infoNode
        );
        ...
        if (this.fdHandlerId) {
          var url =
            dojoConfig.baseUrl + "sys/zone/index.do?userid=" + this.fdHandlerId;
          this.connect(linkNode, "click", function (evt) {
            adapter.openUserCard({
              ekpId: this.fdHandlerId,
        ...
        var h4Node = domConstruct.create(
          "h4",
          {
        ...
        domConstruct.create(
          "p",
          {
            innerHTML: "<span>" + this.fdCreateTime + "</span>",
        ...
        if (this.fdAuditNoteFrom) {
          domConstruct.create(
            ...
            {
              innerHTML:
                msg["mui.lbpmservice.node.operation.from"] +
                device.getClientTypeStr(this.fdAuditNoteFrom),
        ...
        if (
          ...
          if (this.store.fdIsShowLbpmPostscriptIcon === "1") {
            ...
            this.postscriptNode = domConstruct.create(
              "a",
              {
                className: "muiLbpmserviceAuditLabelItemPostscript",
                ...
                innerHTML:
                  ...
                  this.postscriptImage +
                  ') no-repeat;background-size:cover;display:inline-block;width:1.5rem;height:1.5rem;" ></span>',
                href: "javascript:;",
              },
              actionNode
            );
        ...
        this.lbpmPostscriptNode = domConstruct.create(
          "p",
          {
            className: "muiLbpmservicePostscriptNode muiLbpmPostscript",
            innerHTML: "",
          },
          this.contentNode
        );
        ...
        if (this.hasBorder) {
          domClass.add(this.domNode, "muiLbpmserviceAuditNodeItemBorder");
        }
