		...
		<table class="tb_normal process_review_panel" width="100%">
			...
			<tr>
				...
				<td colspan="3">
					...
					<input type="text" class="inputSgl" style="width:30px;" id="minuteOfNotifyDrafter" key="minuteOfNotifyDrafter" validate="digits,min(0)"><bean:message bundle="sys-lbpmservice" key="FlowChartObject.Lang.Node.minute" />
