							...
							<table width=100% border=0 class="tb_noborder" id="fdUsageContentTb">
								<tr>
									<td id="optionButtons" colspan="2">
										...
										<a href="javascript:;" class="com_btn_link" style="margin-left: 10px;" onclick="lbpm.globals.selectHistoryHandlers(this,'fdUsageContent');"><bean:message bundle="sys-lbpmservice" key="lbpm.process.noticeHandler.name" /></a><span style='display:none'>(<span class="noticeHandlerNum">0</span>/<span class="noticeHandlerTotal">0</span>)</span>
									</td>
								</tr>
								<tr>
									...
									<td width="15%">
										<input id="process_review_button" style="margin-top: 5px;" class="process_review_button" type=button value="<bean:message key="button.submit"/>"
