...
<c:when test="${param.isCategory == 'true' or param.isCategory == '1'}">
	...
	<kmss:auth  requestURL="/sys/lbpmservice/support/lbpm_template/lbpmNodes2Excel.do?method=doExportNodesExcel"  requestMethod="GET">
	    ...
	    <ui:button text="${lfn:message('sys-lbpmservice-support:lbpmTemplate.flowchart2Excel.button')}" order="4"  onclick="flowchartExportCategory('${KMSS_Parameter_ContextPath}sys/lbpmservice/flowchartimport/LbpmFlowchartImportAction.do?method=doExportNodesExcel&type=2&fdModelName=${param.fdModelName}');" >
	    </ui:button>
	</kmss:auth>
</c:when>
