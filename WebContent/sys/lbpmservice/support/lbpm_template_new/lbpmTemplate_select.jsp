		...
		<script>
			...
			function submitSelected() {
				seajs.use([ 'lui/dialog' ], function(dialog) {
					...
					dialog.confirm('<bean:message bundle="sys-lbpmservice-support" key="lbpmTemplate.select.confirm"/>',function(value){
						if(value==true){
			...
			<div style="border: 1px #e8e8e8 solid;">
				<div style="width: 98%;margin: 10px auto;">
					<div data-lui-type="lui/search_box!SearchBox">
						...
						{
						placeholder: "${ lfn:message('sys-lbpmservice-support:lbpmTemplate.select.inputq') }",
						width: '90%'
						}
						</script>
			...
			<div style="border: 1px #e8e8e8 solid;padding: 5px;height:auto;">
				<list:listview id="sourceList">
					<ui:source type="AjaxJson">
						{"url":"/sys/workflow/sys_wf_common_template_new/sysWfCommonTemplate.do?method=data&rowsize=8&fdModelName=${JsParam.fdModelName}&fdKey=${JsParam.fdKey}&fdType=${JsParam.fdType}"}
					</ui:source>
...
<script type="text/javascript">
	...
	if(dialogObject.winTitle==null)
		dialogObject.winTitle = '<bean:message bundle="sys-lbpmservice-support" key="table.lbpmTemplate.common" />';
