...
<html>
	...
	<body style="margin: 0px;height: 600px;width:800px;overflow:hidden;">
		<iframe width="100%" height="100%" frameborder="0" scrolling="no" id="topFrame" src="<c:url value="/sys/lbpmservice/support/lbpm_usage/lbpmUsage.do" />?method=define">
		</iframe>
	</body>
