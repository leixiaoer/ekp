				...
				<td width="85%">
					...
					<table class="tb_normal" width="100%">
						<tr>
							...
							<td width="68%">
								<ui:switch property="value(isHanderUnvaluableSkip)" enabledText="${lfn:message('sys-ui:ui.switch.enabled')}" disabledText="${lfn:message('sys-ui:ui.switch.disabled')}"></ui:switch>
								<bean:message bundle="sys-lbpmservice-support" key="lbpmSetting.isHanderUnvaluableSkip.desc"/>
								<br/><a class="com_btn_link" href="javascript:void(0)" onclick="showItemDetail('isHanderUnvaluableSkip');"><bean:message bundle="sys-lbpmservice-support" key="lbpmSetting.showItemDetail"/></a>
							</td>
						</tr>
					</table>
					...
					<table class="tb_normal" width="100%">
						<tr>
							...
							<td width="68%">
								<ui:switch checked="false" property="value(isRemoveNodeIdentifier)" enabledText="${lfn:message('sys-ui:ui.switch.enabled')}" disabledText="${lfn:message('sys-ui:ui.switch.disabled')}"></ui:switch>
								<bean:message bundle="sys-lbpmservice-support" key="lbpmSetting.isRemoveNodeIdentifier.desc"/>
