	...
	<template:replace name="content">
				...
				<ui:content title="${lfn:message('sys-lbpmservice-support:lbpmSetting.processRun.defaultValues')}" >
					<table class="tb_normal" width=100%>
						...
						<tr>
							...
							<td width="80%">
								<xform:address textarea="true" propertyId="value(fastTodoIds)" propertyName="value(fastTodoNames)" mulSelect="true" orgType="ORG_TYPE_PERSON | ORG_TYPE_POST" style="width:85%">
								</xform:address>
						...
						<tr>
							...
							<td width="80%">
								<xform:address textarea="true" propertyId="value(summaryApprovalIds)" propertyName="value(summaryApprovalNames)" mulSelect="true" orgType="ORG_TYPE_PERSON | ORG_TYPE_POST" style="width:85%">
								</xform:address>
		...
		Com_IncludeFile("doclist.js");
	 		...
	 		window.selectShowModules = function(){
	 			Dialog_Tree(true, 'value(moduleScopeIds)','value(moduleScopeNames)', ';','sysLbpmSelectModuleInfoService&fdValue=!{value}', "<bean:message bundle='sys-lbpmservice-support' key='lbpmSetting.modularSelect.scope'/>");
	 		}
