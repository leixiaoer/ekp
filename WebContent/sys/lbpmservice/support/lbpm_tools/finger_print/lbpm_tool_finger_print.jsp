...
<table class="tb_normal lbpmToolsTable" width="90%">
	...
	<tr>
		...
		<td width="80%">
			...
			<a href="javascript:void(0);" onclick="lbpmToolsSelectSubFlow('fingerPrintTemplateId','fingerPrintTemplateName');" style="color:#666"><kmss:message key="FlowChartObject.Lang.Node.select" bundle="sys-lbpmservice" /></a>
			</br>
		</td>
	</tr>
	<tr>
...
seajs.use(['lui/jquery', 'lui/dialog'], function($, dialog) {
	window.searchFingerPrint = function() {
		...
		myIframe.src="${LUI_ContextPath}/sys/lbpmservice/support/lbpm_tools/finger_print/lbpm_tool_finger_print_list.jsp?range="+$("input[name='fingerPrintTemplateId']").val()+"&nodeName="+encodeURIComponent($("input[name='fingerPrintNodeName']").val())+"&isCanFingerPrint="+$("input[name='isCanFingerPrint']").val();
		myIframe.reload();
	}
});
</script>