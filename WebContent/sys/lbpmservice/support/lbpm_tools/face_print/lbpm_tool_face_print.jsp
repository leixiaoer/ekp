...
<table class="tb_normal lbpmToolsTable" width="90%">
	...
	<tr>
		...
		<td width="80%">
			...
			<a href="javascript:void(0);" onclick="lbpmToolsSelectSubFlow('facePrintTemplateId','facePrintTemplateName');" style="color:#666"><kmss:message key="FlowChartObject.Lang.Node.select" bundle="sys-lbpmservice" /></a>
			</br>
		</td>
	</tr>
	<tr>
...
seajs.use(['lui/jquery', 'lui/dialog'], function($, dialog) {
	window.searchFacePrint = function() {
		...
		myIframe.src="${LUI_ContextPath}/sys/lbpmservice/support/lbpm_tools/face_print/lbpm_tool_face_print_list.jsp?range="+$("input[name='facePrintTemplateId']").val()+"&nodeName="+encodeURIComponent($("input[name='facePrintNodeName']").val())+"&isCanFacePrint="+$("input[name='isCanFacePrint']").val();
		myIframe.reload();
	}
});
</script>