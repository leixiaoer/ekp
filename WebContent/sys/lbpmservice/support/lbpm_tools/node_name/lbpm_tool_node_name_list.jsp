	...
	<template:replace name="content">
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/sys/lbpmservice/support/LbpmToolsAction.do?method=listNodeName&range=${JsParam.range}&nodeName='+encodeURIComponent('${JsParam.nodeName}')}
			</ui:source>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable" rowHref="/sys/lbpmservice/support/LbpmToolsAction.do?method=viewTemp&fdModelId=!{fdModelId}&fdModelName=!{fdModelName}">
				...
				<list:col-auto props="subject,fdFactId,fdFactName,creator"></list:col-auto>
			</list:colTable>
	 	...
	 	<script type="text/javascript">
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
		 		...
		 		window.update = function(id) {
					...
					var url  = '<c:url value="/sys/lbpmservice/support/LbpmToolsAction.do?method=updateNodeName&updateName='+encodeURIComponent('${JsParam.updateName}')+'"/>';
