...
<table class="tb_normal lbpmToolsTable" width="90%">
	...
	<tr>
		...
		<td width="80%">
			...
			<a href="javascript:void(0);" onclick="lbpmToolsSelectSubFlow('nodeNameTemplateId','nodeNameTemplateName');" style="color:#666"><kmss:message key="FlowChartObject.Lang.Node.select" bundle="sys-lbpmservice" /></a>
			</br>
		</td>
	</tr>
	<tr>
...
seajs.use(['lui/jquery', 'lui/dialog'], function($, dialog) {
	window.searchNodeName = function() {
		...
		if(beforeValidate && afterValidate){
			...
			myIframe.src="${LUI_ContextPath}/sys/lbpmservice/support/lbpm_tools/node_name/lbpm_tool_node_name_list.jsp?range="+$("input[name='nodeNameTemplateId']").val()+"&nodeName="+encodeURIComponent(beforeName.val())+"&updateName="+encodeURIComponent(afterName.val());
			myIframe.reload();
		}
	}
});
