...
<table class="tb_normal lbpmToolsTable" width="90%">
	<tr>
		...
		<td width="80%">
			...
			<a href="javascript:void(0);" onclick="lbpmToolsSelectSubFlow('notifyTypeTemplateId','notifyTypeTemplateName');" style="color:#666"><kmss:message key="FlowChartObject.Lang.Node.select" bundle="sys-lbpmservice" /></a>
			</br>
		</td>
	</tr>
	<tr>
...
seajs.use(['lui/jquery', 'lui/dialog'], function($, dialog) {
	window.searchNotifyType = function() {
		...
		if(notifyType.val()){
			...
			myIframe.src="${LUI_ContextPath}/sys/lbpmservice/support/lbpm_tools/notify_type/lbpm_tool_notify_type_list.jsp?range="+$("input[name='notifyTypeTemplateId']").val()+"&notifyType="+notifyType.val();
			myIframe.reload();
		}
	}
});
