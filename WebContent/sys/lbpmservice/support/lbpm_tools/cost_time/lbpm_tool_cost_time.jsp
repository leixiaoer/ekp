	...
	<table class="tb_normal lbpmToolsTable" width="90%">
		<tr>
			...
			<td width="80%">
				...
				<a href="javascript:void(0);" onclick="lbpmToolsSelectSubFlow('costTimeTemplateId','costTimeTemplateName');" style="color:#666"><kmss:message key="FlowChartObject.Lang.Node.select" bundle="sys-lbpmservice" /></a>
				</br>
			</td>
		</tr>
		<tr>
	...
	window.submitAction = function() {
		...
		if(costTimeValidate){
			...
			$.ajax({
				...
				type : 'POST',
				dataType : 'json',
				data : $.param({"templateId" : $("input[name='costTimeTemplateId']").val(),"cIsCostTime":$("input[name='cIsCostTime']").val()}, true),
				error : function(data) {
