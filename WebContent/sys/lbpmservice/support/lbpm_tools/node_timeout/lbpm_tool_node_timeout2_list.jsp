	...
	<template:replace name="content">
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/sys/lbpmservice/support/LbpmToolsAction.do?method=listNodeTimeout&range=${JsParam.range}&nodeName='+encodeURIComponent('${JsParam.nodeName}')+'&nodeTimeoutType=${JsParam.nodeTimeoutType}&more=${JsParam.more}'}
			</ui:source>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable" rowHref="/sys/lbpmservice/support/LbpmToolsAction.do?method=viewTemp&fdModelId=!{fdModelId}&fdModelName=!{fdModelName}">
				...
				<list:col-auto props="subject,reviewTime,fdCreator.fdName,fdCreateTime"></list:col-auto>
			</list:colTable>
