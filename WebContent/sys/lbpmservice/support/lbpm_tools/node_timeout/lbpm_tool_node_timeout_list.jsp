	...
	<template:replace name="content">
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/sys/lbpmservice/support/LbpmToolsAction.do?method=listNodeTimeout&range=${JsParam.range}&nodeName='+encodeURIComponent('${JsParam.nodeName}')+'&nodeTimeoutType=${JsParam.nodeTimeoutType}'}
			</ui:source>
