			...
			<div style="border: 1px #e8e8e8 solid;padding: 5px;height:auto;">
				<list:listview id="sourceList">
					<ui:source type="AjaxJson">
						{"url":"/sys/workflow/sys_wf_common_template/sysWfCommonTemplate.do?method=data&rowsize=8&fdModelName=${JsParam.fdModelName}&fdKey=${JsParam.fdKey}&fdType=${JsParam.fdType}"}
					</ui:source>
