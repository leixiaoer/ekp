					...
					<c:if test="${lbpmAuditNote.fdActionKey != '_concurrent_branch'}">
						<c:choose>
							...
							<c:otherwise>
								id="${lbpmAuditNote.fdId}"
								<c:choose>
									<c:when test="${lbpmAuditNote.fdExecutionId == rootVoteExecutionId}">
										class="child-of-${rootVoteId}"
									</c:when>
									<c:when test="${not empty rootSubExecutionId &&  lbpmAuditNote.fdParentExecutionId == rootSubExecutionId}">
										class="child-of-${rootSubId}"
									</c:when>
									<c:when test="${not empty lbpmAuditNote.fdParentExecutionId}">
										class="child-of-${lbpmAuditNote.fdExecutionId}"
									</c:when>
								</c:choose>
							</c:otherwise>
