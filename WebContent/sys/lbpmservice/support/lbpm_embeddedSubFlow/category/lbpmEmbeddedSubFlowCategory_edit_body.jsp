...
<c:set var="sysSimpleCategoryMain" value="${requestScope[param.formName]}" />
		...
		<tr>
			...
			<div class="description_txt">
				<bean:message bundle="sys-lbpmservice-support" key="lbpmEmbeddedSubFlowCategory.description.cate.tempEditor" />
			</div>
			</td>
		</tr>
		<!-- 可使用者 -->
		<tr>
			...
			<div id="Cate_AllUserNote">
				<bean:message bundle="sys-lbpmservice-support" key="lbpmEmbeddedSubFlowCategory.description.cate.tempReader.allUse" />
			</div>
			</td>
		</tr>
