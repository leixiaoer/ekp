...
<template:include ref="default.view" showQrcode='false' sidebar="no">
	...
	<template:replace name="toolbar">
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
			...
			<ui:button text="${lfn:message('button.delete') }" order="2" onclick="Com_OpenWindow('lbpmSummaryApprovalConfig.do?method=delete&fdId=${lbpmSummaryApprovalConfigForm.fdId}','_self');"></ui:button>
