...
<template:include ref="default.simple">
	...
	<list:listview id="auditNoteTable">
		<ui:source type="AjaxJson">
				{url:'/sys/lbpmservice/support/lbpm_audit_note/lbpmAuditNote.do?method=list&fdModelId=${JsParam.fdModelId}'}
		</ui:source>
		<list:colTable isDefault="true" layout="sys.ui.listview.columntable">
			<list:col-auto props="fdArrivalTime;fdCreateTime;fdFactNodeName;handlerName;fdActionInfo;fdActionName;fdNotifyType;fdCostTimeDisplayString"></list:col-auto> 
		</list:colTable>
