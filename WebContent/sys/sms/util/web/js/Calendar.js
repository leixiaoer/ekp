...
*
*/
Calendar.prototype.addDate=function(amount){

	//日的加减
	   this.date = this.date + amount;
	   if(this.isBigMonth(this.month)){
	   		if(this.date == 31){
	   				this.addMonth(1);
	   				this.date = 1;	   			
	   		}else if(this.date == 0){	   			
	   ...
	   if(this.isSmallMonth(this.month)){
	   		//debugger;
	   		if(this.date  == 30){	   			
	   				this.addMonth(1);
	   				this.date = 1;	   			
...
Calendar.prototype.addMonth=function(amount){
	//月的加减
	 if(this.month == 12){
