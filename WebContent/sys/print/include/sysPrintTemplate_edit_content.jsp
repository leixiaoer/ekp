						...
						<tr>
							<td colspan="4">
							   ...
							   <div id="content_print" style="height: 0px;width: 0px;overflow:hidden;">
							   		<c:if test="${supportJg eq 'supported' && pageScope._isWpsWebOffice != 'true'}">
