...
<c:if test="${sysEvaluationForm.evaluationForm.fdIsShow=='true'}">
	...
	<script>
		if(window.eval_opt==null)
			window.eval_opt = new EvaluationOpt('${eval_modelName}','${eval_modelId}','${JsParam.key}',eval_lang,${sysEvaluationForm.evaluationForm.fdIsCommented == 'true'}, '<%=IDGenerator.generateID()%>');
		</script>
