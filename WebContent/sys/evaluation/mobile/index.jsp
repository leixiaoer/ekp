...
<template:include ref="mobile.list" tiny="true">
	...
	<template:replace name="content">
		...
		<div id="eval_scollView"
			...
			<div class="muiEvalStoreListBar">
			    <span>${lfn:message('sys-evaluation:table.sysEvaluationMain')}</span>
			    <span id="barEvalCount">(0)</span>
			</div>
		...
		<ul data-dojo-type="mui/tabbar/TabBar" id="eval_tabbar" fixed="bottom">
			<kmss:auth requestURL="${s_requestUrl}" requestMethod="GET">
					<div class="muiEvalOpt" 
						...
						id="muiEvalOpt">
						<input type="text" readonly="readonly" class="muiEvalText evalButton" placeholder="${lfn:message('sys-evaluation:sysEvaluation.add.evaluation')}" />
					</div>
			</kmss:auth>
		</ul>
	</template:replace>
