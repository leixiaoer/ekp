						...
						onReplyClick : function() {
							...
							this._onReplyClick({
								...
								data : {
									...
									evalMark : 0,
									parentReplyNameLable:Msg['mui.sysEvaluation.mobile.btnReply'],
									parentReplyName:self.label
								},
						...
						requestReply : function() {
							...
							request.get(util.formatUrl(util.urlResolver(
								...
								array.forEach(replys, function(reply) {
									reply.parentReplayerName=self.label;
									domConstruct.place(
