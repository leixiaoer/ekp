define(	["dojo/_base/declare", "dojox/mobile/TabBarButton", "dojo/dom-class",
				...
				"dojo/_base/lang", "dojo/dom-attr","dojox/mobile/viewRegistry", "dojo/query", "dojo/_base/array", "mui/device/adapter"],
				function(declare, TabBarButton, domClass, domStyle, Badge, util, lang, domAttr, viewRegistry, query, array, adapter) {
...
//							this.setTitle();
						...
						onClick : function() {
							...
							this.defer(function(){
								if (this.href) {
									adapter.open(util.formatUrl(this.href, true), "_blank");
