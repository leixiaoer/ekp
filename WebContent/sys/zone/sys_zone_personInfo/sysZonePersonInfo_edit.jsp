								...
								<td><html:form
										...
										<table class="tb_normal" width=90%>
											...
											<tr>
												...
												<td width="85%">
													<xform:text property="email" value="${lfn:escapeHtml(sysOrgPerson.fdEmail)}" validators="email maxLength(200)" style="width:50%" showStatus="edit" ></xform:text>
												</td>
												<%}else{ %>
												<td width="85%">
													${lfn:escapeHtml(sysOrgPerson.fdEmail)}
													<div style="display:none"><xform:text property="email" value="${lfn:escapeHtml(sysOrgPerson.fdEmail)}" showStatus="readOnly" ></xform:text></div>
												</td>
												<%} %>
											</tr>
											<tr>
