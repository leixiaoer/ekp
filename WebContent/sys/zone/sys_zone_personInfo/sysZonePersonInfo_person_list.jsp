			...
			<div style="width:98%;margin:0 auto;">
				...
				<logic:iterate id="sysOrgPerson" name="queryPage" property="list"
					...
					<tr
						...
						<td width="60px">
								<a target="_blank" href="${KMSS_Parameter_ContextPath}sys/zone/sys_zone_private_change/sysZonePrivateChange.do?method=editPrivate&fdIds=${sysOrgPerson.fdId}">
									${lfn:message('sys-zone:sysZonePersonInfo.privacy')}
								</a>
						</td>
						<td>
						...
						<td width="120px">
							<a href="${KMSS_Parameter_ContextPath}sys/zone/sys_zone_personInfo/sysZonePersonInfo.do?method=modifyOtherResume&personId=${sysOrgPerson.fdId}" 
							   target="_blank">
