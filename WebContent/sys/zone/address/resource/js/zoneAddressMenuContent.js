...
define(function(require, exports, module) {
	...
	var ChildMiddleContent = AbstractCommonContent.extend({
				...
				generateFinderMiddleHTML : function(cateNode) {
					...
					var finderMiddleHTML = "<h3 class='department_name'>"
				...
				generateDeptInfoHTML : function(deptId, deptName, deptPersonNum, nodeType) {
					...
					// 部门图标
					deptInfoHTML += "<span class='icon_depart'></span>";
					deptInfoHTML += "</div>";
				...
				generateRightHTML : function(personInfo) {
					...
					if (personInfo.personType && personInfo.personType == "inner") {
						...
						childRightHTML += "<li><em class='item_name'>" + zonelang['zoneAddress.remarks']
								...
								+ (personInfo.signatureName || "") + "</span></li>";
						}else{
					...
					if (this.parent.menuType == "inner") {
						dialog.iframe(
								"/sys/zone/sys_zone_address_cate/sysZoneAddressCate.do?method=edit&fdId="
										...
										zonelang['zoneAddress.inner.iframe.edit'], this.editNodeCB, {
									width : 980,
									height : 550
								});
						...
						dialog.iframe(
								...
								zonelang['zoneAddress.outer.iframe.edit'], this.editNodeCB, {
									width : 980,
									height : 550
								});
					}
