...
<table border="0" width="95%">
			...
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					...
					<td style="padding: 0px;">
						<div style="margin: 8px;">&nbsp;&nbsp;服务地址：http://localhost:8080/ekp/sys/webservice/sysZoneWebService?wsdl<br/>
						&nbsp;&nbsp;类别维护服务接口：SysZoneWebService
						</div>
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							...
							<tr>
								<td>updateUserImage</td>
								<td>更新用户头像</td>
								<td>success</td>
								<td>SysZoneWebService</td>
				...
				<tr>
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;请求对象：Expert</div>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);" id="dataInfo"><br/>&nbsp;&nbsp;2.2&nbsp;&nbsp;更新用户头像
			<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
			</td>
	</tr>
	<tr style="display: none">
		<td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' xmlns:web='http://webservice.zone.sys.kmss.landray.com/'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Header>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<soap:Body>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<web:updateUserImage>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<arg0>admin</arg0>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<arg1>  <imageByte>cid:1233293188977</imageByte> </arg1>(类似上传附件的写法)"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="/<web:updateUserImage>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Body>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Envelope>"/><br/>
		-------------------------------------------------------------------------------<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="public static void main(String[] args) throws Exception {"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="WebServiceConfig cfg = WebServiceConfig.getInstance();"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="Object service = callService(cfg.getAddress(), cfg.getServiceClass());"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="ISysZoneWebService webservice = (ISysZoneWebService)service; "/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="File f = new File('C://Users//zhang//Desktop//668573_151228656194_2.jpg');"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value=" BufferedImage bi;"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value=" bi = ImageIO.read(f);"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="ByteArrayOutputStream baos = new ByteArrayOutputStream();"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value=" ImageIO.write(bi, 'jpg', baos);"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="byte[] bytes = baos.toByteArray();"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="AttachImage attachImage = new AttachImage();"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="attachImage.setImageByte(bytes);"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="webservice.updateUserImage(’user1', attachImage);"/><br/>
	}
		</td>
	</tr>
		<tr>
