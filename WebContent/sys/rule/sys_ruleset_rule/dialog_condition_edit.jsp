			...
			<table width="95%" class="tb_normal">
				<tr>
					...
					<td width="85%" colspan="3">
						...
						<label><input name="fdConditionMode" type="radio" value="org"/><bean:message key="sysRuleSetRule.mode.org" bundle="sys-rule"/></label>
					</td>
				</tr>
				<tr>
					...
					<td width="85%" colspan="3" id="orgArea" style="display:none">
						...
						<!-- 比较关系 -->
						<span>
							<xform:select property="orgCompare" showPleaseSelect="false" showStatus="edit" onValueChange="switchFun">
