...
<script src="<c:url value="/sys/rule/resources/js/formula_common.js"/>"></script>
<script src="<c:url value="/sys/rule/resources/js/formula_edit.js"/>"></script>
</head>
<body>
<script type="text/javascript">
...
<table cellpadding=0 cellspacing=0 width="100%" style="height:99%; border-collapse:collapse;border: 0px #303030 solid;">
	<tr>
		<td valign="top" style="width:220px; border:#303030 solid; border-width:0px 1px 0px 0px; border-collapse:collapse;">
			<iframe id="treeiframe" height=100% style="width:220px;" frameborder=0 scrolling="auto" src='<c:url value="/sys/rule/sys_ruleset_rule/dialog_tree.jsp"/>'></iframe>
		</td>
		<td width="5px">&nbsp;</td>
		<td valign="top">
		    ...
		    <tr>
		    	<td align=center colspan="2">
			    	...
			    	<div class="resultBtn-group">
		      		<input class="calcBtn resultBtn" type=button value="<bean:message key="button.ok"/>" onclick="validateFormulaByRule(writeBack);">
							...
							<input class="calcBtn resultBtn" type=button value="<bean:message bundle="sys-formula" key="button.check"/>" 
								onclick="validateFormulaByRule(validateMessage);">
