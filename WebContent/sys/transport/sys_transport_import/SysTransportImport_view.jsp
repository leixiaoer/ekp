...
function confirmDelete(msg){
	...
	dialog.confirm('<bean:message key="page.comfirmDelete"/>', function(value) {
		if(value == true) {
			Com_OpenWindow('SysTransportImport.do?method=delete&fdId=${JsParam.fdId}&fdModelName=${sysTransportImportForm.fdModelName}','_self')
		}
		else{
...
<div id="optBarDiv">
	...
	<input type="button" value="<bean:message bundle="sys-transport" key="sysTransport.button.dataImport"/>"
				onclick="Com_OpenWindow('SysTransportImport.do?method=showUploadForm&fdId=${JsParam.fdId }&fdModelName=${sysTransportImportForm.fdModelName}');">
	<input type=button value="<bean:message key="button.edit"/>"
		onclick="Com_OpenWindow('SysTransportImport.do?method=edit&fdId=${param.fdId}&fdModelName=${sysTransportImportForm.fdModelName}&type=${JsParam.type}','_self');">
	<input type=button value="<bean:message key="button.delete"/>"
		onclick="confirmDelete()">
	<input type="button" value="<bean:message key="button.close"/>" onclick="Com_CloseWindow();">
</div>
<p class="txttitle"><kmss:message key="${modelMessageKey}"/><bean:message  bundle="sys-transport" key="table.sysTransportImportConfig"/></p>
