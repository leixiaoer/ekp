...
<script type="text/javascript" src="${LUI_ContextPath}/sys/transport/sys_transport_import/resource/js/SysTransportImport_upload.js"></script>
<style>
html,body{
...
<html:form action="/sys/transport/sys_transport_import/SysTransportImportUpload.do?method=upload&fdModelName=${HtmlParam.fdModelName}" enctype="multipart/form-data" onsubmit="return validateForm(this);">
...
<div class="upload-container">
	...
	<!-- 导入提醒描述 -->
	<div style="color: rgb(255, 0, 0);margin-top: 2px;"><bean:message key="sysTransport.import.warning" bundle="sys-transport"/></div>
	<!-- 导入结果 -->
