...
<form
			...
			<tr>
				...
				<td id="rerunIfErrorTDContent" colspan="3"><label
					id="rerunIfErrorLabel"> <input type="checkbox"	
						id="rerunIfError" value="true" <c:if test="${param.fdInterface=='yes'}">checked="checked"</c:if> > <kmss:message
	...
	<center>
		<div data-lui-mark="dialog.content.buttons" style="position: fixed;bottom:0px;left: 15px;width:95%;background: #fff;padding-bottom:20px;">
			<ui:button style="width:80px" onclick="if(validateMustSignYourSuggestion()){document.forms[0].submit();}" text="${lfn:message('button.update') }" />
		</div>
	</center>
