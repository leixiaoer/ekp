...
<template:include ref="default.view" showQrcode="false" sidebar="auto">
	...
	<template:replace name="content">
		...
		<div class="lui_form_content_frame">
			<table class="tb_normal" width=100%>
				...
				<tr>
					...
					<td class="td_normal_title" width=15%><bean:message
								bundle="sys-lbpmmonitor" key="sysLbpmMonitor.interface.transferInterfaceTime" /></td>
					<td width=35%>
		...
		<div class="lui_form_content_frame">
			<table class="tb_normal" width=100%>
				...
				<tr>
					...
					<td width=35%>
					 <c:if test="${interfacelogForm.transferResult=='0'}">
		          			${lfn:message("sys-lbpmmonitor:sysLbpmMonitor.interface.sucess")}
			        </c:if>
			        <c:if test="${interfacelogForm.transferResult=='1'}">
				          	${lfn:message("sys-lbpmmonitor:sysLbpmMonitor.interface.error")}
			        </c:if>
			        <c:if test="${interfacelogForm.transferResult=='2'}">
				...
				<tr>
					<td class="td_normal_title" width=15%><bean:message
							bundle="sys-lbpmmonitor" key="sysLbpmMonitor.interfacelog.excutInterfaceDesc" /></td>
					<td  colspan="3" ><c:out value="${interfacelogForm.inferfaceResult}" /></td>
				</tr>
		...
		<ui:tabpage expand="false" >
			<%--流程机制 --%>
			<c:import url="/sys/lbpmmonitor/import/sysLbpmMonitorProcess_interfaceView.jsp"
				charEncoding="UTF-8">
				...
				<c:param name="processId" value="${interfacelogForm.fdId}" />
			</c:import>
		</ui:tabpage>
