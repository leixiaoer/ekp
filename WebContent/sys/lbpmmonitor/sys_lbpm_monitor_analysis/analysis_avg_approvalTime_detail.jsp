      ...
      <div class="lui-flowMonitor-tab-pane fade active in" >
	   ...
	   seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($ ,dialog, topic) {
			 ...
			 approvalTimeProcessItem.on('click', function (param) { 
			       ...
			       dialog.iframe('/sys/lbpmmonitor/sys_lbpm_monitor_analysis/analysis_avg_approvalTime_list.jsp?fdTempletModelId=' + fdTempletModelId+"&status=30&excuteType=processAvgApproval",
				 			"流程清单", null, {
						width : 960,
						height : 400
					});
