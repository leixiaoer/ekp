...
<table class="tb_normal" width=100%>
	...
	<tr>
		...
		<td width=85% colspan="3">
			...
			<font color="red">(注:设置前请确保(后台设置->默认值设置)中已设置了"本系统单位编码",同时已进行了单位同步操作)</font>
		</td>
	</tr>
	<tr>
		<td class="td_normal_title" width=15%>
...
<script language="JavaScript">
      ...
      function  selectUnit(){
    	  Dialog_List(true, "fdUnitIds", "fdUnitNames", ";", "kmImissiveOuterUnitDataBeanService&type=all", null, null, false, true, "外部单位选择");
      }
