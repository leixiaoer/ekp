...
function generateTree(){
	...
	LKSTree = new TreeView("LKSTree", "<bean:message bundle="sys-unit" key="sysUnitDialog.allcate"/>", document.getElementById("treeDiv"));
	
	var n1 = LKSTree.treeRoot;
	var param = "sysUnitListWithAuthByCateService&parentId=!{value}&showCate=true"
	n1.isExpanded = true;
	n1.parameter=param;
	...
	var groupTreeBean  = "sysUnitCategoryTreeService&parentId=!{value}", unitDataBean = "sysUnitListWithAuthByCateService&parentId=!{value}&showCate=true&type=" + getUnitType;
	n1.AppendBeanData(groupTreeBean, unitDataBean, null, null, null);
...
function Dialog_ClickNode(node){
	...
	window.top.sysUnitSelectType = 3;
