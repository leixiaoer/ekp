	...
	<template:replace name="content">
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/sys/unit/km_imissive_unit/kmImissiveUnit.do?method=list&q.fdNature=2'}
			</ui:source>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable" 
			     rowHref="/sys/unit/km_imissive_unit/kmImissiveUnit.do?method=view&fdId=!{fdId}">
				<list:col-checkbox></list:col-checkbox>
				<list:col-auto props="fdOrder,fdName,fdCode,fdParent.fdName,fdShortName,docCreator.fdName,docCreateTime,fdIsAvailable"></list:col-auto>
			</list:colTable>
		</list:listview>
		<br>
		<!-- 分页 -->
