...
<% 
request.setAttribute("admin", (UserUtil.checkRole("ROLE_KMIMISSIVE_CONFIG_SETTING")||UserUtil.getKMSSUser().isAdmin()));
%>
...
<table class="tb_normal" width=100%>
	...
	<tr>
		...
		<td class="td_normal_title" width=15%>
			...
			<font color="red">(<bean:message  bundle="sys-unit" key="tips.unique.code"/>)</font>
		</td><td width=35%>
