...
<template:include ref="config.profile.list">
	...
	<template:replace name="content">
        ...
        <script type="text/javascript" src="${LUI_ContextPath}/sys/organization/resource/js/orgChart.js?s_cache=${LUI_Cache}"></script>
		...
		$(function(){
			window.root_FdId = '${JsParam.parent}';  // 根节点组织机构ID 
