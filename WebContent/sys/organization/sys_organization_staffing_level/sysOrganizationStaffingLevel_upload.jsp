...
<template:include ref="default.dialog">
	<template:replace name="content">
		...
		<center>
		<!-- 模板下载表单 -->
		<form id="downloadTempletForm" action="<c:url value="/sys/organization/sys_organization_staffing_level/sysOrganizationStaffingLevel.do?method=downloadTemplet" />" method="post">
		</form>
