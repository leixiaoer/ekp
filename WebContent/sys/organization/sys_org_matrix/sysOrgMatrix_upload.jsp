...
<template:include ref="default.simple" sidebar="auto">
	...
	<template:replace name="body">
		...
		<div style="width: 95%; margin: 100px auto;">
	        ...
	        <div class="lui_maxtrix_import_wrap lui_maxtrix_import_disable">
	            ...
	            <p class="import_desc">
	            	...
	            	<a href="javascript:downloadTemplet();" class="lui_text_primary">
		...
		<!-- 模板下载 -->
		<form id="downloadTempletForm" action="${LUI_ContextPath}/sys/organization/sys_org_matrix/sysOrgMatrix.do?method=downloadTemplet&fdId=${sysOrgMatrixForm.fdId}" method="post"></form>
