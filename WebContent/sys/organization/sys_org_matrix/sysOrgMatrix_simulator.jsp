...
<template:include ref="config.edit" sidebar="no">
			...
			seajs.use(['lui/jquery','lui/dialog'], function($, dialog) {
				...
				window.startCalculate = function() {
					...
					if(checkMatrix()) {
						...
						var data = {"id":matrixId,"version":version,"results":results,"option":option,"conditionals":conditionals};
				...
				$(function() {
					setTimeout(function() {
						...
						console.log("paramMatrixId:", paramMatrixId);
						if(paramMatrixId.length > 0) {
							var paramMatrixName = decodeURIComponent("${JsParam.matrixName}");
							console.log("paramMatrixName:", paramMatrixName);
	...
	<template:replace name="content">
		<p class="txttitle" style="margin: 30px 0;"><bean:message bundle="sys-organization" key="sysOrgMatrix.simulator"/></p>
		<center>
