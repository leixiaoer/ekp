		...
		<div class="lui_list_operation">
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					...
					<list:sortgroup>
						<list:sort property="fdOrder" text="${lfn:message('sys-organization:sysOrgMatrix.fdOrder') }" group="sort.list" value="up"></list:sort>
						<list:sort property="fdName" text="${lfn:message('sys-organization:sysOrgMatrix.fdName') }" group="sort.list"></list:sort>
					</list:sortgroup>
					</ui:toolbar>
				</div>
			</div>
		 	...
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
				...
				topic.subscribe('successReloadPage', function() {
		 		...
		 		window.dataCate = function(id) {
		 			Com_OpenWindow('<c:url value="/sys/organization/sys_org_matrix/sysOrgMatrix.do" />?method=dataCate&fdId=' + id);
		 		}
		 		// 置为无效
