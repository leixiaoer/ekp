...
<div style="width: 96%;text-align: left;">
	<p>&nbsp;&nbsp;EKP系统提供了组织架构接入webservice接口服务，包含两部分，同步组织架构基本信息（syncOrgElementsBaseInfo）以及
						...
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							...
							<tr>
								...
								<td>设置和ekpJ系统做组织架构同步系统的所有组织架构基本数据.<br/>
									...
									其中id（唯一标识）、lunid(唯一标示，可替换为主健),name（名称），type（类型有：org，dept，group，person，post）不允许为空。<br>
...
<br>}<br/></font>
							...
							<tr>
								...
								<td>布尔</td>
								<td>允许为空</td>
								<td>该<font color="red">参数在本接口中无效</font></td>
							</tr>
					</table>
					</td>
				</tr>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);"><br/>&nbsp;&nbsp;1.3 实时更新组织架构信息（updateOrgElement）
			<img src="${KMSS_Parameter_StylePath}icons/collapse.gif" border="0" align="bottom"/>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;同步所有组织架构基本信息代码样例
		<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
		</td>
	</tr>
	<tr style="display: none">
		<td>
		<div style="width:96%;margin-left: 40px;"><iframe style="width:100%;height:500px;" src="in.txt" ></iframe></div>
		</td>
	</tr>
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;同步需要更新的组织架构信息代码样例
		<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
		</td>
	</tr>
	<tr style="display: none">
		<td>
		<div style="width:96%;margin-left: 40px;"><iframe style="width:100%;height:500px;" src="in1.txt" ></iframe></div>
		</td>
	</tr>
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;实时更新组织架构信息代码样例
		<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
		</td>
	</tr>
	<tr style="display: none">
		<td>
		<div style="width:96%;margin-left: 40px;"><iframe style="width:100%;height:500px;" src="in2.txt" ></iframe></div>
		</td>
	</tr>
</table>
