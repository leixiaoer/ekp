			...
			<div class="conf_show_more_w">
				<div class="conf_btn_edit">
					...
					<kmss:auth requestURL="/sys/organization/sys_org_person/sysOrgPerson.do?method=add" requestMethod="GET">
						<!-- 新建人员 -->
						<a class="btn_txt" href="javascript:addPerson('${sysOrgDept.fdId}')">${ lfn:message('sys-organization:sys.org.operations.createPerson') }</a>
					</kmss:auth>
					...
					<kmss:auth requestURL="/sys/organization/sys_org_org/sysOrgOrg.do?method=updateDeptToOrg" requestMethod="POST">
						<!-- 转机构 -->
							<a class="btn_txt" href="javascript:toOrg('${sysOrgDept.fdId}')">${ lfn:message('sys-organization:sys.org.operations.toOrg') }</a>
					</kmss:auth>
					</c:if>
