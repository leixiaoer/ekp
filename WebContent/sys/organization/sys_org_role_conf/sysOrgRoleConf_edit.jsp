...
<table class="tb_normal" width=60%>
	...
	<tr>
		...
		<td  width=85% colspan="3"><html:hidden property="fdRoleLineReaderIds" /> <html:textarea
			...
			href="#"
			onclick="Dialog_Address(true, 'fdRoleLineReaderIds','fdRoleLineReaderNames', ';',null);"><bean:message
			key="dialog.selectOther" /></a><br>
			<bean:message key="sysOrgRoleConf.fdRoleLineReaders.detail" bundle="sys-organization"/>
	   </td>
	</tr>		
</table>
</center>
