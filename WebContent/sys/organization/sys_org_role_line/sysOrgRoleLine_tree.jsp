...
<template:include ref="config.edit" sidebar="no">
	<template:replace name="head">
		...
		<script type="text/javascript">Com_IncludeFile("dialog.js|optbar.js|list.js|jquery.js");</script>
	...
	<template:replace name="content">
		...
		<script src="${ KMSS_Parameter_ContextPath}sys/organization/resource/js/sysOrgRoleLine_tree.script.js" type="text/javascript"></script>
