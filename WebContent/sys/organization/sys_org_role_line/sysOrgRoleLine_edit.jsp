...
function selectMember(){
	...
	if(flag=="false"){
		Dialog_Address(false, 'fdMemberId', 'fdMemberName', null, ORG_TYPE_POSTORPERSON , getOrgType);
	}else{
		Dialog_Address(false, 'fdMemberId', 'fdMemberName', null, ORG_TYPE_POSTORPERSON|ORG_TYPE_ORGORDEPT , getOrgType);
	}
}
