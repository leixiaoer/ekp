...
<list:data>
	<list:data-columns var="sysNewsMain" list="${queryPage.list }"  custom="false">
	    ...
	    <!-- 主题-->	
		<list:data-column headerClass="width100"  col="docSubject" title="${ lfn:message('sys-news:sysNewsMain.docSubject') }" 
		escape="false" style="text-align:left;min-width:100px">
