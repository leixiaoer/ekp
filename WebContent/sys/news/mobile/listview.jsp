...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar" 
		 data-dojo-props="modelName:'com.landray.kmss.sys.news.model.SysNewsMain'"> 
	</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docPublishTime',subject:'<bean:message bundle="sys-news" key="mobile.sysNews.docPublishTime" />',value:'down'">
	</div>
	<%-- 排序（浏览次数）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docReadCount',subject:'<bean:message bundle="sys-news" key="mobile.sysNews.views" />',value:''">
	</div>

	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		 data-dojo-type="mui/property/FilterItem"
		 data-dojo-mixins="sys/news/mobile/js/header/NewsPropertyMixin"></div>
	<div class="muiHeaderItemRight" 
		 data-dojo-type="mui/catefilter/FilterItem"
		 data-dojo-mixins="mui/simplecategory/SimpleCategoryMixin"
		 data-dojo-props="modelName: 'com.landray.kmss.sys.news.model.SysNewsTemplate',catekey: 'categoryId',prefix:''"></div>
</div>
...
<div data-dojo-type="mui/list/NavView">
	...
	<ul data-dojo-type="mui/list/HashJsonStoreList" 
		data-dojo-mixins="sys/news/mobile/js/NewsItemListMixin">
	</ul>
</div>
