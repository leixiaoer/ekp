define([ "dojo/_base/declare", "dojo/dom-construct", "dojo/dom-class",
	...
	var item = declare("sys.news.TextItemSortMixin",[ ItemBase,OpenProxyMixin ],{
		...
		buildRendering : function() {
			...
			var sortNode = domConstruct.create('div',{className : 'muiPortalSimpleListSort' },this.domNode);
			var contextNode = domConstruct.create('div',{className : 'muiPortalSimpleListContext' },this.domNode);
			var linkNode = domConstruct.create('a',{className : 'muiPortalSimpleListLink' },contextNode);
			if(this.href){
			...
			// 序号
			domConstruct.create('div',{innerHTML : parseInt(this.itemIndex) + 1,className : 'muiPortalSimpleListIndex'},sortNode);
			
			// 标题
			domConstruct.create('div',{innerHTML:this.label,className : 'muiPortalSimpleListLabel muiFontSizeM muiFontColorInfo muiSortListLabel'},linkNode);
