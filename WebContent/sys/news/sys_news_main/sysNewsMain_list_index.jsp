	   ...
	   <%-- 筛选器 --%>	
		...
		<div class="lui_list_operation">
			...
			<div style="float:right">
				<div style="display: inline-block;vertical-align: middle;">
					<ui:toolbar count="10" id="btnToolBar">
							...
							<kmss:authShow roles="ROLE_SYSNEWS_CREATE">
								<ui:button text="${lfn:message('button.add')}" onclick="addDoc()" order="6"></ui:button>	
							</kmss:authShow>
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
					{url:'/sys/news/sys_news_main/sysNewsMainIndex.do?method=listChildren&categoryId=${JsParam.categoryId}'}
			</ui:source>
