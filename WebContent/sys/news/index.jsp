		...
		<div class="lui_list_operation">
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					...
					<list:sortgroup>
						<list:sort property="docAlterTime" text="${lfn:message('sys-news:sysNewsMain.new') }" group="sort.list" value="down"></list:sort>
						<list:sort property="docPublishTime;docAlterTime;docCreateTime" text="${lfn:message('sys-news:sysNewsMain.docPublishTime') }" group="sort.list" ></list:sort>
				  ...
				  {$
					 <div class="clearfloat lui_listview_rowtable_summary_content_box">
						<dl>
			          	...
			          	<dl>	
			                <dt> 
			                	<a onclick="Com_OpenNewWindow(this)"  
			                	data-href="${LUI_ContextPath}{%row.url%}" class="textEllipsis com_subject" target="_blank" data-lui-mark-id="{%row.rowId%}">{%row.docSubject_row%}</a>
			                </dt>	
							<dd>
							...
							<dd class="lui_listview_rowtable_summary_content_box_foot_info">
								...
								<span>${lfn:message('sys-news:sysNewsMain.publishUnit') }：{%row['fdDepartment.fdName']%}</span>
								<%-- <%if(ISysAuthConstant.IS_AREA_ENABLED) { %> 
