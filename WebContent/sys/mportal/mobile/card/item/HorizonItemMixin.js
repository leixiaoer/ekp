define([ "dojo/_base/declare", "dojo/dom-construct", "dojo/dom-class",
		...
		"mui/util", "sys/mportal/mobile/OpenProxyMixin" ], function(declare,
	...
	var item = declare("sys.mportal.item.HorizonItemMixin", [ ItemBase,
		...
		buildRendering : function() {
			...
			if(this.count) {
				domConstruct.create("span", {
					className : "count",
					innerHTML : "<span class='muiDripListReadNum'>"+this.count+"</span><span class='muiDripListReadViewText'>观看</span>"
				}, info);
			}
		},
