define([
  ...
  var cls = declare("mui.portal.NavBareMor", null, {
    ...
    buildRendering: function() {
      ...
      if (this.drawByEven) {
        // 首页缓存用事件触发渲染
        this.subscribe("/mui/nav/drawNavBarMore", "drawByEventFunction");
      } else {
        this.draw();
      }
    },
    ...
    buildMore: function() {
      ...
      this.subscribe("/sys/mportal/navBarMore/buildContent", "buildContent");
      this.subscribe("/sys/mportal/navBarMore/clickItem", "clickItem");
    },
    ...
    changeSelect: function(tabIndex) {
      if (!this.liArr) {
        this.liArr = query(".et-portal-tabs-all li");
      }
