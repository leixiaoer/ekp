...
<kmss:authShow roles="ROLE_SYSIASSISTER_SETTING">
	...
	<script type="text/javascript"
		src="${LUI_ContextPath }/sys/iassister/resource/js/Sortable.min.js?s_cache=${LUI_Cache}"></script>
	<script type="text/javascript"
		src="${LUI_ContextPath }/sys/iassister/resource/js/vuedraggable.js"></script>
	<script
	...
	<script type="text/javascript">
		...
		function luiReady() {
			var jsPath = 'sys/iassister/sys_iassister_template/js/edit.js';
