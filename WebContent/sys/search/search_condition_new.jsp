...
<div>
    <iframe src="" name="searchIframe" id="searchIframe" align="top" width="97%" Frameborder=No Border=0 Marginwidth=0 Marginheight=0 Scrolling="auto" onload="Javascript:SetWinHeight(this)" style="min-height:450px">
    </iframe>
</div>
