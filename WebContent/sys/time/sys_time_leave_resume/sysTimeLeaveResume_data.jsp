...
<list:data>
	<list:data-columns var="sysTimeLeaveResume" list="${queryPage.list}" varIndex="status">
		<%
			SysTimeLeaveResume resumeDetail = (SysTimeLeaveResume) pageContext.getAttribute("sysTimeLeaveResume");
			Float fdTotalTime = resumeDetail.getFdTotalTime();
			if(Integer.valueOf(3).equals(resumeDetail.getFdLeaveDetail().getFdStatType())){
