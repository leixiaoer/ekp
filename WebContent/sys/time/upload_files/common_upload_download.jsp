...
<link type="text/css" rel="stylesheet" href="${LUI_ContextPath}/sys/time/resource/css/upload_file.css?s_cache=${LUI_Cache}"/>
			...
			<div class="lui_batch_process_container">
			    <div class="lui_batch_process-content">
			      ...
			      <div class="lui_batch_process-content-confirm">
			        <button id="submitBtn" onclick="update_submit();">${lfn:message('sys-time:sysTime.import.button.submit')}</button>
			      </div>
			      ...
			      <div class="lui_batch_process-content-tip">
			        <div class="lui_batch_process-tip-title">
						...
						<c:choose>
							<c:when test="${state}">
								<img src="${LUI_ContextPath}/sys/time/resource/images/status_succ.gif" /> <c:out value="${resultMsg}" />
							</c:when>
							<c:otherwise>
								<img src="${LUI_ContextPath}/sys/time/resource/images/status_faile.gif" /> ${lfn:message('sys-time:sysTime.import.failed')}
								<br><br>
								${resultMsg}
							</c:otherwise>
						</c:choose>
