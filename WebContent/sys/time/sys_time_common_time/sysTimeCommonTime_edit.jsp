                        ...
                        <tr id="restRow">
                            ...
                            <td width="35%">
                            	<div id="_xform_fdRestStartTime" _xform_type="datetime">
                                    <xform:datetime onValueChange="window._calcWorkHour" property="fdRestStartTime" subject="午休开始时间" 
                            ...
                            <td width="35%">
                            	<div id="_xform_fdRestEndTime" _xform_type="datetime">
                                    <xform:datetime onValueChange="window._calcWorkHour" property="fdRestEndTime" subject="午休结束时间" 
                                    	validators="checkStartEnd checkWithWorkTime" showStatus="edit" dateTimeType="time" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
