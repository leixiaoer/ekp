                        ...
                        <tr id="restRow">
                            ...
                            <td width="35%">
                            	<div id="_xform_fdRestStartTime" _xform_type="datetime">
                                    <xform:datetime property="fdRestStartTime" showStatus="view" dateTimeType="time" style="width:95%;" />
                                </div>
                            </td>
                            <td class="td_normal_title" width="15%">
                            ...
                            <td width="35%">
                            	<div id="_xform_fdRestEndTime" _xform_type="datetime">
                                    <xform:datetime property="fdRestEndTime" showStatus="view" dateTimeType="time" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
