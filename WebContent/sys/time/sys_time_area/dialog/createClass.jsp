					...
					<tr id="restRow">
						...
						<td width="35%">
							<div id="_xform_fdRestStartTime" _xform_type="datetime">
								<xform:datetime  property="fdRestStartTime" subject="午休开始时间"
												 showStatus="edit"
												 dateTimeType="time" style="width:95%;" />
							</div>
						</td>
						<td class="td_normal_title" width="15%">
						...
						<td width="35%">
							<div id="_xform_fdRestEndTime" _xform_type="datetime">
								<xform:datetime  property="fdRestEndTime" subject="午休结束时间"
												 showStatus="edit"
												 dateTimeType="time" style="width:95%;" />
							</div>
						</td>
					...
					window.handleSubmit = function() {
						...
						if(checkData(data)) {
							if(!window.checkStartEnd()){
								dialog.alert('午休开始时间不能晚于午休结束时间');
								return;
							}
							if(!window.checkWithWorkTime()){
								dialog.alert('午休时间不能在工作时间范围外');
								return;
							}
							// 校验颜色是否重复
