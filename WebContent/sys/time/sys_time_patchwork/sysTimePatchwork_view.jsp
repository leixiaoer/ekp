		...
		<td class="td_normal_title" width="15%">
   		...
   		<td width="35%">
   			<div id="_xform_fdRestStartTime" _xform_type="datetime">
          		<xform:datetime property="sysTimeCommonTimeForm.fdRestStartTime" showStatus="view" dateTimeType="time" style="width:95%;" />
   			</div>
     	</td>
      	<td class="td_normal_title" width="15%">
			午休结束时间
      	...
      	<td width="35%">
        	<div id="_xform_fdRestEndTime" _xform_type="datetime">
        		<xform:datetime property="sysTimeCommonTimeForm.fdRestEndTime" showStatus="view" dateTimeType="time" style="width:95%;" />
         	</div>
     	</td>
   	</tr>
   	</c:if>
