...
<table width="100%" class="tb_normal" id="TABLE_DocList">
	...
	<tr class="td_normal_title" style="text-align:center;">
		...
		<td class="td_normal_title" width="45%"><bean:message bundle="sys-time" key="sysTimeHoliday.holiday.day"/></td>
		<td class="td_normal_title" width="35%"><bean:message bundle="sys-time" key="sysTimeHoliday.mend.work.day"/></td>
