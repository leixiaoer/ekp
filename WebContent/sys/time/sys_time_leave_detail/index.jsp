	...
	<template:replace name="body">
		...
		<list:listview id="listview">
			...
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable"
				...
				<list:col-html headerStyle="display:none" style="display:none" title="${ lfn:message('sys-time:sysTimeLeaveDetail.fdLeaveTime') }(${ lfn:message('sys-time:sysTimeLeaveDetail.fdLeaveTime.hour') })">{$ {%row['fdLeaveTimeHour']%} $}</list:col-html>
