			...
			<div class="lui_form_content_frame" style="padding-top:20px">
				<table class="tb_normal" width=100%>
					<tr>
						...
						<td width="35%">
							<xform:address style="width: 95%" propertyId="fdPersonId" propertyName="fdPersonName" orgType="ORG_TYPE_PERSON" required="true" subject="${ lfn:message('sys-time:sysTimeLeaveDetail.fdPerson') }" onValueChange="onChangePerson">
							</xform:address>
						</td>
						<%-- 请假类型 --%>
						<td width="15%" class="td_normal_title">
