...
<%@ include file="/sys/ui/jsp/common.jsp"%>
 <ui:content id="notifyToviewdoneContent" title="${ lfn:message('sys-notify:sysNotifyTodo.tab.title4') }" cfg-route="{path:'/read'}" >
  <list:criteria id="toview_done" channel="list_toview_done">
	...
	<list:cri-criterion title="${lfn:message('sys-notify:sysNotifyTodo.todo.system') }" key="fdAppName" multi="false">
		<list:box-select>
			<list:item-select type="lui/criteria!CriterionSelectDatas"   cfg-if="param['fdAppName']"  id="appNames_toview_done">
				<ui:source type="AjaxJson" >
