...
width: 85%;
 ...
 <ui:content id="notifySysToviewContent" title="${ lfn:message('sys-notify:sysNotifyTodo.tab.title2') }" cfg-route="{path:'/sysUnread'}">
  <list:criteria id="systoview" channel="list_systoview">
	...
	<list:cri-criterion title="${lfn:message('sys-notify:sysNotifyTodo.todo.system') }" key="fdAppName" multi="false">
		<list:box-select>
			<list:item-select type="lui/criteria!CriterionSelectDatas"   cfg-if="param['fdAppName']"  id="appNames_systoview">
				<ui:source type="AjaxJson" >
