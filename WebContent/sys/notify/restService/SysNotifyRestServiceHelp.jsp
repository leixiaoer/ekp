...
<table border="0" width="95%">
						...
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							<tr class="tr_normal_title">
							 ...
							 <TR>
					          ...
					          <TD>可为空</TD>
					          <TD>
					          	    表示获取指定人待办列表。<BR>数据格式为JSON，格式描述请查看"《2.1  组织架构数据说明》"。<br>
					        ...
					        <TR>
					          ...
					          <TD>辅助上两个查询条件，来定位要获取的待办列表。<BR/>
					          	 ...
					          	 link（链接）、mobileLink（移动端链接）、padLink（pad端链接）、key（关键字）、param1（参数1）、param2（参数2）、beginTime（开始时间）、endTime（结束时间）
					          	 <br>
					          	 beginTime和endTime是查询fdCreateTime的时间范围，支持的格式有3种：“1616745084271”，“2021-02-04”，“2021-02-04 03:36”
							  </TD>
					        </TR>
					        <TR>
					          <TD>rowSize</TD>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);"><br/>&nbsp;&nbsp;1.7&nbsp;&nbsp;获取待办接收人接口(getTodoTargets)
			<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
			</td>
	</tr>
	<tr style="display: none">
		<td>
			...
			<br>
			<div style="color:red;">注意：该接口是一次性返回该待办的所有接收者，不做分页处理。</div>
		</td>
	</tr>
		...
		<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;"><tr><td>
		        ...
		        public class Test {<br/><br/>
		            &nbsp;&nbsp;public static void main(String[] args) {<br/>
		               ...
		               &nbsp;&nbsp;&nbsp;&nbsp;// 定义请求接口URL<br/>
		               &nbsp;&nbsp;&nbsp;&nbsp;String url = "http://127.0.0.1:8080/ekp/api/sys-notify/sysNotifyTodoRestService/getTodo";<br/><br/> 
