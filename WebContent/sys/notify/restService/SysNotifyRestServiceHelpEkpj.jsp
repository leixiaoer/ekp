...
<div style="width: 95%;text-align: left;">
	<p>&nbsp;&nbsp;EKP系统提供了待办restful服务，包含了发送待办（sendTodo）、删除待办（deleteTodo）、
...
<table border="0" width="95%">
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;1.1&nbsp;&nbsp;新增待办接口(add)
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;待办发送上下文（NotifyTodoSendContext），详细说明如下:</div>
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							...
							<tr>
								...
								<td>可为空</td>
								<td>作为待办的fdId<br/>
									注：未设置该参数的情况下，自动生成fdId，否则以设置的fdId为准
								</td>
							</tr>
							<tr>
								<td>language</td>
	...
	<tr style="display: none">
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					<td class="td_normal_title" width="20%">参数信息</td>
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;待办上下文（NotifyTodoClearContext），详细说明如下:</div>
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							<tr class="tr_normal_title">
								<td align="center" width="10%"><b>程序名</b></td>
								<td align="center" width="10%"><b>描述</b></td>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);"><br/>&nbsp;&nbsp;1.4&nbsp;&nbsp;更新待办接口(updateTodo)
			<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
			</td>
	</tr>
	<tr style="display: none">
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					<td class="td_normal_title" width="20%">参数信息</td>
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;获取待办上下文（NotifyTodoUpdateContext），详细说明如下:</div>
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							<tr class="tr_normal_title">
								<td align="center" width="10%"><b>程序名</b></td>
								<td align="center" width="10%"><b>描述</b></td>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);"><br/>&nbsp;&nbsp;1.5&nbsp;&nbsp;获取待办接口(getAllTodo)
			<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
			</td>
	</tr>
	<tr style="display: none">
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					<td class="td_normal_title" width="20%">参数信息</td>
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;获取待办上下文（NotifyTodoGetAllContext），详细说明如下:</div>
						<table class="tb_normal" cellpadding="0" cellspacing="0" width=100%>
							<tr class="tr_normal_title">
								<td align="center" width="10%"><b>程序名</b></td>
								<td align="center" width="10%"><b>描述</b></td>
							...
							<tr>
							 ...
							 <TR>
					          ...
					          <TD>允许为空</TD>
					          <TD>
					          	    表示获取指定人待办数。<BR>数据格式为JSON，格式描述请查看"《2.1  组织架构数据说明》"，不设置则获取所有人的待办。
					          </TD></TR>
					        <TR>
					          <TD>type</TD>
					          <TD>待办类型</TD>
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;获取待办接口调用案例
		<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
		</td>
	</tr>
	<tr style="display: none">
		...
		<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;"><tr><td>
		        ...
		        public class Test {<br/><br/>
		            &nbsp;&nbsp;public static void main(String[] args) {<br/>
		               ...
		               &nbsp;&nbsp;&nbsp;&nbsp;// 定义请求接口URL<br/>
		               &nbsp;&nbsp;&nbsp;&nbsp;String url = "http://127.0.0.1:8080/ekp/api/sys-notify/sysNotifyTodoRestServiceEkpj/getAllTodo";<br/><br/>
		               
		               &nbsp;&nbsp;&nbsp;&nbsp;// 定义header对象<br/>
		               &nbsp;&nbsp;&nbsp;&nbsp;HttpHeaders headers = new HttpHeaders();<br/><br/>
		               
		               &nbsp;&nbsp;&nbsp;&nbsp;// 如果EKP对该接口启用了Basic认证，那么客户端需要加入认证header信息<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;String accountID = "admin";         // 认证用户名<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;String accountPassword = "123456";  // 认证密码<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;addAuth(headers,accountID+":"+accountPassword);<br/><br/>
                       
                       &nbsp;&nbsp;&nbsp;&nbsp;// 定义请求参数Map<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;Map&lt;String,Object&gt; paramBody = new HashMap&lt;String,Object&gt;();<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;paramBody.put("targets", "{\"LoginName\":\"admin\"}");<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;paramBody.put("type", 0);<br/><br/>
			               paramBody.put("appName", "lbpm");<br/><br/>
                       
                       &nbsp;&nbsp;&nbsp;&nbsp;// 定义http请求实体对象<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;HttpEntity&lt;Map&lt;String,Object&gt;&gt; entity = new HttpEntity&lt;Map&lt;String,Object&gt;&gt;(paramBody,headers);<br/><br/>
                       
                       &nbsp;&nbsp;&nbsp;&nbsp;// 发送请求<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;RestTemplate template = new RestTemplate();<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;ResponseEntity&lt;Map&gt; exchange = template.exchange(url, HttpMethod.POST, entity, Map.class);<br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;System.out.println(exchange.getBody());<br/>
		            &nbsp;&nbsp;}<br/><br/>
		          
		              &nbsp;&nbsp;private static void addAuth(HttpHeaders headers,String yourEncryptedWorlds){<br/>
					        &nbsp;&nbsp;&nbsp;&nbsp;byte[] encodedAuth = org.springframework.security.crypto.codec.Base64.encode(yourEncryptedWorlds.getBytes(Charset.forName("UTF-8")));<br/>
					        &nbsp;&nbsp;&nbsp;&nbsp;String authHeader = "Basic " + new String( encodedAuth );<br/>
					        &nbsp;&nbsp;&nbsp;&nbsp;headers.set("Authorization", authHeader );<br/>
                      &nbsp;&nbsp;}<br/><br/>
