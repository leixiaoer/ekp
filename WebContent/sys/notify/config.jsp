...
<table class="tb_normal" width=100%>
	...
	<tr style="display:none" id="kmss.notify.mailSetting">
		<td class="td_normal_title" colspan="2"><a  target="_blank"
					onclick="Com_OpenNewWindow(this)" data-href='<c:url value="/sys/profile/index.jsp#notify/mail/"/>'><font color="red">请进入后台配置，“统一消息中心”—“邮件”—“邮箱设置”中配置详细信息（注意，该操作是必须完成的）</font></a></td>
	</tr>
	<tr style="" id="kmss.notify.todoSetting">
		<td class="td_normal_title" colspan="2"><a  target="_blank"
		onclick="Com_OpenNewWindow(this)" data-href='<c:url value="/sys/profile/index.jsp#notify/mail/"/>'><font color="red">1.待办为默认设置不能取消(保存不生效)</font></a></td>
	</tr>
