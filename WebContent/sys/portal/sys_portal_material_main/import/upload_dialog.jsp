...
<template:include ref="default.dialog">
    <template:replace name="head">
        ...
        <script type="text/javascript">
            ...
            Com_IncludeFile("swf_att_material.js", "${LUI_ContextPath}/sys/portal/sys_portal_material_main/source/", "js", true);
    		...
    		<script type="text/javascript">
    		  ...
    		  var _image_max_size = <%=ResourceUtil.getKmssConfigString("sys.att.imageMaxSize")%>?<%=ResourceUtil.getKmssConfigString("sys.att.imageMaxSize")%>:5;
    			...
    			var size = '${JsParam.type}'=='1'?_image_max_size:0.2	;
	     		var saveMaterialAsyncURL = Com_Parameter.ContextPath + "sys/portal/sys_portal_material_main/sysPortalMaterialMain.do?method=saveMaterialAsync";
        ...
        <div class="lui_material_upload_dlg">
            <ul class="material_upload_ul" id="material_upload_li_default_renderId">
                ...
                <li id="formTemple" class="material_upload_li  " style="display: none">
                    ...
                    <input name="fdSize" class="material_input_hidden " placeholder="${ lfn:message('sys-portal:sysPortalMaterialMain.fdName.help')}" type="text">
                    <input name="fdWidth" class="material_input_hidden " placeholder="${ lfn:message('sys-portal:sysPortalMaterialMain.fdName.help')}" type="text">
                    <input name="fdLength" class="material_input_hidden " placeholder="${ lfn:message('sys-portal:sysPortalMaterialMain.fdName.help')}" type="text">
                    <input class="material_upload_title " placeholder="${ lfn:message('sys-portal:sysPortalMaterialMain.fdName.help')}" type="text">

                    <div class="material_upload_li_hr"></div>

                    <div class="inputselectsgl" style="width:98%">
                        <input name="tagsName" class="material_upload_tags " placeholder="${ lfn:message('sys-portal:sysPortalMaterialMain.fdTags.help')}" 
                        type="text" >
                    </div>
                    ...
                    <div class="material_upload_cover">
                        ...
                        <div class="material_upload_option">
                            <span class="material_upload_cancel" onclick="btnDelViewContainer(event)">${ lfn:message('sys-portal:sysPortalMaterialMain.btn.cancelUp')}</span>
                            <span class="material_upload_restart">${ lfn:message('sys-portal:sysPortalMaterialMain.btn.restartUp')}</span>
                            <span class="lui_material_mark_split material_upload_split"></span>
                            <span class="material_upload_del" onclick="btnDelViewContainer(event)">  ${ lfn:message('sys-portal:sysPortalMaterialMain.btn.del')}</span>
                        </div>
                    </div>
                </li>
                <!-- temp end-->
