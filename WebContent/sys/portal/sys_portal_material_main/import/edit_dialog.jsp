        ...
        <div class="lui_material_edit_container">
            <div class="lui_material_edit_left">
                ...
                <div class="lui_material_edit_l_option">
                    ...
                    <span class="lui_text_primary" onclick="reset()">原始尺寸</span>
                    <span class="lui_material_mark_split "></span>
                    <span class="lui_text_primary" onclick="imgRotate(true)">左转</span>
                    <span class="lui_text_primary" onclick="imgRotate(false)">右转</span>
                    <span class="lui_material_mark_split "></span>
                    <span>裁剪比例</span>
                ...
                <div class="lui_material_edit_r_table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>&emsp;<input type="text" name="fdTags"
                                             value="${mainForm.fdTagNames==null?'':lfn:escapeHtml(mainForm.fdTagNames) }"
                                             onchange="validXss(event)"></td>
                        </tr>
                        <tr>
                            <td>${ lfn:message('sys-portal:sysPortalMaterialMain.fdSize')}</td>
                            <td>&emsp;<span name="size">${main.fdSize }</span></td>
                        </tr>
                        <tr>
                            <td>${ lfn:message('sys-portal:sysPortalMaterialMain.ppi')}</td>
                            <td>&emsp;
...
<script>
    ...
    function onSureCut() {
        ...
        if (validStrXss(fdName) || validStrXss(fdTags)) {
            alert("名称或标签中含有非法字符");
            return false;
        }
