...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('sys-portal:module.sys.pop') }-${ lfn:message('sys-portal:table.sysPortalPopMain') }" />
    </template:replace>
    ...
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('sys-portal:table.sysPortalPopMain') }" />
        ...
        <div class="lui_list_nav_frame">
            <ui:accordionpanel>
                ...
                <ui:content title="${ lfn:message('list.otherOpt') }">
                    <ul class='lui_list_nav_list'>
                        <li><a href="${LUI_ContextPath}/sys/portal/pop/sys_portal_pop_tpl/index.jsp${j_iframe}">${lfn:message('sys-portal:table.sysPortalPopTpl')}</a>
                        </li>
        ...
        <div style="margin:5px 10px;">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/portal/pop/sys_portal_pop_main/sysPortalPopMain.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
