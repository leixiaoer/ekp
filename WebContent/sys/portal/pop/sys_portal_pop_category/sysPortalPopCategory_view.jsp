...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/sys/portal/pop/sys_portal_pop_category/sysPortalPopCategory.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('sysPortalPopCategory.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/sys/portal/pop/sys_portal_pop_category/sysPortalPopCategory.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('sysPortalPopCategory.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
    ...
    <div style="width:95%;">
        <table class="tb_normal" width="100%">
            <tr>
                ...
                <td width="35%">
                    <a href="${KMSS_Parameter_ContextPath}sys/portal/pop/sys_portal_pop_category/sysPortalPopCategory.do?method=view&fdId=${sysPortalPopCategoryForm.fdParentId}" target="blank" class="com_btn_link">
                        <c:out value="${sysPortalPopCategoryForm.fdParentName}" />
                    </a>
                </td>
                <td class="td_normal_title" width="15%">
...
<script>
    ...
    var viewOption = {
        ...
        basePath: '/sys/portal/pop/sys_portal_pop_category/sysPortalPopCategory.do',
        customOpts: {
