					...
					<td colspan="2">
						...
						<div id=DIV_AllControl style="display:none">
							...
							<span lks_info="EditNode">
								<a onclick="optAddNode();return false;" href=""><bean:message  bundle="sys-portal" key="sysHomeNav.button.createChild"/></a>
