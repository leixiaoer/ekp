...
<c:if test="${empty param['j_content'] }">
	...
	<html>
		...
		<body class="lui_portal_body lui_portal_full_column_content">
...
<c:if test="${not empty param['j_content'] && param['j_content'] == true }">
	...
	<div class="lui_portal_main_background_quick lui_portal_full_column_content" style="background-image:${empty param['backgroundimagepath'] ? 'none;' : 'url('.concat(LUI_ContextPath).concat(param['backgroundimagepath']).concat(');')}" >
