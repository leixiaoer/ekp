...
function createDropDownMenu($menuItem,data,submenuData){
	var dropDownMenu = $("<div class='lui_portal_header_dropdown_menu'></div>");
...
function getSubmenuData(portalPageId){	
	...
	$.ajax({
		url: Com_Parameter.ContextPath + "sys/portal/anonym/sysPortalNavAnonym.do?method=getPortletNavByPortalPageId",
		async: false,
		data: params,
		type: "POST",
		dataType: 'json',
