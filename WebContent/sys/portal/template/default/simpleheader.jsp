...
<div class="lui_portal_header_simple_frame${ param['scene'] eq 'portal' ? '' : ' lui_portal_header_nofixed' }">
	...
	<div style="width: ${ empty param['width'] ? '980px' : param['width'] };min-width:980px;max-width:${fdHeaderMaxWidth};" class="lui_portal_header_simple_content clearfloat">
		<div class="lui_portal_header_simple_portal">
			<c:if test="${ param['showPortal']==null || param['showPortal']=='true' || param['showPortal']=='1' || param['showPortal']=='2'}">
			 <div class="lui_portal_header_simple_portal_switch"><%-- 切换门户 --%>
				<div class="lui_portal_header_text" data-lui-switch-class="lui_portal_header_text_over">
					...
					<ui:popup align="down-left" borderWidth="2">
						<c:if test="${param['showPortal']=='2' }">	
							<div class="lui_portal_simple_popup_container" style="width:600px;padding: 8px; background:white;max-height:500px;overflow-y: auto;overflow-x: hidden;">
						...
						<c:if test="${param['showPortal']!='2' }">
							<div class="lui_portal_simple_popup_container" style="width:160px;max-height:500px;background:white;overflow-y: auto;overflow-x: hidden;">
								<ui:dataview>
									<ui:source type="AjaxJson">
	...
	<div class="lui_portal_header_simple_menu_wrapper">
		<div style="width: ${ empty param['width'] ? '980px' : param['width'] };min-width:980px;max-width:${fdHeaderMaxWidth};" class="lui_portal_header_simple_menu clearfloat">
