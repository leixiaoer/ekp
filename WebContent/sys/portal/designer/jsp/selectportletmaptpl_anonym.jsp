			...
			<td valign="top">
				<list:listview>
					<ui:source type="AjaxJson">
						{"url":"/sys/anonym/sysAnonymData.do?method=twoStageAnonymData&showType=twoStageFdNameSelect&fdModelName=com.landray.kmss.sys.portal.model.SysPortalMapTpl&rowsize=10"}
					</ui:source>
