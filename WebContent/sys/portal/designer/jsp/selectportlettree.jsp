...
<template:include ref="default.simple">
	<template:replace name="title">选择树菜单</template:replace>
			...
			<td valign="top">
				...
				<list:listview>
					<ui:source type="AjaxJson">
						{"url":"/sys/portal/sys_portal_tree/sysPortalTree.do?method=select&fdType=${ param['fdType'] }&rowsize=10&orderby=docCreateTime desc"}
					</ui:source>
