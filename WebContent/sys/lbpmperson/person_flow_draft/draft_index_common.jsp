...
<list:criteria channel="channel_common_draft" expand="false"
	multi="false">
	<%--模块--%>
	<list:cri-criterion
...
<div class="lui_list_operation">
	...
	<div style="float: left">
		<div style="display: inline-block; vertical-align: middle;">
			<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" count="6" channel="channel_common_draft">
				<list:sortgroup>
	...
	<div style="float: left;">
		<list:paging layout="sys.ui.paging.top" channel="channel_common_draft">
		</list:paging>
	</div>

</div>
<ui:fixed elem=".lui_list_operation"></ui:fixed>
<list:listview channel="channel_common_draft">
	<ui:source type="AjaxJson">
													{url:'/sys/lbpmperson/sys_lbpmperson_myprocess/SysLbpmPersonMyProcess.do?method=listDraft&modelName=${JsParam.modelName }&fdStatus=${JsParam.fdStatus}&fdType=${JsParam.fdType}'}
											</ui:source>
...
<list:paging channel="channel_common_draft"></list:paging>
<script>
//解决多子系统页面显示不全问题
domain.autoResize();
	seajs
