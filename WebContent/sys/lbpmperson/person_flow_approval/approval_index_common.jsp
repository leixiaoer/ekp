...
<list:listview id="list_approve" channel="channel_common_approve">
	<ui:source type="AjaxJson">
													{url:'/sys/lbpmperson/sys_lbpmperson_myprocess/SysLbpmPersonMyProcess.do?method=listApproval&modelName=${JsParam.modelName }&fdStatus=${JsParam.fdStatus}&fdType=${JsParam.fdType}&fastop=${param.fastop}'}
											</ui:source>
