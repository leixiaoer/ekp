...
<div style="top:233px;position:absolute;left:35%;">
	<input type="button" style="border-radius:4px;font-size:14px;" class="lui_form_button" value="${lfn:message('sys-lbpmperson:lbpmperson.batchreview.agreeall')}" onclick="submitUpdateForm('pass');"/>
	<input type="button" style="border-radius:4px;margin-left:20px;font-size:14px;" class="lui_form_button" value="${lfn:message('sys-lbpmperson:lbpmperson.batchreview.refuseall')}" onclick="submitUpdateForm('refuse');"/>
</div>
</form>
<script>
$KMSSValidation();
