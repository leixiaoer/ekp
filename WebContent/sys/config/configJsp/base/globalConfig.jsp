...
<table class="tb_normal" width=100%>
	...
	<tr>
		<td class="td_normal_title" width="15%">帐户trim()函数：默认开启</td>
		<td>
			<label>
				<html:checkbox value="true" property="value(kmss.org.loginname.query)" />
				关闭
			</label>
			<br>
			<span class="message">
				trim函数会引起数据库检索的性能下降，在大用户量建议关闭。关闭后，需要自主检查组织架构的excel导入和第三方同步等引入的左右空格问题。
			</span>
		</td>
	</tr>					
</table>