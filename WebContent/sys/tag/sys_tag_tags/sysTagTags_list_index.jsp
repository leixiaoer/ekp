		...
		<list:listview id="listview">
			<c:choose>
				...
				<c:when test="${param.fdIsPrivate == '0'}">
					...
					<c:when test="${param.fdStatus == '1'}">
						<ui:source type="AjaxJson">
							{url:'/sys/tag/sys_tag_tags/sysTagTags.do?method=list&fdStatus=1&fdIsPrivate=0'}
						</ui:source>
					</c:when>
					<c:when test="${param.fdStatus == '0'}">
						<ui:source type="AjaxJson">
							{url:'/sys/tag/sys_tag_tags/sysTagTags.do?method=list&fdStatus=0&fdIsPrivate=0'}
						</ui:source>
					</c:when>
					<c:otherwise>
						<ui:source type="AjaxJson">
							{url:'/sys/tag/sys_tag_tags/sysTagTags.do?method=list&fdIsPrivate=0'}
						</ui:source>
					</c:otherwise>
					</c:choose>
				</c:when>
