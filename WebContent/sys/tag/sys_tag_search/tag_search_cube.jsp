...
<script language="JavaScript"> 
	...
	Com_IncludeFile("tag_search_cube.css", "style/"+Com_Parameter.Style+"/tag/");
</script> 
<body style="margin:0; padding:0;"> 
<DIV class='bt'  style="height: 40px"> 
<DIV class='btw' > 
<IMG  src="${KMSS_Parameter_StylePath}tag/dot_orange.jpg"/>
<span class='fz_15'><bean:message bundle="sys-tag" key="sysTagResult.total" />
<span class='cl_orange bol fz_15'  >${queryPage.totalrows}</span>
...
<DIV  style="width: 100%"> 
<iframe   src="<c:url value='/sys/tag/sys_tag_search/tag_search_norecord.jsp'/>" width=100% height=100%  frameborder=0 scrolling=no marginheight="0"    onload="Javascript:parent.SetWinHeight(this)"  >
</iframe>
</DIV>
</c:if>
...
<c:if test="${queryPage.totalrows>0}">
<DIV class='vline'>
<DIV class='w95 ' style="margin-top: -13px;width: 95%">
