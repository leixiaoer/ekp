...
element.append("<div class=\"lui_tag_cloud_content\"></div>")
...
$('.lui_tag_cloud_content').html(renderHotTagList(data))

$('.lui_tag_cloud_content').appendTo(element)
...
* 功能：鼠标移入标签，当前标签静止放大
* 说明：
* 源代码地址：https://www.jq22.com/jquery-info18951
* */
...
tagcloud({
    selector: ".lui_tag_cloud_content",  //元素选择器
    fontsize: 16,       //基本字体大小, 单位px
