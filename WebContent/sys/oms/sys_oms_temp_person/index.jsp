...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('sys-oms:module.sys.oms') }-${ lfn:message('sys-oms:table.sysOmsTempPerson') }" />
    </template:replace>
    <template:replace name="path">
        <ui:menu layout="sys.ui.menu.nav">
            <ui:menu-item text="${ lfn:message('home.home') }" icon="lui_icon_s_home" href="/" target="_top" />
            <ui:menu-item text="${ lfn:message('sys-oms:table.sysOmsTempPerson') }" />
        </ui:menu>
    </template:replace>
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('sys-oms:table.sysOmsTempPerson') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/sys/oms/sys_oms_temp_person/sysOmsTempPerson.do"} ]
            </ui:varParam>
        </ui:combin>
            ...
            <ui:accordionpanel>
                ...
                <ui:content title="${ lfn:message('list.otherOpt') }">
                    <ul class='lui_list_nav_list'>
                        ...
                        <li><a href="${LUI_ContextPath}/sys/oms/sys_oms_temp_dp/index.jsp${j_iframe}">${lfn:message('sys-oms:table.sysOmsTempDp')}</a>
                        </li>
    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                ...
                <list:cri-auto modelName="com.landray.kmss.sys.oms.model.SysOmsTempPerson" property="fdMobileNo" />
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="3">
                            ...
                            <kmss:auth requestURL="/sys/oms/sys_oms_temp_person/sysOmsTempPerson.do?method=deleteall">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/oms/sys_oms_temp_person/sysOmsTempPerson.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/sys/oms/sys_oms_temp_person/sysOmsTempPerson.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdName;fdCreateTime;fdParentid;fdOrder;fdMobileNo;fdEmail;fdSex;fdStatus;fdPersonId;fdAlterTime;fdIsAvailable.name;fdTrxId;fdExtra" url="" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
        <script>
            var listOption = {
                ...
                jPath: 'temp_person',
                modelName: 'com.landray.kmss.sys.oms.model.SysOmsTempPerson',
                templateName: '',
                basePath: '/sys/oms/sys_oms_temp_person/sysOmsTempPerson.do',
                canDelete: '${canDelete}',
                mode: '',
                templateService: '',
