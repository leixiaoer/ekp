...
<table border="0" width="95%" style="margin-top:-80px;margin-bottom:30px;">
							...
							<tr>
								...
								<td>
									...
									<ul style="list-style: none;padding: 5px;">
										<li>dpetIdIsNull: 部门ID为空</li>
										<li>postIdIsNull: 岗位ID为空</li>
										<li>personIdIsNull: 人员ID为空</li>
										<li>nameIsNull: 名称为空</li>
										<li>availableIsNull: 是否有效为空</li>
										<li>parentIdNotFound: 父部门ID找不到</li>
										<li>postIdNotFound: 岗位ID找不到</li>
										<li>deptIdNotFound: 部门ID找不到</li>
										<li>personIdNotFound: 人员ID找不到</li>
										<li>deptIdDuplicate: 部门ID重复</li>
										<li>postIdDuplicate: 岗位ID重复</li>
										<li>personIdDuplicate: 人员ID重复</li>
										<li>othorErr: 同步失败</li>
										<li>loginNameIsNull: 人员登录名为空</li>
									</ul>
								</td>
							</tr>
							<tr>
	...
	private static void addPerson(Map<String,String> headers,String trxId){<br/>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;for (int i = 0; i < 10; i++) {<br/>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;person.put("fdParentid","0");//该字段为fd_import_info信息，如：com.landray.kmss.third.ding.oms.SynchroOrgDing2EkpImp_dept_340481102<br/>
