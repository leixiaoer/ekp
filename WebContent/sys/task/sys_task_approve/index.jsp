...
<template:replace name="content">
		...
		<list:criteria id="criteria">
		     <list:cri-ref key="fdApprove" ref="criterion.sys.docSubject" title="${lfn:message('sys-task:sysTaskApprove.fdApprove') }">
			</list:cri-ref>
		</list:criteria>
		<!-- 操作栏 -->
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
						<list:sortgroup>
							<list:sort property="fdOrder" text="${lfn:message('sys-task:sysTaskApprove.fdOrder') }" group="sort.list" value="up"></list:sort>
					...
					<ui:toolbar id="Btntoolbar">
						...
						<kmss:auth requestURL="/sys/task/sys_task_approve/sysTaskApprove.do?method=deleteall">
							...
							<c:import url="/sys/profile/common/change_order_num.jsp" charEncoding="UTF-8">
								<c:param name="modelName" value="com.landray.kmss.sys.task.model.SysTaskApprove"></c:param>
		...
		<ui:source type="AjaxJson">
				{url:'/sys/task/sys_task_approve/sysTaskApprove.do?method=list&fdId=${fdId}'}
		</ui:source>
			...
			layout="sys.ui.listview.columntable" >
				...
				<list:col-auto props="fdOrder,fdApprove,fdScore,fdIsAvailable,operations"></list:col-auto>			
			</list:colTable>
		 	...
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
				...
				topic.subscribe('successReloadPage', function() {
		 		...
		 		window.deleteAll = function(id){
					...
					var url = '<c:url value="/sys/task/sys_task_approve/sysTaskApprove.do?method=deleteall"/>';
				...
				window.enable = function(id){
					if(id){
						$.post('<c:url value="/sys/task/sys_task_approve/sysTaskApprove.do?method=updateIsAvailable"/>',
