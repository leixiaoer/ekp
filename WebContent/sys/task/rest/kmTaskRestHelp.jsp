...
<table border="0" width="95%">
	<!-- 接口01 -->
	<tr>
		<td style="cursor: pointer;font-size: 15px;">&nbsp;&nbsp;1.&nbsp;&nbsp;任务今日工作同步接口<br><br>
		...
		<td>
			<table class="tb_normal" width=95%>
				<tr>
					...
					<td width="85%">/api/sys-task/main/get</td>
				</tr>
				<tr>
					<td class="td_normal_title" width=15%>功能描述</td>
					<td width="85%">同步任务管理中的任务列表到今日工作中。<br>
同步时，当传递beginTime参数时，只获取在beginTime之后创建，并且计划完成时间在今日之后的任务，如果不传递参数，则获取所有计划完成时间在今日之后的任务。<br>
同步时，如果任务状态不是进行中，则会标记删除该任务。</td>
				</tr>
				<tr>
					...
					<td width="35%">
						...
						同步时，当传递beginTime参数时，只获取在beginTime之后创建，并且计划完成时间在今日之后的任务，如果不传递参数，则获取所有计划完成时间在今日之后的任务	
					</td>
				</tr>	
				<tr>
