...
<kmss:auth requestURL="/sys/task/sys_task_main/sysTaskMain.do?method=add" requestMethod="GET">
	<input type="button" value="<bean:message key="button.add"/>"
		onclick="Com_OpenWindow('<c:url value="/sys/task/sys_task_main/sysTaskMain.do" />?method=add&fdModelId=${JsParam.fdModelId}&fdModelName=${param.fdModelName}&fdKey=${param.fdKey}');">
</kmss:auth>
...
function requery(){
	...
	var url = "${KMSS_Parameter_ContextPath}sys/task/sys_task_main/sysTaskMain_calendar_view.jsp?serviceBean=${JsParam.serviceBean}";
	...
	url = Com_SetUrlParameter(url,"s_path","${JsParam.s_path}");
