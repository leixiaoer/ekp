...
<%@ include file="/sys/task/import/taskChart.jsp"%>
	<table width=100% style="table-layout: fixed" >
			...
			<td>
				...
				<div style="float: left;margin: 10px;" class="scaleDiv">
		             ...
		             <div style="display: inline-block;vertical-align: top">	
		             	展开：<select id="select_Arrow" onchange="selectChange(this)"  style="width:100px;"></select>
		             </div>
				</div>
		...
		<tr>
			<td>
				<center>
					<div id="worldMap" style="height:300px;overflow: scroll;">
			...
			seajs.use(['lui/jquery','${LUI_ContextPath}/sys/task/js/jquery.orgchart.js'],function($,orgchart){
				...
				$(document).ready(function(){
					...
					GetOrgChartAjax(fdId, ajaxUrl,0.8);
				});
			});
			</script>
		</tr>
