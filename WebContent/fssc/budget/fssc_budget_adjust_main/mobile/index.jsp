        ...
        <c:choose>
            <c:when test="${ param.filter == '1' }">
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/back/HrefBackMixin" data-dojo-props="href:'/fssc/budget/fssc_budget_adjust_main/mobile/index.jsp'">
                    </div>
                    ...
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/simplecategory/SimpleCategoryDialogMixin" data-dojo-props="icon:'mui mui-ul', modelName:'com.landray.kmss.fssc.budget.model.FsscBudgetAdjustCategory', redirectURL:'/fssc/budget/fssc_budget_adjust_main/mobile/index.jsp?moduleName=!{curNames}&filter=1', filterURL:'/fssc/budget/fssc_budget_adjust_main/fsscBudgetAdjustMain.do?method=data&q.docTemplate=!{curIds}&orderby=docCreateTime&ordertype=down'">
                    </div>
                </div>
                <div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
                    <div data-dojo-type="mui/search/SearchBar" data-dojo-props="modelName:'com.landray.kmss.fssc.budget.model.FsscBudgetAdjustMain',needPrompt:false,height:'3.8rem'">
                    </div>
            ...
            <c:otherwise>
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/nav/MobileCfgNavBar" data-dojo-props="defaultUrl:'/fssc/budget/fssc_budget_adjust_main/mobile/nav.jsp', modelName:'com.landray.kmss.fssc.budget.model.FsscBudgetAdjustMain'">
                    </div>
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/Folder" data-dojo-props="tmplURL:'/fssc/budget/fssc_budget_adjust_main/mobile/query.jsp'"></div>
                </div>
