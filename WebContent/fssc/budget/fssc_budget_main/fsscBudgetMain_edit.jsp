                        ...
                        <tr>
                            ...
                            <td width="35%">
                                <div id="_xform_fdCompanyId" _xform_type="dialog">
                                    ...
                                    <xform:dialog dialogJs="dialogSelect(false,'fssc_base_company_fdCompany','fdCompanyId','fdCompanyName',changeCompany);"  propertyId="fdCompanyId" propertyName="fdCompanyName" showStatus="edit" required="true" subject="${lfn:message('fssc-budget:fsscBudgetMain.fdCompany')}" style="width:95%;">
                                    </xform:dialog>
                                </div>
                            </td>
                            <td class="td_normal_title" width="15%">
