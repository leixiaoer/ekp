                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="_xform_fdCompanyId" _xform_type="dialog">
                                            <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdCompanyId',nameField:'fdCompanyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCompany',dataURL:getSource('fssc_base_company_fdCompany'),subject:'${lfn:message('fssc-budget:fsscBudgetMain.fdCompany')}',required:true,curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscBudgetMainForm.fdCompanyId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscBudgetMainForm.fdCompanyName))}',afterSelect:afterDialogSel">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div id="_xform_fdBudgetSchemeId" _xform_type="select">
                                            <xform:select property="fdBudgetSchemeId" htmlElementProperties="id='fdBudgetSchemeId'" showStatus="edit" required="true" subject="${lfn:message('fssc-budget:fsscBudgetMain.fdBudgetScheme')}" mobile="true">
                                                <xform:beanDataSource serviceBean="fsscBaseBudgetSchemeService" selectBlock="fdId,fdName" />
                                            </xform:select>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div id="_xform_fdCurrencyId" _xform_type="dialog">
                                            <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdCurrencyId',nameField:'fdCurrencyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCurrency',dataURL:getSource('fssc_base_currency_fdCurrency'),subject:'${lfn:message('fssc-budget:fsscBudgetMain.fdCurrency')}',curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscBudgetMainForm.fdCurrencyId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscBudgetMainForm.fdCurrencyName))}',afterSelect:afterDialogSel">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
