...
<div class="btn_container">
    ...
    <table class="tb_normal" width="100%;" id="TABLE_DocList_fdDetailList_Form"  align="center" tbdraggable="true">
        ...
        <tr KMSS_IsReferRow="1" style="display:none;">
            ...
            <fssc:showBudgetAdjustDetail type="datumline" adjustType="${adjustType}"  fdSchemeId="${fsscBudgetAdjustMainForm.fdBudgetSchemeId}"></fssc:showBudgetAdjustDetail>
            <td align="center">
        ...
        <c:forEach items="${fsscBudgetAdjustMainForm.fdDetailList_Form}" var="fdDetailList_FormItem" varStatus="vstatus">
            <tr KMSS_IsContentRow="1">
                ...
                <td align="center">
             	...
             	<fssc:showBudgetAdjustDetail adjustType="${adjustType}" type="contentline" fdSchemeId="${fsscBudgetAdjustMainForm.fdBudgetSchemeId}" detailForm="${fdDetailList_FormItem}" method="edit" tdIndex="${vstatus.index}"></fssc:showBudgetAdjustDetail>
                <td align="center">
                    <a href="javascript:void(0);" onclick="DocList_DeleteRow();" title="${lfn:message('doclist.delete')}">
                        <img src="${KMSS_Parameter_StylePath}icons/icon_del.png" border="0" />
                    </a>
