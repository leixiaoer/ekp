...
<div class="btn_container">
    ...
    <table class="tb_normal" width="2200px;" id="TABLE_DocList_fdDetailList_Form"  align="center" tbdraggable="true">
        <tr align="center" class="tr_normal_title">
            ...
            <fssc:showBudgetDetail type="title" fdCompanyId="${fsscBudgetMainForm.fdCompanyId}" fdSchemeId="${fsscBudgetMainForm.fdBudgetSchemeId}"></fssc:showBudgetDetail>
            <td style="width:80px;">
            </td>
        </tr>
        <tr KMSS_IsReferRow="1" style="display:none;">
            ...
            <fssc:showBudgetDetail type="datumline" fdCompanyId="${fsscBudgetMainForm.fdCompanyId}" fdSchemeId="${fsscBudgetMainForm.fdBudgetSchemeId}"></fssc:showBudgetDetail>
        ...
        <c:forEach items="${fsscBudgetMainForm.fdDetailList_Form}" var="fdDetailList_FormItem" varStatus="vstatus">
            <tr KMSS_IsContentRow="1">
              ...
              <fssc:showBudgetDetail type="contentline" fdCompanyId="${fsscBudgetMainForm.fdCompanyId}" fdSchemeId="${fsscBudgetMainForm.fdBudgetSchemeId}" detailForm="${fdDetailList_FormItem}" method="edit" tdIndex="${vstatus.index}"></fssc:showBudgetDetail>
                 <td align="center">
