    ...
    <table class="tb_normal" width="80%" id="TABLE_DocList_fdDetailList_Form" align="center" tbdraggable="true">
        ...
        <c:forEach items="${fsscBudgetMainForm.fdDetailList_Form}" var="fdDetailList_FormItem" varStatus="vstatus">
            <tr KMSS_IsContentRow="1">
                ...
                <fssc:showBudgetDetail type="contentline" fdCompanyId="${fsscBudgetMainForm.fdCompanyId}" fdSchemeId="${fsscBudgetMainForm.fdBudgetSchemeId}" detailForm="${fdDetailList_FormItem}" method="view" tdIndex="${vstatus.index}"></fssc:showBudgetDetail>
                <td align="center">
