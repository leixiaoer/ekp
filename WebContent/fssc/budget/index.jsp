                ...
                <ui:accordionpanel>
                    <ui:content title="${ lfn:message('fssc-budget:fsscBudget.button.import') }">
						<ui:combin ref="menu.nav.simple">
							<ui:varParam name="source">
			  					<ui:source type="Static">
			  						<fssc:nav displayName="fdName" modelName="com.landray.kmss.fssc.base.model.FsscBaseBudgetScheme"  whereBlock="fsscBaseBudgetScheme.fdIsAvailable=true"  path="budgetMain"></fssc:nav>
			  					</ui:source>
			  				</ui:varParam>
			  			</ui:combin>
					</ui:content>
                    ...
                    <ui:content title="${ lfn:message('fssc-budget:py.YuSuanChaXun') }" expand="false">
                        <ui:combin ref="menu.nav.simple">
							<ui:varParam name="source">
			  					<ui:source type="Static">
			  						<fssc:nav displayName="fdName" modelName="com.landray.kmss.fssc.base.model.FsscBaseBudgetScheme"  whereBlock="fsscBaseBudgetScheme.fdIsAvailable=true"  path="budgetData"></fssc:nav>
			  					</ui:source>
			  				</ui:varParam>
			  			</ui:combin>
                    </ui:content>
                    <%-- <ui:content title="${ lfn:message('fssc-budget:py.YuSuanDiaoZheng') }" expand="false">
                        <ui:combin ref="menu.nav.simple">
							<ui:varParam name="source">
			  					<ui:source type="Static">
			  						<fssc:nav displayName="fdName" modelName="com.landray.kmss.fssc.base.model.FsscBaseBudgetScheme"  whereBlock="fsscBaseBudgetScheme.fdIsAvailable=true"  path="budgetAdjust"></fssc:nav>
			  					</ui:source>
			  				</ui:varParam>
			  			</ui:combin>
                    </ui:content> --%>
