...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('fssc-budget:module.fssc.budget') }-${ lfn:message('fssc-budget:table.fsscBudgetAdjustLog') }" />
    </template:replace>
    ...
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('fssc-budget:table.fsscBudgetAdjustLog') }" />
            ...
            <ui:accordionpanel>
                ...
                <ui:content title="${ lfn:message('list.otherOpt') }">
                    <ul class='lui_list_nav_list'>
                        ...
                        <li><a href="${LUI_ContextPath}/fssc/budget/fssc_budget_execute/index.jsp${j_iframe}">${lfn:message('fssc-budget:table.fsscBudgetExecute')}</a>
                        </li>
        ...
        <div style="margin:5px 10px;">
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="3">
                            ...
                            <kmss:auth requestURL="/fssc/budget/fssc_budget_adjust_log/fsscBudgetAdjustLog.do?method=add">
                                <ui:button text="${lfn:message('button.add')}" onclick="addDoc()" order="2" />
                            </kmss:auth>
                            <kmss:auth requestURL="/fssc/budget/fssc_budget_adjust_log/fsscBudgetAdjustLog.do?method=deleteall">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/fssc/budget/fssc_budget_adjust_log/fsscBudgetAdjustLog.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/fssc/budget/fssc_budget_adjust_log/fsscBudgetAdjustLog.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdModelName;fdAmount;docCreator.name;docCreateTime" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
