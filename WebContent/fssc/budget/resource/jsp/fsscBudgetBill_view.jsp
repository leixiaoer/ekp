...
<%
	request.setAttribute("fdIsBudget", FsscBaseUtil.getSwitchValue("fdIsBudget"));
%>
<c:if test="${(empty fdIsBudget or fdIsBudget=='1')  and (param.docStatus=='20' or param.docStatus=='30')}">
