...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/fee/fssc_fee_expense_item/fsscFeeExpenseItem.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscFeeExpenseItem.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/fee/fssc_fee_expense_item/fsscFeeExpenseItem.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscFeeExpenseItem.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
            ...
            <tr>
                ...
                <td colspan="3" width="85.0%">
                    ...
                    <div id="_xform_fdTemplateId" _xform_type="dialog">
                        <xform:dialog propertyId="fdTemplateId" propertyName="fdTemplateName" showStatus="view" style="width:95%;">
                ...
                <td colspan="3" width="85.0%">
                    ...
                    <div id="_xform_fdItemListIds" _xform_type="dialog">
                        <xform:dialog propertyId="fdItemListIds" propertyName="fdItemListNames" showStatus="view" style="width:95%;">
                            dialogSelect(true,'fssc_base_expense_item_fdParent','fdItemListIds','fdItemListNames');
                        </xform:dialog>
                    </div>
                </td>
            </tr>
