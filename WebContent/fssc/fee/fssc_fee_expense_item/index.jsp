...
<template:include ref="config.list">
    <template:replace name="content">
        ...
        <script>
            ...
            seajs.use(['lui/dialog','lang!fssc-base','lui/topic'],function(dialog,lang,topic){
            	// 新建
        ...
        <c:import url="/fssc/base/resource/jsp/fsscBaseImport_include.jsp" charEncoding="UTF-8">
        </c:import>
    </template:replace>
</template:include>