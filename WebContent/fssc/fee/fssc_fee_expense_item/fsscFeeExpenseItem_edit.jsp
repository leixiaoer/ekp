                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ...
                        <div id="_xform_fdItemListIds" _xform_type="dialog">
                            <xform:dialog propertyId="fdItemListIds" propertyName="fdItemListNames" showStatus="edit" required="true" subject="${lfn:message('fssc-fee:fsscFeeExpenseItem.fdItemList')}" style="width:95%;">
