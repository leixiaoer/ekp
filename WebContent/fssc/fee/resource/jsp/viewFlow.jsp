	...
	<div id="scrollView" data-dojo-type="mui/view/DocScrollableView" data-dojo-mixins="mui/form/_ValidateMixin">
		<div data-dojo-type="mui/panel/AccordionPanel">
			<xform:isExistRelationProcesses relationType="parent">
                ...
                <c:if test="${fsscFeeMainForm.docStatus >=20}">
                <template:include file="/sys/lbpmservice/mobile/import/tarbar.jsp" editUrl="/fssc/fee/fssc_fee_main/fsscFeeMain.do?method=edit&fdId=${param.fdId }" formName="fsscFeeMainForm" viewName="lbpmView" allowReview="true">
                    <template:replace name="flowArea">


                        <c:import url="/sys/circulation/mobile/import/view.jsp" charEncoding="UTF-8">
                            <c:param name="formName" value="fsscFeeMainForm"></c:param>
