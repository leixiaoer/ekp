...
var Designer_FormOption = {
    dialogs: {
        fssc_base_company_fdCompany: {
            ...
            sourceUrl: '/fssc/base/fssc_base_company/fsscBaseCompanyData.do?method=fdCompany&authCurrent=true'
        },
        ...
        fssc_base_currency_selectCurrency:{
