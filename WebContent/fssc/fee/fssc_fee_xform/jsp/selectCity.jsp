...
<template:include ref="default.dialog">
	<template:replace name="content"> 
		...
		<br/>
		<p class="txttitle">
			${lfn:message("fssc-base:tips.selectCity")}
		</p>
			...
			<tr>
					...
					<script>
						function generateTree(){
							LKSTree = new TreeView(
								"LKSTree",
								'${lfn:message("fssc-base:table.fsscBaseArea")}',
								document.getElementById("treeDiv")
							);
							LKSTree.ClickNode = function(id){
								node = Tree_GetNodeByID(LKSTree.treeRoot, id);
								var id = node.parameter[0];
								LUI('listview1').source.setUrl('/fssc/base/fssc_base_area/fsscBaseAreaData.do?method=listCity&fdCompanyId=${param.fdCompanyId}&fdId='+id);
							...
							data.AddBeanData("fsscBaseAreaService&fdCompanyId=${param.fdCompanyId}");
				...
				<td colspan="3" width="75%">
						...
						<ui:source type="AjaxJson" >
							{url:'/fssc/base/fssc_base_area/fsscBaseAreaData.do?method=listCity&fdCompanyId=${param.fdCompanyId }'}
						</ui:source>
