		...
		<tr>
			...
			<td  width=23% >
				<xform:dialog propertyId="fdCostCenterGroupId" propertyName="fdCostCenterGroupName" showStatus="edit" subject="${lfn:message('fssc-fee:control.budgetRule.costCenter')}" style="width:35%;">
					dialogSelect(false,'fssc_base_cost_center_selectCostCenterGroup','fdCostCenterGroupId','fdCostCenterGroupName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'selectType':'search'});
				</xform:dialog>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td  width=23% >
				<xform:dialog propertyId="fdExpenseItemId" propertyName="fdExpenseItemName" showStatus="edit" subject="${lfn:message('fssc-fee:control.budgetRule.expenseItem')}" style="width:35%;">
					dialogSelect(false,'fssc_base_expense_item_selectExpenseItem','fdExpenseItemId','fdExpenseItemName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'type':'all'});
				</xform:dialog>
			</td>
		</tr>
		<tr>
