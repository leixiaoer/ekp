...
<table width="100%" align="center" class="tb_normal" id="TABLE_DL_fd_37425415d18482" style="width: 100%;" required="undefined"  fd_type="detailsTable"  layout2col="undefined" tablename="fd_374252852c0bd2" label="明细表1" data-multihead="false" showindex="true" showrow="1" showstatisticrow="undefined" showcopyopt="undefined" excelexport="undefined" excelimport="undefined">
...
window.Designer_Control_Company_Event_List['fd_374252eae52b20'].push(Designer_Control_Expense_Item_Load);
			...
			<xform:dialog propertyId="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a743e82b4e)" propertyName="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a743e82b4e_name)" style="width:85%"  subject="内部订单" title="内部订单" dialogJs="Designer_DialogSelect(false,'fssc_base_inner_order_fdInnerOrder','extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a743e82b4e)','extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a743e82b4e_name)',null,{fdCompanyId:'fd_374252eae52b20'});">
...
if(!window.Designer_Control_DayCount_Props)window.Designer_Control_DayCount_Props=JSON.parse("{'width':'40px','id':'fd_374254c73c8c6c','subject':'天数','matchType':'2','matchTableId':'fd_37425415d18482','startDateId':'fd_37425415d18482.fd_374254c3f61e8c','endDateId':'fd_37425415d18482.fd_374254c2b4c6b4','isPlusOne':'2'}".replace(/'/g,'"'));
