...
<xformflag id="_xform_extendDataFormInfo.value(fd_38cb02e77f784a)" style="display:none" _xform_type="inputText">
				<xform:xtext property="extendDataFormInfo.value(fd_38cb02e77f784a)" required="false" showStatus="noShow" mobile="true" subject="${xform:subject('fd_38cb02e77f784a','label')}" title="${xform:subject('fd_38cb02e77f784a','label')}" onValueChange="__xformDispatch" /></xformflag>
				</td>
	</tr>
	<tr>
				<td class="muiTitle" style="width:30%;">
...
<xform:lang id='fd_3742545ef3d044' option='content'/></label>
				...
				<xform:address propertyId="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_374254b781a860.id)" propertyName="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_374254b781a860.name)" mulSelect="false" orgType="ORG_TYPE_PERSON" subject="${xform:subject('fd_374254b781a860','label')}" title="${xform:subject('fd_374254b781a860','label')}" required="true" mobile="true" onValueChange="__xformDispatch" isLoadDataDict="false">
					...
					<tr data-celltr="true">
						<td class="muiTitle">
							<label class="xform_label" style=" color: rgb(0, 0, 0);  -ms- overflow-wrap: break-word;;word-break:break-all;;word-wrap:break-word;"  fd_type="textLabel"  ishiddeninmobile="false" line="normal">
<xform:lang id='fd_3747bc70838570' option='content'/></label>

						</td>
						<td>
								<xformflag id="_xform_extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3747bc78a5acac)" _xform_type="address">
				<xform:address propertyId="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3747bc78a5acac.id)" propertyName="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3747bc78a5acac.name)" mulSelect="false" orgType="ORG_TYPE_ORG|ORG_TYPE_DEPT" subject="${xform:subject('fd_3747bc78a5acac','label')}" title="${xform:subject('fd_3747bc78a5acac','label')}" required="false" mobile="true" onValueChange="__xformDispatch" isLoadDataDict="false">
				</xform:address>
</xformflag>
						</td>
					</tr>
...
<xform:lang id='fd_3896a73beb4292' option='content'/></label>
					...
					<tr data-celltr="true">
						<td class="muiTitle">
							<label  class="xform_label" ishiddeninmobile="false" line="normal"  fd_type="textLabel" style=" color: rgb(0, 0, 0);   overflow-wrap: break-word;;word-break:break-all;;word-wrap:break-word;">
<xform:lang id='fd_3896a73d7ab8fe' option='content'/></label>

						</td>
						<td>
								
				<xform:dialog subject="wbs" title="wbs" propertyId="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a7428a5ce6)" propertyName="extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a7428a5ce6_name)" dialogJs="Designer_DialogSelect(false,'fssc_base_company_fdCompany','extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a7428a5ce6)','extendDataFormInfo.value(fd_37425415d18482.!{index}.fd_3896a7428a5ce6_name)',Designer_Control_Company_Changed);">
				</xform:dialog>
...
<xform:lang id='fd_374254a847dbda' option='content'/></label>
						...
						<td>
								<c:if test="${fsscFeeMainForm.extendDataFormInfo.formData['fd_37425415d18482'][vstatus.index]['fd_374254daea2108_standard_status']=='0'}">无标准</c:if><c:if test="${fsscFeeMainForm.extendDataFormInfo.formData['fd_37425415d18482'][vstatus.index]['fd_374254daea2108_standard_status']=='1'}">标准内</c:if><c:if test="${fsscFeeMainForm.extendDataFormInfo.formData['fd_37425415d18482'][vstatus.index]['fd_374254daea2108_standard_status']=='2'}">超标准</c:if>
						</td>
					</tr>
			</table>
		</td>
...
<xform:lang id='fd_3747bc70838570' option='content'/></label>
						...
						<td>
								<xformflag id="_xform_extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3747bc78a5acac)" _xform_type="address">
				<xform:address propertyId="extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3747bc78a5acac.id)" propertyName="extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3747bc78a5acac.name)" mulSelect="false" orgType="ORG_TYPE_ORG|ORG_TYPE_DEPT" subject="${xform:subject('fd_3747bc78a5acac','label')}" title="${xform:subject('fd_3747bc78a5acac','label')}" required="false" mobile="true" onValueChange="__xformDispatch" isLoadDataDict="false">
				</xform:address>
</xformflag>
						</td>
					</tr>
...
<xform:lang id='fd_3896a73d7ab8fe' option='content'/></label>
				...
				<xform:dialog subject="wbs" title="wbs" propertyId="extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3896a7428a5ce6)" propertyName="extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3896a7428a5ce6_name)" dialogJs="Designer_DialogSelect(false,'fssc_base_company_fdCompany','extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3896a7428a5ce6)','extendDataFormInfo.value(fd_37425415d18482.${vstatus.index}.fd_3896a7428a5ce6_name)',Designer_Control_Company_Changed);">
				</xform:dialog>
...
window._mobileDetailsTableScript.init('fd_37425415d18482','TABLE_DL_fd_37425415d18482','1','false');
})
</script>
