                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_fdVoucherTypeId" style="display: none;" _xform_type="dialog">
                            <xform:dialog propertyId="fdVoucherTypeId" propertyName="fdVoucherTypeName" subject="${lfn:message('fssc-voucher:fsscVoucherRuleConfig.fdVoucherType')}" showStatus="edit" style="width:95%;">
                                dialogSelect(false,'fssc_base_voucher_type_getVoucherType','fdVoucherTypeId','fdVoucherTypeName');
                            </xform:dialog>
                            <span class="txtstrong">*</span>
                        </div>
                    ...
                    <td colspan="4" width="100%">
                        <table class="tb_normal" width="100%" id="TABLE_DocList_fdDetail_Form" align="center" tbdraggable="true">
                            <tr align="center" class="tr_normal_title">
                                ...
                                <td style="width:6.5%;">
                                    ${lfn:message('fssc-voucher:fsscVoucherRuleDetail.fdBaseAccountsCom')}
                                </td>
                                <td style="width:6.5%;">
                            ...
                            <tr KMSS_IsReferRow="1" style="display:none;">
                                ...
                                <td align="center">
                                    <%-- 会计科目--%>
                                    <div id="_xform_fdDetail_Form[!{index}].fdBaseAccountsComFlag" _xform_type="radio">
                                        <xform:radio property="fdDetail_Form[!{index}].fdBaseAccountsComFlag" onValueChange="onChangFlag" htmlElementProperties="id='fdDetail_Form[!{index}].fdBaseAccountsComFlag'" showStatus="edit">
                                            <xform:enumsDataSource enumsType="fssc_voucher_operation_type"/>
                                        </xform:radio>
                                    </div>
                                    <div id="_xform_fdDetail_Form[!{index}].fdBaseAccountsComId" style="display: none;" _xform_type="dialog">
                                        <xform:dialog propertyId="fdDetail_Form[!{index}].fdBaseAccountsComId" propertyName="fdDetail_Form[!{index}].fdBaseAccountsComName" subject="${lfn:message('fssc-voucher:fsscVoucherRuleDetail.fdBaseAccountsCom')}" showStatus="edit" style="width:95%;">
                                    ...
                                    <div id="_xform_fdDetail_Form[!{index}].fdBaseAccountsComFormula" style="display: none;" _xform_type="dialog">
                                        <xform:dialog propertyId="fdDetail_Form[!{index}].fdBaseAccountsComFormula" propertyName="fdDetail_Form[!{index}].fdBaseAccountsComText" showStatus="edit" style="width:95%;">
                                            selectFormula('fdDetail_Form[*].fdBaseAccountsComFormula','fdDetail_Form[*].fdBaseAccountsComText');
                                        </xform:dialog>
                                    </div>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    ...
                                    <div id="_xform_fdDetail_Form[!{index}].fdBaseErpPersonId" style="display: none;" _xform_type="dialog">
                                        <xform:dialog propertyId="fdDetail_Form[!{index}].fdBaseErpPersonId" propertyName="fdDetail_Form[!{index}].fdBaseErpPersonName" subject="${lfn:message('fssc-voucher:fsscVoucherRuleDetail.fdBaseErpPerson')}" showStatus="edit" style="width:95%;">
                                            dialogSelect(false,'fssc_base_erp_person_fdERPPerson','fdDetail_Form[*].fdBaseErpPersonId','fdDetail_Form[*].fdBaseErpPersonName');
                                        </xform:dialog>
                                    </div>
                                ...
                                <td align="center">
                                    ...
                                    <div id="_xform_fdDetail_Form[!{index}].fdBaseCustomerId" style="display: none;" _xform_type="dialog">
                                        <xform:dialog propertyId="fdDetail_Form[!{index}].fdBaseCustomerId" propertyName="fdDetail_Form[!{index}].fdBaseCustomerName" subject="${lfn:message('fssc-voucher:fsscVoucherRuleDetail.fdBaseCustomer')}" showStatus="edit" style="width:95%;">
                                            dialogSelect(false,'fssc_base_supplier_getSupplier','fdDetail_Form[*].fdBaseCustomerId','fdDetail_Form[*].fdBaseCustomerName',{'fdType':'1'});
                                        </xform:dialog>
                                    </div>
                                ...
                                <td align="center">
                                    ...
                                    <div id="_xform_fdDetail_Form[!{index}].fdBaseSupplierId" style="display: none;" _xform_type="dialog">
                                        <xform:dialog propertyId="fdDetail_Form[!{index}].fdBaseSupplierId" propertyName="fdDetail_Form[!{index}].fdBaseSupplierName" subject="${lfn:message('fssc-voucher:fsscVoucherRuleDetail.fdBaseSupplier')}" showStatus="edit" style="width:95%;">
                                            dialogSelect(false,'fssc_base_supplier_getSupplier','fdDetail_Form[*].fdBaseSupplierId','fdDetail_Form[*].fdBaseSupplierName',{'fdType':'2'});
                                        </xform:dialog>
                                    </div>
                            ...
                            <c:forEach items="${fsscVoucherRuleConfigForm.fdDetail_Form}" var="fdDetail_FormItem" varStatus="vstatus">
                                <tr KMSS_IsContentRow="1">
                                    ...
                                    <td align="center">
                                        <%-- 会计科目--%>
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdBaseAccountsComFlag" _xform_type="radio">
                                            <xform:radio property="fdDetail_Form[${vstatus.index}].fdBaseAccountsComFlag" onValueChange="onChangFlag" htmlElementProperties="id='fdDetail_Form[${vstatus.index}].fdBaseAccountsComFlag'" showStatus="edit">
                                                <xform:enumsDataSource enumsType="fssc_voucher_operation_type"/>
                                            </xform:radio>
                                        </div>
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdBaseAccountsComId" style="display: none;" _xform_type="dialog">
                                            <xform:dialog propertyId="fdDetail_Form[${vstatus.index}].fdBaseAccountsComId" propertyName="fdDetail_Form[${vstatus.index}].fdBaseAccountsComName" subject="${lfn:message('fssc-voucher:fsscVoucherRuleDetail.fdBaseAccountsCom')}" showStatus="edit" style="width:95%;">
                                                dialogSelect(false,'fssc_base_accounts_com_fdMinLevel','fdDetail_Form[*].fdBaseAccountsComId','fdDetail_Form[*].fdBaseAccountsComName');
                                            </xform:dialog>
                                        </div>
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdBaseAccountsComFormula" style="display: none;" _xform_type="dialog">
                                            <xform:dialog propertyId="fdDetail_Form[${vstatus.index}].fdBaseAccountsComFormula" propertyName="fdDetail_Form[${vstatus.index}].fdBaseAccountsComText" idValue="${fdDetail_FormItem.fdBaseAccountsComFormula}" nameValue="${fdDetail_FormItem.fdBaseAccountsComText}" showStatus="edit" style="width:95%;">
                                                selectFormula('fdDetail_Form[*].fdBaseAccountsComFormula','fdDetail_Form[*].fdBaseAccountsComText');
                                            </xform:dialog>
                                        </div>
                                    </td>
