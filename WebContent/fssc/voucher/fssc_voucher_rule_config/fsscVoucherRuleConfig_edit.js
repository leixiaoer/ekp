...
//		var formValiduteObj = $KMSSValidation(document.forms[formOption.formName]);
        ...
        function init(){
            ...
            var detailPropertys = new Array('fdBaseAccountsCom','fdBaseCostCenter','fdBaseErpPerson','fdBaseCashFlow','fdBaseCustomer'
                ,'fdBaseSupplier','fdBaseProject','fdBasePayBank','fdBaseWbs','fdBaseInnerOrder');
