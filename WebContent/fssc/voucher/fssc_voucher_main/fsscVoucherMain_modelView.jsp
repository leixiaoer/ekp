<%@ page import="com.landray.kmss.fssc.base.util.FsscBaseUtil" %>
...
<%
	...
	if(ArrayUtil.isEmpty(voucherList)){
		...
		//ture 勾选了SAP
		request.setAttribute("fdIsChechedSAP", FsscBaseUtil.getSwitchValue("fdFinancialSystem").indexOf("SAP")>-1);
		%>
				...
				<div style="width:100%; max-height:250px; overflow-x:scroll;overflow-y:auto;">
					<table id="List_ViewTable" class="tb_normal" width="100%;">
						<tr align="center" class="tr_normal_title">
							...
							<td>${lfn:message('fssc-voucher:fsscVoucherDetail.fdBaseAccountsComCode')}</td>
							<td>${lfn:message('fssc-voucher:fsscVoucherDetail.fdBaseAccountsComName')}</td>
