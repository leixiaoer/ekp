seajs.use(['lui/jquery','lui/dialog','fssc/common/resource/js/dialog_common','lui/util/str','lang!fssc-budget'], function($, dialog, dialogCommon,strutil,lang){
	window.dialogSelect=function(mul, key, idField, nameField,extendParam,action,targetWin){
...
//配置页对话框,系统自带，废弃不用
function dialogSelect_bak(mul, key, idField, nameField, extendParam, action){
	var rowIndex;
