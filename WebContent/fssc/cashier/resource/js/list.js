...
seajs.use(['lui/jquery','lui/dialog','lui/topic','lui/dialog_common','lang!fssc-cashier'], function($, dialog , topic, dialogCommon,lang){
...
LUI.ready(function() {
    ...
    var canPass=$("[name='canPass']").val();
    if(canPass==='' && LUI('btnPass')){
    	LUI('btnPass').setVisible(false);
    }
});
