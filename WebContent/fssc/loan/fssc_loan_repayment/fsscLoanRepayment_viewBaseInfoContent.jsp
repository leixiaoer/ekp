...
<table class="tb_simple" width="100%">
		...
		<tr>
			...
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_voucher_status" value="${fsscLoanRepaymentForm.fdVoucherStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
			<td  class="td_normal_title" width="32%" >${lfn:message('fssc-loan:fsscLoanRepayment.fdBookkeepingStatus') }</td>
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_bookkeeping_status" value="${fsscLoanRepaymentForm.fdBookkeepingStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
