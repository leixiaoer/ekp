    ...
    <table class="tb_normal" width="100%">
        <tr>
            <td class="td_normal_title" width="16.6%">
                ${lfn:message('fssc-loan:fsscLoanRepayment.docCreator')}
            </td>
            <td width="16.6%">
                <%-- 创建人--%>
                <div id="_xform_docCreatorId" _xform_type="address">
                    <ui:person personId="${fsscLoanRepaymentForm.docCreatorId}" personName="${fsscLoanRepaymentForm.docCreatorName}" />
                </div>
            </td>
            <td class="td_normal_title" width="16.6%">
            ...
            <td class="td_normal_title" width="16.6%">
                ${lfn:message('fssc-loan:fsscLoanRepayment.docNumber')}
            </td>
            <td width="16.6%">
                <%-- 编号--%>
        ...
        <tr>
            <td class="td_normal_title" width="16.6%">
                ${lfn:message('fssc-loan:fsscLoanRepayment.docStatus')}
            </td>
            <td width="16.6%">
                <%-- 文档状态--%>
            ...
            <td class="td_normal_title" width="16.6%">
                ${lfn:message('fssc-loan:fsscLoanRepayment.fdVoucherStatus')}
            </td>
            <td width="16.6%">
                <%-- 制证状态--%>
            ...
            <td class="td_normal_title" width="16.6%">
                ${lfn:message('fssc-loan:fsscLoanRepayment.fdBookkeepingStatus')}
            </td>
            <td width="16.6%">
                <%-- 记账状态--%>
        ...
        <tr>
        	<td class="td_normal_title" width="16.6%">
                ${lfn:message('fssc-loan:fsscLoanRepayment.docPublishTime')}
            </td>
