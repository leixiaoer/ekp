				...
				<tr>
					...
					<td class="td_normal_title" width=15%>
						...
						<bean:message bundle="fssc-loan" key="fsscLoanPayWarn.title1.message4"/>
							<xform:dialog propertyId="fdForwardSubject" propertyName="fdForwardSubjectText" style="width:95%;">
				...
				<tr>
					...
					<td class="td_normal_title" width=15%>
						...
						<bean:message bundle="fssc-loan" key="fsscLoanPayWarn.title2.message4"/>
							<xform:dialog propertyId="fdPastSubject" propertyName="fdPastSubjectText" style="width:95%;">
