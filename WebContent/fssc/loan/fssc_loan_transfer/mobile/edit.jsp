                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="_xform_fdReceiveCostCenterId" _xform_type="dialog">
                                                <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdReceiveCostCenterId',nameField:'fdReceiveCostCenterName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCostCenter',dataURL:getSource('fssc_base_cost_center_selectCostCenter'),subject:'${lfn:message('fssc-loan:fsscLoanTransfer.fdReceiveCostCenter')}',required:true,curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanTransferForm.fdReceiveCostCenterId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanTransferForm.fdReceiveCostCenterName))}',afterSelect:afterDialogSel">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
