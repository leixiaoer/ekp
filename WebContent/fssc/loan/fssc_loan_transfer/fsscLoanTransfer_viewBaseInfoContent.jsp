...
<ui:content title="${lfn:message('fssc-loan:py.JiBenXinXi') }" titleicon="lui-fm-icon-2">
	...
	<table class="tb_simple" width="100%">
		...
		<tr>
			...
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_voucher_status" value="${fsscLoanTransferForm.fdVoucherStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
			<td  class="td_normal_title" width="32%" >${lfn:message('fssc-loan:fsscLoanTransfer.fdBookkeepingStatus') }</td>
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_bookkeeping_status" value="${fsscLoanTransferForm.fdBookkeepingStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
