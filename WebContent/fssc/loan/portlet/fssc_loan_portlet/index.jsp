...
<head>
    ...
    <link charset="utf-8" rel="stylesheet" href="${LUI_ContextPath}/fssc/base/portlet/fssc_work_portlet/css/css.css">
    <link charset="utf-8" rel="stylesheet" href="${LUI_ContextPath}/fssc/base/portlet/fssc_work_portlet/css/listview_.css"> <!-- 这里请使用变量引入当前主题包的css -->
    <script>
