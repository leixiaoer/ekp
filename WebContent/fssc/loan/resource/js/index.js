            ...
            $router.define({
                ...
                routes : [{
    				...
    				action : {
    					type : 'pageopen',
    					options : {
    						url : $var.$contextPath + '/fssc/base/resource/jsp/sysRecycleBox.jsp?modelName=com.landray.kmss.fssc.loan.model.FsscLoanMain;com.landray.kmss.fssc.loan.model.FsscLoanRepayment;com.landray.kmss.fssc.loan.model.FsscLoanTransfer',
    						target : '_rIframe'
    					}
    				}
    			}]
