...
<c:if test="${lbpmApproveModel eq 'right'}">
	<template:include ref="lbpm.right" showQrcode="true" isEdit="true"  formName="fsscLoanMainForm" formUrl="${LUI_ContextPath}/fssc/loan/fssc_loan_main/fsscLoanMain.do">
