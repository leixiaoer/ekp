...
<ui:content title="${lfn:message('fssc-loan:py.JiBenXinXi') }" titleicon="lui-fm-icon-2">
	...
	<table class="tb_simple" width="100%">
		...
		<tr>
			...
			<td  width="75%"><sunbor:enumsShow enumsType="fssc_base_payment_status" value="${fsscLoanMainForm.docCreatorName }"></sunbor:enumsShow></td>
		</tr>
		...
		<tr>
		 ...
		 <tr>
			...
			<td  width="75%"><sunbor:enumsShow enumsType="fssc_base_payment_status" value="${fsscLoanMainForm.fdPaymentStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
			<td  class="td_normal_title" width="32%" >${lfn:message('fssc-loan:fsscLoanMain.fdVoucherStatus') }</td>
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_voucher_status" value="${fsscLoanMainForm.fdVoucherStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
			<td  class="td_normal_title" width="32%" >${lfn:message('fssc-loan:fsscLoanMain.fdBookkeepingStatus') }</td>
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_bookkeeping_status" value="${fsscLoanMainForm.fdBookkeepingStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
