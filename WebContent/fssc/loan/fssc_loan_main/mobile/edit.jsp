                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="_xform_fdCostCenterId" _xform_type="dialog">
                                                <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdCostCenterId',nameField:'fdCostCenterName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCostCenter',dataURL:getSource('fssc_base_cost_center_selectCostCenter'),subject:'${lfn:message('fssc-loan:fsscLoanMain.fdCostCenter')}',required:true,curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanMainForm.fdCostCenterId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanMainForm.fdCostCenterName))}',afterSelect:afterDialogSel">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div id="_xform_fdCompanyId" _xform_type="dialog">
                                                <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdCompanyId',nameField:'fdCompanyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCompany',dataURL:getSource('fssc_base_company_fdCompany'),subject:'${lfn:message('fssc-loan:fsscLoanMain.fdCompany')}',required:true,curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanMainForm.fdCompanyId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanMainForm.fdCompanyName))}',afterSelect:afterDialogSel">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="_xform_fdBasePayWayId" _xform_type="dialog">
                                                <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdBasePayWayId',nameField:'fdBasePayWayName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBasePayWay',dataURL:getSource('fssc_base_pay_way_getPayWay'),subject:'${lfn:message('fssc-loan:fsscLoanMain.fdBasePayWay')}',required:true,curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanMainForm.fdBasePayWayId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscLoanMainForm.fdBasePayWayName))}',afterSelect:afterDialogSel">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
