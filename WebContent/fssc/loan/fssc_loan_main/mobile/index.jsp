    ...
    <template:replace name="content">
        <c:choose>
            <c:when test="${ param.filter == '1' }">
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/back/HrefBackMixin" data-dojo-props="href:'/fssc/loan/fssc_loan_main/mobile/index.jsp'">
                    </div>
                ...
                <div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
                    <div data-dojo-type="mui/search/SearchBar" data-dojo-props="modelName:'com.landray.kmss.fssc.loan.model.FsscLoanMain',needPrompt:false,height:'3.8rem'">
                    </div>
            ...
            <c:otherwise>
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/nav/MobileCfgNavBar" data-dojo-props="defaultUrl:'/fssc/loan/fssc_loan_main/mobile/nav.jsp', modelName:'com.landray.kmss.fssc.loan.model.FsscLoanMain'">
                    </div>
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/Folder" data-dojo-props="tmplURL:'/fssc/loan/fssc_loan_main/mobile/query.jsp'"></div>
                </div>
        ...
        <ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom">
           ...
           <%--  <kmss:auth requestURL="/fssc/loan/fssc_loan_main/fsscLoanMain.do?method=add">
                <li data-dojo-type="mui/tabbar/CreateButton" data-dojo-mixins="mui/simplecategory/SimpleCategoryMixin" data-dojo-props="icon1:'',createUrl:'/fssc/loan/fssc_loan_main/fsscLoanMain.do?method=add&i.docTemplate=!{curIds}',modelName:'com.landray.kmss.fssc.loan.model.FsscLoanCategory'">
            ...
            <li data-dojo-type="mui/tabbar/TabBarButtonGroup" data-dojo-props="icon1:'mui mui-more'">
                ...
                <div data-dojo-type="mui/tabbar/TabBarButton" data-dojo-props="icon1:'mui mui-ul', href:'/fssc/loan/fssc_loan_repayment/mobile/index.jsp', label:'${lfn:message('fssc-loan:table.fsscLoanRepayment')}'">
                </div>
