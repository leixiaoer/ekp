                            ...
                            <td colspan="3" width="50.0%">
                                ...
                                <div id="_xform_fdCompanyId" _xform_type="dialog">
                                    <xform:dialog propertyId="fdCompanyId" propertyName="fdCompanyName" showStatus="edit" required="true" subject="${lfn:message('fssc-loan:fsscLoanMain.fdCompany')}" style="width:95%;">
                                        ...
                                        dialogSelect(false,'fssc_base_company_getCompanyByPerson','fdCompanyId','fdCompanyName',null,{'fdPersonId':$('[name=fdLoanPersonId]').val(),fdModelName:'com.landray.kmss.fssc.loan.model.FsscLoanMain'},selectFdCompanyNameCallback);
                                    </xform:dialog>
                                </div>
                            </td>
                            <td class="td_normal_title" width="16.6%">
                           ...
                           <c:if test="${fdIsProject==true}">
                                ...
                                <div id="_xform_fdBaseProjectId" _xform_type="dialog" >
                                    <xform:dialog propertyId="fdBaseProjectId" propertyName="fdBaseProjectName" required="true" showStatus="edit" subject="${lfn:message('fssc-loan:fsscLoanMain.fdBaseProject')}" style="width:95%;">
                                        dialogSelect(false,'fssc_base_project_project','fdBaseProjectId','fdBaseProjectName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'fdProjectType':1},afterSelectProject);
                                    </xform:dialog>
                                </div>
                            	</td>
                     	 </c:if>
                                ...
                                <td colspan="5" width="83.0%">
                                    <div id="_xform_fdBaseProjectAccountingId" _xform_type="dialog">
                                        <xform:dialog propertyName="fdBaseProjectAccountingName" propertyId="fdBaseProjectAccountingId" style="width:95%;" required="true" subject="${lfn:message('fssc-loan:fsscLoanMain.fdBaseProjectAccounting')}">
                                        	dialogSelect(false,'fssc_base_project_project','fdBaseProjectAccountingId','fdBaseProjectAccountingName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'fdProjectType':2});
                                        </xform:dialog>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td width="16.6%">
                                ...
                                <div id="_xform_fdLoanMoney" _xform_type="text">
                                    <input name="fdLoanMoney" subject="${lfn:message('fssc-loan:fsscLoanMain.fdLoanMoney')}" class="inputsgl" value="<kmss:showNumber value="${fsscLoanMainForm.fdLoanMoney}" pattern="##0.00"></kmss:showNumber>" type="text" validate="required number min(0) scaleLength(2)" style="width:93%;">
                            ...
                            <td width="16.6%">
                                ...
                                <div id="_xform_fdOffsetterIds" _xform_type="address">
                                    <xform:dialog propertyId="fdBaseCurrencyId" propertyName="fdBaseCurrencyName" showStatus="readOnly" subject="${lfn:message('fssc-loan:fsscLoanMain.fdBaseCurrency')}" style="width:95%;">
                                    </xform:dialog>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td width="12%" align="center">
                                ...
                                <div id="_xform_fdBasePayWayId" _xform_type="dialog">
                                    <xform:dialog propertyId="fdBasePayWayId" propertyName="fdBasePayWayName" showStatus="edit" required="true" subject="${lfn:message('fssc-loan:fsscLoanMain.fdBasePayWay')}" style="width:95%;">
                                        dialogSelect(false,'fssc_base_pay_way_fdPayWay','fdBasePayWayId','fdBasePayWayName',null,{'fdCompanyId':$('[name=fdCompanyId]').val()},afterSelectPayWay);
                                    </xform:dialog>
                                </div>
                            </td>
                            <td width="12%" align="center">
