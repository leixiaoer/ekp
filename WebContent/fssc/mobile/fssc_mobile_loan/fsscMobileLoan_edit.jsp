        ...
        <div class="ld-newApplicationForm-info">
            ...
            <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'1')>-1 }">
            	<div>
	                ...
	                <div>
	                     <input type="text" validator="required" name="fdBaseWbsName" subject="${lfn:message('fssc-loan:fsscLoanMain.fdBaseWbs')}" value="${fsscLoanMainForm.fdBaseWbsName }" readonly="readonly" onclick="selectObject('fdBaseWbsId','fdBaseWbsName','${LUI_ContextPath}/fssc/mobile/fssc_mobile_note/fsscMobileNote.do?method=getWbsList',afterSelectWbs);" />
            ...
            <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'2')>-1 }">
            	<div>
	                ...
	                <div>
	                     <input type="text" validator="required" name="fdBaseInnerOrderName" subject="${lfn:message('fssc-loan:fsscLoanMain.fdBaseInnerOrder')}" value="${fsscLoanMainForm.fdBaseInnerOrderName }" readonly="readonly" onclick="selectObject('fdBaseInnerOrderId','fdBaseInnerOrderName','${LUI_ContextPath}/fssc/mobile/fssc_mobile_note/fsscMobileNote.do?method=getOrderList',afterSelectOrder);" />
            ...
            <div>
                <span>${lfn:message("fssc-loan:fsscLoanMain.fdLoanMoney")}</span>
                <div>
                    <input type="text" name="fdLoanMoney"   onblur="changeLoanMoney(this)"  validator="required currency-dollar" subject="${lfn:message('fssc-loan:fsscLoanMain.fdLoanMoney')}" placeholder='${lfn:message("fssc-mobile:fssc.mobile.placeholder.input")}${lfn:message("fssc-loan:fsscLoanMain.fdLoanMoney")}' value="<kmss:showNumber value="${fsscLoanMainForm.fdLoanMoney}" pattern="##0.00"></kmss:showNumber>" />
                    <span style="margin-left:2px;color:#d02300;">*</span>
                </div>
            </div>
             <div>
        ...
        <div class="ld-newApplicationForm-info">
        	<div>
                ...
                <div>
                    ...
                    <input  type="hidden"  name="fdBankId"  value="${fsscLoanMainForm.fdBankId}" />
