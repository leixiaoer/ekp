            ...
            <div class="ld-remember-specialInfo ld-remember-info-item">
                ...
                <div>
                    ...
                    <div class="ld-remember-valBox" >
                        <input type="text" id ="fdCostCenterName" style="font-size:14px;" validate="required" subject="${lfn:message('fssc-mobile:fsscMobileNote.fdCostCenter')}" value="${ fsscMobileNoteForm.fdCostCenterName}" placeholder="${lfn:message('fssc-mobile:fssc.mobile.placeholder.select')}${lfn:message('fssc-mobile:fsscMobileNote.fdCostCenter')}" onclick="selectCostCenter();" readonly="readonly">   
                        <xform:text property="fdCostCenterName" showStatus="noShow"/>
                        <xform:text property="fdCostCenterId" showStatus="noShow" />
                        <xform:text property="fdCompanyId" value="${fdCompanyId }" validators="required" subject="${lfn:message('fssc-mobile:fsscMobileNote.fdCompany') }"  showStatus="noShow"/>
