				...
				<div>
					<div data-dojo-type="mui/view/DocScrollableView" 
						...
						<div class="muiFlowInfoW muiFormContent">
							...
							<input name="modelFlag" value="fsscFeeMain" type="hidden" />
						</div>
					...
					require(["fssc/mobile/resource/js/ajax-form!fsscFeeMainForm"]);
					function review_submit(){
						var docStatus = $("input[name='docStatus']").val();
						$.ajax({
							url:Com_Parameter.ContextPath+'fssc/fee/fssc_fee_mobile/fsscFeeMobile.do?method=saveOrUpdateBill',
