...
<body>
    ...
    <script>
		function viewFee(id){
			window.open("${LUI_ContextPath}/fssc/mobile/fssc_mobile_authorize/fsscMobileAuthorize.do?method=view&fdId="+id,'_self');
		}
		function addAuthorize(){
			window.open("${LUI_ContextPath}/fssc/mobile/fssc_mobile_authorize/fsscMobileAuthorize.do?method=add",'_self');
		}
    </script>
</body>
</html>