...
<div class="fssc-mobile-link-add">
		<div class="ld-info-item">
            ...
            <div class="content">
                 <input type="text" value="${fsscBaseAccountForm.fdName }" name="fdName" placeholder="请输入账户名"/>
        ...
        <div class="ld-info-item">
            ...
            <div class="content" >
                <input type="text" name="fdBankName" value="${fsscBaseAccountForm.fdBankName }" placeholder="请输入开户行"/>
                <span style="color:red;">*</span>
            </div>
        </div>
        <div class="ld-info-item">
            ...
            <div class="content" >
                <input type="text" name="fdBankAccount" value="${fsscBaseAccountForm.fdBankAccount }" placeholder="请输入开户行账号"/>
                <span style="color:red;">*</span>
            </div>
        </div>
        <div class="ld-info-item">
            ...
            <div class="content" >
                <input type="text" name="fdBankNo" value="${fsscBaseAccountForm.fdBankNo }" placeholder="请输入联行号"/>
                <span>&nbsp;</span>
            </div>
        </div>
        ...
        <div class="ld-info-item">
            ...
            <div class="content" onclick="selectOrgElement('fdPersonId','fdPersonName','','false','person');">
                 <input type="text" name="fdPersonName" value="${fsscBaseAccountForm.fdPersonName }" readonly placeholder="请选择归属人"/>
                 <input name="fdPersonId" value="${fsscBaseAccountForm.fdPersonId}" type="hidden"/>
                 <span style="color:red;">*</span>
                 <i></i>
            </div>
        </div>
        ...
        <div class="ld-info-item">
            <div class="title">归属人</div>
            <div class="content">
                 <input type="text" name="fdPersonName" value="${fsscBaseAccountForm.fdPersonName }" readonly/>
                 <input name="fdPersonId" value="${fsscBaseAccountForm.fdPersonId}" type="hidden"/>
                 <span>&nbsp;</span>
            </div>
        </div>
        ...
        <div class="ld-info-item">
            ...
            <div class="content" onclick="selectObject('fdAccountAreaId','fdAccountArea');">
                 <input type="text" name="fdAccountArea" value="${fsscBaseAccountForm.fdAccountArea }" readonly placeholder="请选择账户归属地"/>
                 <input name="fdAccountAreaId" value="${fsscBaseAccountForm.fdPersonId}" type="hidden"/>
                 <span style="color:red;">*</span>
                 <i></i>
            </div>
        </div>
        ...
        <div class="ld-info-item">
            ...
            <div class="content" >
             		<div class="checkbox_item ${fsscBaseAccountForm.fdIsDefault==true?'checked':''}" style="width: 1rem;float: right;">
             		...
             		<div class="checkbox_item ${fsscBaseAccountForm.fdIsDefault==false?'checked':''}" style="width: 1rem;float: right;">
             			<div class="checkbox_item_out">
             				<div class="checkbox_item_in"></div>
             			</div>
             		...
             		<input type="hidden" name="fdIsDefault" value="${fsscBaseAccountForm.fdIsDefault }">
             </div>
        </div>
        <div class="fssc-mobile-footer" style="position:relative;bottom:0;">
			<div class="fssc-mobile-footer-cancel" onclick="window.open('${LUI_ContextPath}/fssc/base/fssc_base_account/fsscBaseAccount.do?method=listMobile','_self');">返回</div>
			<div class="fssc-mobile-footer-add" onclick="Com_Submit(document.fsscBaseAccountForm,'updateByMobile')">保存</div>
		</div>
	</div>
<input name="submitType" value="${param.method}" type="hidden"/>
<input name="fdId" value="${fsscBaseAccountForm.fdId}" type="hidden"/>
</html:form>
</body>
</html>