    ...
    <script >
    	...
    	function deleteAccount(e,id){
    		...
    		jqalert({
                ...
                yesfn:function () {
                		$.ajax({
                			url:'${LUI_ContextPath}/fssc/base/fssc_base_account/fsscBaseAccount.do?method=deleteall',
                			type:'POST',
                			dataType:'json',
...
<c:forEach var="fsscBaseAccount" items="${queryPage.list}" varStatus="status">
<li onclick="window.open('${LUI_ContextPath}/fssc/base/fssc_base_account/fsscBaseAccount.do?method=editMobile&fdId=${fsscBaseAccount.fdId}','_self');" class="ld-account-my-list-item">
      <div class="ld-account-my-top">
      		...
      		<div class="ld-account-my-account">
          		${fsscBaseAccount.fdName}	
          	</div>
          	<div class="ld-account-my-del">
          		<img src="${LUI_ContextPath }/fssc/mobile/resource/images/del.png" onclick="deleteAccount(event,'${fsscBaseAccount.fdId}')">
          	</div>
      </div>
      <div class="ld-account-my-info">
      		<div class="ld-account-my-info-left">
      			${fsscBaseAccount.fdBankName}
      		</div>
          <div class="ld-account-my-info-right">
            	${fsscBaseAccount.fdBankAccount}
          </div>
      </div>
  </li>
</c:forEach>
</ul>
<div class="addOne" onclick="window.open('${LUI_ContextPath}/fssc/base/fssc_base_account/fsscBaseAccount.do?method=addMobile','_self')"></div>
