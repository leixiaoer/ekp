...
<template:include ref="mobile.view" compatibleMode="true">
	<template:replace name="title">
		<c:out value="${fsscLoanRepaymentForm.docSubject}"></c:out>
	</template:replace>
	...
	<div id="scrollView" data-dojo-type="mui/view/DocScrollableView" data-dojo-mixins="mui/form/_ValidateMixin">
		<div data-dojo-type="mui/panel/AccordionPanel">
			<xform:isExistRelationProcesses relationType="parent">
                ...
                <c:if test="${fsscLoanRepaymentForm.docStatus >=20}">
                <template:include file="/sys/lbpmservice/mobile/import/tarbar.jsp" editUrl="/fssc/loan/fssc_loan_repayment/fsscLoanRepayment.do?method=edit&fdId=${param.fdId }" formName="fsscLoanRepaymentForm" viewName="lbpmView" allowReview="true">
