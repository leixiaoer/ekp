				...
				<div>
					<div data-dojo-type="mui/view/DocScrollableView" 
						...
						<div class="muiFlowInfoW muiFormContent">
							...
							<input name="modelFlag" value="fsscLoanRepayment" type="hidden" />
						</div>
					...
					function review_submit(){
						...
						$.ajax({
							url:Com_Parameter.ContextPath+'fssc/loan/fssc_loan_repay_mobile/fsscLoanRepayMobile.do?method=saveOrUpdateBill',
