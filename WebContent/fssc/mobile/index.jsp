        ...
        <div class="ld-feesCharged-mine ld-feesCharged-hidden">
        		...
        		<div class="ld-feesCharged-mine-cell" onclick="listData();">
        			<div class="ld-feesCharged-mine-cell-left">
        				...
        				<span>${lfn:message('fssc-base:table.fsscBaseAuthorize')}</span>
        			</div>
        			<div class="ld-feesCharged-mine-cell-right">
        				<span></span>
        			</div>
        		...
        		<div class="ld-feesCharged-mine-cell" onclick="window.open('${LUI_ContextPath}/fssc/base/fssc_base_account/fsscBaseAccount.do?method=listMobile','_self');">
        			<div class="ld-feesCharged-mine-cell-left">
