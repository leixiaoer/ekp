				...
				<div>
					<div data-dojo-type="mui/view/DocScrollableView" 
						...
						<div class="muiFlowInfoW muiFormContent">
							...
							<input name="modelFlag" value="fsscExpenseMain" type="hidden" />
						</div>
					...
					function review_submit(){
						...
						$.ajax({
							url:Com_Parameter.ContextPath+'fssc/expense/fssc_expense_mobile/fsscExpenseMobile.do?method=saveOrUpdateBill',
