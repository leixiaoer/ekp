        ...
        <div class="ld-newApplicationForm-info">
            <div>
                ...
                <div class="ld-selectPersion">
                	...
                	<!-- 未启用授权 -->
                	<c:if test="${fdIsAuthorize=='0' or empty fdIsAuthorize}">
            ...
            <div>
                ...
                <div>
                    <input type="text"  id="fdCostCenterName" placeholder="请选择成本中心" name="fdCostCenterName" value="${fsscExpenseMainForm.fdCostCenterName }"  readonly="readonly" onclick="selectObject('fdCostCenterId','fdCostCenterName',formOption['url']['getFsscBaseCostCenter'],afterSelectCostCenter);" >
            ...
            <c:if test="${docTemplate.fdIsProject=='true' }">
	            <div>
	                ...
	                <div>
	                    <input type="text"  id="fdProject" name="fdProject" value="${fsscExpenseMainForm.fdProjectName }" readonly="readonly" onclick="selectObject('fdProjectId','fdProject',formOption['url']['getFdProject']);" >
