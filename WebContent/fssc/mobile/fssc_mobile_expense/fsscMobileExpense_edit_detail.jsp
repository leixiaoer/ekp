            ...
            <div class="ld-entertain-detail-persionlInfo">
              <c:if test="${docTemplate.fdExpenseType eq '2'  and docTemplate.fdIsTravelAlone eq 'true'}">
                ...
                <span>${lfn:message("fssc-expense:fsscExpenseDetail.fdExpenseItem")}</span>
                      <div>
                        <input type="text" placeholder="请选择费用类型" id="fdExpenseItemName"  name="fdExpenseItemName"  onclick="selectObject('fdExpenseItemId','fdExpenseItemName',formOption['url']['getFsscBaseExpenseItem'],FSSC_ChangeIsDeduct);" onchange="" readonly="readonly">
                ...
                <div class="ld-entertain-detail-item">
                    ...
                    <div>
                        <input type="text" placeholder="请选择成本中心" id="fdCostCenterDetail" name="fdCostCenterDetail" onclick="selectObject('fdCostCenterDetailId','fdCostCenterDetail',formOption['url']['getFsscBaseCostCenter'],afterSelectCostCenter);" onchange="FSSC_ChangeIsDeduct();" readonly="readonly">
    ...
    <div class="ld-travel-detail-body">
        <div class="ld-travel-detail">
            <div class="ld-travel-detail-persionlInfo">
                <div class="ld-info-item">
                    ...
                    <div class="">
                        <input type="text" placeholder="请填写发票号码"  id="fdInvoiceNumber">
                ...
                <div class="ld-info-item">
                    ...
                    <div class="">
                        <input type="text" placeholder="请选择发票类型" readonly id="fdInvoiceType" onclick="selectInvoiceTypeItem();">
                ...
                <%-- <div class="ld-info-item">
                     <span> ${lfn:message('fssc-expense:fsscExpenseInvoiceDetail.fdExpenseType')}</span>
                    <div >
                        <input type="text" placeholder="请选择费用类型" id="fdExpenseType" name="fdExpenseType"  readonly="readonly"  value="" onclick="selectObject('fdExpenseTypeId','fdExpenseType',formOption['url']['getFsscBaseExpenseItem']);" >
                        <input type="text"  id="fdExpenseTypeId" name="fdExpenseTypeId" value="" hidden='true'>
                        <i></i>
                    </div> 
                </div> --%>
            </div>
        ...
        <div class="ld-travel-detail-costInfo">
           <div class="currency ld-info-item">
                ...
                <div>
                    <input type="text" id="fdInvoiceCode" placeholder="请输入发票代码" value="">
           ...
           <div class="currency ld-info-item">
            ...
            <div class="currency ld-info-item">
             ...
             <div class="currency ld-info-item">
              ...
              <div>
                 <input type="text" id="fdInvoiceMoney" placeholder="请输入价税合计" value="" onchange="selectTaxrate();">
                 <span style="color:#d02300;">*</span>
              </div>
        	 </div>
            <div class="currency ld-info-item">
              ...
              <div>
                  <input type="text" id="fdTaxValue" name="fdTaxValue" placeholder="请填写税率" value=""  onchange="selectTaxrate();" >
