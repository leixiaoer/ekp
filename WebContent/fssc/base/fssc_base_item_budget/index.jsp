        ...
        <div style="margin:5px 10px;">
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="9" id="btn">
							...
							<%-- <kmss:auth requestURL="/fssc/base/fssc_base_item_budget/fsscBaseItemBudget.do?method=copy">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/fssc/base/fssc_base_item_budget/fsscBaseItemBudget.do?method=data&fdCompanyId=${param.fdCompanyId }'}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/fssc/base/fssc_base_item_budget/fsscBaseItemBudget.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdItems;fdCompany.name;fdCategory;fdOrgs;operations" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
