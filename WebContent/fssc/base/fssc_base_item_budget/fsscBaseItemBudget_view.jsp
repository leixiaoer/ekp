...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/base/fssc_base_item_budget/fsscBaseItemBudget.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscBaseItemBudget.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/base/fssc_base_item_budget/fsscBaseItemBudget.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscBaseItemBudget.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
        ...
        <table class="tb_normal" width="100%">
            <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ${fsscBaseItemBudgetForm.fdCompanyName }
                    </td>
                </tr>
                <tr>
                    <td class="td_normal_title" width="15%">
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdOrgIds" _xform_type="address">
                            <xform:address propertyId="fdOrgIds" propertyName="fdOrgNames" mulSelect="true" orgType="ORG_TYPE_ALLORG" required="true" subject="${lfn:message('fssc-base:fsscBaseItemBudget.fdOrgs')}" textarea="true" style="width:95%;" />
                        </div>
                    </td>
                </tr>
                <tr>
...
<script>
    ...
    var viewOption = {
        ...
        basePath: '/fssc/base/fssc_base_item_budget/fsscBaseItemBudget.do',
        customOpts: {
