...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/base/fssc_base_budget_scheme/fsscBaseBudgetScheme.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscBaseBudgetScheme.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/base/fssc_base_budget_scheme/fsscBaseBudgetScheme.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscBaseBudgetScheme.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
...
$(document).ready(function(){
    ...
    var viewOption = {
        ...
        basePath: '/fssc/base/fssc_base_budget_scheme/fsscBaseBudgetScheme.do',
        customOpts: {
