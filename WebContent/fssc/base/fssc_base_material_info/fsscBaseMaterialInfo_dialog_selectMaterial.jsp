...
<list:data>
    <list:data-columns var="fsscBaseMaterialInfo" list="${queryPage.list}" varIndex="status" custom="false">
        ...
        <list:data-column property="fdName" title="${lfn:message('fssc-base:fsscBaseMaterialInfo.fdName')}" escape="false" />
        <list:data-column col="index">
            ${status+1}
        </list:data-column>

        <list:data-column property="fdCode" title="${lfn:message('fssc-base:fsscBaseMaterialInfo.fdCode')}" escape="false" />
        <list:data-column property="fdIsInventory" title="" />
