...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscBaseSpecialItem.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscBaseSpecialItem.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
            ...
            <tr>
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdDescription" _xform_type="text">
                        <xform:text property="fdDescription" showStatus="view" style="width:95%;" />
                    </div>
                </td>
            </tr>
            <tr>
