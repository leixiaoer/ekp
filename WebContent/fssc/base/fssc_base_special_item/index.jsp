    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
			...
			<list:criteria id="criteria1">
                <list:cri-ref key="fdDescription" ref="criterion.sys.docSubject" title="${lfn:message('fssc-base:fsscBaseSpecialItem.fdDescription')}" />
                ...
                <div style="float:left">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
                            <list:sort property="fdCode" text="${lfn:message('fssc-base:fsscBaseSpecialItem.fdCode')}" group="sort.list" />
                        </ui:toolbar>
                    </div>
                </div>
                <div style="float:left;">
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="9" id="btn">
							...
							<%-- <kmss:auth requestURL="/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=copy">
								<ui:button text="${lfn:message('fssc-base:button.copy')}" onclick="copy()" order="2" />
							</kmss:auth> --%>
							<kmss:auth requestURL="/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=enable">
								<ui:button text="${lfn:message('fssc-base:button.enable')}" onclick="enable()" order="3" />
							</kmss:auth>
							<kmss:auth requestURL="/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=disable">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=data&fdCompanyId=${param.fdCompanyId }')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
        ...
        <script>
            var listOption = {
                ...
                templateName: '',
                basePath: '/fssc/base/fssc_base_special_item/fsscBaseSpecialItem.do',
                canDelete: '${canDelete}',
                mode: '',
                customOpts: {
