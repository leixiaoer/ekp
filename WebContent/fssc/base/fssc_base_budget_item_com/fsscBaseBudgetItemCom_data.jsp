...
<list:data>
    <list:data-columns var="fsscBaseBudgetItemCom" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column col="docCreator.name" title="${lfn:message('fssc-base:fsscBaseBudgetItemCom.docCreator')}" escape="false">
            <c:out value="${fsscBaseBudgetItemCom.docCreator.fdName}" />
        </list:data-column>
        <list:data-column col="docCreator.id" escape="false">
            <c:out value="${fsscBaseBudgetItemCom.docCreator.fdId}" />
        </list:data-column>
        <list:data-column col="docCreateTime" title="${lfn:message('fssc-base:fsscBaseBudgetItemCom.docCreateTime')}">
            <kmss:showDate value="${fsscBaseBudgetItemCom.docCreateTime}" type="datetime"></kmss:showDate>
        </list:data-column>
    </list:data-columns>
    <%-- 分页信息生成 --%>
