...
<script type="text/javascript">
    ...
    Com_IncludeFile("form_option.js", "${LUI_ContextPath}/fssc/base/fssc_base_accounts/", 'js', true);
</script>
...
<html:form action="/fssc/base/fssc_base_accounts/fsscBaseAccounts.do">
    <div id="optBarDiv">
        <c:choose>
            <c:when test="${fsscBaseAccountsForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="Com_Submit(document.fsscBaseAccountsForm, 'update');">
            </c:when>
            <c:when test="${fsscBaseAccountsForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="Com_Submit(document.fsscBaseAccountsForm, 'save');">
                <input type="button" value="${ lfn:message('button.saveadd') }" onclick="Com_Submit(document.fsscBaseAccountsForm, 'saveadd');">
            </c:when>
        </c:choose>
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdParentId" _xform_type="dialog">
                            <xform:dialog propertyId="fdParentId" propertyName="fdParentName" subject="${lfn:message('fssc-base:fsscBaseAccountsCom.fdParent')}" showStatus="edit" style="width:95%;">
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdCode" _xform_type="text">
                        	<c:if test="${empty fsscBaseAccountsForm.fdCode}">
                        		<xform:text property="fdCode" showStatus="edit" required="true" style="width:95%;" />
                        	</c:if>
                        	<c:if test="${not empty fsscBaseAccountsForm.fdCode}">
