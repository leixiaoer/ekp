...
<link type="text/css" rel="stylesheet" href="${LUI_ContextPath}/fssc/base/resource/css/banner.css"/>
...
<div class="lbpm_flowInfoW">
	<c:if test="${fsscLbpmMainForm.docStatus eq '30'}">
   		<div class="lbpmProcessStatus">
   			<div class="lbpmProcessText">${lfn:message('fssc-base:fsscLbpmMainForm.processStatus.end')}</div>
      	</div>
    </c:if>
   	<c:if test="${fsscLbpmMainForm.docStatus eq '00'}">
    	<div class="lbpmProcessStatus lbpmDiscardStatus">
      		<div class="lbpmProcessText">${lfn:message('fssc-base:fsscLbpmMainForm.processStatus.discard')}</div>
      	</div>
   	</c:if>
</div>
