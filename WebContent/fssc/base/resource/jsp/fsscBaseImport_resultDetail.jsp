...
<link rel="stylesheet" href="<c:url value="/fssc/base/resource/css/importResult.css"/>" />
<script>
	Com_IncludeFile("jquery.js");
</script>
<center>
<p class="txtTitle"><bean:message bundle="fssc-base" key="message.import.reslut"/></p>
...
<script>
	...
	Com_AddEventListener(window,'load',function(){
		...
		window.parent.imptDialo.hide({data:data,cols:cols})
	})
