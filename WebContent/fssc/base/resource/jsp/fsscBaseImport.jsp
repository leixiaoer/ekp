...
<template:include ref="default.dialog" sidebar="auto">
	<template:replace name="content">
		<html:form action="/fssc/base/fssc_base_business/fsscBaseBusiness.do" method="post" enctype="multipart/form-data">
		<script>
		</script>
		...
		<script>
			seajs.use(['lui/dialog'],function(dialog){
				...
				window.download = function(){
					window.open('${LUI_ContextPath}/fssc/base/fssc_base_business/fsscBaseBusiness.do?method=downloadTemplate&modelName=${param.modelName}');
				}
			});
		</script>
		</html:form>
