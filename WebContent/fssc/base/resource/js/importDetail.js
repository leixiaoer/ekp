Com_IncludeFile("iconfont.css", Com_Parameter.ContextPath+"fssc/base/resource/iconfont/", 'css', true);
Com_IncludeFile("common.css", Com_Parameter.ContextPath+"fssc/common/resource/css/", 'css', true);
Com_IncludeFile("render.js", Com_Parameter.ContextPath+"fssc/base/resource/js/", 'js', true);
...
ImportDetailUtil.prototype.getProperties = function(){
	...
	data = data.AddBeanData('fsscBaseBusinessService&type=getDetailImportCol&authCurrent=true&properties='+encodeURIComponent(JSON.stringify(fields))+"&modelName="+this.modelName);
...
ImportDetailUtil.prototype.downloadTemplate = function(){
	window.open(Com_Parameter.ContextPath+'fssc/base/fssc_base_business/fsscBaseBusiness.do?method=downloadDetailTemplate&modelName='+this.modelName+"&properties="+encodeURI(JSON.stringify(this.properties)));
}
ImportDetailUtil.prototype.importData = function(){
	...
	seajs.use(['lui/dialog','lang!fssc-base'],function(dialog,lang){
		window.imptDialo = dialog.iframe(
			'/fssc/base/resource/jsp/importDetail.jsp?modelName='+self.modelName+"&properties="+encodeURI(JSON.stringify(self.properties))+"&fdCompanyId="+self.fdCompanyId+"&docTemplateId="+self.docTemplateId,
...
ImportDetailUtil.prototype.addButton = function(){
	...
	this.buttons = {};
	var self = this;
	seajs.use(['lang!fssc-base'],function(lang){
		var btns = [];
