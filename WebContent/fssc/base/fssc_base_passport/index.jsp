...
<template:include ref="default.simple4list">
    <template:replace name="title">
        <c:out value="${ lfn:message('fssc-base:table.fsscBasePassport') }" />
    </template:replace>
    <template:replace name="content">
    	<ui:tabpanel id="fsscBasePassportPanel" layout="sys.ui.tabpanel.list" cfg-router="true">
		<ui:content id="fsscBasePassportContent" title="${ lfn:message('fssc-base:table.fsscBasePassport') }">
