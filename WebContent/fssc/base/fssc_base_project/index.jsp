    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                <list:cri-ref key="fdName" ref="criterion.sys.docSubject" title="${lfn:message('fssc-base:fsscBaseProject.fdName')}" />
                <list:cri-auto modelName="com.landray.kmss.fssc.base.model.FsscBaseProject" property="fdCode" expand="true" />
               <fssc:switchOn property="fdShowType">
                ...
                <list:cri-criterion title="${lfn:message('fssc-base:fsscBaseProject.fdIsAvailable')}" key="fdIsAvailable">
					<list:box-select>
                ...
                <list:cri-auto modelName="com.landray.kmss.fssc.base.model.FsscBaseProject" property="docCreator" />
                <list:cri-auto modelName="com.landray.kmss.fssc.base.model.FsscBaseProject" property="docCreateTime" />
                ...
                <div style="float:left">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
                            <list:sort property="fdCode" text="${lfn:message('fssc-base:fsscBaseProject.fdCode')}" group="sort.list" />
                        </ui:toolbar>
                    </div>
                </div>
                <div style="float:left;">
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="9" id="btn">
							...
							<%-- <kmss:auth requestURL="/fssc/base/fssc_base_project/fsscBaseProject.do?method=copy">
								<ui:button text="${lfn:message('fssc-base:button.copy')}" onclick="copy()" order="3" />
							</kmss:auth> --%>
							<kmss:auth requestURL="/fssc/base/fssc_base_project/fsscBaseProject.do?method=enable">
								<ui:button text="${lfn:message('fssc-base:button.enable')}" onclick="enable()" order="3" />
							</kmss:auth>
							<kmss:auth requestURL="/fssc/base/fssc_base_project/fsscBaseProject.do?method=disable">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/fssc/base/fssc_base_project/fsscBaseProject.do?method=data&fdCompanyId=${param.fdCompanyId }'}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/fssc/base/fssc_base_project/fsscBaseProject.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdName;fdCode;fdCompany.name;fdParent.name;fdType.name;fdIsAvailable.name;docCreator.name;docCreateTime;operations" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
        <script>
            var listOption = {
                ...
                templateName: '',
                basePath: '/fssc/base/fssc_base_project/fsscBaseProject.do',
                canDelete: '${canDelete}',
                mode: '',
                customOpts: {
