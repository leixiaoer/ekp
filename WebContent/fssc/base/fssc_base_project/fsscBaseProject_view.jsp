...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/base/fssc_base_project/fsscBaseProject.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscBaseProject.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/base/fssc_base_project/fsscBaseProject.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscBaseProject.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
...
<center>
    ...
    <div style="width:95%;">
        <table class="tb_normal" width="100%">
            ...
            <c:if test="${fsscBaseProjectForm.fdType!='2'}">
            <tr>
                <td class="td_normal_title" width="15%">
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdProjectManager" _xform_type="address">
                        <ui:person personId="${fsscBaseProjectForm.fdProjectManagerId}" personName="${fsscBaseProjectForm.fdProjectManagerName}" />
                    </div>
                </td>
            </tr>
            </c:if>
