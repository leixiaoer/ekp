...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/base/fssc_base_cash_flow/fsscBaseCashFlow.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscBaseCashFlow.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/base/fssc_base_cash_flow/fsscBaseCashFlow.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscBaseCashFlow.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
                   ...
                   <td class="td_normal_title" width="15%">
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdAccountsCom" _xform_type="text">
                             <xform:dialog propertyId="fdAccountsComId" propertyName="fdAccountsComName" showStatus="view" style="width:95%;">
