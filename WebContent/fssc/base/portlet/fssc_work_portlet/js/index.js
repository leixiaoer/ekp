...
function demoGetListData(pageno, rowsize, workId) {
    ...
    if (workId == "demoFsscWork01") {
        ...
        dataUrl = formInitData['LUI_ContextPath']+"/fssc/base/fssc_base_portlet/fsscBasePortlet.do?method=listApproval&postType=shenhe&pageno="+pageno+"&rowsize="+rowsize;//会计制证岗
        ...
        $(".demo_fssc_work_panel_btns").append('<div class="demo_fssc_work_panel_btns_item"><a href="#" target="_blank">批量审核</a></div>');
        dataUrl = formInitData['LUI_ContextPath']+"/fssc/base/fssc_base_portlet/fsscBasePortlet.do?method=listApproval&postType=chuna&pageno="+pageno+"&rowsize="+rowsize;//出纳岗
        ...
        dataUrl = formInitData['LUI_ContextPath']+"/fssc/base/fssc_base_portlet/fsscBasePortlet.do?method=listApproval&postType=zhangwu&pageno="+pageno+"&rowsize="+rowsize;//财务审核
    }
