...
<template:include ref="default.edit">
    <template:replace name="head">
        ...
        <script type="text/javascript">
            ...
            Com_IncludeFile("main_edit.js", "${LUI_ContextPath}/fssc/base/resource/js/", 'js', true);
            Com_IncludeFile("form_option.js", "${LUI_ContextPath}/fssc/base/fssc_base_payment/", 'js', true);
        </script>
    </template:replace>

    <template:replace name="title">
        <c:choose>
            <c:when test="${fsscBasePaymentForm.method_GET == 'add' }">
                <c:out value="${ lfn:message('operation.create') } - ${ lfn:message('fssc-base:table.fsscBasePayment') }" />
            </c:when>
            <c:otherwise>
                <c:out value="${fsscBasePaymentForm.fdSubject} - " />
                <c:out value="${ lfn:message('fssc-base:table.fsscBasePayment') }" />
            </c:otherwise>
        </c:choose>
    </template:replace>
    <template:replace name="toolbar">
        <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
            <c:choose>
                <c:when test="${ fsscBasePaymentForm.method_GET == 'edit' }">
                    <ui:button text="${ lfn:message('button.update') }" onclick="Com_Submit(document.fsscBasePaymentForm, 'update');" />
                </c:when>
                <c:when test="${ fsscBasePaymentForm.method_GET == 'add' }">
                    <ui:button text="${ lfn:message('button.save') }" onclick="Com_Submit(document.fsscBasePaymentForm, 'save');" />
                </c:when>
            </c:choose>
    ...
    <template:replace name="content">
        <html:form action="/fssc/base/fssc_base_payment/fsscBasePayment.do">
            <div class='lui_form_title_frame'>
                <div class='lui_form_subject'>
                    ${lfn:message('fssc-base:table.fsscBasePayment')}
                </div>
            ...
            <table class="tb_normal" width="100%">
                <tr>
                    <td class="td_normal_title" width="15%">
                        ${lfn:message('fssc-base:fsscBasePayment.fdSubject')}
                    </td>
                ...
                <tr>
                    <td class="td_normal_title" width="15%">
                        ${lfn:message('fssc-base:fsscBasePayment.fdModelNumber')}
                    </td>
                    <td width="35%">
                    ...
                    <td class="td_normal_title" width="15%">
                        ${lfn:message('fssc-base:fsscBasePayment.fdPaymentMoney')}
                    </td>
                    <td width="35%">
                ...
                <tr>
                    <td class="td_normal_title" width="15%">
                        ${lfn:message('fssc-base:fsscBasePayment.fdPaymentTime')}
                    </td>
                    <td width="35%">
                    ...
                    <td class="td_normal_title" width="15%">
                        ${lfn:message('fssc-base:fsscBasePayment.fdStatus')}
                    </td>
                    <td width="35%">
                        <div id="_xform_fdStatus" _xform_type="radio">
                            <sunbor:enumsShow enumsType="fssc_base_payment_status" value="${fsscBasePaymentForm.fdStatus }"/>
                       		<input type="hidden" value="${fsscBasePaymentForm.fdStatus }"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="td_normal_title" width="15%">
                        ${lfn:message('fssc-base:fsscBasePayment.fdRemark')}
                    </td>
                    ...
                    <td colspan="4" width="100%">
                        <table class="tb_normal" width="100%" id="TABLE_DocList_fdDetail_Form" align="center" tbdraggable="false">
                            <tr align="center" class="tr_normal_title">
                                ...
                                <td width="15%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayWay')}
                                </td>
                                <td width="15%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayBank')}
                                </td>
                                <td width="8%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPaymentMoney')}
                                </td>
                                <td width="8%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdCurrency')}
                                </td>
                                <td width="13%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeName')}
                                </td>
                                <td width="13%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeAccount')}
                                </td>
                                <td width="10%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeBankName')}
                                </td>
                                <td width="15%">
                                    ${lfn:message('fssc-base:fsscBasePaymentDetail.fdPlanPaymentDate')}
                                </td>
                                <td style="width:80px;">
        						</td>
                            </tr>
						        ...
						        <td align="center">
                                    ...
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[!{index}].fdPayeeName" _xform_type="text">
                                            <xform:text property="fdDetail_Form[!{index}].fdPayeeName" showStatus="readOnly" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeName')}" validators=" maxLength(200)" style="width:95%;" />
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[!{index}].fdPayeeAccount" _xform_type="text">
                                            <xform:text property="fdDetail_Form[!{index}].fdPayeeAccount" showStatus="readOnly" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeAccount')}" validators=" maxLength(200)" style="width:95%;" />
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[!{index}].fdPayeeBankName" _xform_type="text">
                                            <xform:text property="fdDetail_Form[!{index}].fdPayeeBankName" showStatus="readOnly" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeBankName')}" validators=" maxLength(200)" style="width:95%;" />
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[!{index}].fdPlanPaymentDate" _xform_type="datetime">
                                            <xform:datetime required="true" property="fdDetail_Form[!{index}].fdPlanPaymentDate" showStatus="edit" dateTimeType="date" style="width:95%;" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPlanPaymentDate')}"/>
                                        </div>
                                    </td>
                                    <td align="center">
                            ...
                            <c:forEach items="${fsscBasePaymentForm.fdDetail_Form}" var="fdDetail_FormItem" varStatus="vstatus">
                                <tr KMSS_IsContentRow="true">
                                    ...
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdPayeeName" _xform_type="text">
                                            <xform:text property="fdDetail_Form[${vstatus.index}].fdPayeeName" showStatus="readOnly" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeName')}" validators=" maxLength(200)" style="width:95%;" />
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdPayeeAccount" _xform_type="text">
                                            <xform:text property="fdDetail_Form[${vstatus.index}].fdPayeeAccount" showStatus="readOnly" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeAccount')}" validators=" maxLength(200)" style="width:95%;" />
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdPayeeBankName" _xform_type="text">
                                            <xform:text property="fdDetail_Form[${vstatus.index}].fdPayeeBankName" showStatus="readOnly" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPayeeBankName')}" validators=" maxLength(200)" style="width:95%;" />
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div id="_xform_fdDetail_Form[${vstatus.index}].fdPlanPaymentDate" _xform_type="datetime">
                                            <xform:datetime required="true" property="fdDetail_Form[${vstatus.index}].fdPlanPaymentDate" showStatus="edit" dateTimeType="date" style="width:95%;" subject="${lfn:message('fssc-base:fsscBasePaymentDetail.fdPlanPaymentDate')}"/>
                                        </div>
                                    </td>
                                    <td align="center">
						                <a href="javascript:void(0);" onclick="DocList_CopyRow();" title="${lfn:message('doclist.copy')}">
        ...
        <script>
			...
			seajs.use(['lui/dialog'],function(dialog){
				window.FSSC_SelectPayBank = function(index){
					...
					dialogSelect(false,'fssc_base_pay_bank_fdBank','fdDetail_Form[*].fdPayBankId','fdDetail_Form[*].fdPayBankName',null,{fdCompanyId:fdCompanyId},function(data){
				...
				window.FSSC_SelectPayWay = function(index){
					var fdCompanyId = $("[name='fdDetail_Form["+index+"].fdCompanyId']").val();
		    		dialogSelect(false,'fssc_base_pay_way_getPayWay','fdDetail_Form[*].fdPayWayId','fdDetail_Form[*].fdPayWayName',null,{fdCompanyId:fdCompanyId});
		    	}
				window.FSSC_SelectCurrency = function(index){
					var fdCompanyId = $("[name='fdDetail_Form["+index+"].fdCompanyId']").val();
					dialogSelect(false,'fssc_base_currency_fdCurrency','fdDetail_Form[*].fdCurrencyId','fdDetail_Form[*].fdCurrencyName',null,{fdCompanyId:fdCompanyId,existCurrency:'${currencyIds}'},function(rtn){
			    		...
			    		data = data.AddBeanData('fsscBaseExchangeRateService&type=getRateByCurrency&fdCurrencyId='+fdCurrencyId+'&fdCompanyId='+fdCompanyId).GetHashMapArray();
						if(data.length>0){
				...
				Com_Parameter.event.submit.push(function(){
					...
					$.ajax({
						url:'${LUI_ContextPath}/fssc/base/fssc_base_payment/fsscBasePayment.do?method=checkPayMoney',
						data:{fdModelName:'${fsscBasePaymentForm.fdModelName}',fdModelId:'${fsscBasePaymentForm.fdModelId}',info:JSON.stringify(info)},
						async:false,
						dataType:'json',
