...
<list:data>
    <list:data-columns var="fsscBaseMaterialType" list="${queryPage.list}" varIndex="status" custom="false">
        ...
        <list:data-column property="fdName" title="${lfn:message('fssc-base:fsscBaseMaterialType.fdName')}" escape="false" />
        <list:data-column col="index">
            ${status+1}
        </list:data-column>

        <list:data-column property="fdCode" title="${lfn:message('fssc-base:fsscBaseMaterialType.fdCode')}" escape="false" />
