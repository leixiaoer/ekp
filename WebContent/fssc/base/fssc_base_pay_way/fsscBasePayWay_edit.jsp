...
<script type="text/javascript">
    ...
    Com_IncludeFile("form_option.js", "${LUI_ContextPath}/fssc/base/fssc_base_pay_way/", 'js', true);
</script>

    <% pageContext.setAttribute("currentUser", UserUtil.getKMSSUser()); %>

<html:form action="/fssc/base/fssc_base_pay_way/fsscBasePayWay.do">
    <div id="optBarDiv">
        <c:choose>
            <c:when test="${fsscBasePayWayForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="Com_Submit(document.fsscBasePayWayForm, 'update');">
            </c:when>
            <c:when test="${fsscBasePayWayForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="Com_Submit(document.fsscBasePayWayForm, 'save');">
                <input type="button" value="${ lfn:message('button.saveadd') }" onclick="Com_Submit(document.fsscBasePayWayForm, 'saveadd');">
            </c:when>
        </c:choose>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdCompanyId" _xform_type="dialog">
                        	...
                        	<fssc:switchOn property="fdShowType">
	                            <xform:dialog propertyId="fdCompanyId" propertyName="fdCompanyName" subject="${lfn:message('fssc-base:fsscBasePayWay.fdCompany')}" showStatus="edit" required="true" style="width:95%;">
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdAccountId" _xform_type="dialog">
                            <xform:dialog propertyId="fdAccountId" propertyName="fdAccountName" subject="${lfn:message('fssc-base:fsscBasePayWay.fdAccount')}" showStatus="edit" style="width:95%;">
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdDefaultPayBankId" _xform_type="dialog">
                            <xform:dialog propertyId="fdDefaultPayBankId" propertyName="fdDefaultPayBankName" subject="${lfn:message('fssc-base:fsscBasePayWay.fdDefaultPayBank')}" showStatus="edit" style="width:95%;">
                               dialogSelect(false,'fssc_base_pay_bank_fdBank','fdDefaultPayBankId','fdDefaultPayBankName',FSSC_AfterBankSelected);
                            </xform:dialog>
                        </div>
                    </td>
                </tr>
