...
<list:data>
    <list:data-columns var="fsscBaseWbs" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column property="fdName" title="${lfn:message('fssc-base:fsscBaseWbs.fdName')}"  escape="false"/>
        <list:data-column property="fdCode" title="${lfn:message('fssc-base:fsscBaseWbs.fdCode')}"  escape="false"/>
