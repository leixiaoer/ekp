...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/base/fssc_base_standard/fsscBaseStandard.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscBaseStandard.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/base/fssc_base_standard/fsscBaseStandard.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscBaseStandard.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdBerthId" _xform_type="dialog">
                        <xform:dialog propertyId="fdBerthId" propertyName="fdBerthName" showStatus="view" style="width:95%;">
                            dialogSelect(false,'fssc_base_berth_fdBerth','fdBerthId','fdBerthName');
                        </xform:dialog>
                    </div>
                </td>
            </tr>
