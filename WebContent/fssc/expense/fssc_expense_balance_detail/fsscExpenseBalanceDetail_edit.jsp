	        ...
	        <td align="center">
	            ...
	            <div id="_xform_fdDetailList_Form[!{index}].fdExpenseItemId" _xform_type="dialog">
	                <xform:dialog propertyId="fdDetailList_Form[!{index}].fdExpenseItemId" propertyName="fdDetailList_Form[!{index}].fdExpenseItemName" required="true" showStatus="edit" style="width:85%;" subject="${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdExpenseItem')}">
	                    dialogSelect(false,'fssc_base_expense_item_fdParent','fdDetailList_Form[*].fdExpenseItemId','fdDetailList_Form[*].fdExpenseItemName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''},function(rtn){FSSC_AfterExpenseItemSelected(!{index},rtn)});
	                </xform:dialog>
	            </div>
	        </td>
	        <td align="center">
	            ...
	            <div id="_xform_fdDetailList_Form[!{index}].fdAccountId" _xform_type="dialog">
	                <xform:dialog propertyId="fdDetailList_Form[!{index}].fdAccountId" propertyName="fdDetailList_Form[!{index}].fdAccountName" subject="${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdAccount') }" showStatus="edit" required="true" style="width:85%;">
	                    dialogSelect(false,'fssc_base_accounts_com_fdAccount','fdDetailList_Form[*].fdAccountId','fdDetailList_Form[*].fdAccountName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''},function(rtn){FSSC_AfterAccountSelected(!{index},rtn)});
	                </xform:dialog>
	            </div>
	        </td>
	        <td align="center">
	            ...
	            <div id="_xform_fdDetailList_Form[!{index}].fdCostCenterId" _xform_type="dialog">
	                <xform:dialog propertyId="fdDetailList_Form[!{index}].fdCostCenterId" propertyName="fdDetailList_Form[!{index}].fdCostCenterName" subject="${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdCostCenter') }" showStatus="edit" style="width:85%;">
	                    dialogSelect(false,'fssc_base_cost_center_selectCostCenter','fdDetailList_Form[*].fdCostCenterId','fdDetailList_Form[*].fdCostCenterName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''});
	                </xform:dialog>
	            </div>
	        </td>
	        <td align="center">
	        ...
	        <td align="center">
	            ...
	            <div id="_xform_fdDetailList_Form[!{index}].fdCashFlowId" _xform_type="dialog">
	                <xform:dialog propertyId="fdDetailList_Form[!{index}].fdCashFlowId" propertyName="fdDetailList_Form[!{index}].fdCashFlowName" subject="${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdCashFlow') }" showStatus="edit" style="width:85%;" >
	                    dialogSelect(false,'fssc_base_cash_flow_getCashFlow','fdDetailList_Form[*].fdCashFlowId','fdDetailList_Form[*].fdCashFlowName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''});
	                </xform:dialog>
	            </div>
	        </td>
	        <td align="center">
	            ...
	            <div id="_xform_fdDetailList_Form[!{index}].fdProjectId" _xform_type="dialog">
	                <xform:dialog propertyId="fdDetailList_Form[!{index}].fdProjectId" propertyName="fdDetailList_Form[!{index}].fdProjectName"  subject="${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdProject') }" showStatus="edit" style="width:85%;" >
	                    dialogSelect(false,'fssc_base_project_project','fdDetailList_Form[*].fdProjectId','fdDetailList_Form[*].fdProjectName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''});
	                </xform:dialog>
	            </div>
	        </td>
	        <td align="center">
	        ...
	        <tr KMSS_IsContentRow="1">
		        ...
		        <td align="center">
		            ...
		            <div id="_xform_fdDetailList_Form[${vstatus.index }].fdExpenseItemId" _xform_type="dialog">
		                <xform:dialog propertyId="fdDetailList_Form[${vstatus.index }].fdExpenseItemId" propertyName="fdDetailList_Form[${vstatus.index }].fdExpenseItemName" required="true" showStatus="edit" style="width:85%;">
		                    dialogSelect(false,'fssc_base_expense_item_fdParent','fdDetailList_Form[*].fdExpenseItemId','fdDetailList_Form[*].fdExpenseItemName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''},function(rtn){FSSC_AfterExpenseItemSelected(${vstatus.index },rtn)});
		                </xform:dialog>
		            </div>
		        </td>
		        <td align="center">
		            ...
		            <div id="_xform_fdDetailList_Form[${vstatus.index }].fdAccountId" _xform_type="dialog">
		                <xform:dialog propertyId="fdDetailList_Form[${vstatus.index }].fdAccountId" propertyName="fdDetailList_Form[${vstatus.index }].fdAccountName" subject="${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdAccount') }" showStatus="edit" required="true" style="width:85%;">
		                    dialogSelect(false,'fssc_base_accounts_com_fdAccount','fdDetailList_Form[*].fdAccountId','fdDetailList_Form[*].fdAccountName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''},function(rtn){FSSC_AfterAccountSelected(${vstatus.index },rtn)});
		                </xform:dialog>
		            </div>
		        </td>
		        <td align="center">
		        ...
		        <td align="center">
		            ...
		            <div id="_xform_fdDetailList_Form[${vstatus.index }].fdCashFlowId" _xform_type="dialog">
		                <xform:dialog propertyId="fdDetailList_Form[${vstatus.index }].fdCashFlowId" propertyName="fdDetailList_Form[${vstatus.index }].fdCashFlowName" showStatus="edit" style="width:85%;">
		                    dialogSelect(false,'fssc_base_cash_flow_getCashFlow','fdDetailList_Form[*].fdCashFlowId','fdDetailList_Form[*].fdCashFlowName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''});
		                </xform:dialog>
		            </div>
		        </td>
		        <td align="center">
		            ...
		            <div id="_xform_fdDetailList_Form[${vstatus.index }].fdProjectId" _xform_type="dialog">
		                <xform:dialog propertyId="fdDetailList_Form[${vstatus.index }].fdProjectId" propertyName="fdDetailList_Form[${vstatus.index }].fdProjectName" showStatus="edit" style="width:85%;">
		                    dialogSelect(false,'fssc_base_project_project','fdDetailList_Form[*].fdProjectId','fdDetailList_Form[*].fdProjectName',null,{fdCompanyId:$('[name=fdCompanyId]').val(),fdNotId:''});
		                </xform:dialog>
		            </div>
		        </td>
