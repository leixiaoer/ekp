  ...
  <tr KMSS_IsReferRow="1" style="display:none;">
      ...
      <td align="center">
          <div id="_xform_fdTravelList_Form[!{index}].fdBeginDate" _xform_type="datetime">
              <xform:datetime subject="${lfn:message('fssc-expense:fsscExpenseTravelDetail.fdBeginDate') }" validators="checkDate" required="true" property="fdTravelList_Form[!{index}].fdBeginDate" showStatus="edit" dateTimeType="date" style="width:90%;" />
          </div>
      </td>
      <td align="center">
          <div id="_xform_fdTravelList_Form[!{index}].fdEndDate" _xform_type="datetime">
              <xform:datetime subject="${lfn:message('fssc-expense:fsscExpenseTravelDetail.fdEndDate') }" validators="checkDate" required="true" property="fdTravelList_Form[!{index}].fdEndDate" showStatus="edit" dateTimeType="date" style="width:90%;" />
          </div>
      </td>
      <td align="center">
      ...
      <td align="center">
          <a href="javascript:void(0);" onclick="DocList_DeleteRow();FSSC_RefreshTravelOption();" title="${lfn:message('doclist.delete')}">
      ...
      <tr KMSS_IsContentRow="1">
          ...
          <td align="center">
              <div id="_xform_fdTravelList_Form[${vstatus.index}].fdBeginDate" _xform_type="datetime">
                  <xform:datetime subject="${lfn:message('fssc-expense:fsscExpenseTravelDetail.fdBeginDate') }" validators="checkDate"  required="true" property="fdTravelList_Form[${vstatus.index}].fdBeginDate" showStatus="edit" dateTimeType="date" style="width:90%;" />
              </div>
          </td>
          <td align="center">
              <div id="_xform_fdTravelList_Form[${vstatus.index}].fdEndDate" _xform_type="datetime">
                  <xform:datetime subject="${lfn:message('fssc-expense:fsscExpenseTravelDetail.fdEndDate') }" validators="checkDate"  required="true" property="fdTravelList_Form[${vstatus.index}].fdEndDate" showStatus="edit" dateTimeType="date" style="width:90%;" />
              </div>
          </td>
          <td align="center">
