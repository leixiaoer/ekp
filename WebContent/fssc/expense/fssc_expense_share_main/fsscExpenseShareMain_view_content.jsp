                    ...
                    <table class="tb_normal" width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="5" width="83.0%">
                            	<a target="_blank" href="<c:url value="/fssc/expense/fssc_expense_main/fsscExpenseMain.do"/>?method=view&fdId=${fsscExpenseShareMainForm.fdExpenseMainId}">
                                <div style="color:#83C2EB" id="_xform_fdContent" _xform_type="textarea">
                                    <xform:dialog required="true" propertyName="fdExpenseMainName" propertyId="fdExpenseMainId" subject="${lfn:message('fssc-expense:fsscExpenseShareMain.fdExpenseMain') }" style="width:95%;">
                                    	dialogSelect(false,'fssc_expense_main_getExpenseMain','fdExpenseMainId','fdExpenseMainName',null,{docTemplateId:'${docTemplate.fdId}'},FSSC_AfterExpenseMainSelected);
                                    </xform:dialog>
                                </div>
                                </a>
                            </td>
