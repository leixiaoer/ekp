          ...
          <tr>
              ...
              <td colspan="5" width="83.0%">
                  <div id="_xform_fdContent" _xform_type="textarea">
                      <xform:dialog required="true" propertyName="fdExpenseMainName" propertyId="fdExpenseMainId" subject="${lfn:message('fssc-expense:fsscExpenseShareMain.fdExpenseMain') }" style="width:95%;">
                      	dialogSelect(false,'fssc_expense_main_getExpenseMain','fdExpenseMainId','fdExpenseMainName',null,{docTemplateId:'${docTemplate.fdCategory.fdId}'},FSSC_AfterExpenseMainSelected);
                      </xform:dialog>
                  </div>
              </td>
          </tr>
          	...
          	<td colspan="6">
          		<table class="tb_normal" width="100%" id="TABLE_EXPENSE">
          			<tr>
          				...
          				<td class="td_normal_title" align="center">${lfn:message('fssc-expense:fsscExpenseDetail.fdRealUser') }</td>
