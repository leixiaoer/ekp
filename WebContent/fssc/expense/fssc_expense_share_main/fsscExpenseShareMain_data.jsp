...
<list:data>
    <list:data-columns var="fsscExpenseShareMain" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column col="fdExpenseMain.docSubject" escape="false" title="${lfn:message('fssc-expense:fsscExpenseShareMain.fdExpenseMain')}">
            <c:out value="${fsscExpenseShareMain.fdExpenseMain.docSubject}" />
        </list:data-column>
