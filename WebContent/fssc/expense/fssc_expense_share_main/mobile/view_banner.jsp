...
<%@ taglib uri="/WEB-INF/KmssConfig/sys/person/person.tld" prefix="person"%>
		<div class="muiFlowInfoW muiFormContent">
				<div class="muiFormSubject">
				 ...
				 <c:if test="${fsscExpenseShareMainForm.docStatus eq '30'}">
                 ...
                 <c:if test="${fsscExpenseShareMainForm.docStatus eq '00'}">
					...
					<tr>
						<td rowspan="2" class="muiFlowIconTd">
							 <div class="muiProcessIcon">
			                    <img class="muiProcessImg" src='<person:headimageUrl contextPath="true"  personId="${fsscExpenseShareMainForm.docCreatorId}" size="m" />'/>
			                </div>
						...
						<td class="muiFlowSummary">
							<div>${lfn:message('fssc-expense:fsscExpenseShareMainForm.docTemplate') }：<c:out value="${fsscExpenseShareMainForm.docTemplateName}" /> </div>
							<div>${lfn:message('fssc-expense:fsscExpenseShareMainForm.fdNumber') }： <c:out value="${fsscExpenseShareMainForm.fdNumber}" /></div>
							<div>${lfn:message('fssc-expense:fsscExpenseShareMainForm.docCreateTime') }： <c:out value="${fsscExpenseShareMainForm.docCreateTime}" /></div>
						</td>
					</tr>
				</table>
			</div>
