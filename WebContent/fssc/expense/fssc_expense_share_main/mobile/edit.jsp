                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCompanyId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCompanyId',nameField:'fdDetailList_Form[!{index}].fdCompanyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCompany',dataURL:getSource('fssc_base_company_fdCompany'),subject:'${lfn:message('fssc-expense:fsscExpenseShareDetail.fdCompany')}',required:true,afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCostCenterId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCostCenterId',nameField:'fdDetailList_Form[!{index}].fdCostCenterName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCostCenter',dataURL:getSource('fssc_base_cost_center_selectCostCenter'),subject:'${lfn:message('fssc-expense:fsscExpenseShareDetail.fdCostCenter')}',required:true,afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCostDeptId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCostDeptId',nameField:'fdDetailList_Form[!{index}].fdCostDeptName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCostCenter',dataURL:getSource('fssc_base_cost_center_selectCostCenter'),subject:'${lfn:message('fssc-expense:fsscExpenseShareDetail.fdCostDept')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdExpenseItemId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdExpenseItemId',nameField:'fdDetailList_Form[!{index}].fdExpenseItemName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseExpenseItem',dataURL:getSource('fssc_base_expense_item_fdParent'),subject:'${lfn:message('fssc-expense:fsscExpenseShareDetail.fdExpenseItem')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
