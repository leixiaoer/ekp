        ...
        <c:choose>
            <c:when test="${ param.filter == '1' }">
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/back/HrefBackMixin" data-dojo-props="href:'/fssc/expense/fssc_expense_share_main/mobile/index.jsp'">
                    </div>
                ...
                <div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
                    <div data-dojo-type="mui/search/SearchBar" data-dojo-props="modelName:'com.landray.kmss.fssc.expense.model.FsscExpenseShareMain',needPrompt:false,height:'3.8rem'">
                    </div>
            ...
            <c:otherwise>
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/nav/MobileCfgNavBar" data-dojo-props="defaultUrl:'/fssc/expense/fssc_expense_share_main/mobile/nav.jsp', modelName:'com.landray.kmss.fssc.expense.model.FsscExpenseShareMain'">
                    </div>
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/Folder" data-dojo-props="tmplURL:'/fssc/expense/fssc_expense_share_main/mobile/query.jsp'"></div>
                </div>
