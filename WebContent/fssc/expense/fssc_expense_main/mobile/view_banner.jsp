...
<%@ taglib uri="/WEB-INF/KmssConfig/sys/person/person.tld" prefix="person"%>
		<div class="muiFlowInfoW muiFormContent">
				<div class="muiFormSubject">
				 ...
				 <c:if test="${fsscExpenseMainForm.docStatus eq '30'}">
                 ...
                 <c:if test="${fsscExpenseMainForm.docStatus eq '00'}">
					...
					<tr>
						<td rowspan="2" class="muiFlowIconTd">
							 <div class="muiProcessIcon">
			                    <img class="muiProcessImg" src='<person:headimageUrl contextPath="true"  personId="${fsscExpenseMainForm.docCreatorId}" size="m" />'/>
			                </div>
						...
						<td class="muiFlowSummary">
							<div>${lfn:message('fssc-expense:fsscExpenseMain.docTemplate') }：<c:out value="${fsscExpenseMainForm.docTemplateName}" /> </div>
							<div>${lfn:message('fssc-expense:fsscExpenseMain.docNumber') }： <c:out value="${fsscExpenseMainForm.docNumber}" /></div>
							<div>${lfn:message('fssc-expense:fsscExpenseMain.docCreateTime') }： <c:out value="${fsscExpenseMainForm.docCreateTime}" /></div>
						</td>
					</tr>
				</table>
			</div>
