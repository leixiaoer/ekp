...
<div data-dojo-type="mui/table/ScrollableHContainer" >
	<div data-dojo-type="mui/table/ScrollableHView" style="margin-top:20px;" id="dt_wrap_travel_hview">
		    <table class="muiNormal" id="TABLE_DocList_fdTravelList_Form" width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr KMSS_IsContentRow="1">
		          ...
		          <td align="center">
		              <div id="_xform_fdTravelList_Form[${vstatus.index}].fdTravelDays" _xform_type="text">
		                  <xform:text subject="${lfn:message('fssc-expense:fsscExpenseTravelDetail.fdTravelDays') }" property="fdTravelList_Form[${vstatus.index}].fdTravelDays" showStatus="view" style="width:90%;" />
		              </div>
		          </td>
		          <td align="center">
