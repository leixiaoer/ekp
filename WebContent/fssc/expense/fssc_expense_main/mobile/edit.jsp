                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdTravelList_Form[!{index}].fdBerthId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdTravelList_Form[!{index}].fdBerthId',nameField:'fdTravelList_Form[!{index}].fdBerthName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseBerth',dataURL:getSource('fssc_base_berth_fdBerth'),subject:'${lfn:message('fssc-expense:fsscExpenseTravelDetail.fdBerth')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCompanyId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCompanyId',nameField:'fdDetailList_Form[!{index}].fdCompanyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCompany',dataURL:getSource('fssc_base_company_fdCompany'),subject:'${lfn:message('fssc-expense:fsscExpenseDetail.fdCompany')}',required:true,afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCostCenterId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCostCenterId',nameField:'fdDetailList_Form[!{index}].fdCostCenterName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCostCenter',dataURL:getSource('fssc_base_cost_center_selectCostCenter'),subject:'${lfn:message('fssc-expense:fsscExpenseDetail.fdCostCenter')}',required:true,afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCurrencyId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCurrencyId',nameField:'fdDetailList_Form[!{index}].fdCurrencyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCurrency',dataURL:getSource('fssc_base_currency_fdCurrency'),subject:'${lfn:message('fssc-expense:fsscExpenseDetail.fdCurrency')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdInvoiceList_Form[!{index}].fdCompanyId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdInvoiceList_Form[!{index}].fdCompanyId',nameField:'fdInvoiceList_Form[!{index}].fdCompanyName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCompany',dataURL:getSource('fssc_base_company_fdCompany'),subject:'${lfn:message('fssc-expense:fsscExpenseInvoiceDetail.fdCompany')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdInvoiceList_Form[!{index}].fdExpenseTypeId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdInvoiceList_Form[!{index}].fdExpenseTypeId',nameField:'fdInvoiceList_Form[!{index}].fdExpenseTypeName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseExpenseItem',dataURL:getSource('fssc_base_expense_item_fdParent'),subject:'${lfn:message('fssc-expense:fsscExpenseInvoiceDetail.fdExpenseType')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div id="_xform_fdInvoiceList_Form[${vstatus.index}].fdExpenseTypeId" _xform_type="dialog">
                                                                                            <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdInvoiceList_Form[${vstatus.index}].fdExpenseTypeId',nameField:'fdInvoiceList_Form[${vstatus.index}].fdExpenseTypeName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseExpenseItem',dataURL:getSource('fssc_base_expense_item_fdParent'),subject:'${lfn:message('fssc-expense:fsscExpenseInvoiceDetail.fdExpenseType')}',curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscExpenseMainForm.fdInvoiceList_Form[vstatus.index].fdExpenseTypeId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscExpenseMainForm.fdInvoiceList_Form[vstatus.index].fdExpenseTypeName))}',afterSelect:afterDialogSel">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
