...
<c:if test="${param.approveType ne 'right' }">
	...
	<ui:tabpage expand="false" collapsed="true" id="reviewTabPage"
		...
		<table class="tb_normal" width="100%">
			...
			<tr>
				...
				<td width="16.6%">
					<div id="_xform_fdClaimantId" _xform_type="address">
						...
						<!-- 未启用提单转授权 -->
						<c:if test="${fdIsAuthorize=='0'}">
							<xform:address propertyId="fdClaimantId" propertyName="fdClaimantName" onValueChange="clearInfoWhenCliamntChanged" orgType="ORG_TYPE_PERSON" showStatus="edit" required="true" subject="${lfn:message('fssc-expense:fsscExpenseMain.fdClaimant')}" style="width:95%;" />
						</c:if>
					</div>
				</td>
				<td class="td_normal_title" width="16.6%">
				...
				<td width="16.6%">
					<div id="_xform_fdCompanyId" _xform_type="dialog">
						<xform:dialog propertyId="fdCompanyId"
							...
							style="width:95%;">
                                            dialogSelect(false,'fssc_base_company_fdCompany','fdCompanyId','fdCompanyName',null,{fdPersonId:$('[name=fdClaimantId]').val(),fdModelName:'com.landray.kmss.fssc.expense.model.FsscExpenseMain'},clearDetailWhenCompanyChanged);
                                        </xform:dialog>
				...
				<td width="16.6%">
					<div id="_xform_fdCostCenterId" _xform_type="dialog">
						<xform:dialog propertyId="fdCostCenterId"
							...
							style="width:95%;">
                                            dialogSelect(false,'fssc_base_cost_center_selectCostCenter','fdCostCenterId','fdCostCenterName',null,{'fdCompanyId':$('[name=fdCompanyId]').val()},FSSC_MainCostCenterChanged);
                                        </xform:dialog>
					</div>
				</td>
			</tr>
						...
						<div id="_xform_fdContent" _xform_type="textarea">
							<xform:dialog propertyName="fdFeeNames" propertyId="fdFeeIds"
								...
								subject="${lfn:message('fssc-expense:fsscExpenseMain.fdFeeNames')}">
                                        	dialogSelect(true,'fssc_expense_main_selectFee','fdFeeIds','fdFeeNames',null,{'docTemplateId':$('[name=docTemplateId]').val(),'fdPersonId':$('[name=fdClaimantId]').val()},FSSC_AfterFeeSelected);
                            </xform:dialog>
                            <span id="closeFeeMain">
						&nbsp &nbsp
					...
					<td colspan="5" width="83.0%">
						<div id="_xform_fdContent" _xform_type="textarea">
							<xform:dialog propertyName="fdProappName" propertyId="fdProappId" style="width:85%;" required="true" subject="${lfn:message('fssc-expense:fsscExpenseMain.fdProappName')}">
                                 dialogSelect(false,'fssc_expense_main_selectProapp','fdProappId','fdProappName',null,{},FSSC_AfterProappChanged);
                            </xform:dialog>
						</div>
					</td>
				</tr>
					...
					<td colspan="5" width="83.0%">
						<div id="_xform_fdContent" _xform_type="textarea">
							<xform:dialog propertyName="fdProjectName" propertyId="fdProjectId" style="width:85%;" required="true" subject="${lfn:message('fssc-expense:fsscExpenseMain.fdProject')}">
                                 dialogSelect(false,'fssc_base_project_project','fdProjectId','fdProjectName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'fdProjectType':1},afterSelectProject);
                            </xform:dialog>
						</div>
					</td>
				</tr>
                ...
                <td colspan="5" width="83.0%">
                    <div id="_xform_fdContent" _xform_type="textarea">
                        <xform:dialog propertyName="fdProjectAccountingName" propertyId="fdProjectAccountingId" style="width:85%;" required="true" subject="${lfn:message('fssc-expense:fsscExpenseMain.fdProjectAccounting')}">
                        	dialogSelect(false,'fssc_base_project_project','fdProjectAccountingId','fdProjectAccountingName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'fdProjectType':2});
                        </xform:dialog>
                    </div>
                </td>
            </tr>
			...
			<tr>
				...
				<td colspan="5" width="83.0%">
					<div id="_xform_fdContent" _xform_type="textarea">
						<xform:textarea property="fdContent" showStatus="edit" style="width:95%;height:50px;" />
					</div>
				</td>
			</tr>
			<tr>
	...
	<c:if test="${param.approveType eq 'right'}">
		<ui:content title="${lfn:message('fssc-expense:fsscExpenseMain.fdpanel.other') }" expand="true" >
