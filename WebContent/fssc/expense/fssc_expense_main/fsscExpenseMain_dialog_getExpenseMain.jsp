...
<list:data>
    <list:data-columns var="fsscExpenseMain" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column col="fdCompany" title="${lfn:message('fssc-expense:fsscExpenseMain.fdCompany')}" >
        	${fsscExpenseMain.fdCompany.fdName}
        </list:data-column>
        <list:data-column col="fdCostCenter" title="${lfn:message('fssc-expense:fsscExpenseMain.fdCostCenter')}" >
        	${fsscExpenseMain.fdCostCenter.fdName}
        </list:data-column>
