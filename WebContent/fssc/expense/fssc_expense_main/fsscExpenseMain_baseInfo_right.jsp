...
<ui:content title="${ lfn:message('fssc-expense:py.JiBenXinXi') }" titleicon="lui-fm-icon-2">
	<table class="tb_simple" width="100%">
		...
		<tr>
			...
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_voucher_status" value="${fsscExpenseMainForm.fdVoucherStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
			<td  class="td_normal_title" width="30%" >${lfn:message('fssc-expense:fsscExpenseMain.fdBookkeepingStatus') }</td>
			<td  width="75%"> <sunbor:enumsShow enumsType="fssc_base_fd_bookkeeping_status" value="${fsscExpenseMainForm.fdBookkeepingStatus }"></sunbor:enumsShow></td>
		</tr>
		<tr>
