		...
		<tr>
			...
			<td  width=23% >
				<xform:dialog propertyId="fdProjectId" propertyName="fdProjectName" showStatus="edit" subject="${lfn:message('fssc-expense:fsscExpenseMain.fdProject')}" style="width:35%;">
					dialogSelect(false,'fssc_base_project_project','fdProjectId','fdProjectName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'fdProjectType':'1'});
				</xform:dialog>
			</td>
		</tr>
		...
		<tr>
			...
			<td  width=23% >
				<xform:dialog propertyId="fdExpenseItemId" propertyName="fdExpenseItemName" showStatus="edit" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdExpenseItem')}" style="width:35%;">
					dialogSelect(false,'fssc_base_expense_item_selectExpenseItem','fdExpenseItemId','fdExpenseItemName',null,{'fdCompanyId':$('[name=fdCompanyId]').val(),'type':'all','fdCategoryId':$('[name=fdCategoryId]').val()});
				</xform:dialog>
			</td>
		</tr>
		<tr>
			...
			<td  width=23% >
				<xform:address propertyId="docCreatorId" propertyName="docCreatorName" orgType="ORG_TYPE_PERSON" showStatus="edit" subject="${lfn:message('fssc-expense:fsscExpenseMain.docCreator')}" style="width:35%;">
				</xform:address>
			</td>
		</tr>
		<tr>
			...
			<td  width=23% >
				<xform:address propertyId="fdClaimantId" propertyName="fdClaimantName" orgType="ORG_TYPE_PERSON" showStatus="edit" subject="${lfn:message('fssc-expense:fsscExpenseMain.fdClaimant')}" style="width:35%;" />
			</td>
		</tr>
		<tr>
		    <!-- 填单日期 -->
	...
	<script language="JavaScript">
	 seajs.use(['lui/dialog','lang!fssc-expense','lang!','lui/util/env'],function(dialog,lang,comlang,env){ 
        ...
        window.selectCompany=function(){
        	...
        	dialogSelect(false,'fssc_base_company_fdCompany','fdCompanyId','fdCompanyName',false,null,function(data){
        		if(!data){
					return;
				}
