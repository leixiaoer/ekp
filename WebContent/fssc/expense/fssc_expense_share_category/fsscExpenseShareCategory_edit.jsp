            ...
            <tr LKS_LabelName="${ lfn:message('fssc-expense:py.JiBenXinXi') }">
                <td>
                    <table class="tb_normal" width="100%">
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('fssc-expense:fsscExpenseShareCategory.fdCategory')}
                            </td>
                            <td colspan="3" width="85.0%">
                                <div id="_xform_fdCode" _xform_type="text">
                                    <xform:dialog propertyName="fdCategoryNames" propertyId="fdCategoryIds" subject="${lfn:message('fssc-expense:fsscExpenseShareCategory.fdCategory')}" style="width:95%">
                                    	dialogSelect(true,'fssc_expense_category_getCategory','fdCategoryIds','fdCategoryNames')
                                    </xform:dialog>
                                </div>
                            </td>
                        </tr>
