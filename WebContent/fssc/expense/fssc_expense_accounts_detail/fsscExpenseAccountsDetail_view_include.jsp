...
<script>
    seajs.use(['lui/dialog'],function(dialog){
    	...
    	window.FSSC_SelectAccount = function(){
    		var index = DocListFunc_GetParentByTagName('TR').rowIndex-1;
    		dialogSelect(false,'fssc_base_account_fdAccount','fdAccountsList_Form[*].fdAccountId','fdAccountsList_Form[*].fdAccountName',null,{fdPersonId:$("input[name='fdClaimantId']").val()},function(rtn){
    			if(rtn){
