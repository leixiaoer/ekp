...
<template:include ref="default.dialog">
	<template:replace name="content"> 
		...
		<br/>
		<p class="txttitle">
			${lfn:message("page.select")}${lfn:message("fssc-base:table.fsscBaseBerth")}
		</p>
					...
					<script>
						function generateTree(){
							LKSTree = new TreeView(
								"LKSTree",
								'${lfn:message("fssc-base:table.fsscBaseVehicle")}',
								document.getElementById("treeDiv")
							);
							LKSTree.ClickNode = function(id){
								node = Tree_GetNodeByID(LKSTree.treeRoot, id);
								var id = node.parameter[0];
								LUI('listview1').source.setUrl('/fssc/base/fssc_base_berth/fsscBaseBerthData.do?method=fdBerth&fdCompanyId=${param.fdCompanyId}&fdVehicleId='+id);
							...
							data.AddBeanData("fsscBaseVehicleService&fdCompanyId=${param.fdCompanyId}");
				...
				<td colspan="3" width="75%">
						<div data-lui-type="lui/search_box!SearchBox">
							<script type="text/config">
								{
									placeholder: "${lfn:message('fssc-base:tips.selectCityTip')}",
									width: '90%'
								}
							</script>
						...
						<ui:source type="AjaxJson" >
							{url:'/fssc/base/fssc_base_berth/fsscBaseBerthData.do?method=fdBerth&fdCompanyId=${param.fdCompanyId }'}
						</ui:source>
