...
<table class="tb_normal feetable"   id="TABLE_DocList_fdDetailList_Form" align="center">
    ...
    <tr KMSS_IsReferRow="1" style="display:none;">
        ...
        <td align="center">
            <div id="_xform_fdDetailList_Form[!{index}].fdRealUserId" _xform_type="address">
                <xform:address propertyId="fdDetailList_Form[!{index}].fdRealUserId" propertyName="fdDetailList_Form[!{index}].fdRealUserName" orgType="ORG_TYPE_PERSON" showStatus="edit" required="true" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdRealUser')}" style="width:85%;" />
            </div>
        </td>
        <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'7')>-1 }">
        <td align="center">
            <div id="_xform_fdDetailList_Form[!{index}].fdDeptId" _xform_type="address">
                <xform:address propertyId="fdDetailList_Form[!{index}].fdDeptId" propertyName="fdDetailList_Form[!{index}].fdDeptName" orgType="ORG_TYPE_DEPT" showStatus="edit"  subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdDept')}"  style="width:90%;" />
            </div>
        </td>
        </c:if>
        <fssc:configEnabled property="fdFinancialSystem" value="SAP">
        ...
        <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'5')>-1 }">
        <td>
       		<xform:datetime property="fdDetailList_Form[!{index}].fdStartDate" validators="checExpensekDate" showStatus="edit" required="true" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdStartDate')}" style="width:85%;" dateTimeType="date"/>
       	</td>
       	</c:if>
        <td align="center">
            <div id="_xform_fdDetailList_Form[!{index}].fdHappenDate" _xform_type="text">
                <xform:datetime property="fdDetailList_Form[!{index}].fdHappenDate" validators="checExpensekDate" showStatus="edit" required="true" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdHappenDate')}" style="width:85%;" dateTimeType="date"/>
            </div>
        </td>
        <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'5')>-1 }">
        <td>
        ...
        <td align="center">
            <div id="_xform_fdDetailList_Form[!{index}].fdPersonNumber" _xform_type="text">
                <xform:text property="fdDetailList_Form[!{index}].fdPersonNumber" required="true" validators="digits min(1)" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdPersonNumber')}" style="width:85%;"/>
            </div>
        </td>
        </c:if>
        <td align="center">
    ...
    <c:forEach items="${fsscExpenseMainForm.fdDetailList_Form}" var="fdDetailList_FormItem" varStatus="vstatus">
        ...
        <tr KMSS_IsContentRow="1">
            ...
            <td align="center">
	            <div id="_xform_fdDetailList_Form[!{index}].fdDeptId" _xform_type="address">
	                <xform:address propertyId="fdDetailList_Form[${vstatus.index}].fdDeptId" propertyName="fdDetailList_Form[${vstatus.index}].fdDeptName" orgType="ORG_TYPE_DEPT" showStatus="edit" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdDept')}"
	                style="width:90%;" />
	            </div>
	        </td>
	        </c:if>
	        ...
	        <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'5')>-1 }">
	        <td>
	       		<xform:datetime property="fdDetailList_Form[${vstatus.index}].fdStartDate" showStatus="edit" validators="checExpensekDate" required="true" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdStartDate')}" style="width:85%;" dateTimeType="date"/>
	       	</td>
	       	</c:if>
            <td align="center">
	            <div id="_xform_fdDetailList_Form[!{index}].fdHappenDate" _xform_type="text">
	                <xform:datetime property="fdDetailList_Form[${vstatus.index}].fdHappenDate" showStatus="edit" validators="checExpensekDate" required="true" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdHappenDate')}" style="width:85%;" dateTimeType="date"/>
	            </div>
	        </td>
	        <c:if test="${fn:indexOf(docTemplate.fdExtendFields,'5')>-1 }">
	        <td>
	        ...
	        <td align="center">
	            <div id="_xform_fdDetailList_Form[${vstatus.index}].fdPersonNumber" _xform_type="text">
	                <xform:text property="fdDetailList_Form[${vstatus.index}].fdPersonNumber" required="true" validators="digits min(1)" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdPersonNumber')}" style="width:85%;"/>
	            </div>
	        </td>
	        </c:if>
            <td align="center">
            ...
            <td align="center">
                <div id="_xform_fdDetailList_Form[${vstatus.index}].fdCurrencyId" _xform_type="dialog">
                    ...
                    <xform:text property="fdDetailList_Form[${vstatus.index}].fdExchangeRate" onValueChange="FSSC_ChangeExchangeRate" showStatus="edit" required="true" subject="${lfn:message('fssc-expense:fsscExpenseDetail.fdExchangeRate')}" style="width:85%;" />
                </div>
            </td>
...
<script src="${LUI_ContextPath }/fssc/base/resource/js/importDetail.js"></script>
<style>
