			...
			routes : [{
				...
				action : {
					...
					options : {
						panelId : 'fsscExpensePanel',
						contents : {
							'fsscExpenseContent' : { title : $lang['DaiFuKuan'], route:{ path: '/listDaiFuKuan' }, cri :{'fdPaymentStatus':'1','j_path':'/listDaiFuKuan'} , selected : true }
						}
					}
				}
			},{
				...
				action : {
					...
					options : {
						panelId : 'fsscExpensePanel',
						contents : {
							'fsscExpenseContent' : { title : $lang['YiFuKuan'], route:{ path: '/listYiFuKuan' }, cri :{'fdPaymentStatus':'2','j_path':'/listYiFuKuan'} , selected : true }
						}
					}
				}
			},{
				...
				action : {
					type : 'pageopen',
					options : {
						url : $var.$contextPath + '/fssc/base/resource/jsp/sysRecycleBox.jsp?modelName=com.landray.kmss.fssc.expense.model.FsscExpenseMain;com.landray.kmss.fssc.expense.model.FsscExpenseBalance;com.landray.kmss.fssc.expense.model.FsscExpenseShareMain',
						target : '_rIframe'
					}
				}
			}]
