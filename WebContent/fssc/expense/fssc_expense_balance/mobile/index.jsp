    ...
    <template:replace name="content">
        <c:choose>
            <c:when test="${ param.filter == '1' }">
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/back/HrefBackMixin" data-dojo-props="href:'/fssc/expense/fssc_expense_balance/mobile/index.jsp'">
                    </div>
                    ...
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/simplecategory/SimpleCategoryDialogMixin" data-dojo-props="icon:'mui mui-ul', modelName:'com.landray.kmss.fssc.expense.model.FsscExpenseBalanceCategory', redirectURL:'/fssc/expense/fssc_expense_balance/mobile/index.jsp?moduleName=!{curNames}&filter=1', filterURL:'/fssc/expense/fssc_expense_balance/fsscExpenseBalance.do?method=data&q.docTemplate=!{curIds}&orderby=docCreateTime&ordertype=down'">
                    </div>
                </div>
                <div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
                    <div data-dojo-type="mui/search/SearchBar" data-dojo-props="modelName:'com.landray.kmss.fssc.expense.model.FsscExpenseBalance',needPrompt:false,height:'3.8rem'">
                    </div>
            ...
            <c:otherwise>
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/nav/MobileCfgNavBar" data-dojo-props="defaultUrl:'/fssc/expense/fssc_expense_balance/mobile/nav.jsp', modelName:'com.landray.kmss.fssc.expense.model.FsscExpenseBalance'">
                    </div>
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/Folder" data-dojo-props="tmplURL:'/fssc/expense/fssc_expense_balance/mobile/query.jsp'"></div>
                </div>
        ...
        <ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom">
            ...
            <li data-dojo-type="mui/tabbar/TabBarButtonGroup" data-dojo-props="icon1:'mui mui-more'">
                ...
                <div data-dojo-type="mui/tabbar/TabBarButton" data-dojo-props="icon1:'mui mui-ul', href:'/fssc/expense/fssc_expense_main/mobile/index.jsp', label:'${lfn:message('fssc-expense:table.fsscExpenseMain')}'">
                </div>
