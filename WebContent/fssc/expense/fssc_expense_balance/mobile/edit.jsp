                                        ...
                                        <td>
                                            <div id="_xform_fdVoucherTypeId" _xform_type="radio">
                                                <xform:radio property="fdVoucherTypeId" htmlElementProperties="id='fdVoucherTypeId'" showStatus="edit" mobile="true">
                                                    <xform:beanDataSource serviceBean="fsscBaseVoucherTypeService" selectBlock="fdId,fdName" />
                                                </xform:radio>
                                            </div>
                                        </td>
                                    </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdExpenseItemId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdExpenseItemId',nameField:'fdDetailList_Form[!{index}].fdExpenseItemName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseExpenseItem',dataURL:getSource('fssc_base_expense_item_fdParent'),subject:'${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdExpenseItem')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCostCenterId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCostCenterId',nameField:'fdDetailList_Form[!{index}].fdCostCenterName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCostCenter',dataURL:getSource('fssc_base_cost_center_selectCostCenter'),subject:'${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdCostCenter')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdCashFlowId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdCashFlowId',nameField:'fdDetailList_Form[!{index}].fdCashFlowName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCashFlow',dataURL:getSource('fssc_base_cash_flow_getCashFlow'),subject:'${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdCashFlow')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div id="_xform_fdDetailList_Form[!{index}].fdProjectId" _xform_type="dialog">
                                                                                        <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[!{index}].fdProjectId',nameField:'fdDetailList_Form[!{index}].fdProjectName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseProject',dataURL:getSource('fssc_base_project_project'),subject:'${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdProject')}',afterSelect:afterDialogSel">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div id="_xform_fdDetailList_Form[${vstatus.index}].fdCashFlowId" _xform_type="dialog">
                                                                                            <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[${vstatus.index}].fdCashFlowId',nameField:'fdDetailList_Form[${vstatus.index}].fdCashFlowName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseCashFlow',dataURL:getSource('fssc_base_cash_flow_getCashFlow'),subject:'${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdCashFlow')}',curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscExpenseBalanceForm.fdDetailList_Form[vstatus.index].fdCashFlowId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscExpenseBalanceForm.fdDetailList_Form[vstatus.index].fdCashFlowName))}',afterSelect:afterDialogSel">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div id="_xform_fdDetailList_Form[${vstatus.index}].fdProjectId" _xform_type="dialog">
                                                                                            <div data-dojo-type="mui/form/CommonDialog" data-dojo-props="idField:'fdDetailList_Form[${vstatus.index}].fdProjectId',nameField:'fdDetailList_Form[${vstatus.index}].fdProjectName',isMul:false,modelName:'com.landray.kmss.fssc.base.model.FsscBaseProject',dataURL:getSource('fssc_base_project_project'),subject:'${lfn:message('fssc-expense:fsscExpenseBalanceDetail.fdProject')}',curIds:'${lfn:escapeHtml(lfn:escapeJs(fsscExpenseBalanceForm.fdDetailList_Form[vstatus.index].fdProjectId))}',curNames:'${lfn:escapeHtml(lfn:escapeJs(fsscExpenseBalanceForm.fdDetailList_Form[vstatus.index].fdProjectName))}',afterSelect:afterDialogSel">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
