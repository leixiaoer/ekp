...
<%@ taglib uri="/WEB-INF/KmssConfig/sys/person/person.tld" prefix="person"%>
		<div class="muiFlowInfoW muiFormContent">
				<div class="muiFormSubject">
				 ...
				 <c:if test="${fsscExpenseBalanceForm.docStatus eq '30'}">
                 ...
                 <c:if test="${fsscExpenseBalanceForm.docStatus eq '00'}">
					...
					<tr>
						<td rowspan="2" class="muiFlowIconTd">
							 <div class="muiProcessIcon">
			                    <img class="muiProcessImg" src='<person:headimageUrl contextPath="true"  personId="${fsscExpenseBalanceForm.docCreatorId}" size="m" />'/>
			                </div>
						...
						<td class="muiFlowSummary">
							<div>${lfn:message('fssc-expense:fsscExpenseBalance.docTemplate') }：<c:out value="${fsscExpenseBalanceForm.docTemplateName}" /> </div>
							<div>${lfn:message('fssc-expense:fsscExpenseBalance.docNumber') }： <c:out value="${fsscExpenseBalanceForm.docNumber}" /></div>
							<div>${lfn:message('fssc-expense:fsscExpenseBalance.docCreateTime') }： <c:out value="${fsscExpenseBalanceForm.docCreateTime}" /></div>
						</td>
					</tr>
				</table>
			</div>
