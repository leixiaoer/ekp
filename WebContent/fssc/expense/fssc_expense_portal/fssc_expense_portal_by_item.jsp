...
<script type="text/javascript">
   ...
   <body style="height:100%;margin:0 auto;">
       ...
       <div id="container" style="height:95%;width:96%;"></div>
       ...
       function changeMap(){
    	   var data1 = new KMSSData();
			...
			var rtn1 = data1.AddBeanData("fsscExpensePortalService&authCurrent=true&fdType=checkSubject&fdCompanyId="+fdCompanyId).GetHashMapArray();
			if(rtn1.length>0){
