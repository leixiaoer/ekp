...
seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic', 'lui/dialog_common','lang!fssc-ledger','lang!'], function($, dialog, topic, dialogCommon,lang,comlang) {
    var option = window.listOption;
    ...
    window.deleteAllOfInvoice = function() {
        var selected = [];
        $("input[name='List_Selected']:checked").each(function() {
            selected.push($(this).val());
        });
