...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('fssc-ledger:module.fssc.ledger') }-${ lfn:message('fssc-ledger:table.fsscLedgerMaterialStock') }" />
    </template:replace>
    ...
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('fssc-ledger:table.fsscLedgerMaterialStock') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/fssc/ledger/fssc_ledger_material_stock/fsscLedgerMaterialStock.do"} ]
            </ui:varParam>
        </ui:combin>
    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="3">
                            ...
                            <kmss:auth requestURL="/fssc/ledger/fssc_ledger_material_stock/fsscLedgerMaterialStock.do?method=add">
                                <ui:button text="${lfn:message('button.add')}" onclick="addDoc()" order="2" />
                            </kmss:auth>
                            <kmss:auth requestURL="/fssc/ledger/fssc_ledger_material_stock/fsscLedgerMaterialStock.do?method=deleteall">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/fssc/ledger/fssc_ledger_material_stock/fsscLedgerMaterialStock.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/fssc/ledger/fssc_ledger_material_stock/fsscLedgerMaterialStock.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdModelId;fdModelName;fdStockId;fdWarehousingDate;fdUnit;fdPrice;fdQuantity;fdModel" url="" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
        <script>
            var listOption = {
                ...
                jPath: 'material_stock',
                modelName: 'com.landray.kmss.fssc.ledger.model.FsscLedgerMaterialStock',
                templateName: '',
