...
<template:include ref="mobile.list">
    ...
    <template:replace name="head">
        ...
        <script type="text/javascript" src="${LUI_ContextPath}/fssc/ledger/resource/js/mobile_list.js?s_cache=${MUI_Cache}"></script>
    </template:replace>
    <template:replace name="content">
        <c:choose>
            <c:when test="${ param.filter == '1' }">
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/_Folder,mui/back/HrefBackMixin" data-dojo-props="href:'/fssc/ledger/fssc_ledger_invoice/mobile/index.jsp'">
                    </div>
                ...
                <div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
                    <div data-dojo-type="mui/search/SearchBar" data-dojo-props="modelName:'com.landray.kmss.fssc.ledger.model.FsscLedgerInvoice',needPrompt:false,height:'3.8rem'">
                    </div>
            ...
            <c:otherwise>
                <div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
                    <div data-dojo-type="mui/nav/MobileCfgNavBar" data-dojo-props="defaultUrl:'/fssc/ledger/fssc_ledger_invoice/mobile/nav.jsp', modelName:'com.landray.kmss.fssc.ledger.model.FsscLedgerInvoice'">
                    </div>
                    <div data-dojo-type="mui/header/HeaderItem" data-dojo-mixins="mui/folder/Folder" data-dojo-props="tmplURL:'/fssc/ledger/fssc_ledger_invoice/mobile/query.jsp'"></div>
                </div>
        ...
        <ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom">
            ...
            <kmss:auth requestURL="/fssc/ledger/fssc_ledger_invoice/fsscLedgerInvoice.do?method=add">
                <li data-dojo-type="mui/tabbar/CreateButton" data-dojo-props="_onClick:function(){location='${LUI_ContextPath}/fssc/ledger/fssc_ledger_invoice/fsscLedgerInvoice.do?method=add'}">
