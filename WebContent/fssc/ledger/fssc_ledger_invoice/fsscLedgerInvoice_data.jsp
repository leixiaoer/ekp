...
<list:data>
    <list:data-columns var="fsscLedgerInvoice" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column col="fdTotalAmount" title="${lfn:message('fssc-ledger:fsscLedgerInvoice.fdTotalAmount')}" >
         	<c:choose>
				<c:when test="${not empty fsscLedgerInvoice.fdTotalAmount}"><kmss:showNumber value="${fsscLedgerInvoice.fdTotalAmount}" pattern="#0.00"/></c:when>
				<c:when test="${empty fsscLedgerInvoice.fdTotalAmount}">""</c:when>
			</c:choose>
        </list:data-column>
        ...
        <list:data-column col="fdTotalTax" title="${lfn:message('fssc-ledger:fsscLedgerInvoice.fdTotalTax')}" >
         	<c:choose>
				<c:when test="${not empty fsscLedgerInvoice.fdTotalTax}"><kmss:showNumber value="${fsscLedgerInvoice.fdTotalTax}" pattern="#0.00"/></c:when>
				<c:when test="${empty fsscLedgerInvoice.fdTotalTax}">""</c:when>
			</c:choose>
        </list:data-column>
        ...
        <list:data-column col="fdCheckStatus" title="${lfn:message('fssc-ledger:fsscLedgerInvoice.fdCheckStatus')}">
            <sunbor:enumsShow value="${fsscLedgerInvoice.fdCheckStatus}" enumsType="fssc_invoice_check_status" />
        </list:data-column>
        <list:data-column col="fdUseStatus" title="${lfn:message('fssc-ledger:fsscLedgerInvoice.fdUseStatus')}">
            <sunbor:enumsShow value="${fsscLedgerInvoice.fdUseStatus}" enumsType="fssc_invoice_use_status" />
        </list:data-column>
        ...
        <list:data-column col="fdJshj" title="${lfn:message('fssc-ledger:fsscLedgerInvoice.fdJshj')}" >
        	<c:choose>
				<c:when test="${not empty fsscLedgerInvoice.fdJshj}"><kmss:showNumber value="${fsscLedgerInvoice.fdJshj}" pattern="#0.00"/></c:when>
				<c:when test="${empty fsscLedgerInvoice.fdJshj}">""</c:when>
			</c:choose>
        </list:data-column>
