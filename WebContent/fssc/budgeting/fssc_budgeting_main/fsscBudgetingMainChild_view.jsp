...
<template:include ref="default.view">
    <template:replace name="head">
        ...
        <script type="text/javascript">
            var formInitData = {
            		parentAmountJson:'${parentAmountJson}',
                	canApplyAmountJson:'${canApplyAmountJson}',
            };
            var messageInfo = {
            ...
            Com_IncludeFile("fsscBudgetingMainChild_view.js|budgeting_common.js", "${LUI_ContextPath}/fssc/budgeting/fssc_budgeting_main/", "js", true);
        ...
        <ui:content title="${ lfn:message('fssc-budgeting:py.JiBenXinXi') }" expand="true" id="main_content">
         <table class="tb_normal" width="100%">
             ...
             <tr>
                 <td colspan="6" width="100%">
                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetailChild_view.jsp" charEncoding="UTF-8"></c:import>
                 </td>
             </tr>
         </table>
         </ui:content>
         ...
         <%-- <ui:content title="${ lfn:message('fssc-budgeting:fssc.budgeting.quarter') }" expand="false">
         	<table class="tb_normal" width="100%">
	             <tr>
	                 <td>
	                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetailChildQuarter_view.jsp" charEncoding="UTF-8"></c:import>
	                 </td>
	             </tr>
            </table>
         </ui:content>
         <ui:content title="${ lfn:message('fssc-budgeting:fssc.budgeting.half.year') }" expand="false">
         	<table class="tb_normal" width="100%">
	             <tr>
	                 <td>
	                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetailChildHalfYear_view.jsp" charEncoding="UTF-8"></c:import>
	                 </td>
	             </tr>
            </table>
         </ui:content> --%>
         <ui:content title="${ lfn:message('fssc-budgeting:fssc.budgeting.year') }" expand="false">
         	<table class="tb_normal" width="100%">
	             <tr>
	                 <td>
	                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetailChildYear_view.jsp" charEncoding="UTF-8"></c:import>
	                 </td>
	             </tr>
            </table>
