...
<template:include ref="default.view">
    <template:replace name="head">
        ...
        <script type="text/javascript">
            ...
            Com_IncludeFile("fsscBudgetingMainIndependent_view.js||budgeting_common.js", "${LUI_ContextPath}/fssc/budgeting/fssc_budgeting_main/", "js", true);
        ...
        <ui:content title="${ lfn:message('fssc-budgeting:py.JiBenXinXi') }" expand="true" id="main_content">
         <table class="tb_normal" width="100%">
             ...
             <tr>
                 <td colspan="6" width="100%">
                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetailIndependent_view.jsp" charEncoding="UTF-8"></c:import>
                 </td>
             </tr>
             <tr>
                  <td class="td_normal_title" width="12.5%">
         ...
         <ui:content title="${ lfn:message('fssc-budgeting:fssc.budgeting.quarter') }" expand="false">
         	<table class="tb_normal" width="100%">
	             <tr>
	                 <td>
	                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingInitIndepQuarter_view.jsp" charEncoding="UTF-8"></c:import>
	                 </td>
	             </tr>
            </table>
         </ui:content>
         <ui:content title="${ lfn:message('fssc-budgeting:fssc.budgeting.half.year') }" expand="false">
         	<table class="tb_normal" width="100%">
	             <tr>
	                 <td>
	                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingInitIndepHalfYear_view.jsp" charEncoding="UTF-8"></c:import>
	                 </td>
	             </tr>
            </table>
         </ui:content>
         <ui:content title="${ lfn:message('fssc-budgeting:fssc.budgeting.year') }" expand="false">
         	<table class="tb_normal" width="100%">
	             <tr>
	                 <td>
	                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingInitIndepYear_view.jsp" charEncoding="UTF-8"></c:import>
	                 </td>
	             </tr>
            </table>
