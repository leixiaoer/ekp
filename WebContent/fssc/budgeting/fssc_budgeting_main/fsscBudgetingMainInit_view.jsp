...
<template:include ref="default.view">
    <template:replace name="head">
        ...
        <script type="text/javascript">
            ...
            Com_IncludeFile("fsscBudgetingMainInit_view.js||budgeting_common.js", "${LUI_ContextPath}/fssc/budgeting/fssc_budgeting_main/", "js", true);
         ...
         <table class="tb_normal" width="100%">
             ...
             <tr>
                 <td colspan="6" width="100%">
                     <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetailInit_view.jsp" charEncoding="UTF-8"></c:import>
                 </td>
             </tr>
             <tr>
                  <td class="td_normal_title" width="12.5%">
