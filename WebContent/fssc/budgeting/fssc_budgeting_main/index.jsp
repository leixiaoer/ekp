...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('fssc-budgeting:module.fssc.budgeting') }-${ lfn:message('fssc-budgeting:table.fsscBudgetingMain') }" />
    </template:replace>
    <template:replace name="path">
        <ui:menu layout="sys.ui.menu.nav">
            <ui:menu-item text="${ lfn:message('home.home') }" icon="lui_icon_s_home" href="/" target="_top" />
            <ui:menu-item text="${ lfn:message('fssc-budgeting:table.fsscBudgetingMain') }" />
        </ui:menu>
    </template:replace>
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('fssc-budgeting:table.fsscBudgetingMain') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/fssc/budgeting/fssc_budgeting_main/fsscBudgetingMain.do"} ]
            </ui:varParam>
        </ui:combin>
            ...
            <ui:accordionpanel>
                ...
                <ui:content title="${ lfn:message('list.otherOpt') }">
                    <ul class='lui_list_nav_list'>
                        ...
                        <li><a href="${LUI_ContextPath}/fssc/budgeting/fssc_budgeting_org/index.jsp${j_iframe}">${lfn:message('fssc-budgeting:table.fsscBudgetingOrg')}</a>
                        </li>
