...
<template:include ref="default.edit">
    <template:replace name="head">
        ...
        <script type="text/javascript">
            ...
            Com_IncludeFile("form_option.js", "${LUI_ContextPath}/fssc/budgeting/fssc_budgeting_main/", 'js', true);
            Com_IncludeFile("config_edit.js", "${LUI_ContextPath}/fssc/budgeting/resource/js/", 'js', true);
            Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
            Com_IncludeFile("fsscBudgetingMain_edit.js|budgeting_common.js", "${LUI_ContextPath}/fssc/budgeting/fssc_budgeting_main/", "js", true);
              ...
              <table class="tb_normal" width="100%">
                  ...
                  <tr>
                      ...
                      <td width="12.5%" style="text-align: left;">
                          ...
                          <div id="_xform_fdChildTotalMoney" _xform_type="text">
                              <xform:text property="fdChildTotalMoney" value="${fsscBudgetingMainForm.fdChildTotalMoney}" showStatus="readOnly" style="width:95%;color:#333;" />
                          </div>
                      </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      <td colspan="6" width="100%">
                          <c:import url="/fssc/budgeting/fssc_budgeting_detail/fsscBudgetingDetail_edit.jsp" charEncoding="UTF-8"></c:import>
                      </td>
                  </tr>
              </table>
