define(["mui/util"], function(util) {
  function portletLoad(params, load) {
    ...
    var html =
      ...
      "data-dojo-props=\"url:'/kms/knowledge/kms_knowledge_base_doc/kmsKnowledgeBaseDocIndex.do?method=listChildren&orderby=!{orderby}&ordertype=!{ordertype}&rowsize=!{rowsize}&categoryId=!{categoryId}&q.docIsIntroduced=!{docIsIntroduced}&q.docStatus=30',lazy:false,pic:false\">" +
      "</div>"
