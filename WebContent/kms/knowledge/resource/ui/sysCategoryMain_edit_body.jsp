...
<c:set var="tempEditor" value="${lfn:message('kms-knowledge:kmsKnowledgeCategory.description.main.tempEditor') }"></c:set>	
...
<c:if test="${kms_professional}">	
	...
	%>
		...
		<c:set var="tempEditor" value="${lfn:message('kms-knowledge:kmsKnowledgeCategory.description.main.tempEditor.categoryTrue') }"></c:set>
