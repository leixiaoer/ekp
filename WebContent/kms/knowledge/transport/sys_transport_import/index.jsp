	...
	<template:replace name="content">
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/sys/transport/sys_transport_import/SysTransportImport.do?method=list&fdModelName=${JsParam.fdModelName}'}
			</ui:source>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable" 
				rowHref="/kms/knowledge/transport/sys_transport_import/SysTransportImport.do?method=view&fdId=!{fdId}&fdModelName=${JsParam.fdModelName}&type=${JsParam.type}">
	 	...
	 	<script type="text/javascript">
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
				...
				topic.subscribe('successReloadPage', function() {
			 	...
			 	// 增加
		 		window.add = function() {
		 			Com_OpenWindow('<c:url value="/kms/knowledge/transport/sys_transport_import/SysTransportImport.do" />?method=add&fdModelName=${JsParam.fdModelName}&type=${JsParam.type}');
		 		};
		 		// 编辑
		 		window.edit = function(id) {
			 		if(id)
		 				Com_OpenWindow('<c:url value="/kms/knowledge/transport/sys_transport_import/SysTransportImport.do" />?method=edit&fdId=' + id + '&fdModelName=${JsParam.fdModelName}&type=${JsParam.type}');
		 		};
		 		// 删除
