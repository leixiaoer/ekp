...
<template:include ref="default.edit" sidebar="no" showTop="false">
	...
	<template:replace name="toolbar">
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
		   <ui:button text="${lfn:message('button.submit')}" order="1" onclick="addDoc();"></ui:button>
		   <ui:button text="${lfn:message('kms-knowledge:kmsKnowledge.button.batchUpdate')}" order="2" onclick="batchUpdate();"></ui:button>
		   <ui:button text="${lfn:message('button.delete')}" order="3" onclick="deleteUpdate();"></ui:button>
		</ui:toolbar>
    </template:replace>
