...
<table border="0" width="95%">
		...
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;基础请求对象：IkmsWikiSearchCategoryWSServiceService</div>
		...
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;知识仓库类别查询服务地址：http://localhost:8080/ekp/sys/webservice/kmsWikiSearchCategoryWSService?wsdl<br/>&nbsp;&nbsp;类别查询服务接口：IkmsWikiSearchCategoryWSServiceService</div>
						<table class="tb_normal" width=100%>
							<tr class="tr_normal_title">
	...
	<tr style="display: none">
		<td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<tns:RequestSOAPHeader xmlns:tns='http://localhost:8080/ekp/sys/webservice/kmsWikiSearchCategoryWSService'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</tns:RequestSOAPHeader>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Header>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<soap:Body>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<ser:searchCategoryList xmlns:ns2='http://service.category.webservice.wiki.kms.kmss.landray.com/'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<arg0>"/><br/>
