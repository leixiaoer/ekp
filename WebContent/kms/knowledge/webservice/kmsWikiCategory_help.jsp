...
<table border="0" width="95%">
		...
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;服务地址：http://localhost:8080/ekp/sys/webservice/kmsWikiMaintainCategoryWSService?wsdl<br/>&nbsp;&nbsp;类别维护服务接口：IKmsWikiMaintainCategoryWSServiceService</div>
						<table class="tb_normal" width=100%>
							...
							<tr>
								...
								<td>KmsMaintainCategoryResponseaddCategories(List(KmsWikiMaintainCategoryRequest) requests) throws KmsFaultException
								</td>
							</tr>
							<tr>
								...
								<td>String updateCategory(KmsWikiMaintainCategoryRequestrequest) throws KmsFaultException</td>
							</tr>
							<tr>
								<td>delCategory</td>
								...
								<td>Successful或者是Failed</td>
								<td>tring delCategory(KmsWikiMaintainCategoryRequestrequest) throws KmsFaultException</td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				...
				<tr>
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;知识仓库请求对象：KmsWikiMaintainCategoryRequest(继承基础请求对象)</div>
						<table class="tb_normal" width=100%>
							<tr class="tr_normal_title">
								<td align="center" style="width: 30%"><b>字段名</b></td>
								<td align="center" style="width: 30%"><b>描述</b></td>
	...
	<tr style="display: none">
		<td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<tns:RequestSOAPHeader xmlns:tns='http://localhost:8080/ekp10.0_last_new/sys/webservice/kmsWikiMaintainCategoryWSService'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<tns:user xmlns='http://localhost:8080/ekp10.0_last_new/sys/webservice/kmsWikiMaintainCategoryWSService'>chenliang</tns:user>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<tns:password xmlns='http://localhost:8080/ekp10.0_last_new/sys/webservice/kmsWikiMaintainCategoryWSService'>b700ba5df2e2d5a4fef24d020ab8c47e</tns:password>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<tns:service	xmlns='http://localhost:8080/ekp10.0_last_new/sys/webservice/kmsWikiMaintainCategoryWSService'>kmsWikiWebserviceService</tns:service>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</tns:RequestSOAPHeader>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Header>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<soap:Body>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<ns2:addCategories xmlns:ns2='http://service.category.webservice.wiki.kms.kmss.landray.com/'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<arg0>"/><br/>
	...
	<tr style="display: none">
		<td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Header>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<soap:Body>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<ns2:updateCategory xmlns:ns2='http://service.category.webservice.wiki.kms.kmss.landray.com/'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<arg0>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<priviledgeKey>abcldlllllllllllllllll</priviledgeKey>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<relateId>123445678</relateId>"/><br/>
	...
	<tr style="display: none">
		<td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="</soap:Header>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<soap:Body>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<ns2:delCategory xmlns:ns2='http://service.category.webservice.wiki.kms.kmss.landray.com/'>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<arg0>"/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<c:out  value="<priviledgeKey>abcldlllllllllllllllll</priviledgeKey>"/><br/>
