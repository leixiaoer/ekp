...
<tr>
	...
	<td>
	    <label><input checked="true" type="checkbox" name="${luivarid}" value="fdScore">&nbsp;${lfn:message('kms-knowledge:kmsKnowledge.portlet.knowledge.score') }</label>&nbsp;&nbsp;
	    <label><input type="checkbox" name="${luivarid}" value="fdRich">&nbsp;${lfn:message('kms-knowledge:kmsKnowledge.portlet.knowledge.rich') }</label>&nbsp;&nbsp;<span class="com_help"></span>
	</td>
</tr>