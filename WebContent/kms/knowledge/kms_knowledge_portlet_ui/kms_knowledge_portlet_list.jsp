...
<ui:dataview>
	...
	<ui:source type="AjaxJson">
		{url:'/kms/knowledge/kms_knowledge_portlet/kmsKnowledgePortlet.do?method=getKnowledgeBaseDocList&rowsize=${JsParam.rowsize}&categoryId=${JsParam.categoryId}&type=${JsParam.type}&scope=${JsParam.scope}'}
	</ui:source>
</ui:dataview>
