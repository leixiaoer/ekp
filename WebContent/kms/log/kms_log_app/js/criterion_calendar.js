define(function(require, exports, module) {
	...
	var getLastWeek = function() {
		...
		return init_date.formatDate(lastDate);
	}
	...
	var CriterionCalendarDatas = CriterionInputDatas.extend({
		...
		startup : function($super) {
			...
			if(this.isDate) {
				...
				this.allDates[this.TYPE_WEEK] = [getLastWeek(), init_date.getToday()];
				
				this.allDates[this.TYPE_MONTH] = [getLastMonth(), init_date.getToday()];
				
				this.allDates[this.TYPE_3MONTH] = [getLast3Month(), init_date.getToday()];
				
				this.allDates[this.TYPE_HALFYEAR] = [getLastHalfYear(), init_date.getToday()];
				
				this.allDates[this.TYPE_YEAR] = [getLastYear(), init_date.getToday()];
			}
