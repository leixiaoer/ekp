...
<tr>
	<td class="td_normal_title" width=15%>
		...
		<a href="javascript:void(0)"
			onclick="recordProTemId();
		Dialog_TreeList(false,'fdSysPropTemplateId','fdSysPropTemplateName', null, 'sysPropertyTemplateListService&fdParentId=!{value}&fdModelName=${param.mainModelName}', '<bean:message bundle="sys-property" key="table.sysPropertyTemplate" />', 'sysPropertyDataListService&categoryId=!{value}&fdModelName=${param.mainModelName}',updateNotice, 'sysPropertyDataListService&key=!{keyword}&type=search&fdModelName=${param.mainModelName}');">
