            ...
            <list:listview id="listview">
                ...
                <list:colTable isDefault="false" name="columntable">
                    ...
                    <list:col-html
                        ...
                        {$
                        {%row['icon']%}
                        <a href="${pageContext.request.contextPath}/sns/group/sns_group_main/snsGroupMain.do?method=view&fdId={%row['fdId']%}" target="_black">{%row['docSubject']%}</a>
                        $}
                    </list:col-html>
            ...
            seajs.use(['lui/jquery', 'lui/dialog'], function ($, dialog) {
                ...
                window.onSubmit = function () {
                    ...
                    if (values.length > 1 && !${param.mulSelect}) {
                        dialog.alert("${ lfn:message('kms-common:kmsShareMain.circle.selectExcessMain')}");
                        return false;
                    } else if (values.length < 1) {
                        dialog.alert("${ lfn:message('kms-common:kmsShareMain.circle.selectNoMain')}");
                        return false;
                    }
                    var rtn = [];
