									...
									<tr>
										...
										<td width="100%" id="innerAuthor" <c:if test="${empty kmsMultidocKnowledgeForm.fdDocAuthorList }">style="display: none;"</c:if> >
											<c:if test="${empty kmsMultidocKnowledgeForm.fdDocAuthorList }">
												<xform:address mobile="true"  onValueChange="changeAuthodInfo" mulSelect="true" isLoadDataDict="false" style="width:100%" propertyId="docAuthorId" propertyName="docAuthorName" orgType='ORG_TYPE_PERSON'  subject="${lfn:message('sys-doc:sysDocBaseInfo.docAuthor') }" ></xform:address>
											</c:if>
