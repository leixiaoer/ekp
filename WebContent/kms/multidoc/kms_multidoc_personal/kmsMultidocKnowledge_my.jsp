...
<list:criteria>
	...
	<list:cri-ref cfg-if="criteria('mydoc')[0]!='create'" key="fdDocAuthorList"  ref="criterion.sys.person"  multi="false" expand="false"
...
<div class="lui_list_operation">
	<div class="lui_list_operation_order_text"> ${lfn:message('kms-knowledge:kmsKnowledge.list.orderType')}：</div>
	<%--排序按钮  --%>
...
<list:listview id="listview">
	<ui:source type="AjaxJson">
		{url:'/kms/knowledge/kms_knowledge_base_doc/kmsKnowledgeBaseDocIndex.do?method=listChildren&orderby=${fdOrderBy}&ordertype=down&q.template=1'}
	</ui:source>
	...
	<list:gridTable name="gridtable" columnNum="4"
		...
		<ui:source type="AjaxJson">
			{url:'/kms/knowledge/kms_knowledge_base_doc/kmsKnowledgeBaseDocIndex.do?method=listChildren&orderby=${fdOrderBy}&ordertype=down&dataType=pic&rowsize=12&q.template=1'}
		</ui:source>
	...
	<list:colTable layout="sys.ui.listview.columntable"
		...
		rowHref="/kms/knowledge/kms_knowledge_base_doc/kmsKnowledgeBaseDoc.do?method=view&fdId=!{fdId}&fdKnowledgeType=!{fdKnowledgeType}">
		<ui:source type="AjaxJson"> 
			{url:'/kms/knowledge/kms_knowledge_base_doc/kmsKnowledgeBaseDocIndex.do?method=getSysAttList&orderby=${fdOrderBy}&q.template=1'}
		</ui:source>
