...
<table border="0" width="95%">
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;3.1&nbsp;&nbsp;更新组织架构信息服务（updateOrgInfo）样例
			<img src="${KMSS_Parameter_StylePath}icons/expand.gif" border="0" align="bottom"/>
		</td>
	</tr>
	<tr style="display: none">
...
public static void main(String[] args) throws Exception {
	...
	IThirdImSyncForKKWebService service = (IThirdImSyncForKKWebService) callService(
			"http://localhost:8080/ekp/sys/webservice/thirdImSyncForKKWebService",
			cfg.getServiceClass());
	// 请在此处添加业务代码
	ThirdImKKOrgSyncContext context = new ThirdImKKOrgSyncContext();
	context.setOrgInfo(null);
	ThirdImKKSyncResult result = service.updateOrgInfo(context);
	if (result != null) {
