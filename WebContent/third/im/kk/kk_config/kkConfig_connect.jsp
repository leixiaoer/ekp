            ...
            <section class="integra-con" v-show="base.page1" style="width: 1000px;">
                <ul>
                    ...
                    <li class="bdbuttom pdleft">
                        <label>
                            <div class="integra-list integra-listbox">
                                <div><span class="corp-xitong">${lfn:message('third-im-kk:kk.config.connect.secretKey')}: </span><span class="miyao" >${secret }</span></div>
                    ...
                    <li class="bdbuttom pdleft">
                        <label>
                            <div class="integra-list integra-listbox">
                                <div><span class="corp-xitong">${lfn:message('third-im-kk:kk.config.connect.title')}:</span><span style="color: #1d2ae4;cursor:pointer;" secret="${secret }" onclick="exchangeSecret();">${lfn:message('third-im-kk:kk.config.connect.exchange')}</span></div>
                            </div>
                        </label>
                    </li>
                    <li class="bdbuttom pdleft">
                        <label for="">
                            <div class="integra-list integra-listbox">
                                <div>
                                	<span class="corp-xitong">${lfn:message('third-im-kk:kk.config.connect.status')}:</span>
                                	<span class="app" v-for="app in appListData" id="connectionMsg">
				                   		${lfn:message('third-im-kk:kk.config.connect.wait')}
				                    </span>
                                </div>
                            </div>
                        </label>
                ...
                <button class="integra-btn active" id="nextBtn" onclick="submit();" disabled="disabled">${lfn:message('third-im-kk:kk.config.connect.next')}</button>
            </section>
        </section>
