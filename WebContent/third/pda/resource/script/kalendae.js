...
Kalendae.Input.prototype = util.merge(Kalendae.prototype, {
	...
	show : function () {
		...
		var clientWidth = bodyVar.offsetWidth;
		if(clientWidth==null || clientWidth==0)
			clientWidth = bodyVar.clientWidth?bodyVar.clientWidth:clientWidth;
		style.display = '';
		switch (opts.side) {
			case 'left':
			...
			case 'bottom':
				/* falls through */
				var left = (pos.left>clientWidth?(clientWidth-10):pos.left)- util.getWidth($container);
				style.left = ((left<0?10:left) + this.settings.offsetLeft) + 'px';
...
var moment = Kalendae.moment = (function (Date, undefined) {
    ...
    moment.lang('zh_CN', {
        months : window.lang_Calender?lang_Calender['month'].split("_"):"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
        monthsShort : "1_2_3_4_5_6_7_8_9_10_11_12".split("_"),
        weekdays : window.lang_Calender?lang_Calender["week"].split("_"):"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
        weekdaysShort : window.lang_Calender?lang_Calender["simWeek"].split("_"):"Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),
        longDateFormat : {
            LT : "h:mm A",
            L : "MM/DD/YYYY",
            LL : "MMMM D YYYY",
