...
<%
	...
	if(PdaFlagUtil.checkClientIsPdaApp(request)){
		...
		out.println("\"message\":\""+ResourceUtil.getString("return.optFailure")+"\"");
		out.println("}");
	}else{
%>
<%@include file="/third/pda/htmlhead.jsp"%>
	...
	<body>
		...
		<center>
			<div style="position:relative;width:120px;margin-top: 100px; padding-left:65px;text-align:left;height:64px;background:url('<c:url value="/third/pda/resource/images/ico_error.png"/>') left no-repeat;">
				<br/>
				&nbsp;&nbsp;<b style="font-size: 15px;font-weight: bolder"><bean:message key="return.optFailure" /></b>
				<br/>
				...
				<%=ResourceUtil.getString(request.getSession(), "third-pda","phone.return.msg1")%>
			</div>
		</center>	
	</body>
</html>
