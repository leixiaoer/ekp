...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('third-ding-notify:module.third.ding') }-${ lfn:message('third-ding-notify:table.thirdDingNotifyWorkrecord') }" />
    </template:replace>
    <template:replace name="path">
        <ui:menu layout="sys.ui.menu.nav">
            <ui:menu-item text="${ lfn:message('home.home') }" icon="lui_icon_s_home" href="/" target="_top" />
            <ui:menu-item text="${ lfn:message('third-ding-notify:table.thirdDingNotifyWorkrecord') }" />
        </ui:menu>
    </template:replace>
