    ...
    <template:include ref="config.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/third/ding/third_ding_work/thirdDingWork.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('thirdDingWork.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/third/ding/third_ding_work/thirdDingWork.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('thirdDingWork.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <%-- <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('third-ding:table.thirdDingWork') }" href="/third/ding/third_ding_work/" target="_self" />
            </ui:menu>
        </template:replace> --%>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div id="_xform_fdSecret" _xform_type="text">
                                    <xform:text property="fdSecret" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
                        <tr>
