...
<script type="text/javascript">
	if ("${thirdDingLeavelogForm.fdEkpUserid}" != "") {
		window.document.title = "${thirdDingLeavelogForm.docSubject} - aaa  ${ lfn:message('third-ding:table.thirdDingLeavelog') }";
	}
...
<p class="txttitle">${ lfn:message('third-ding:thirdDingLeavelog.switch') }</p>
<center>
