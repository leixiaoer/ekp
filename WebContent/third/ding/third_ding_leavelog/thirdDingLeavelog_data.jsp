...
<list:data>
    <list:data-columns var="thirdDingLeavelog" list="${queryPage.list}" varIndex="status" custom="false">
        ...
        <list:data-column col="docCreator.name" title="${lfn:message('third-ding:third.ding.leave.user')}" escape="false">
        ...
        <list:data-column property="fdSubType" title="${lfn:message('third-ding:thirdDingLeavelog.fdSubType')}" />
