        ...
        <div style="margin:5px 10px;">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/third/ding/third_ding_leavelog/thirdDingLeavelog.do?method=checkData')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable rowHref="/third/ding/third_ding_leavelog/thirdDingLeavelog.do?method=checkView&fdId=!{fdId}" isDefault="false" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
        ...
        <script>
            ...
            seajs.use([ 'lui/jquery', 'lui/dialog' ], function($, dialog) {
                ...
                window.resyncCheckToDing=function(fdId){
	            	...
	            	var url = '<c:url value="/third/ding/third_ding_leavelog/thirdDingLeavelog.do?method=resyncCheck&fdId=" />'+fdId;
