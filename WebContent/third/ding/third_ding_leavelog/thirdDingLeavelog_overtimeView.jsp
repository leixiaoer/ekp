			...
			<tr>
				...
				<td colspan="3">
					<table class="tb_normal" width="100%"
						...
						<c:forEach items="${thirdDingLeavelogForm.fdOvertimeDetail_Form}"
							...
							<tr KMSS_IsContentRow="1" class="docListTr">
								...
								<td class="docList" align="center">
									...
									<div id="_xform_fdOvertimeDetail_Form[${vstatus.index}].fdDate"
										_xform_type="text">
										<xform:text
											property="fdOvertimeDetail_Form[${vstatus.index}].fdDate"
								...
								<td class="docList" align="center">
									...
									<div
										...
										_xform_type="text">
										<xform:text
											property="fdOvertimeDetail_Form[${vstatus.index}].fdDuration"
											showStatus="view" style="width:95%;" />
									</div>
								</td>
							</tr>
