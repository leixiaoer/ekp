	...
	<div style="width: 95%;">
		<table class="tb_normal" width="100%">
			<tr>
				...
				<td colspan="3">
					...
					<div id="_xform_docSubject" _xform_type="text">
						<a href="/km/review/km_review_main/kmReviewMain.do?method=view&fdId=${thirdDingLeavelogForm.fdApproveId}" class="com_btn_link"
			...
			<tr>
				...
				<td colspan="3">
					<%-- 查看撤销单信息--%>
					<div id="_xform_info" _xform_type="text">
					   <a href="/third/ding/third_ding_leavelog/thirdDingLeavelog.do?method=view&fdId=${thirdDingLeavelogForm.fdJumpUrl}"  class="com_btn_link" style="text-decoration: none;">查看</a>
					</div>
				</td>
			</tr>
		</table>
