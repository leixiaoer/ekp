...
<p class="txttitle">${ lfn:message('third-ding:thirdDingLeavelog.buss') }</p>
<center>
	...
	<div style="width: 95%;">
		<table class="tb_normal" width="100%">
			...
			<tr>
				...
				<td colspan="3">
					<table class="tb_normal" width="100%"
						id="TABLE_DocList_fdBussDetail_Form" align="center"
						tbdraggable="true">
						<tr align="center" class="tr_normal_title">
					  	  <td>${lfn:message('third-ding:thirdDingBuss.fdDate')}</td>
						...
						<c:forEach items="${thirdDingLeavelogForm.fdBussDetail_Form}"
							var="fdBussDetail_FormItem" varStatus="vstatus">
							<tr KMSS_IsContentRow="1" class="docListTr">
								...
								<td class="docList" align="center">
									<%-- 日期 --%>
									<div id="_xform_fdBussDetail_Form[${vstatus.index}].fdDate"
										_xform_type="text">
										<xform:text
											property="fdBussDetail_Form[${vstatus.index}].fdDate"
								...
								<td class="docList" align="center">
									<%-- 天数--%> 
									<input type="hidden"
										name="fdBussDetail_Form[${vstatus.index}].fdId"
										value="${fdBussDetail_FormItem.fdId}" />
									<div
										id="_xform_fdBussDetail_Form[${vstatus.index}].fdDuration"
										_xform_type="text">
										<xform:text
											property="fdBussDetail_Form[${vstatus.index}].fdDuration"
											showStatus="view" style="width:95%;" />
									</div>
								</td>
							</tr>
