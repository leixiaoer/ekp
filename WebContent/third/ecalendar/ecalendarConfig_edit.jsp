...
<template:include ref="config.profile.edit" sidebar="no">
	...
	<tr>
		...
		<td>
			<xform:text showStatus="edit" property="value(calendar.integrate.ecalendar.offset)" style="width:50px" subject="${lfn:message('third-ecalendar:exchange.synchro.time.offset')}" />${lfn:message('third-ecalendar:exchange.synchro.time.offset.hour')}<br>
			<span class="txtstrong">
