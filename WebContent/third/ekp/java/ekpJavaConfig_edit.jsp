	...
	<template:replace name="content">
		...
		<html:form action="/third/ekp/java/oms/in/config.do" onsubmit="return validate();">
			...
			--%>
				...
				<tr>
					<td class="td_normal_title" width="15%">${lfn:message('third-ekp-java:ekp.java.notify.mq.send.enabled')}</td>
					<td><label> 
				...
				<tr>
					<td class="td_normal_title" width="15%">${lfn:message('third-ekp-java:ekp.java.notify.mq.receive.enable')}</td>
					<td><label> 
