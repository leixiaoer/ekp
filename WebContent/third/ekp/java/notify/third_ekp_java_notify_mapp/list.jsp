    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                ...
                <list:cri-auto modelName="com.landray.kmss.third.ekp.java.notify.model.ThirdEkpJavaNotifyMapp" property="fdNotifyId" />
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/third/ekp/java/notify/third_ekp_java_notify_mapp/thirdEkpJavaNotifyMapp.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/third/ekp/java/notify/third_ekp_java_notify_mapp/thirdEkpJavaNotifyMapp.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
        ...
        <script>
            var listOption = {
                ...
                modelName: 'com.landray.kmss.third.ekp.java.notify.model.ThirdEkpJavaNotifyMapp',
                templateName: '',
