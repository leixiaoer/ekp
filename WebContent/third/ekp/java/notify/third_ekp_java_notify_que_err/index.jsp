...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('third-ekp-java-notify:module.third.ekp') }-${ lfn:message('third-ekp-java-notify:table.thirdEkpJavaNotifyQueErr') }" />
    </template:replace>
    <template:replace name="path">
        <ui:menu layout="sys.ui.menu.nav">
            <ui:menu-item text="${ lfn:message('home.home') }" icon="lui_icon_s_home" href="/" target="_top" />
            <ui:menu-item text="${ lfn:message('third-ekp-java-notify:table.thirdEkpJavaNotifyQueErr') }" />
        </ui:menu>
    </template:replace>
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('third-ekp-java-notify:table.thirdEkpJavaNotifyQueErr') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/third/ekp/third_ekp_java_notify_que_err/thirdEkpJavaNotifyQueErr.do"} ]
            </ui:varParam>
        </ui:combin>
    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                ...
                <list:cri-auto modelName="com.landray.kmss.third.ekp.model.ThirdEkpJavaNotifyQueErr" property="fdNotifyId" />
                <list:cri-auto modelName="com.landray.kmss.third.ekp.model.ThirdEkpJavaNotifyQueErr" property="fdMethod" />
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="3">
                            ...
                            <kmss:auth requestURL="/third/ekp/third_ekp_java_notify_que_err/thirdEkpJavaNotifyQueErr.do?method=deleteall">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/third/ekp/third_ekp_java_notify_que_err/thirdEkpJavaNotifyQueErr.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/third/ekp/third_ekp_java_notify_que_err/thirdEkpJavaNotifyQueErr.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
        ...
        <script>
            var listOption = {
                ...
                modelName: 'com.landray.kmss.third.ekp.model.ThirdEkpJavaNotifyQueErr',
                templateName: '',
