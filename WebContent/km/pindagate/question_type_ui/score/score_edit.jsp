		...
		<table class="tb_normal" width=90%>
			...
			<tr>
				<td>
					...
					<input type="checkbox" name="showAverage" id="showAverage" value="true" checked="checked"><bean:message bundle="km-pindagate" key="kmPindagateQuestion.showAverage"/>
				</td>
			</tr>
			<tr>
				<td align="center">
...
<%@include file="/km/pindagate/question_type_ui/score/score_edit_script.jsp"%>