			...
			<tr>
				<td>
					<table id="questionitemlist" class="tb_normal" width=100%>
						<tr>
							<td width="30" ><img src="${KMSS_Parameter_StylePath}icons/add.gif" onclick="addQuestionItem();" style="cursor:hand"></td>
				...
				<td>
					<table id="selectitemlist" class="tb_normal" width=100%>
						<tr>
							...
							<td width="30"><bean:message key="page.serial"/></td>
							<td width="245" align="center">
								<bean:message bundle="km-pindagate" key="kmPindagateQuestion.matrix.option"/>
								<font color=red><bean:message bundle="km-pindagate" key="kmPindagateQuestion.IncreasedMulti"/></font>
							</td>
							<td width="180" align="center"><bean:message bundle="km-pindagate" key="kmPindagateQuestion.image.title"/></td>
						</tr>
			...
			<tr>
				<td>
					...
					<span id="div_minSelectNumber">
						,<bean:message bundle="km-pindagate" key="kmPindagateQuestion.matrix.minSelectNumber"/>
						<input type="text" name="eachMinSelectNumber" id="eachMinSelectNumber" value=""  class="inputsgl">
					</span>
					<br/>
...
<%@include file="/km/pindagate/question_type_ui/multimatrix/multimatrix_edit_script.jsp"%>