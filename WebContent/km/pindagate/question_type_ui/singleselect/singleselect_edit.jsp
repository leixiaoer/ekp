		...
		<table class="tb_normal" width=90% >
			<tr>
				<td>
					...
					<div align="right">
						<bean:message bundle="km-pindagate" key="kmPindagateQuestion.showFigure"/>
						<input type="radio" name="statisticPic" value="histogram"  checked="checked"/>
						<bean:message bundle="km-pindagate" key="kmPindagateQuestion.histogram"/>
						<input type="radio" name="statisticPic" value="pie" />
						<bean:message bundle="km-pindagate" key="kmPindagateQuestion.pie"/>
					</div>
				</td>
			</tr>
			<%--问题题目--%>
...
<%@include file="/km/pindagate/question_type_ui/singleselect/singleselect_edit_script.jsp"%>