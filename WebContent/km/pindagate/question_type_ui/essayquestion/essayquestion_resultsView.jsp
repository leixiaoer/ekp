...
function function_${JsParam.index}(){
	...
	otherDiv += '<a href="javascript:void(0);" onclick="essayquestion_viewOtherAnswer('+index+');" style="cursor: pointer;"><bean:message bundle="km-pindagate" key="kmPindagateResponse.view"/></a>”</div>';
...
* 全部信息:“查看”
*/
function essayquestion_viewOtherAnswer(questionId){
