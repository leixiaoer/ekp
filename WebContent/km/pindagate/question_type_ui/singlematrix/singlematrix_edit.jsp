...
<template:include ref="default.dialog">
	<template:replace name="content" >
		...
		<table class="tb_normal" width=90%>
			<tr>
				<td>
					<b><bean:message bundle="km-pindagate" key="kmPindagateQuestion.type.singlematrix"/></b>
					...
					<table id="questionitemlist" class="tb_normal" width=100%>
						<tr>
							...
							<td width="245" align="center">
								<bean:message bundle="km-pindagate" key="kmPindagateQuestion.quetItem"/><span class="txtstrong">*</span>
...
<%@include file="/km/pindagate/question_type_ui/singlematrix/singlematrix_edit_script.jsp"%>