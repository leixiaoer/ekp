	...
	*/
	function addQuestionItem(text,imgsrc){
		...
		var str = '<tr><td>';
			...
			str+='<td>'+rowCount+'</td>';
			str+='<td><input type="text" style="width:500px;" class="inputsgl" name="itemtext" value="'+text+'"/></td>';
			str+='<td style="display: none;"><div style="position:relative" ><input type="text" style="width:100px;display:none" class="inputsgl" name="questionitemimg'+rowCount+'"  value="'+imgsrc+'"/>';
	...
	*/
	function addSelectItem(text,imgsrc){
		...
		var str = '<tr><td>';
			...
			str+='<td>'+rowCount+'</td>';
			str+='<td><input type="text" style="width:500px;" class="inputsgl" name="itemtext" value="'+text+'"/></td>';
			str+='<td style="display: none;"><div style="position:relative" ><input type="text" style="width:100px;display:none" class="inputsgl" name="selectitemimg'+rowCount+'"  value="'+imgsrc+'"/>';
