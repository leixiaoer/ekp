...
(function(window){
	...
	fillquestions.init=function(questionJson){
		...
		otherDiv += '<a href="javascript:void(0);" onclick="fillquestions_viewOtherAnswer(\''+questionJson.questionId+'\');" style="cursor: pointer;">'+Data_GetResourceString("km-pindagate:kmPindagateResponse.view")+'</a>”</div>';
		div.append(otherDiv);
	};
	...
	// 全部信息:“查看”
	window.fillquestions_viewOtherAnswer=function(questionId){
	...
	window.fillquestions=fillquestions;
