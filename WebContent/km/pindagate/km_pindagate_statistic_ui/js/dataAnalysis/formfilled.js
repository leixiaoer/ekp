...
(function(window){
	...
	formfilled.init=function(questionJson){
		...
		otherDiv += '<a href="javascript:void(0);" onclick="formfilled_viewOtherAnswer(\''+questionJson.questionId+'\');" style="cursor: pointer;">'+Data_GetResourceString("km-pindagate:kmPindagateResponse.view")+'</a>”</div>';
		div.append(otherDiv);
	};
	...
	// 全部信息:“查看”
	window.formfilled_viewOtherAnswer=function(questionId){
