...
Com_IncludeFile("vbar.js",Com_Parameter.ContextPath+"km/pindagate/resource/",null,true);
Com_IncludeFile("circle.js",Com_Parameter.ContextPath+"km/pindagate/resource/",null,true);
...
function kmPindagateStatictisInit(str){
	...
	for(var i=0;i<questionArray.length;i++){
		if(questionArray[i].fdSplit!="true"){
			...
			Com_IncludeFile(jsFile,Com_Parameter.ContextPath+"km/pindagate/km_pindagate_statistic_ui/js/resultView/",null,true);
		}
	}
}
