define(["dojo/_base/declare","../common/BaseResponse","mui/form/Textarea","dojo/dom-style","dojo/dom-construct","dojo/topic","dojo/query","../common/method","dojo/on","dojo/dom-construct","dojo/_base/lang","dojo/parser","../fillquestions/FillquestionsResponse"],
		function(declare,BaseResponse,Textarea,domStyle,domConstruct,topic,query,method,on,domCtr,lang,parser,fillquestionsResponse){
	
	return declare("km.pindagate.essayquestion.FillqiestopmsResponse",[BaseResponse],{


/*自动加载省份列表*/
showProv :function (index,cityShow) {
	self=this;
...
/*根据所选的省份来显示城市列表*/
showCity:function(obj,index,sign) {
	//清除内容
	//closeMsg(index);
...
/*根据所选的城市来显示县区列表*/
showCountry:function (obj,index,sign) {
	//清除内容
	$("input[name='fdItems["+index+"].fdAnswerTxt']").val("");
	$("input[name='fdItems["+index+"].fdAnswer']").val("");
...
showAddress:function (prov,city,index){
	self=this;
	self.showCity(prov,index,"show");
	self.showCountry(city,index,"show");
}
...
var provice = [
    ...
    },
    {
        ...
        city: [
            ...
            {
                name: "深圳市",
                districtAndCounty: ["福田区", "罗湖区", "南山区", "宝安区", "龙岗区", "盐田区","光明新区","坪山新区","大鹏新区","龙华新区"]
            },
            {
                name: "清远市",
