...
* constructor
* ----------------------------------------------------------------- */
html5jp.progress = function (id, p,bColor) {
	if( ! id ) { return; }
	...
	* ----------------------------------------------------------------- */
	var dp = {
		...
		width: 350,	// width of progress bar (pixel)
		height: 18,	//height of progress bar (pixel)
		// styles of frame
		frm_bgc: "white",	// backgroundColor
		frm_bdtc: "#d8d8d8",	// borderTopColor
		frm_bdrc: "#d8d8d8",	// borderRightColor
		frm_bdbc: "#d8d8d8",	// borderBottomColor
		frm_bdlc: "#d8d8d8",	// borderLeftColor
		frm_bdw: "1px",	// borderWidth
		// styles of bar
		bar_bgc: bColor,	// backgroundColor
		bar_bdtc: bColor,	// borderTopColor
		bar_bdrc: bColor,	// borderRightColor
		bar_bdbc: bColor,	// borderBottomColor
		bar_bdlc: bColor,	// borderLeftColor
...
proto.draw = function() {
	...
	if(p.per_shw == true) {
		...
		p.per_top = ( ( p.height + parseInt(p.bar_bdw) * 2 ) / 2 ) -6;
