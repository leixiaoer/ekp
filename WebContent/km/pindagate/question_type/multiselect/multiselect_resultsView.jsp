...
function function_${JsParam.index}(){
	...
	if(fdQuestionDef[index].autoAddOther){
		var otherDiv = '<div style="text-align: left;"><a href="#" onclick="multiselect_viewOtherAnswer('+index+');" style="cursor: pointer;"><bean:message bundle="km-pindagate" key="kmPindagateResponse.view"/>“';
