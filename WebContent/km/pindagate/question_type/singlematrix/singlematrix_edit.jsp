		...
		<td>
			<table id="questionitemlist" class="tb_normal" width=100%>
				<tr>
					...
					<td width="245"><b><bean:message bundle="km-pindagate" key="kmPindagateQuestion.quetItem"/><span class="txtstrong">*</span>&nbsp;&nbsp;&nbsp;&nbsp;</b><font color=red><bean:message bundle="km-pindagate" key="kmPindagateQuestion.IncreasedMulti"/></font></td>
