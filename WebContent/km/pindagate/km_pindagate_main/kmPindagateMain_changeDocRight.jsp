...
function oprOnclickFunc(el){
	...
	$(function(){
		...
		for(var i=0;i<att.length;i++){
			...
			var tr="<tr id='"+att[i]+"Zone'><td width=90% colspan='2'>"
				...
				+"<div id='"+att[i]+"CheckInput' style='display:none'><textarea id='"+att[i]+"Names' name='"+att[i]+"Names' style='width:95%;' readonly></textarea>"
				+"<a href='#' onclick=\"Dialog_Address(true, '"+att[i]+"Ids','"+att[i]+"Names', ';',null);\">"
				+Data_GetResourceString('dialog.selectOrg')+"</a>"+trMessage+"</div></td></tr>"; 
...
<div id="optBarDiv">
		<input type=button value="<bean:message key="button.save"/>"
			onclick="Com_Submit(document.docAuthForm,'docRightUpdate','fdIds');">
