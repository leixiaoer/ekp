		...
		<script type="text/javascript">
			seajs.use(['lui/jquery','lui/topic'],function($,topic){
				...
				function openPageResize(){
					try{
						var mainIfr = parent.parent.document.getElementById("mainIframe");
						var viewIfr = document.getElementsByClassName("lui_profile_moduleIndex_viewframe")[0];
						var	itemIfr = parent.document.getElementsByClassName("lui_widget_iframe")[0];
						var viewSh = viewIfr.contentDocument.body.scrollHeight;
						mainIfr.style.height = viewSh+80 + 'px';
						itemIfr.style.height = viewSh + 'px';
					}catch(e){
					}
				}
