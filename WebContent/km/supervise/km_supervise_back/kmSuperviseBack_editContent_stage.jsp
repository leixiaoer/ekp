			...
			<div class="lui_form_content_frame" >
	            <table class="tb_normal" width="95%">
					...
					<tr>
						...
						<td colspan="3">
							<xform:address propertyName="fdPersonName" propertyId="fdPersonId" orgType="ORG_TYPE_PERSON" required="true" style="width:35%;"/>
						</td>
					</tr>
					<!-- 反馈时间 -->
					<tr>
						...
						<td width="35%">
							...
							<span class="lui_supervise_progress">
						        <span class="lui_supervise_bar">
       							 ...
       							 <span id="lui_supervise_rate" class="lui_supervise_rate">${kmSuperviseBackForm.fdProgress}%</span>
    						</span>
    						<c:choose>
	    						<c:when test="${kmSuperviseBackForm.fdSysUnitEnable eq 'true'}">
					...
					<tr>
						...
						<td colspan="3">
							<xform:radio property="fdStatus" value="0">
