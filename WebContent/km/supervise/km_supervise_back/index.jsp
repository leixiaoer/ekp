...
<template:include ref="default.simple" spa="true">
    ...
    <template:replace name="body">
            ...
            <list:criteria id="criteria1">
            	...
            	<list:cri-ref key="fdPerson" ref="criterion.sys.person" title="${lfn:message('km-supervise:kmSuperviseBack.fdPerson') }"></list:cri-ref>
            	<list:cri-auto modelName="com.landray.kmss.km.supervise.model.KmSuperviseBack" property="fdFeedbackTime" />
				...
				<div class="lui_list_operation_sort_btn">
					...
					<div class="lui_list_operation_sort_toolbar">
                        <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
                        	<list:sortgroup>
                        		<list:sort property="fdFeedbackTime" text="${lfn:message('km-supervise:kmSuperviseBack.fdFeedbackTime')}" group="sort.list" value="down"/>
	                        </list:sortgroup>
                        </ui:toolbar>
                    </div>
                </div>
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/km/supervise/km_supervise_back/kmSuperviseBack.do?method=list'}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable url="${LUI_ContextPath }/sys/profile/listShow/sys_listShow/sysListShow.do?method=getSort&modelName=com.landray.kmss.km.supervise.model.KmSuperviseBack" isDefault="true" layout="sys.ui.listview.columntable" rowHref="/km/supervise/km_supervise_back/kmSuperviseBack.do?method=view&fdId=!{fdId}" name="columntable">
                    <%-- <list:col-checkbox /> --%>
                    <list:col-serial/>
                    <list:col-auto props="fdSupervise.docTemplate.name;fdSupervise.docSubject;fdSupervise.fdStartTime;fdSupervise.fdFinishTime;fdFeedbackTime;fdPerson.name"/>
                </list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
