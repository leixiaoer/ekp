...
<template:include ref="default.simple" spa="true">
    ...
    <template:replace name="body">
            ...
            <list:criteria id="criteria1">
            	...
            	<list:cri-ref key="fdOperator" ref="criterion.sys.person" title="办结人"></list:cri-ref>
            	<list:cri-auto modelName="com.landray.kmss.km.supervise.model.KmSuperviseMainFinish" property="fdRealFinishTime" />
				...
				<div class="lui_list_operation_sort_btn">
					...
					<div class="lui_list_operation_sort_toolbar">
                        <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
                        	<list:sortgroup>
                        		<list:sort property="fdRealFinishTime" text="${lfn:message('km-supervise:kmSuperviseMainFinish.fdRealFinishTime')}" group="sort.list" value="down"/>
	                        </list:sortgroup>
                        </ui:toolbar>
                    </div>
                </div>
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/km/supervise/km_supervise_main_finish/kmSuperviseMainFinish.do?method=list'}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable url="${LUI_ContextPath }/sys/profile/listShow/sys_listShow/sysListShow.do?method=getSort&modelName=com.landray.kmss.km.supervise.model.KmSuperviseMainFinish" isDefault="true" layout="sys.ui.listview.columntable" rowHref="/km/supervise/km_supervise_main_finish/kmSuperviseMainFinish.do?method=view&fdId=!{fdId}" name="columntable">
                    <%-- <list:col-checkbox /> --%>
                    <list:col-serial/>
                    <list:col-auto props="kmSuperviseMain.docTemplate.name;kmSuperviseMain.docSubject;kmSuperviseMain.fdStartTime;kmSuperviseMain.fdFinishTime;fdRealFinishTime;fdOperator.name;fdFinishDesc"/>
                </list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
