			...
			<div data-dojo-type="mui/view/DocScrollableView" 
						...
						<div class="muiFlowInfoW muiFormContent">
							<table class="muiSimple" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td class="muiTitle">
										${lfn:message('km-supervise:kmSuperviseMain.fdFinisher')}
									</td>
									<td>
								...
								<tr>
									<td class="muiTitle">
										${lfn:message('km-supervise:kmSuperviseMain.fdFinishOrg')}
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<xform:datetime property="fdFinishTime" dateTimeType="date"/>
									</td>
								</tr>
								<tr>
									<td class="muiTitle">
										${lfn:message('km-supervise:kmSuperviseMain.fdRealFinishTime')}
									</td>
									<td>
										<xform:config  orient="none">
											<xform:datetime property="fdRealFinishTime" dateTimeType="date" showStatus="edit" required="true" mobile="true"/>
										</xform:config>	
									</td>
								</tr>
								<tr>
									<td class="muiTitle">
										${lfn:message('km-supervise:kmSuperviseMain.fdFinishDesc')}
									</td>
									<td>
										<xform:config  orient="none">
											<xform:textarea property="fdFinishDesc" showStatus="edit" mobile="true"/>
										</xform:config>
									</td>
								</tr>
								<tr>
						...
						<%-- 进度 --%>
							<input data-dojo-type="dojox/mobile/Slider" 
								...
								id="fdSuperviseProgress" name="fdSuperviseProgress" class="progress"/>
						</div>
								
				<ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom" data-dojo-props='fill:"grid"'>
					
					<li data-dojo-type="mui/tabbar/TabBarButton" class="muiBtnSubmit" 
						data-dojo-props='colSize:1,href:"javascript:window.submitForm();"'>提交</li>
