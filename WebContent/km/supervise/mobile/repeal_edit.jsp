						...
						<div class="muiFlowInfoW muiFormContent">
							<table class="muiSimple" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td>
									<xform:config  orient="none">
										<xform:datetime property="fdRepealTime" dateTimeType="date" showStatus="edit" mobile="true" required="true"/>
										</xform:config>
									</td>
								</tr>
								<tr>
...
<script type="text/javascript">
	...
	require(['dojo/ready', 'dijit/registry', 'dojo/topic', 'dojo/request', 
		...
		window.submitForm = function(){
			...
			Com_Submit(document.forms[0],'saveAddRepeal'); 
	/* 		dojo.xhrPost({
			  	url: '${LUI_ContextPath}/km/supervise/km_supervise_main/kmSuperviseMain.do?method=saveAddRepeal',
