define([ "dojo/_base/declare","dojo/request","dojo/html","dojo/query","dojo/dom-construct","mui/util"],
	...
	return declare("km.supervise.mobile.resource.js._AttachmentItemMixin", null, {
		
		attUrl : '/km/supervise/km_supervise_back/kmSuperviseBack.do?method=loadAttachmentInfo',//没有默认的,暂时用任务的代替
