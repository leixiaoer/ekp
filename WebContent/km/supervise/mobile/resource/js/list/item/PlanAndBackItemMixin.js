define([
	...
	var item = declare("km.supervise.list.item.PlanAndBackItemMixin", [ItemBase,OpenProxyMixin], {
		tag:"div",
		...
		buildRendering:function(){
			...
			//最新反馈
			this.backTimeNode = domConstruct.create("div",{className:"lui_asc_item_text"},contentContainer);
			domConstruct.create("span",{innerHTML:msg['mobile.task.new.backTime']+"：" },this.backTimeNode);
			domConstruct.create("span",{innerHTML:this.fdBackTime },this.backTimeNode);
