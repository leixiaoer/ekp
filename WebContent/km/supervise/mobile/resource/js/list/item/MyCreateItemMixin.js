define([
	...
	var item = declare("km.supervise.list.item.MyCreateItemMixin", [ItemBase,OpenProxyMixin], {
		tag:"div",
		...
		buildRendering:function(){
			...
			if(this.docStatusNew != "30" && this.docStatusNew != "40" && this.docStatusNew != "50" && this.docStatusNew != "60"){
