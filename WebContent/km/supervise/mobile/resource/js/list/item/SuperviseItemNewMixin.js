define([
	...
	var item = declare("km.supervise.list.item.KmSuperviseItemNewMixin", [ItemBase,OpenProxyMixin], {
		tag:"div",
		...
		buildRendering:function(){
			...
			//督办类别
			this.templetNode = domConstruct.create("div",{className:"lui_asc_item_text"},UlNode);
			...
			//主办单位
			this.unitNode = domConstruct.create("div",{className:"lui_asc_item_text"},UlNode);
			...
			//计划时间
			this.planNode = domConstruct.create("div",{className:"lui_asc_item_text"},UlNode);
