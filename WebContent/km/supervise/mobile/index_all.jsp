	...
	<template:replace name="content">
		...
		<div data-dojo-type="mui/header/NavHeader">
			...
			<div class="muiHeaderItemRight" 
				...
				data-dojo-props="modelName: 'com.landray.kmss.km.supervise.model.KmSuperviseTemplet',catekey: 'cateId',prefix: 'q'"></div>
		</div>
		...
		<!-- 页脚 starts -->
	  	<div class="lui_db_footer">
		    ...
		    <div class="lui_db_footer_item active" onclick="navigate2View(2)">
