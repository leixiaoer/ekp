				...
				<div data-dojo-type="mui/panel/AccordionPanel">
					<div class="muiFormContent muiFlowInfoW">
						<table class="muiSimple" cellpadding="0" cellspacing="0">
								...
								<td>
									<c:choose>
										<c:when test="${kmSuperviseBackForm.fdSysUnitEnable eq 'true'}">
											<xform:text property="fdSysUnitName" mobile="true" subject="${lfn:message('km-supervise:kmSuperviseMain.fdUnit') }"/>
										</c:when>
										<c:otherwise>
											<xform:address propertyName="fdUnitName" propertyId="fdUnitId" showStatus="view" required="true" mobile="true" subject="${lfn:message('km-supervise:kmSuperviseMain.fdUnit') }"/>
										</c:otherwise>
									</c:choose>
								</td>
							</tr>
							...
							<tr>
								<td>
									<xform:address propertyName="fdPersonName" propertyId="fdPersonId" subject="${lfn:message('km-supervise:kmSuperviseBack.fdPerson') }" showStatus="view" mobile="true"/>
								</td>
							</tr>
							<!-- 反馈时间 -->
							<tr>
