...
<template:replace name="content"> 
	<c:if test="${param.approveModel ne 'right'}">
		<form name="kmSuperviseMainStopForm" method="post" action ="${KMSS_Parameter_ContextPath}km/supervise/km_supervise_main_stop/kmSuperviseMainStop.do">
	</c:if>
    ...
    <c:choose>
		<c:when test="${param.approveModel eq 'right'}">
			<ui:tabpage collapsed="true" id="stopTabPage">
				...
				<c:import url="/km/supervise/km_supervise_main_stop/kmSuperviseMainStop_editContent.jsp" charEncoding="UTF-8">
