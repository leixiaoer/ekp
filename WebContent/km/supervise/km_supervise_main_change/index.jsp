    ...
    <template:replace name="body">
    	<script type="text/javascript">
            ...
            <list:criteria id="criteria1">
            	...
            	<list:cri-ref key="fdChangePerson" ref="criterion.sys.person" title="变更人"></list:cri-ref>
            	<list:cri-auto modelName="com.landray.kmss.km.supervise.model.KmSuperviseMain" property="fdChangeTime" />
                <list:cri-auto modelName="com.landray.kmss.km.supervise.model.KmSuperviseMain" property="fdStartTime;fdFinishTime" />
				...
				<div class="lui_list_operation_sort_btn">
					...
					<div class="lui_list_operation_sort_toolbar">
                        <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
                        	<list:sortgroup>
                        		<list:sort property="fdChangeTime" text="${lfn:message('km-supervise:kmSuperviseMain.fdChangeTime')}" group="sort.list" value="down"/>
	                        </list:sortgroup>
                        </ui:toolbar>
                    </div>
                </div>
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/km/supervise/km_supervise_main/kmSuperviseMain.do?method=data&isChange=true'}
                </ui:source>
                <!-- 列表视图 -->
