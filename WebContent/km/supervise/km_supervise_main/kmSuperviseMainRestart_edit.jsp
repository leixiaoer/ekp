...
<template:include ref="default.edit" sidebar="no">
	...
	<template:replace name="toolbar">
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
			<%--add页面的按钮--%>
			<ui:button text="${lfn:message('button.update') }" order="2" onclick="commitMethod('saveAddRestart');">
			</ui:button>
			<%--关闭--%>
	...
	<template:replace name="content"> 
		<html:form action="/km/supervise/km_supervise_main/kmSuperviseMain.do">
		    <p class="lui_form_subject">${ lfn:message('km-supervise:py.DuBanChongQi') }</p>
	        <div class="lui_form_content_frame" >
	            <table class="tb_normal" width="95%">
	                ...
	                <tr>
						<!-- 重启人 -->
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRestarter" />
						</td>
						<td width="35%">
						...
						<!-- 重启单位 -->
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRestartOrg" />
						</td>
						<td width="35%">
							<xform:address propertyName="fdOperatorUnitName" propertyId="fdOperatorUnitId" showStatus="readOnly" />
						</td>	
					</tr>
					<tr>
						<!-- 任务进度 -->
						...
						<!-- 重启时间 -->
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRestartTime" />
						</td width="35%">
						<td>
							<xform:datetime property="fdRestartTime" showStatus="edit" required="true" />
						</td>
					</tr>
					<!-- 重启原因 -->
					<tr>
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRestartDesc" />
						</td>
						<td colspan="3">
							<html:textarea property="fdRestartDesc" style="width:98%;" />
						</td>
					</tr>
					<!-- 相关附件 -->
					<tr>
