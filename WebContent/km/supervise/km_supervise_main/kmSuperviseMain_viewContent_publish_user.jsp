...
<%@ include file="/sys/ui/jsp/common.jsp"%>
    ...
    <div class="lui_supervise_tabpage_head lui_tabpage_float_header_title">
   	...
   	<ui:event event="show">
    	document.getElementById("planAndBackFrame").src = '<c:url value="/km/supervise/km_supervise_main/import/plan_and_back_frame_user.jsp?fdId=${kmSuperviseMainForm.fdId}" />';
	</ui:event>
