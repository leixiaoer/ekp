...
<template:include ref="default.simple">
	<template:replace name="body">
		...
		<div class="lui_supervise_panel_content">
			<ui:dataview id="instructionMsg">
				<ui:source type="AjaxJson">
					{url:'/km/supervise/km_supervise_instruction/kmSuperviseInstruction.do?method=getAllInstructions&fdMainId=${param.fdMainId}&fdType=1&rowSize=3'}
				</ui:source>
				<ui:render type="Template">
					<c:import url="/km/supervise/km_supervise_main/import/instruction_message_list.jsp" charEncoding="UTF-8"></c:import>
				</ui:render>
				...
				seajs.use(['lui/dialog','lui/jquery'],function(dialog,$){
					...
					window.submitInstruction = function(){
						...
						if(desc != ""){
							$.ajax({
								...
								type: 'POST',
								data:$.param({"desc":desc,"fdType":'1'},true),
								dataType: 'json',
								error: function(data){
					...
					window.showMore=function(rowSize){
						LUI("instructionMsg").source.setUrl('/km/supervise/km_supervise_instruction/kmSuperviseInstruction.do?method=getAllInstructions&fdMainId=${param.fdMainId}&fdType=1&rowSize='+rowSize);
						LUI("instructionMsg").source.get();
					}
					
				});
				</script>
			</ui:dataview>
			<kmss:auth requestURL="/km/supervise/km_supervise_main/kmSuperviseMain.do?method=view&fdId=${param.fdMainId}" requestMethod="GET">
          		<div class="lui_supervise_idea_input">
            		<div class="lui_supervise_idea_input_wrap">
              			<textarea class="lui_supervise_idea_input_write" name="fdInstructionDesc" maxlength="200" placeholder="请输入你的督办留言"></textarea>
            		</div>
