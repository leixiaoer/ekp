...
if(data.length > 0){
	...
	for(var i=0; i < length; i++){
	    ...
	    {$
                        	...
                        	<li>
                          		<div class="lui_sclipici_content_people">{%data[i].fdConcernNames%}</div>
                        	</li>
                        </ul>
                    </div>
        		</div>
	...
	if(data.length > 5){
	{$
		<a href="javascript:void(0);" onclick="showMore('/km/supervise/#j_path=%2FmyManage&mydoc=fenguan')"  class="lui_sclp_item_more">
