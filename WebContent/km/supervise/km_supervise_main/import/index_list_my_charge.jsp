...
if(data.length > 0){
		...
		$}
					    ...
					    <ul class="lui_sclipici_content">
                        	...
                        	<li>
	                            ...
	                            <div class="lui_sclipici_content_info_department" title="主办单位/部门">{%data[i].fdUnitName%}</div>
	...
	if(data.length > 5){
	{$
		<a href="javascript:void(0);" class="lui_sclp_item_more"  onclick="showMore('/km/supervise/#j_path=%2FmyCharge&mydoc=duty')">
