	...
	<template:replace name="body">
            ...
            <list:criteria id="criteria1">
                ...
                <list:tab-criterion title="" key="docStatus">  
					<list:box-select>
						<list:item-select type="lui/criteria/select_panel!TabCriterionSelectDatas" cfg-enable="false" cfg-if="param['mydoc'] == 'duty' || param['mydoc'] == 'manage' || param['mydoc'] == 'concern' || param['mydoc'] == 'copy' || param['mydoc'] == 'all' || param['mydoc'] == 'duban'">
							<ui:source type="Static">
				...
				<list:cri-ref key="fdLead" ref="criterion.sys.person" title="${lfn:message('km-supervise:kmSuperviseMain.fdLead') }" cfg-if="param['mydoc'] == 'duty' || param['mydoc'] == 'manage' || param['mydoc'] == 'concern' || param['mydoc'] == 'copy' || param['mydoc'] == 'all'"></list:cri-ref>
                ...
                <list:cri-auto modelName="com.landray.kmss.km.supervise.model.KmSuperviseMain" property="fdFinishTime;docTemplate" />
            </list:criteria>
            <!-- 操作 -->
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/km/supervise/km_supervise_main/kmSuperviseMain.do?method=data&categoryId=${JsParam.categoryId}&isHistory=true'}
                </ui:source>
                <!-- 列表视图 -->
