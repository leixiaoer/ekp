...
<template:include ref="default.edit" sidebar="no">
	...
	<template:replace name="toolbar">
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
			<%--add页面的按钮--%>
			<ui:button text="${lfn:message('button.update') }" order="2" onclick="commitMethod('saveAddRepeal');">
			</ui:button>
			<%--关闭--%>
	...
	<template:replace name="content"> 
		<html:form action="/km/supervise/km_supervise_main/kmSuperviseMain.do">
		    <p class="lui_form_subject">${ lfn:message('km-supervise:py.DuBanCheXiao') }</p>
	        <div class="lui_form_content_frame" >
	            <table class="tb_normal" width="95%">
	                ...
	                <tr>
						<!-- 撤销人 -->
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRepealer" />
						</td>
						<td width="35%">
						...
						<!-- 撤销单位 -->
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRepealOrg" />
						</td>
						<td width="35%">
					...
					<tr>
						...
						<!-- 撤销时间 -->
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRepealTime" />
						</td>
						<td width="35%">
							<xform:datetime property="fdRepealTime" showStatus="edit" required="true" />
						</td>
					</tr>
					<!-- 撤销原因 -->
					<tr>
						<td class="td_normal_title" width="15%">
							<bean:message bundle="km-supervise" key="kmSuperviseMain.fdRepealDesc" />
						</td>
						<td colspan="3">
							<html:textarea property="fdRepealDesc" style="width:98%;" />
						</td>
					</tr>
					<!-- 相关附件 -->
					<tr>
