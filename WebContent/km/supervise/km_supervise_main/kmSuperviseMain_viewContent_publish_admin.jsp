...
<%@ include file="/sys/ui/jsp/common.jsp"%>
	...
	<!-- 任务反馈情况统计及记录 -->
   	<div class="lui_supervise_tabpage_head lui_tabpage_float_header_title">
   		...
   		<div class="lui_supervise_tabpage_float_header_close" onclick="superviseClose('taskAndBackContent',this)" title="${lfn:message('km-supervise:py.open') }"></div>
   	</div>
    ...
    <div class="lui_supervise_tabpage_head lui_tabpage_float_header_title">
    	...
    	<div class="lui_supervise_tabpage_float_header_close" onclick="superviseClose('allBackFrame',this)" title="${lfn:message('km-supervise:py.open') }"></div>
