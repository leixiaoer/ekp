...
if(dingExist || lDingExist){
	if(MobileUtil.getClientType(new RequestContext(request)) == 11 && GroupConfig.newInstance().getDingCogroupEnable().equals("true")){
...
%>
	...
	<script type="text/javascript">
	require(['dojo/topic', 'dojo/ready','dijit/registry',"mui/util", 'mui/device/adapter', 'dojo/query', "dojo/request","mui/dialog/Tip",'dojo/dom-construct',"lib/weixin/jwxwork-1.0.0"],
