...
<list:data>
	<list:data-columns var="kmSmissiveMain" list="${queryPage.list}" varIndex="status" mobile="true">
		...
		<list:data-column col="label" escape="false" title="${ lfn:message('km-smissive:kmSmissiveMain.docSubject') }">
      	...
      	<%-- 发布时间--%>
      	<list:data-column col="created" title="${ lfn:message('km-smissive:kmSmissiveMain.docPublishTime') }">
		...
		<list:data-column col="creator" escape="false" title="${ lfn:message('km-smissive:kmSmissiveMain.fdMainDeptId') }">
