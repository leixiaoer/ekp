...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docCreateTime',subject:'<bean:message bundle="km-smissive" key="mobile.kmSmissive.draftDate" />',value:'down'">
	</div>
    <%-- 排序（发布日期）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docPublishTime',subject:'<bean:message bundle="km-smissive" key="mobile.kmSmissive.releaseDate" />',value:''">
	</div>

	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		 data-dojo-type="mui/property/FilterItem"
		 data-dojo-mixins="km/smissive/mobile/resource/js/header/SmissivePropertyMixin"></div>
	<div class="muiHeaderItemRight" 
		 data-dojo-type="mui/catefilter/FilterItem"
		 data-dojo-mixins="mui/simplecategory/SimpleCategoryMixin"
		 data-dojo-props="modelName: 'com.landray.kmss.km.smissive.model.KmSmissiveTemplate',catekey: 'categoryId',prefix:''"></div>
</div>
