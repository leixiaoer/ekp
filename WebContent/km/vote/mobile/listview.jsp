...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar" 
		 data-dojo-props="modelName:'com.landray.kmss.km.vote.model.KmVoteMain'"> 
	</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdEffectTime',subject:'<bean:message bundle="km-vote" key="mui.kmVoteMain.fdInitiationTime" />',value:'down'">
	</div>
    <%-- 排序（截止时间）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdExpireTime',subject:'<bean:message bundle="km-vote" key="mui.kmVoteMain.fdExpireTime" />',value:''">
	</div>
	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		 ...
		 data-dojo-props="modelName: 'com.landray.kmss.km.vote.model.KmVoteCategory',catekey: 'categoryId',prefix:''"></div>
</div>
