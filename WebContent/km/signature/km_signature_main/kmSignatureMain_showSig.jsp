				...
				<tr id="basicInfo">
					...
					<td class="td_normal_title" width="15%">
						...
						<xform:select property="fdSignatureMainId" showStatus="edit" style="width:72%" onValueChange="cleanPassword();">
							<xform:beanDataSource serviceBean="kmSignatureMainService" selectBlock="fdId,fdMarkName" whereBlock="(kmSignatureMain.fdIsAvailable = 1 or kmSignatureMain.fdIsAvailable is null) and (${sql })" orderBy="" />
						</xform:select>
