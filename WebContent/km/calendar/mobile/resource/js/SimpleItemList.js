define([
	...
	var simpleItemRenderer = declare('km.calendar.mobile.js.SimpleItemList', [ItemBase], {
		buildRendering:function(){
			...
			domCtr.create("div",{
				...
				innerHTML: '<div class="muiCateName">' + ctx.data['name'] + '</div>'
			},itemContainer);
			
			if(ctx.url){
				on(ctx.domNode, 'click', function(){
					try{
						window.parent.openUrl(ctx.url);
					}catch(e){
