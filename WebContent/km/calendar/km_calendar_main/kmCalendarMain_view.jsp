...
<script>
	seajs.use(['lui/jquery','lui/dialog'], function($,dialog) {
		...
		window.delDoc=function(divId,form){
			...
			var fdIsGroup = $("#"+form+" :input[name='fdIsGroup']").val();
			if(fdIsGroup == 'true'){
				...
				<input type="hidden" name="fdIsGroup" />
		 		<table class="view_sched">
	             	...
	             	<tr id="tr_location" style="display: none;">
	                 	...
	                 	<td>
	                     	<div id="calendar_location" style="text-align: left;word-break: break-all;max-height: 100px;overflow-y: auto;min-width: 200px;"></div>
	                 	</td>
	             	</tr>
