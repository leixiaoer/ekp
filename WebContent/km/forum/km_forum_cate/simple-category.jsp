		...
		seajs
				.use(
						...
						function(category, $, topic) {
							var url = '/km/forum/criteria/sysSimpleCategoryCriteria.do?method=select&modelName=${JsParam.modelName}&parentId=!{parentId}&searchText=!{searchText}&currId=!{currId}&type=!{type}&authType=${JsParam.authType}&pAdmin=!{pAdmin}';
