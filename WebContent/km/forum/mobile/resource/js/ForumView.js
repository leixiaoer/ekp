define(
		[ "dojo/_base/declare", "dojox/mobile/View", "dojo/dom-style",
				...
				"km/forum/mobile/resource/js/ForumScrollableViewMixin" ],
		function(declare, View, domStyle, domClass, win, registry, array,
				topic, ForumScrollableViewMixin) {
			var claz = declare(
					"km.forum.ForumView",
					[ View, ForumScrollableViewMixin ],
					{
						...
						resize : function() {
							...
							domStyle.set(this.domNode, 'height',
									win.global.innerHeight - this.footerHeight + 'px');
