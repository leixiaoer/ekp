...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/carmng/mobile/km_carmng_dispatch/js/header/IndexListNavMixin">
	</div>
	
	<%-- 搜索
	<div data-dojo-type="mui/search/SearchButtonBar"
		 data-dojo-props="modelName:'com.landray.kmss.km.certificate.model.KmCertificateCategory'">
	</div>
	 --%>
</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docCreateTime',subject:'<bean:message key="kmCarmngApplication.fdApplicationTime" bundle="km-carmng"/>',value:'down'">
	</div>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdStartTime',subject:'<bean:message key="kmCarmngUserFeeInfo.fdUseStartTime" bundle="km-carmng"/>',value:''">
	</div>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdMotorcade.fdName',subject:'<bean:message key="kmCarmngApplication.fdMotorcadeId" bundle="km-carmng"/>',value:''">
	</div>

	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		data-dojo-type="mui/property/FilterItem"
		data-dojo-mixins="km/carmng/mobile/km_carmng_dispatch/js/header/CarDispatchPropertyMixin"></div>
</div>
...
<div data-dojo-type="mui/list/NavView">
	...
	<ul data-dojo-type="mui/list/HashJsonStoreList" class="muiList"
		data-dojo-mixins="km/carmng/mobile/km_carmng_dispatch/js/CarDispatchItemListMixin">
</div>
