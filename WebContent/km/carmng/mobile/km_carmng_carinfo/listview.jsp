...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/carmng/mobile/km_carmng_carinfo/js/header/IndexListNavMixin">
	</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docCreateTime',subject:'<bean:message key="kmCarmngInfomation.docCreateTime" bundle="km-carmng"/>',value:'down'">
	</div>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdSeatNumber',subject:'<bean:message key="kmCarmngInfomation.fdSeatNumber" bundle="km-carmng"/>',value:''">
	</div>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdVehichesType.fdName',subject:'<bean:message key="kmCarmngInfomation.fdVehichesType" bundle="km-carmng"/>',value:''">
	</div>
	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		data-dojo-type="mui/property/FilterItem"
		data-dojo-mixins="km/carmng/mobile/km_carmng_carinfo/js/header/CarCarInfoPropertyMixin"></div>
</div>
...
<div data-dojo-type="mui/list/NavView">
	...
	<ul data-dojo-type="mui/list/HashJsonStoreList" class="muiList"
		data-dojo-mixins="km/carmng/mobile/km_carmng_carinfo/js/CarCarInfoItemListMixin">
</div>
