		...
		function(declare, domClass, iconUtils, CategoryItemMixin, util) {
			var item = declare("mui.selectdialog.DialogItemMixin", [CategoryItemMixin ], {
				...
				buildRendering:function(){
					...
					this.type = this.nodeType=='CATEGORY'?window.SYS_CATEGORY_TYPE_CATEGORY:(this.nodeType=='TEMPLATE'?window.SYS_CATEGORY_TYPE_TEMPLATE:window.SYS_CATEGORY_TYPE_DOCUMENT);
				...
				showSelect:function(){
					...
					if(pWeiget && this.type==window.SYS_CATEGORY_TYPE_DOCUMENT){
						return true;
					}
					return false;
				},
