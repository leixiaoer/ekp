...
<template:replace name="content">
			...
			<div style="float:right">
				<div style="display: inline-block;vertical-align: middle;">
					<ui:toolbar id="Btntoolbar">
						<kmss:auth requestURL="/km/carmng/km_carmng_drivers_info/kmCarmngDriversInfo.do?method=add">
		...
		<ui:source type="AjaxJson">
			...
			layout="sys.ui.listview.columntable" >
				...
				<list:col-auto props="fdOrder,fdName,fdMotorcade.fdName,fdDriverNumber,fdCredentialsType,fdValidTime,fdRelationPhone,operations"></list:col-auto>			
			</list:colTable>
	 	...
	 	<script type="text/javascript">
		 	...
		 	// 增加
		 		window.edit = function(id) {
		 		   if(id){
		 			  Com_OpenWindow('<c:url value="/km/carmng/km_carmng_drivers_info/kmCarmngDriversInfo.do" />?method=edit&fdId='+id);
		 		   }
		 		};
		 		// 删除
		 		window.deleteAll = function(id){
					...
					var deleteAllUrl ='<c:url value="/km/carmng/km_carmng_drivers_info/kmCarmngDriversInfo.do?method=deleteall"/>';
