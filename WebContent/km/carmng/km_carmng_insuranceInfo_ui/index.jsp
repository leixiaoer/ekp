...
<template:include ref="default.simple">
	...
	<%-- <template:replace name="path">
			<ui:menu layout="sys.ui.menu.nav" style="height:40px;line-height:40px;">
				...
				<ui:menu-item text="${ lfn:message('km-carmng:kmCarmng.tree.car.information4') }"  target="_self">
				</ui:menu-item>
			</ui:menu>
	</template:replace> --%>
	...
	<template:replace name="body">
		...
		<!-- 筛选器 -->
	<ui:tabpanel id="kmCarmngInsuranceInfoPanel" layout="sys.ui.tabpanel.list">
		<ui:content id="kmCarmngInsuranceInfoContent" title="${ lfn:message('km-carmng:kmCarmng.tree.car.information4') }">
		<list:criteria id="criteria1">
			...
			<list:cri-auto modelName="com.landray.kmss.km.carmng.model.KmCarmngInsuranceInfo" 
				property="fdInsuranceStartTime;fdInsuranceEndTime" />
		</list:criteria>
		<%@ include file="/km/carmng/km_carmng_insuranceInfo_ui/kmCarmngInsuranceInfo_listview.jsp" %>
		</ui:content>
	</ui:tabpanel>	
	</template:replace> 
