			...
			<table class="tb_normal" width=100% id="Table_Main">
				...
				<tr>
					...
					<td width=85% colspan="3">
						...
						<c:choose>
							<c:when test="${pageScope._isWpsWebCloudEnable == 'true' or pageScope._isWpsWebOfficeEnable == 'true'}">
		 ...
		 window.checkEditType=function(value, obj){
			...
			if("word" == value){
				...
				if ("${pageScope._isWpsWebOfficeEnable}" == "true" ){
					wps_editonline.load();
				} else if("${pageScope._isWpsWebOffice}" == "true"){
				...
				if ("${pageScope._isWpsWebOfficeEnable}" == "true" || "${pageScope._isWpsWebCloudEnable}" == "true") {
