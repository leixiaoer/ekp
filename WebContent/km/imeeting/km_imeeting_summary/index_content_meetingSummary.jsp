...
<template:include ref="default.simple" spa="true">
	<template:replace name="body">
		...
		<list:criteria id="summaryCriteria">
			...
			<list:cri-ref key="fdName" ref="criterion.sys.docSubject" title="${lfn:message('km-imeeting:kmImeetingSummary.fdName') }" />
			<%-- 分类导航 --%>
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" count="6" >
						<list:sortgroup>
							<list:sort property="fdHoldDate" text="${lfn:message('km-imeeting:kmImeetingSummary.fdHoldDate') }" group="sort.list" value="down"></list:sort>
							<list:sort property="docCreateTime" text="${lfn:message('km-imeeting:kmImeetingSummary.docCreateTime') }" group="sort.list"></list:sort>
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
						{url:'/km/imeeting/km_imeeting_summary/kmImeetingSummary.do?method=listChildren&categoryId=${JsParam.categoryId}&nodeType=${JsParam.nodeType}&except=${JsParam.except}'}
			</ui:source>
				...
				//新建会议
			 	window.addDoc = function() {
			 		dialog.categoryForNewFile(
						...
						'/km/imeeting/km_imeeting_summary/kmImeetingSummary.do?method=add&fdTemplateId=!{id}&.fdTemplate=!{id}&i.docTemplate=!{id}',false,null,null,cateId,null,null,true);
			 	};
