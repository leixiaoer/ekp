	...
	<template:replace name="body">
		...
		<list:tab-criterion title="" key="meetingStatus">
			...
			<list:cri-criterion title="${ lfn:message('km-imeeting:kmImeeting.examine') }" key="meetingCondition">
				<list:box-select>
					<list:item-select id="status_for_fixed" cfg-enable="true">
						<ui:source type="Static">
							[
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					...
					<list:sortgroup>
						...
						<list:sort property="docCreateTime" text="${lfn:message('km-imeeting:kmImeetingMain.docCreateTime') }" group="sort.list" ></list:sort>
	...
	<%-- 列表视图 --%>
		<list:listview id="listview">
			<ui:source type="AjaxJson">
					{url:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=listChildren&categoryId=${JsParam.categoryId}&nodeType=${JsParam.nodeType}&except=${JsParam.except}&isCycle=false'}
			</ui:source>
				...
				//新建会议
		 		window.addDoc = function() {
						dialog.categoryForNewFile(
								...
								'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=add&fdTemplateId=!{id}&.fdTemplate=!{id}&i.docTemplate=!{id}',false,null,null,getValueByHash("fdTemplate"));
			 	};
