	...
	<template:replace name="body">
		...
		<ui:dataview>
			<ui:source type="AjaxJson">
				{url: "/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=getBallots&fdMainId=${JsParam.fdId}"}
			</ui:source>
			<ui:render type="Template">
				<c:import url="/km/imeeting/km_imeeting_main/import/criteria_ballot.jsp" charEncoding="UTF-8"></c:import>
			</ui:render>
			<ui:event event="load">
				var firstBallot = document.getElementById("firstBallot");
				firstBallot.click();
			</ui:event>
	    </ui:dataview>
	    
		<ui:dataview id="ballotDataView">
			<ui:source type="AjaxJson">
			</ui:source>
			<ui:render type="Template">
				<c:import url="/km/imeeting/km_imeeting_main/import/result_ballot.jsp" charEncoding="UTF-8"></c:import>
			</ui:render>
			<ui:event event="load">
		...
		<script>
			function ballotChange(val,node){
				var newSrc = "/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=getBallotResult&fdBallotId="+val;
				LUI("ballotDataView").source.setUrl(newSrc);
				LUI("ballotDataView").source.get();
