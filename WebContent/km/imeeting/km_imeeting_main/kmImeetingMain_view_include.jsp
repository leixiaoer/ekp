...
<%@ include file="/sys/ui/jsp/common.jsp"%>
	<%
		...
		boolean meetingAllRole = KmImeetingConfigUtil.isMeetingAllRole(UserUtil.getKMSSUser().getUserAuthInfo().getAuthRoleAliases());
		request.setAttribute("meetingAllRole", meetingAllRole);
	...
	<c:import url="/sys/bookmark/import/bookmark_bar.jsp" charEncoding="UTF-8">
		...
		<%--回执页签，管理员、参与人、抄送人可见、拥有会议所有角色的用户--%>
	<c:if test="${ type=='admin' or type=='attend' or type=='cc' or meetingAllRole=='true'}">
		<%--会议回执--%>
