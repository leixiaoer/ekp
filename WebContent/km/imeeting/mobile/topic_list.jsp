...
<list:data>
	<list:data-columns var="kmImeetingTopic" list="${queryPage.list }" varIndex="status" mobile="true">
		...
		<%-- 文档状态 --%>
        <list:data-column col="docStatus" title="${lfn:message('km-supervise:kmImeetingTopic.docStatus')}">
			<c:choose>
		...
		<list:data-column col="docStatusNew" title="${lfn:message('km-supervise:kmImeetingTopic.docStatus')}">
