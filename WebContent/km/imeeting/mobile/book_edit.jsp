				...
				<div class="meetingBookInfo" data-dojo-type="mui/panel/Content" >
					<div class="muiFormContent">
						...
						<table class="muiSimple" cellpadding="0" cellspacing="0">
				            ...
				            <tr>
				            	<td>
				            		<div class="muiFormFlexEle">
				            			<div class="muiFormFlexEleItem" style="flex: 2;">
						            		<div class="muiFormFlexEleMain">
						            			<div class="title"><bean:message bundle="km-imeeting" key="kmImeetingBook.fdHoldDate"/></div>
												<div class="date startDate" name="startDate"></div>
												<div class="time startTime" name="startTime"></div>	
						            		</div>
				            			...
				            			<div class="muiFormFlexEleArrow">
						            		<input type="hidden" name="fdHoldDuration" />	
				            			</div>
				            			<div class="muiFormFlexEleItem" style="flex: 3;">
				            				<div class="muiFormFlexEleMain">
				            					<div class="title"><bean:message bundle="km-imeeting" key="kmImeetingBook.fdFinishDate"/></div>
												<div class="date endDate" name="endDate"></div>
												<div class="time endTime" name="endTime"></div>	
						            		</div>
...
require(['dojo/ready','dojo/date/locale','dojo/date','dijit/registry','dojo/topic','dojo/query','dojo/dom-style','dojo/dom-class',"dojo/_base/lang","mui/dialog/Tip","dojo/request","mui/util","mui/i18n/i18n!km-imeeting:mobile"],
	...
	//日期改变联动修改周几
	topic.subscribe('/mui/form/datetime/change',setDateTimeValue); 
