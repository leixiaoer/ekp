						...
						<table class="muiSimple" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td class="muiTitle" id="attendPersons">
										...
										orgType='${kmImeetingMainForm.fdTemplateId!=null?"ORG_TYPE_ALL":"ORG_TYPE_PERSON"}' mulSelect="true"  mobile="true" required="true"></xform:address>
										<%--外部参加人员--%>
										<xform:textarea  property="fdOtherAttendPerson" htmlElementProperties="placeholder='${lfn:message('km-imeeting:kmImeetingMain.fdOtherAttendPerson') }'"  validators="maxLength(1500)" mobile="true"/>
								</td>
							</tr>
							<c:if test="${kmImeetingMainForm.fdTemplateId!=null}">
								<%
						...
						<div class="muiFormContent">
							<table class="muiSimple" cellpadding="0" cellspacing="0">
								...
								<!-- 纪要完成时间 -->
									<tr>
										<td>
											<xform:datetime  property="fdSummaryCompleteTime" dateTimeType="datetime" validators="after" mobile="true"></xform:datetime>
										</td>
									</tr>
								</c:if>
								<%-- 会议组织人--%>
								...
								<tr>
									<td>
										<xform:address propertyName="docDeptName" propertyId="docDeptId" 
											...
											orgType="ORG_TYPE_DEPT" mobile="true"></xform:address>
									</td>
								</tr>
								<%-- 会议辅助设备--%>
								<tr class="placeResTr">
