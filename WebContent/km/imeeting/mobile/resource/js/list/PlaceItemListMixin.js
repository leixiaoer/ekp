define([
	...
	"km/imeeting/mobile/resource/js/list/item/PlaceItemMixin"
	], function(declare, query, locale, msg ,util,_TemplateItemMixin, PlaceItemMixin) {
	
	return declare("km.imeeting.PlaceItemListMixin", [_TemplateItemMixin], {
		
		itemRenderer : PlaceItemMixin,
		
		dataUrl : '/km/imeeting/km_imeeting_res/kmImeetingRes.do?method=listCategoryAndRes&type=free',
