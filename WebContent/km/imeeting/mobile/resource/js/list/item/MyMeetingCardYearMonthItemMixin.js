define([
	...
	var item = declare("mui.list.item.MyMeetingCardYearMonthItemMixin", [ItemBase, _ListLinkItemMixin], {
		buildRendering:function(){
			this.inherited(arguments);
			this.domNode = this.containerNode;
			domConstruct.create('div', {className : 'meeting_dateList_date',innerHTML:this.yearMonth}, this.domNode);
			this.itemNode = domConstruct.create('div', {className : 'meeting_dateList_item meeting_dateList_item_'+this.status}, this.domNode);
			this.buildInternalRender();
		},
		buildInternalRender : function() {
			
			//日期
	        var dataNode = domConstruct.create('div', {className:'meeting_dateList_item_date' }, this.itemNode);
	        ...
	        //内容
	        var contentNode = domConstruct.create('div', {className:'meeting_dateList_item_content' }, this.itemNode);
