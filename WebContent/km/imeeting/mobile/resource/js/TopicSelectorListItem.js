define([ "dojo/_base/declare", "dijit/_WidgetBase", "dijit/_Contained",
	...
	"dojo/on", "dojo/request", "dojo/touch", "mui/iconUtils" ], 
	
	function(declare, WidgetBase, Contained, Container, win, array, domStyle, domClass, domCtr, domAttr, topic, on, request, touch, iconUtils) {
	
	return declare("km.imeeeting.mobile.js.TopicSelectorListItem", [ WidgetBase, Contained, Container ], {
		...
		renderItem: function(){
			...
			if(ctx.type == ctx.TYPE_CERT) {
				...
				this.iconNode = domCtr.create('div', {
