	...
	seajs.use([
		...
		'lui/util/env'
			...
			window.transformData=function(datas){
				var main=datas.main;
				//setTimeout(function(){ 修复会议/会议室预约安排不按照状态颜色展现#105785
					for(var key in main){
			...
			topic.subscribe('calendar.thing.click',function(arg){
				...
				viewDialog.find(".fdRemark").attr("title", env.fn.formatText(arg.data.fdRemark)).html(env.fn.formatText( textEllipsis(arg.data.fdRemark) ));//备注
				//时间格式2014-7-11~2014-7-12
...
<div class="km_imeeting_calendar_portal" style="min-width: 960px">
