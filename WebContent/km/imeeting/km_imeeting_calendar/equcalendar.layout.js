seajs.use(['lang!km-imeeting'],function(lang){
	...
	var calendar = layout.equcalendar;
	var frame = null;
	...
	function createHeader(){
		...
		$('<span class="meeting_calendar_label_unhold">&nbsp;</span><span class="meeting_calendar_label_text" >'+lang['kmImeeting.equipment.status.unUse']+'</span>').appendTo(rightTd);
		
		$('<span class="meeting_calendar_label_holding">&nbsp;</span><span class="meeting_calendar_label_text">'+lang['kmImeeting.equipment.status.using']+'</span>').appendTo(rightTd);
