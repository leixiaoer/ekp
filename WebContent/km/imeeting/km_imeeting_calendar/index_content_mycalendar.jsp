			...
			seajs.use([
				...
				'lui/util/env'
					...
					topic.subscribe('calendar.thing.click',function(arg){
						...
						viewDialog.find(".fdPlaceDetail").text(arg.schedule.fdPlaceDetail);//设备信息
						viewDialog.find(".fdHoldDate").html(date);//召开时间
						viewDialog.find(".type").html(arg.schedule.type);
						viewDialog.find(".fdRemark").attr("title", env.fn.formatText(arg.schedule.fdRemark)).html(env.fn.formatText(arg.schedule.fdRemark));//备注
