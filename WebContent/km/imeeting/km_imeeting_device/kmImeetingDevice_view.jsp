...
<div id="optBarDiv">
	<kmss:auth requestURL="/km/imeeting/km_imeeting_device/kmImeetingDevice.do?method=edit&fdId=${JsParam.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.edit"/>"
			onclick="Com_OpenWindow('kmImeetingDevice.do?method=edit&fdId=${JsParam.fdId}','_self');">
	</kmss:auth>
	<kmss:auth requestURL="/km/imeeting/km_imeeting_device/kmImeetingDevice.do?method=delete&fdId=${JsParam.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.delete"/>"
			onclick="if(!confirmDelete())return;Com_OpenWindow('kmImeetingDevice.do?method=delete&fdId=${JsParam.fdId}','_self');">
	</kmss:auth>
	<input type="button"
...
<table class="tb_normal" width=95%>
	...
	<tr>
		...
		<td width=85% colspan="3">
			<c:out value="${kmImeetingDeviceForm.authEditorNames}" />
		</td>
	</tr>
	...
	<tr>
		...
		<td width="85%" colspan="3">
			<c:out value="${kmImeetingDeviceForm.authReaderNames}" />
		</td>
	</tr>
