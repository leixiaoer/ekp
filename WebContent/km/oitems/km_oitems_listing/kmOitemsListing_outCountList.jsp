...
function isNullDate(){
 ...
 function clear_data(){
	...
	document.getElementById("listIframe").src = '<c:url value="/km/oitems/km_oitems_listing/kmOitemsListing.do?method=outCountData" />';
 }
 function checkDate(){
	 if(isNullDate()){
 ...
 window.onload =function (){
	...
	function loadList(){
		...
		document.getElementById("listIframe").src = '<c:url value="/km/oitems/km_oitems_listing/kmOitemsListing.do?method=outCountData" />&fdStartTime='+fdStartTime+'&fdEndTime='+fdEndTime
	...
	<ui:content id="kmOitemsOutCountContent" title="${ lfn:message('km-oitems:kmOitems.tree.reporting2') }">
		<div id="contentDiv" style="width:95%;min-height:500px;padding:20px">
		    <div style="float:right;padding-right:30px">
					<ui:button text="${lfn:message('button.export') }" order="2" onclick="Com_SubmitNoEnabled(document.kmOitemsListingForm, 'outCountExport');">
					</ui:button>
			</div>
			<center>
