	...
	<template:replace name="content">
		<c:choose>
			<c:when test="${param.filter == '1' }">
				<c:import url="/km/asset/km_asset_apply_inventory/mobile/filter.jsp" charEncoding="UTF-8">
				</c:import>
			</c:when>
			<c:otherwise>
				<c:import url="/km/asset/km_asset_apply_inventory/mobile/listview.jsp" charEncoding="UTF-8">
				</c:import>
			</c:otherwise>
		</c:choose>
