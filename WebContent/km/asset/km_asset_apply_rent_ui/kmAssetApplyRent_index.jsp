...
<%@page import="com.landray.kmss.sys.config.dict.SysDataDict"%>
	<%
		String mainModelName = "com.landray.kmss.km.asset.model.KmAssetApplyRent";
...
<div id="usualCateDiv">	
	<ui:dataview>
		...
		<ui:source type="AjaxJson">
		    {"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=listUsual&mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyRent&fdTempKey=KmAssetApplyRentDoc"}
		</ui:source>
		<ui:render type="Template">
				{$
				<div id="catexiao">
					<div class="lui-cate-panel-heading usual-cate-title">		     
						 <h2 class="lui-cate-panel-heading-title"><bean:message key="kmAssetApplyTemplate.enum.fdType9" bundle="km-asset"/></h2> 
					</div>
