			...
			<c:if test="${empty  txttitle}">
			 ...
			 <div class="lui_form_content_frame" style="padding-top:20px"> 
				...
				<tr>
					...
					<td colspan="5">
						<c:if test="${kmAssetApplyChangeForm.titleRegulation==null || kmAssetApplyChangeForm.titleRegulation=='' }">
				...
				<tr>
					...
					<td width="19%">
						    <html:hidden property="fdApplyTemplateId" value="${kmAssetApplyChangeForm.fdApplyTemplateId}"/>
							<html:hidden property="fdApplyTemplateName" />
							<c:out value="${kmAssetApplyChangeForm.fdApplyTemplateName}"/>
					</td>
					<!--申请单编号 -->
					...
					<td colspan="3">  
						<c:choose>
							<c:when test='${kmAssetApplyChangeForm.fdNo!=null}'>
							    <xform:text property="fdNo" style="width:95%" showStatus="view"/>
							</c:when>
							<c:otherwise>
				...
				<tr>
					...
					<td width="19%"><html:hidden property="fdDeptId" />
						<xform:address propertyId="fdDeptId"
								propertyName="fdDeptName" orgType="ORG_TYPE_DEPT" style="width:95%" showStatus="view"/>
					</td>	
					<!--申请日期-->
					<td class="td_normal_title" width=15%><bean:message
						bundle="km-asset" key="kmAssetApplyBase.fdCreateDate" /></td>
					<td width="19%"><xform:datetime property="fdCreateDate" showStatus="view" style="width:95%" /></td>
				</tr>
