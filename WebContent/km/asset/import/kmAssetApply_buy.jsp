...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		 ...
		 <ui:content title="${lfn:message('km-asset:kmAsset.buy.inventory') }">
		 	 <%--  <ui:iframe id="bank" src="${LUI_ContextPath }/km/asset/km_asset_apply_buy_ui/kmAssetApplyBuy_index.jsp?fdTempKey=KmAssetApplyBuyDoc&except=docStatus:10_00&path=/kmAsset_buy"></ui:iframe> --%>
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyBuyDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_buy/kmAssetApplyBuy.do?method=list&q.except=docStatus:00&fdTempKey=KmAssetApplyBuyDoc&q.j_path=/kmAsset_buy'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
		  ...
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">
			   <ui:content title="${lfn:message('km-asset:kmAsset.buy.inventory.create') }">
			   <%@ include file="/km/asset/km_asset_apply_buy_ui/kmAssetApplyBuy_index.jsp"%>
			  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyBuy&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyBuyDoc&title=kmAssetApplyTemplate.enum.fdType1"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
