...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		  ...
		  <ui:content title="${lfn:message('km-asset:kmAsset.rentAnddivert.divert') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyDivertDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_divert/kmAssetApplyDivert.do?method=list&except=docStatus:00&fdTempKey=KmAssetApplyDivertDoc&q.j_path=/kmAsset_divert'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
			...
			seajs
		 	  ...
		 	  <%-- <ui:iframe id="divert" src="${LUI_ContextPath }/km/asset/km_asset_apply_divert_ui/kmAssetApplyDivert_index.jsp?fdTempKey=KmAssetApplyDivertDoc&except=docStatus:10_00&path=/kmAsset_divert"></ui:iframe> --%>
		  </ui:content>
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">	
			   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
			     <%@ include file="/km/asset/km_asset_apply_divert_ui/kmAssetApplyDivert_index.jsp"%>
			  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyDivert&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyDivertDoc&title=kmAssetApplyTemplate.enum.fdType5"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
