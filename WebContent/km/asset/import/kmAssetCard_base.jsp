...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		 ...
		 <ui:content title="${ lfn:message('km-asset:table.kmAssetCard') }">
		...
		<list:criteria id="cardcriteria">
			...
			<list:cri-auto modelName="com.landray.kmss.km.asset.model.KmAssetAddress" property="fdAddress" />
				...
				<div style="display: inline-block;vertical-align: middle;">
					<ui:toolbar id="Btntoolbar">
					   <ui:togglegroup order="0">
						...
						<ui:button id="addBatchPrint" text="${lfn:message('km-asset:kmAssetCard.batchPrint')}" order="2" onclick="addBatchPrint();"></ui:button>
		...
		<list:listview id="cardListView">
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_card_index/kmAssetCardIndex.do?method=list&nodeType=${JsParam.nodeType}&q.except=fdAssetStatus:5&q.j_path=/kmAsset_bank'}
			</ui:source>
        ...
        %>
	 	...
	 	seajs.use(['lui/jquery', 'lui/util/str', 'lui/dialog','lui/topic','lui/toolbar'], function($, strutil, dialog , topic,toolbar) {
			...
			window.addBatchPrint = function(){
				...
				// 限制打印数量不能超过200
				if(ids.length > 200) {
					dialog.alert('${lfn:message("km-asset:kmAssetCard.batchPrint.tips")}');
					return false;
				}
				if(isSelected==false) {
					dialog.alert('<bean:message key="page.noSelect"/>');
				...
				document.batchPrintForm.batchPrintFdIds.value = ids.join(",");
			...
			window.exportResult=function (){
				...
				if(values.length == 0){
					...
					url +='&fdNum=999999999&fdColumns=fdName;fdCode;fdAssetCategory;fdNo;fdStandard;fdMeasure;fdFirstValue;fdFirstUnit;fdProvider;fdCanUseYears;docDeptCode;docDept;fdAssetAddress;fdResponsiblePerson;fdBuyer;fdBuyDate;fdInDeptNo;fdInDeptDate;fdWarranty;fdAssetStatus;fdFirstUsedDate;fdExplanation;fdContent'
