...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		 ...
		 <ui:content title="${lfn:message('km-asset:kmAsset.getAndreturn.get') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyGetDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_get/kmAssetApplyGet.do?method=list&q.except=docStatus:00&fdTempKey=KmAssetApplyGetDoc&q.j_path=/kmAsset_get'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
		  ...
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">	
			   ...
			   <%@ include file="/km/asset/km_asset_apply_get_ui/kmAssetApplyGet_index.jsp"%>
			  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyGet&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyGetDoc&title=kmAssetApplyTemplate.enum.fdType4"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
