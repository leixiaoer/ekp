...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		  <ui:tabpanel layout="sys.ui.tabpanel.list">
		   <ui:content title="${lfn:message('km-asset:table.kmAssetApplyInventory') }">
		 	 	<script type="text/javascript">
			function addDoc(){
		...
		<ui:fixed elem=".lui_list_operation"></ui:fixed>
	 	...
	 	<list:listview id="listview">
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_inventory/kmAssetApplyInventory.do?method=data&categoryId=${param.categoryId}&q.except=docStatus:00&q.j_path=/kmAsset_inventory'}
			</ui:source>
			<!-- 列表视图 -->	
			<list:colTable isDefault="false"
				...
				<list:col-auto props="docSubject;fdDescription;docStatus;docCreateTime;fdNo;fdAssetStatus;fdText;docCreator.fdName;fdTask.docSubject;fdApplyTemplate.fdName"></list:col-auto>
			</list:colTable>
			<!-- 摘要视图 -->	
				 ...
				 <div class="clearfloat lui_listview_rowtable_summary_content_box">
					...
					<dl>
						...
						<dd class="lui_listview_rowtable_summary_content_box_foot_info">
							...
							<%-- <span>${lfn:message('km-asset:kmAssetApplyInventory.fdAssetCard') }：{%row['fdAssetCard.docSubject']%}</span> --%>
