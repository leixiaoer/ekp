...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		  ...
		  <ui:content title="${lfn:message('km-asset:kmAsset.changeAnddeal.deal') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyDealDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_deal/kmAssetApplyDeal.do?method=list&except=docStatus:00&fdTempKey=KmAssetApplyDealDoc&q.j_path=/kmAsset_deal'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
			...
			seajs
		 	 ...
		 	 <%--  <ui:iframe id="deal" src="${LUI_ContextPath }/km/asset/km_asset_apply_deal_ui/kmAssetApplyDeal_index.jsp?fdTempKey=KmAssetApplyDealDoc&except=docStatus:10_00&path=/kmAsset_deal"></ui:iframe> --%>
		  </ui:content>
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">	
		   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
		    <%@ include file="/km/asset/km_asset_apply_deal_ui/kmAssetApplyDeal_index.jsp"%>
		  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyDeal&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyDealDoc&title=kmAssetApplyTemplate.enum.fdType7"></c:import> --%>
		  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
