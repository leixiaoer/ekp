...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		 ...
		 <ui:content title="${lfn:message('km-asset:kmAsset.rentAnddivert.rent') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyRentDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_rent/kmAssetApplyRent.do?method=list&except=docStatus:00&fdTempKey=KmAssetApplyRentDo&q.j_path=/kmAsset_rent'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
			...
			seajs
		 	...
		 	<%--   <ui:iframe id="rent" src="${LUI_ContextPath }/km/asset/km_asset_apply_rent_ui/kmAssetApplyRent_index.jsp?fdTempKey=KmAssetApplyRentDoc&except=docStatus:10_00&path=/kmAsset_rent"></ui:iframe> --%>
		  </ui:content>
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">	
			   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
			     <%@ include file="/km/asset/km_asset_apply_rent_ui/kmAssetApplyRent_index.jsp"%>
			  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyRent&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyRentDoc&title=kmAssetApplyTemplate.enum.fdType9"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
