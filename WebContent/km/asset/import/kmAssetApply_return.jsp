...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		  <ui:tabpanel layout="sys.ui.tabpanel.list">
		   <ui:content title="${lfn:message('km-asset:kmAsset.getAndreturn.return') }">
		 	 <%--  <ui:iframe id="return" src="${LUI_ContextPath }/km/asset/km_asset_apply_return_ui/kmAssetApplyReturn_index.jsp?fdTempKey=KmAssetApplyReturnDoc&except=docStatus:10_00&path=/kmAsset_return"></ui:iframe> --%>
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyReturnDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_return/kmAssetApplyReturn.do?method=list&q.except=docStatus:00&fdTempKey=KmAssetApplyReturnDoc&q.j_path=/kmAsset_return'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
		  ...
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">
			   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
			     <%@ include file="/km/asset/km_asset_apply_return_ui/kmAssetApplyReturn_index.jsp"%>
			  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyReturn&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyReturnDoc&title=kmAssetApplyTemplate.enum.fdType10"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
