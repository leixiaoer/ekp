...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		 ...
		 <ui:content title="${lfn:message('km-asset:kmAsset.stockAndin.stock') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyStockDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_stock/kmAssetApplyStock.do?method=list&except=docStatus:00&fdTempKey=KmAssetApplyStockDoc&q.j_path=/kmAsset_stock'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
			...
			seajs
		 	 ...
		 	 <%--  <ui:iframe id="stock" src="${LUI_ContextPath }/km/asset/km_asset_apply_stock_ui/kmAssetApplyStock_index.jsp?fdTempKey=KmAssetApplyStockDoc&except=docStatus:10_00&path=/kmAsset_stock"></ui:iframe> --%>
		  </ui:content>
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">	
			   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
			     <%@ include file="/km/asset/km_asset_apply_stock_ui/kmAssetApplyStock_index.jsp"%>
			  <%--  <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyStock&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyStockDoc&title=kmAssetApplyTemplate.enum.fdType2"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
