...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		 ...
		 <ui:content title="${lfn:message('km-asset:kmAsset.repair.list') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyRepairDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_repair/kmAssetApplyRepair.do?method=list&except=docStatus:00&fdTempKey=KmAssetApplyRepairDoc&q.j_path=/kmAsset_repair'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
			...
			seajs
		 	 ...
		 	 <%--  <ui:iframe id="repair" src="${LUI_ContextPath }/km/asset/km_asset_apply_repair_ui/kmAssetApplyRepair_index.jsp?fdTempKey=KmAssetApplyRepairDoc&except=docStatus:10_00&path=/kmAsset_repair"></ui:iframe> --%>
		  </ui:content>
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">
			   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
			   <%@ include file="/km/asset/km_asset_apply_repair_ui/kmAssetApplyRepair_index.jsp"%>
			   <%-- <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyRepair&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyRepairDoc&title=kmAssetApplyTemplate.enum.fdType6"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
