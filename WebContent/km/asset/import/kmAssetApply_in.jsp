...
<template:include  ref="default.simple">
	...
	<div style="width:100%;">
		  ...
		  <ui:content title="${lfn:message('km-asset:kmAsset.stockAndin.in') }">
				...
				<list:box-select>
					<list:item-select>
						<ui:source type="AjaxJson">
							{"url":"/km/asset/km_asset_apply_template/kmAssetApplyTemplate.do?method=criteria&fdTempKey=KmAssetApplyInDoc"} 
						</ui:source>
					</list:item-select>
				</list:box-select>
			</list:cri-criterion>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/km/asset/km_asset_apply_in/kmAssetApplyIn.do?method=list&except=docStatus:00&fdTempKey=KmAssetApplyInDoc&q.j_path=/kmAsset_in'}
			</ui:source>
			<list:colTable
		...
		<script type="text/javascript">
			...
			seajs
		 	 ...
		 	 <%--  <ui:iframe id="in" src="${LUI_ContextPath }/km/asset/km_asset_apply_in_ui/kmAssetApplyIn_index.jsp?fdTempKey=KmAssetApplyInDoc&except=docStatus:10_00&path=/kmAsset_in"></ui:iframe> --%>
		  </ui:content>
		  <kmss:authShow roles="ROLE_KMASSETAPPLY_CREATE">
			   <ui:content title="${lfn:message('km-asset:kmAsset.create') }">
			     <%@ include file="/km/asset/km_asset_apply_in_ui/kmAssetApplyIn_index.jsp"%>
			   <%-- <c:import charEncoding="UTF-8" url="/km/asset/import/kmAssetApplyBase_create.jsp?mainModelName=com.landray.kmss.km.asset.model.KmAssetApplyIn&modelName=com.landray.kmss.km.asset.model.KmAssetApplyTemplate&isSimpleCategory=false&fdTempKey=KmAssetApplyInDoc&title=kmAssetApplyTemplate.enum.fdType3"></c:import> --%>
			  </ui:content>
		  </kmss:authShow>
		</ui:tabpanel>
	  </div> 
