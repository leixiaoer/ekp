...
function commitMethod(method, saveDraft){
	...
	Com_Submit(document.kmAssetApplyReturnForm, method);
}
</script>
	<c:if test="${param.approveModel ne 'right'}">
		<form name="kmAssetApplyReturnForm" method="post" action ="${KMSS_Parameter_ContextPath}km/asset/km_asset_apply_return/kmAssetApplyReturn.do">
	</c:if>
	...
	<c:choose>
		<c:when test="${param.approveModel eq 'right'}">
			<ui:tabpage collapsed="true" id="reviewTabPage">
				...
				<c:import url="/km/asset/km_asset_apply_return_ui/kmAssetApplyReturn_editContent.jsp" charEncoding="UTF-8">
