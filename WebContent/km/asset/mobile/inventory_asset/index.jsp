...
<template:include ref="mobile.list" canHash="true">
	<template:replace name="title">
		...
		<c:if test="${param.moduleName==null || param.moduleName==''}">
			<c:out value="${lfn:message('km-asset:kmAsset.mobile.nav.inventory.asset')}"></c:out>
		</c:if>
	</template:replace>
	...
	<template:replace name="content">
		 ...
		 <c:import url="/km/asset/mobile/inventory_asset/listview.jsp" charEncoding="UTF-8"></c:import>
