...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/asset/mobile/purchase_asset/js/header/IndexListNavMixin">
	</div>
</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdCreateDate',subject:'<bean:message bundle="km-asset" key="kmAssetApplyBase.fdCreateDate"/>',value:'down'">
	</div>
    <%-- 排序（发布时间）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docPublishTime',subject:'<bean:message bundle="km-asset" key="kmAssetApplyBase.docPublishTime"/>',value:''">
	</div>	

	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		data-dojo-type="mui/property/FilterItem"
		data-dojo-mixins="km/asset/mobile/purchase_asset/js/header/PurchaseAssetPropertyMixin"></div>
</div>
