...
<template:replace name="title">
	<c:choose>
		<c:when test="${ kmAssetApplyRepairForm.method_GET == 'add' }">
			<c:out value="${lfn:message('km-asset:table.kmAssetApplyRepair.create') } - ${ lfn:message('km-asset:module.km.asset') }"></c:out>	
		</c:when>
		<c:otherwise>
