...
<table id="main" width="100%" class="tb_normal">
	...
	<tr align="center">
		<td><!-- 使用部门 --><script>document.write(Data_GetResourceString("km-asset:kmAssetCard.docDept"));</script></td>
		<td>
		<nobr>
	...
	<tr align="center">
		<td><!-- 责任人 --><script>document.write(Data_GetResourceString("km-asset:kmAssetCard.fdResponsiblePerson"));</script></td>
		<td>
		<nobr>
	...
	<tr align="center">
		<td><!-- 存放地点 --><script>document.write(Data_GetResourceString("km-asset:kmAssetCard.fdAssetAddress"));</script></td>
		<td>
		<nobr>
