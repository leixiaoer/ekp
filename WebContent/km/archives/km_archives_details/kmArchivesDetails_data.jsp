...
<list:data>
    <list:data-columns var="kmArchivesDetails" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column col="fdReturnDate" title="${lfn:message('km-archives:kmArchivesDetails.fdReturnDate')}">
			<kmss:showDate value="${not empty kmArchivesDetails.fdRenewReturnDate ? kmArchivesDetails.fdRenewReturnDate : kmArchivesDetails.fdReturnDate }" type="datetime"></kmss:showDate>
		</list:data-column>
