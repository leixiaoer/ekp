...
<template:include ref="default.list" spa="true">
    ...
    <template:replace name="content">
        ...
        <ui:content cfg-route="{path:'/listAll/myCreate'}" id="kmArchivesMyCreate" title="${lfn:message('km-archives:py.WoLuRuDe')}">
        	<ui:iframe src="${LUI_ContextPath }/km/archives/km_archives_main/myExamine.jsp"></ui:iframe>
        </ui:content>
        <!-- 档案录入 -->
        <ui:content cfg-route="{path:'/listAll/addArchives'}" id="kmArchivesMyDoc" title="档案录入">
		...
		%>
        <ui:content cfg-route="{path:'/listAll/myDrafts'}" id="kmArchivesMyDrafts" title="草稿箱 ">
