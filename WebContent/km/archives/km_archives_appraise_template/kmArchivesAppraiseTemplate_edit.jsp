...
<script type="text/javascript">
    var editOption = {
        formName: 'kmArchivesAppraiseTemplateForm',
...
<html:form action="/km/archives/km_archives_appraise_template/kmArchivesAppraiseTemplate.do">
    <div id="optBarDiv">
        <c:choose>
            <c:when test="${kmArchivesAppraiseTemplateForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="Com_Submit(document.kmArchivesAppraiseTemplateForm, 'update');">
            </c:when>
            <c:when test="${kmArchivesAppraiseTemplateForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="Com_Submit(document.kmArchivesAppraiseTemplateForm, 'save');">
            </c:when>
        </c:choose>
                    ...
                    <table class="tb_normal" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                <xform:checkbox property="fdDefaultFlag" value="${ kmArchivesAppraiseTemplateForm.fdDefaultFlag}" showStatus="edit">
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div class="description_txt">
									<bean:message bundle="km-archives" key="kmArchivesAppraiseTemplate.authReaders.description"/>
								</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" width="85.0%">
                                ...
                                <div class="description_txt">
									<bean:message bundle="km-archives" key="kmArchivesAppraiseTemplate.authEditors.description"/>
								</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="35%">
                            	${kmArchivesAppraiseTemplateForm.docCreatorName}
                            </td>
                            <td class="td_normal_title" width="15%">
