	...
	<c:otherwise>
		<c:choose>
			<c:when test="${lbpmApproveModel eq 'right'}">
				<template:include ref="lbpm.right" isEdit="false" fdUseForm="false"  formName="kmArchivesMainForm" formUrl="${KMSS_Parameter_ContextPath}km/archives/km_archives_main/kmArchivesMain.do">
					<c:import url="/km/archives/km_archives_main/kmArchivesMain_viewHead_onUse.jsp" >
			...
			<c:otherwise>
				<template:include ref="default.view" sidebar="auto">
					<c:import url="/km/archives/km_archives_main/kmArchivesMain_viewHead_onUse.jsp" ></c:import>
