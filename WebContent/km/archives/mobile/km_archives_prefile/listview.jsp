...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/archives/mobile/km_archives_prefile/js/header/IndexListNavMixin">
	</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdFileDate',subject:'<bean:message key="kmArchivesMain.fdFileDate" bundle="km-archives" />',value:'down'">
	</div>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdLibrary',subject:'<bean:message key="kmArchivesMain.fdLibrary" bundle="km-archives" />',value:''">
	</div>

	<%-- 默认筛选器头部模板 ,catekey: 'fdTemplate'--%>
	<div class="muiHeaderItemRight" 
		data-dojo-type="mui/property/FilterItem"
		data-dojo-mixins="km/archives/mobile/km_archives_prefile/js/header/ArchivesPrefilePropertyMixin"></div>
	<div class="muiHeaderItemRight" 
		data-dojo-type="mui/catefilter/FilterItem"
		data-dojo-mixins="mui/simplecategory/SimpleCategoryMixin"
		data-dojo-props="modelName: 'com.landray.kmss.km.archives.model.KmArchivesCategory',catekey: 'docTemplate'"></div>
</div>
...
<div data-dojo-type="mui/list/NavView">
	...
	<ul data-dojo-type="mui/list/HashJsonStoreList" class="muiList"
		data-dojo-mixins="km/archives/mobile/resource/js/TextItemListMixin">
	</ul>
</div>
