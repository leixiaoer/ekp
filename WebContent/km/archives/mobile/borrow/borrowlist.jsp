...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/archives/mobile/borrow/js/header/IndexListNavMixin">
	</div>
	
	<%-- 搜索 --%>
	<div data-dojo-type="mui/search/SearchButtonBar"
		 data-dojo-props="modelName:'com.landray.kmss.km.archives.model.KmArchivesDetails'">
	</div>
</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'fdReturnDate',subject:'<bean:message key="mui.kmArchivesDetails.fdReturnDate" bundle="km-archives" />',value:'down'">
	</div>
</div>
...
<div data-dojo-type="mui/list/NavView">
	...
	<ul data-dojo-type="mui/list/HashJsonStoreList" class="muiList"
		data-dojo-mixins="km/archives/mobile/borrow/js/TextItemListMixin">
	</ul>
</div>
