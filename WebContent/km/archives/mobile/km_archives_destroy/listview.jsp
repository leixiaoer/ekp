...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/archives/mobile/km_archives_destroy/js/header/IndexListNavMixin">
	</div>
	
	<%-- 搜索 --%>
	<div data-dojo-type="mui/search/SearchButtonBar"
		 data-dojo-props="modelName:'com.landray.kmss.km.archives.model.KmArchivesDestroy'">
	</div>
</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docCreateTime',subject:'<bean:message key="mobile.destroy.date" bundle="km-archives" />',value:'down'">
	</div>

	<%-- 默认筛选器头部模板 ,catekey: 'fdTemplate'--%>
	<div class="muiHeaderItemRight" 
		data-dojo-type="mui/property/FilterItem"
		data-dojo-mixins="km/archives/mobile/km_archives_destroy/js/header/ArchivesAppraisalPropertyMixin"></div>
	<%--<div class="muiHeaderItemRight" 
