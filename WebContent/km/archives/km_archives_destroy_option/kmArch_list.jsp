...
function dosearch(){
	...
	window.location.href ="${KMSS_Parameter_ContextPath}km/archives/km_archives_destroy/kmArchDestroyOption.do?method=checkArchList&categoryId=${fdCategoryId}&keywords="+keywords+"&fdCurDestroyId=${fdCurDestroyId}";
}
 function showHistory(index,fdId,selectInit){
	...
	window.parent.frames[2].location.href = "${KMSS_Parameter_ContextPath}km/archives/km_archives_destroy/kmArchDestroyOption.do?method=checkList&fdId="+text.substring(0, text.length-1)+"&fdCurDestroyId=${fdCurDestroyId}";
}
