...
%>
<input onclick="file_importFields();" class="lui_form_button" type="button" value="${lfn:message('km-archives:kmArchivesFileTemplate.importFields') }" style="float:right;cursor:pointer;"/>
<script>
//获得自定义表单的属性
