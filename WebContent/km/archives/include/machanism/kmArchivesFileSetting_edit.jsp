...
<table class="tb_normal" width=100% style="border-top:0;">
	...
	<tr>
		...
		<td colspan="3">
			<p>
				<xform:radio property="mechanismMap(KmArchivesFileTemplate).selectFilePersonType" onValueChange="file_changeFilePerson">
			...
			<p>
				<div id="orgSelect">
					<xform:address orgType="ORG_TYPE_PERSON" subject="${lfn:message('km-archives:kmArchivesFileTemplate.fdFilePerson') }" style="width:220px;" propertyName="mechanismMap(KmArchivesFileTemplate).fdFilePersonName" propertyId="mechanismMap(KmArchivesFileTemplate).fdFilePersonId">
					</xform:address>
				</div>
	...
	<tr>
		...
		<td colspan="3">
			<select ftype="com.landray.kmss.sys.organization.model.SysOrgElement" name="mechanismMap(KmArchivesFileTemplate).fdKeeperMapping" class="inputsgl" style="width:220px;">
				<c:import url="/km/archives/include/kmArchivesFileSetting_editOptions.jsp" charEncoding="UTF-8">
	...
	<tr>
		...
		<td colspan="3">
			<select ftype="String" name="kmArchivesFileTemplateForm.fdDenseLevelMapping" class="inputsgl" style="width:220px;">
				<c:import url="/km/archives/include/kmArchivesFileSetting_editOptions.jsp" charEncoding="UTF-8">
					<c:param name="type" value="String|com.landray.kmss.km.imissive.model.KmImissiveSecretGrade" />
