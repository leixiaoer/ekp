...
<c:if test="${param.mechanismMap == 'true'}">
	<c:set var="fileForm" value="${templateForm.mechanismMap['KmArchivesFileTemplate']}" />
</c:if>
<!-- 设计器区域 -->
...
<table class="tb_normal" width=100% style="border-top:0;">
	...
	<tr>
		...
		<td colspan="3">
            <xform:dialog propertyId="mechanismMap(KmArchivesFileTemplate).categoryId" propertyName="mechanismMap(KmArchivesFileTemplate).categoryName" showStatus="view" style="width:220px;">
            	Dialog_SimpleCategory('com.landray.kmss.km.archives.model.KmArchivesCategory','mechanismMap(KmArchivesFileTemplate).categoryId','mechanismMap(KmArchivesFileTemplate).categoryName',false,null,'01',file_afterSelectCategory,false);
            </xform:dialog>
		</td>
	</tr>
	<tr>
		...
		<td colspan="3">
			<%-- <p>
				<xform:radio property="mechanismMap(KmArchivesFileTemplate).selectFilePersonType">
			...
			<p>
				<c:choose>
					<c:when test="${'org' eq fileForm.selectFilePersonType }">
						<xform:address showStatus="view" style="width:220px;" propertyName="mechanismMap(KmArchivesFileTemplate).fdFilePersonName" propertyId="mechanismMap(KmArchivesFileTemplate).fdFilePersonId">
						</xform:address>
					</c:when>
					<c:otherwise>
