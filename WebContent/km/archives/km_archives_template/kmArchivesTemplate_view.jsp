...
<div id="optBarDiv">
    <kmss:auth requestURL="/km/archives/km_archives_template/kmArchivesTemplate.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${ lfn:message('button.edit') }" onclick="Com_OpenWindow('kmArchivesTemplate.do?method=edit&fdId=${param.fdId}','_self');">
    </kmss:auth>
    <kmss:auth requestURL="/km/archives/km_archives_template/kmArchivesTemplate.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${ lfn:message('button.delete') }" onclick="if(!confirmDelete())return;Com_OpenWindow('kmArchivesTemplate.do?method=delete&fdId=${param.fdId}','_self');">
    </kmss:auth>
            ...
            <td>
                <table class="tb_normal" width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="3" width="85.0%">
                        	<xform:checkbox property="listDenseLevelIds" showStatus="view"
                    ...
                    <tr>
                        ...
                        <td colspan="3" width="85.0%">
                            <xform:checkbox property="fdDefaultFlag" value="${ kmArchivesTemplateForm.fdDefaultFlag}" showStatus="view">
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            <ui:person personId="${kmArchivesTemplateForm.docCreatorId}" personName="${kmArchivesTemplateForm.docCreatorName}" />
                        </td>
                        <td class="td_normal_title" width="15%">
