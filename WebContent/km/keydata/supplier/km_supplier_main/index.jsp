...
<template:include file="/sys/profile/resource/template/list.jsp">
	<template:replace name="content">
		...
		<list:criteria id="criteria">
		     <list:cri-ref key="fdName" ref="criterion.sys.docSubject" title="${lfn:message('km-keydata-supplier:kmSupplierMain.fdName') }">
			</list:cri-ref>
		</list:criteria>
		<!-- 操作栏 -->
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
						<list:sort property="docCreateTime" text="${lfn:message('km-keydata-supplier:kmSupplierMain.docCreateTime') }" group="sort.list" value="down"></list:sort>
					</ui:toolbar>
				</div>
			</div>
			<!-- 分页 -->
				...
				<div style="display: inline-block;vertical-align: middle;">
					<ui:toolbar id="Btntoolbar">
						...
						<c:import url="/sys/right/import/cchange_doc_right_button.jsp" charEncoding="UTF-8">
							<c:param name="modelName" value="com.landray.kmss.km.keydata.supplier.model.KmSupplierMain" />
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/km/keydata/supplier/km_supplier_main/kmSupplierMain.do?method=listChildren&fdIsAvailable=${param.fdIsAvailable}&categoryId=${param.categoryId}'}
			</ui:source>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable" 
			     rowHref="/km/keydata/supplier/km_supplier_main/kmSupplierMain.do?method=showUsed&fdId=!{fdId}">
				<list:col-checkbox></list:col-checkbox>
				<list:col-serial></list:col-serial>
				<list:col-auto props="fdName,fdCode,fdLegal,fdRegMoney,fdContactPerson,docCreator.fdName,operations"></list:col-auto>
			</list:colTable>
		</list:listview>
		<br>
		<!-- 分页 -->
	 	...
	 	<script type="text/javascript">
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
		 		...
		 		window.addByDialog = function(){
			 		...
			 		var modelName = 'com.landray.kmss.km.keydata.supplier.model.KmSupplierCategory';
			 		var urlParam = '/km/keydata/supplier/km_supplier_main/kmSupplierMain.do?method=add&fdTemplateId=!{id}&fdTemplateName=!{name}';
		 		...
		 		window.add = function(){
		 			Com_OpenWindow('<c:url value="/km/keydata/supplier/km_supplier_main/kmSupplierMain.do" />?method=add&fdTemplateId=${param.categoryId}');
			 	}

		 		window.edit = function(id){
					if(id){
						Com_OpenWindow('<c:url value="/km/keydata/supplier/km_supplier_main/kmSupplierMain.do?method=edit&fdId=" />'+id,'_blank');
					}
				};
		 		...
		 		window.disableAll = function(id){
					...
					if(id){
						values.push(id);
						$.post('<c:url value="/km/keydata/supplier/km_supplier_main/kmSupplierMain.do?method=disableAll"/>',
				...
				window.enableAll = function(id){
					...
					if(id){
						values.push(id);
						$.post('<c:url value="/km/keydata/supplier/km_supplier_main/kmSupplierMain.do?method=enableAll"/>',
								$.param({"List_Selected":values},true),delCallback,'json');
					}else{
						$("input[name='List_Selected']:checked").each(function(){
							values.push($(this).val());
