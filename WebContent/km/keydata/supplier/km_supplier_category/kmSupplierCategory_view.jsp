...
<div id="optBarDiv">
	<kmss:auth requestURL="/km/keydata/supplier/km_supplier_category/kmSupplierCategory.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.edit"/>"
			onclick="Com_OpenWindow('kmSupplierCategory.do?method=edit&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<kmss:auth requestURL="/km/keydata/supplier/km_supplier_category/kmSupplierCategory.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.delete"/>"
			onclick="if(!confirmDelete())return;Com_OpenWindow('kmSupplierCategory.do?method=delete&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<input type="button"
...
<table class="tb_normal" width=95%>
	...
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<c:out value="${kmSupplierCategoryForm.docCreatorName}" />
		</td>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="km-keydata-supplier" key="kmSupplierCategory.docAlteror"/>
		</td><td width="35%">
			<c:out value="${kmSupplierCategoryForm.docAlterorName}" />
		</td>
	</tr>
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<c:out value="${kmSupplierCategoryForm.docAuthorName}" />
		</td>
