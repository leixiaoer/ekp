...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar" 
		 data-dojo-props="modelName:'com.landray.kmss.km.institution.model.KmInstitutionKnowledge'"> 
	</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docCreateTime',subject:'<bean:message bundle="km-institution" key="mobile.kmInstitution.effectiveTime" />',value:'down'">
	</div>
    <%-- 排序（生效时间）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docPublishTime',subject:'<bean:message bundle="km-institution" key="mobile.kmInstitution.entryTime" />',value:''">
	</div>
	
	<%-- 默认筛选器头部模板 --%>
	<div class="muiHeaderItemRight" 
		 data-dojo-type="mui/property/FilterItem"
		 data-dojo-mixins="km/institution/mobile/resource/js/header/InstitutionPropertyMixin"></div>
	<div class="muiHeaderItemRight" 
		 data-dojo-type="mui/catefilter/FilterItem"
		 data-dojo-mixins="mui/simplecategory/SimpleCategoryMixin"
		 data-dojo-props="modelName: 'com.landray.kmss.km.institution.model.KmInstitutionTemplate',catekey: 'categoryId',prefix:''"></div>
</div>
...
<div data-dojo-type="mui/list/NavView">
	...
	<ul data-dojo-type="mui/list/HashJsonStoreList" 
		data-dojo-mixins="mui/list/DocItemListMixin">
	</ul>
</div>
