...
<kmss:windowTitle subjectKey="km-institution:kmInstitutionKnowledge.param.config" moduleKey="km-institution:module.km.institution" />
...
<div style="margin-top:25px">
	...
	<input type="hidden" name="modelName" value="com.landray.kmss.km.institution.model.KmInstitutionConfig" />
</html:form>
<script>
	$KMSSValidation();
</script>
