...
<list:data>
	<list:data-columns var="kmReviewTemplate" list="${queryPage.list }">
		...
		<list:data-column  property="fdName" title="${ lfn:message('km-review:kmReviewTemplate.fdName') }" style="text-align:left;min-width:180px">
		</list:data-column>
		<list:data-column headerClass="width80" col="fdIsAvailable" title="${ lfn:message('km-review:kmReviewTemplate.fdStatus') }" escape="false">
		...
		<list:data-column headerClass="width120" property="docCreateTime" title="${ lfn:message('km-review:kmReviewTemplate.docCreateTime') }">
		</list:data-column>
		<!-- 其它操作 -->
