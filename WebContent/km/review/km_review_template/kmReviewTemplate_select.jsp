		                   ...
		                   <c:forEach items="${extensions}" var="extension" varStatus="vstatus">
		                    <ui:content title="${extension.sourceName}">
		                        <ui:iframe id="template_listview_${extension.sourceUUID}"
		                                   src="${LUI_ContextPath }/${extension.sourceURL}?fdMainModelName=${JsParam.fdMainModelName}&fdKey=${JsParam.fdKey}&fdModelName=${JsParam.fdModelName}&parentId=${parentId}&version=${version}"></ui:iframe>
		                    </ui:content>
		  	 			</c:forEach>
		               </ui:tabpanel>
		         </div>
