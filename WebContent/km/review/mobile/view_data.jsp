		...
		<html:form action="/km/review/km_review_main/kmReviewMain.do">		
			<div id="scrollView"
				...
				<c:if test="${'true' eq kmReviewMainForm.fdIsMobileView}">
					    <div data-dojo-type="mui/panel/NavPanel" data-dojo-mixins="mui/panel/extend/_PromptPanelMixin" data-dojo-props="modelId:'${kmReviewMainForm.fdId }',modelName:'com.landray.kmss.km.review.model.KmReviewMain'">
					        <%--  审批内容    --%>
