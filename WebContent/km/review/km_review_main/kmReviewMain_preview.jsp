...
function openUrl(id,nodeType){
	...
	parent.moduleAPI.kmReview.openPreview(id);
...
<link rel="stylesheet" href="${KMSS_Parameter_ContextPath}km/review/resource/style/prestyle/previewnew.css" />
...
<a href="javascript:;" onclick="quickCreate();"><img  src="../resource/style/images/tips.png">
		...
		<div style="margin: 0 auto; padding-top:10px; background-color: #f7f7f7;">
			<h1 style="text-align:center;font-size:20px;margin-top:0px"><bean:message bundle="km-review" key="kmReview.tree.preview" /></h1>
		    <ui:dataview>
				<ui:source type="AjaxJson">
				    {"url":"/km/review/km_review_overview/kmReviewOverview.do?method=preview"}
				</ui:source>
