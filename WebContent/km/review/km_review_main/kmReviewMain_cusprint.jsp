...
<template:include ref="default.print">
	<template:replace name="content">
				...
				<%
					...
					String formBeanName = "kmReviewMainForm";
					...
					KmReviewMainForm mainForm = (KmReviewMainForm)request.getAttribute(mainFormName);
				...
				<c:if test="${not empty fdTmpFileName }">
					...
					<script type="text/javascript">
						...
						function domReady(){
							...
							$('form[name="sysPrintTemplateForm"] table[fd_type="table"]').css('width','100%');
