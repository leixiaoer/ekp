 ...
 * queue and then not know whether to consume the EXDATE or not.
 * <p>
...
final class DateValueComparison {
	...
	/**
	 * reduces a date to a value that can be easily compared to others,
	 * consistent with {@link com.google.ical.values.DateValueImpl#compareTo}.
	 */
	static long comparable(DateValue dv) {
		...
		if (dv instanceof TimeValue) {
			...
			// It would be odd if an all day exclusion matched a midnight event
			// on
