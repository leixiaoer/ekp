...
public class PeriodValueImpl implements PeriodValue {
	 ...
	 *            non null.
	 * @param end
	 *            on or after start. May/must have a time if the start has a
	 *            time.
	 */
	 ...
	 *            non null.
	 * @param dur
	 *            a positive duration represented as a DateValue.
	 */
	...
	public boolean intersects(PeriodValue pv) {
		DateValue sa = this.start, ea = this.end, sb = pv.start(), eb = pv
				.end();
